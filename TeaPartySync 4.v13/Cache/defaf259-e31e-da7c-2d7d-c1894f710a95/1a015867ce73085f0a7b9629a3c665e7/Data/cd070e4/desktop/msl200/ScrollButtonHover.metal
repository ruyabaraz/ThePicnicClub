...
//}
//ubo int UserUniforms 0:37:5296 {
//float4 sc_Time 1376
...
//float2 Port_Input1_N008 4728
//float2 Port_Input2_N008 4736
//float4 Port_Value0_N005 4752
//float Port_Position1_N005 4768
//float4 Port_Value1_N005 4784
//float Port_Position2_N005 4800
//float4 Port_Value2_N005 4816
//float4 Port_Value3_N005 4832
//float4 Port_Input1_N065 4848
//float3 Port_Normal_N064 4864
//float Port_Exponent_N064 4880
//float Port_Intensity_N064 4884
//float2 Port_Input1_N067 4888
//float2 Port_Input2_N067 4896
//float4 Port_Value0_N069 4912
//float Port_Position1_N069 4928
//float4 Port_Value1_N069 4944
//float Port_Position2_N069 4960
//float4 Port_Value2_N069 4976
//float Port_Position3_N069 4992
//float4 Port_Value3_N069 5008
//float4 Port_Value4_N069 5024
//float4 Port_Input0_N092 5040
//float4 Port_Input1_N092 5056
//float3 Port_Normal_N091 5072
//float Port_Exponent_N091 5088
//float Port_Intensity_N091 5092
//float4 Port_Input1_N093 5104
//float4 Port_Import_N074 5120
//float4 Port_Import_N075 5136
//float Port_Input0_N087 5152
//float Port_Input1_N087 5156
//float Port_RangeMinA_N076 5160
//float Port_RangeMaxA_N076 5164
//float Port_RangeMinB_N076 5168
//float Port_RangeMaxB_N076 5172
//float2 Port_CoordsIn_N090 5176
//float Port_Rotation_N090 5184
//float2 Port_Center_N090 5192
//float2 Port_Center_N078 5208
//float2 Port_Import_N079 5216
//float2 Port_Import_N081 5224
//float Port_Input1_N086 5232
//float Port_Input2_N086 5236
//float2 Port_Input1_N028 5240
//float2 Port_Input2_N028 5248
//float Port_Value0_N016 5256
//float Port_Position1_N016 5260
//float Port_Value1_N016 5264
//float Port_Position2_N016 5268
//float Port_Value2_N016 5272
//float Port_Position3_N016 5276
//float Port_Value3_N016 5280
//float Port_Value4_N016 5284
//float depthRef 5288
//}
...
float l9_255=abs(dot(-param_49.ViewDirWS,param_45));
float param_48=pow(1.0-l9_255,param_46);
...
float l9_256=abs(dot(-param_64.ViewDirWS,param_60));
float param_63=pow(1.0-l9_256,param_61);
...
float l9_257=sin(radians(param_66));
float l9_258=cos(radians(param_66));
float2 param_68=param_65-param_67;
param_68=float2(dot(float2(l9_258,l9_257),param_68),dot(float2(-l9_257,l9_258),param_68))+param_67;
...
{
float4 l9_259=gl_FragCoord;
float2 l9_260=floor(mod(l9_259.xy,float2(4.0)));
float l9_261=(mod(dot(l9_260,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_79<l9_261)
{
discard_fragment();
}
}
bool l9_262=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_262)
{
...
float4 l9_263=fast::max(param_80,float4(0.0));
float4 param_81=l9_263;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_272=param_82;
float4 l9_273=float4(0.0);
float4 l9_274=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_275=out.FragColor0;
float4 l9_276=l9_275;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_276.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_278=gl_FragCoord;
float2 l9_279=l9_278.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_280=l9_279;
...
int l9_284=l9_283;
int l9_285=l9_284;
float3 l9_286=float3(l9_280,0.0);
int l9_287=l9_282;
int l9_288=l9_285;
if (l9_287==1)
{
l9_286.y=((2.0*l9_286.y)+float(l9_288))-1.0;
}
float2 l9_289=l9_286.xy;
l9_281=l9_289;
}
else
{
...
int l9_300=l9_298;
float2 l9_301=l9_299;
int l9_302=l9_300;
float l9_303=0.0;
float4 l9_304=float4(0.0);
float2 l9_305=l9_301;
int l9_306=sc_ScreenTextureLayout_tmp;
int l9_307=l9_302;
float l9_308=l9_303;
...
float l9_316=l9_308;
float4 l9_317=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_315,bias(l9_316));
float4 l9_318=l9_317;
l9_304=l9_318;
...
{
l9_274.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_322=l9_274;
float4 l9_323=l9_322;
float3 l9_324=l9_323.xyz;
float3 l9_325=l9_324;
float3 l9_326=l9_272.xyz;
...
l9_273=float4(l9_327.x,l9_327.y,l9_327.z,l9_273.w);
float3 l9_328=mix(l9_324,l9_273.xyz,float3(l9_272.w));
l9_273=float4(l9_328.x,l9_328.y,l9_328.z,l9_273.w);
l9_273.w=1.0;
float4 l9_329=l9_273;
param_82=l9_329;
}
else
{
float4 l9_330=param_82;
float4 l9_331=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_331=float4(mix(float3(1.0),l9_330.xyz,float3(l9_330.w)),l9_330.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_332=l9_330.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_332=fast::clamp(l9_332,0.0,1.0);
}
l9_331=float4(l9_330.xyz*l9_332,l9_332);
}
else
{
l9_331=l9_330;
...
float4 l9_333=l9_331;
param_82=l9_333;
}
}
}
float4 l9_334=param_82;
FinalColor=l9_334;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_335=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_335=float4(0.0);
...
float4 l9_337=param_85;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_337.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_337;
return out;
}
} // FRAGMENT SHADER
