...
let MobileInteractor = class MobileInteractor extends BaseInteractor_1.default {
    ...
    updateDragVector() {
        ...
        if ((this.currentTrigger & Interactor_1.InteractorTriggerType.Select) !== 0) {
            ...
            this.planecastDragProvider.getDragVector(this.planecastPoint, (_b = (_a = this.currentInteractable) === null || _a === void 0 ? void 0 : _a.enableInstantDrag) !== null && _b !== void 0 ? _b : null);
        }
        else {
