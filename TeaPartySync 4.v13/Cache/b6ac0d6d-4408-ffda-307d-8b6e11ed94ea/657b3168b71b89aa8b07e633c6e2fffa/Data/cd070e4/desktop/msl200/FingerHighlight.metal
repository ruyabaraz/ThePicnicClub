...
//}
//ubo int UserUniforms 0:35:4624 {
//float4 sc_Time 1376
...
//float3x3 fingertipTransform 4352
//float4 fingertipUvMinMax 4400
//float4 fingertipBorderColor 4416
//float3x3 handGlowTexTransform 4480
//float4 handGlowTexUvMinMax 4528
//float4 handGlowTexBorderColor 4544
//float blend_coef 4560
//float4 thumbGlowColor 4576
//float thumbBrightness 4592
//float Port_Input0_N003 4596
//float Port_Input0_N011 4600
//float depthRef 4608
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_fingertip 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_handGlowTex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_fingertip 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_handGlowTex 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int fingertipLayout 84 0
//spec_const int handGlowTexLayout 85 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_fingertip [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_handGlowTex [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_fingertip [[function_constant(81)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_handGlowTex [[function_constant(82)]];
...
constant int fingertipLayout [[function_constant(84)]];
constant int fingertipLayout_tmp = is_function_constant_defined(fingertipLayout) ? fingertipLayout : 0;
constant int handGlowTexLayout [[function_constant(85)]];
...
float l9_80=l9_72;
float4 l9_81=sc_set0.fingertip.sample(sc_set0.fingertipSmpSC,l9_79,bias(l9_80));
float4 l9_82=l9_81;
float4 l9_83=l9_82;
if (param_14)
{
...
float param_27=0.0;
bool l9_91=param_25&&(!param_23);
float l9_92=1.0;
float l9_93=param_19.x;
int l9_94=param_22.x;
if (l9_94==1)
{
l9_93=fract(l9_93);
}
...
float l9_105=param_19.x;
float l9_106=param_24.x;
float l9_107=param_24.z;
bool l9_108=l9_104;
float l9_109=l9_92;
...
float l9_114=param_19.y;
float l9_115=param_24.y;
float l9_116=param_24.w;
bool l9_117=l9_113;
float l9_118=l9_92;
...
float2 l9_121=param_19;
bool l9_122=param_20;
float3x3 l9_123=param_21;
if (l9_122)
{
...
param_19=l9_126;
float l9_127=param_19.x;
int l9_128=param_22.x;
bool l9_129=l9_91;
float l9_130=l9_92;
...
param_19.x=l9_127;
l9_92=l9_130;
float l9_138=param_19.y;
int l9_139=param_22.y;
bool l9_140=l9_91;
float l9_141=l9_92;
...
param_19.y=l9_138;
l9_92=l9_141;
float2 l9_149=param_19;
int l9_150=param_17;
int l9_151=param_18;
float l9_152=param_27;
...
float l9_160=l9_152;
float4 l9_161=sc_set0.handGlowTex.sample(sc_set0.handGlowTexSmpSC,l9_159,bias(l9_160));
float4 l9_162=l9_161;
float4 l9_163=l9_162;
if (param_25)
{
l9_163=mix(param_26,l9_163,float4(l9_92));
}
...
float4 l9_165=param_36;
float4 l9_166=param_37;
float3 l9_167=l9_165.xyz*l9_165.w;
l9_165=float4(l9_167.x,l9_167.y,l9_167.z,l9_165.w);
float4 param_35=l9_165+(l9_166*(1.0-l9_165.w));
Output_N14=param_35;
...
float2 l9_169=floor(mod(l9_168.xy,float2(4.0)));
float l9_170=(mod(dot(l9_169,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_38<l9_170)
{
discard_fragment();
}
}
bool l9_171=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_171)
{
...
float4 l9_172=fast::max(param_39,float4(0.0));
float4 param_40=l9_172;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_175=fast::clamp(l9_174.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_175=fast::clamp(dot(l9_174.xyz,float3(l9_174.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_175=(1.0-dot(l9_174.xyz,float3(0.33333001)))*l9_174.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_175=(1.0-fast::clamp(dot(l9_174.xyz,float3(1.0)),0.0,1.0))*l9_174.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_175=fast::clamp(dot(l9_174.xyz,float3(1.0)),0.0,1.0)*l9_174.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_175=fast::clamp(dot(l9_174.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_175=dot(l9_174.xyz,float3(0.33333001))*l9_174.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_175=1.0-fast::clamp(dot(l9_174.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_176=l9_175;
float l9_177=l9_176;
float l9_178=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_177;
float3 l9_179=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_173.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_180=float4(l9_179.x,l9_179.y,l9_179.z,l9_178);
param_41=l9_180;
}
else
{
...
{
float4 l9_181=param_41;
float4 l9_182=float4(0.0);
float4 l9_183=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_184=out.FragColor0;
float4 l9_185=l9_184;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_185.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_188=l9_187.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_189=l9_188;
...
int l9_193=l9_192;
int l9_194=l9_193;
float3 l9_195=float3(l9_189,0.0);
int l9_196=l9_191;
int l9_197=l9_194;
if (l9_196==1)
{
l9_195.y=((2.0*l9_195.y)+float(l9_197))-1.0;
}
float2 l9_198=l9_195.xy;
l9_190=l9_198;
}
else
{
...
int l9_207=l9_202;
float2 l9_208=l9_201;
int l9_209=l9_207;
float2 l9_210=l9_208;
int l9_211=l9_209;
float l9_212=0.0;
float4 l9_213=float4(0.0);
float2 l9_214=l9_210;
...
float2 l9_224=l9_223.xy;
float l9_225=l9_217;
float4 l9_226=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_224,bias(l9_225));
float4 l9_227=l9_226;
l9_213=l9_227;
float4 l9_228=l9_213;
...
{
l9_183.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_231=l9_183;
float4 l9_232=l9_231;
float3 l9_233=l9_232.xyz;
float3 l9_234=l9_233;
float3 l9_235=l9_181.xyz;
float3 l9_236=definedBlend(l9_234,l9_235,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_182=float4(l9_236.x,l9_236.y,l9_236.z,l9_182.w);
float3 l9_237=mix(l9_233,l9_182.xyz,float3(l9_181.w));
l9_182=float4(l9_237.x,l9_237.y,l9_237.z,l9_182.w);
l9_182.w=1.0;
float4 l9_238=l9_182;
param_41=l9_238;
}
else
{
float4 l9_239=param_41;
...
{
l9_244=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_244=float4(0.0);
