...
//float blur 4576
//float2 boxSize 4584
//float cornerRadius 4592
//float Port_Speed_N022 4656
//float Port_Speed_N063 4704
//float4 Port_Default_N369 4720
//float Port_Default_N204 4776
//float Port_Input1_N098 4780
//float2 Port_Input1_N085 4784
//float2 Port_Input1_N089 4792
//float Port_Input1_N094 4800
//float3 Port_Input0_N073 4816
//float3 Port_Input1_N073 4832
//float2 Port_Input0_N042 4848
//float2 Port_Input1_N046 4856
//float Port_Input1_N047 4864
//float Port_Multiplier_N054 4868
//float Port_Input1_N078 4872
//float Port_Input1_N080 4876
//float Port_Input1_N079 4880
//float Port_Input1_N057 4884
//float Port_Input1_N070 4888
//float2 Port_Scale_N081 4896
//float Port_Input2_N082 4904
//float Port_Input2_N045 4908
//float Port_Input1_N099 4912
//float depthRef 4916
//}
...
constant int SC_SOFTWARE_WRAP_MODE_U_opacityTex [[function_constant(90)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_opacityTex [[function_constant(93)]];
...
constant int opacityTexLayout [[function_constant(96)]];
...
{
l9_624=pow(Output_N73.x,Output_N70);
}
float l9_625=l9_624;
float l9_626;
if (Output_N73.y<=0.0)
...
{
l9_626=pow(Output_N73.y,Output_N70);
}
float l9_627=l9_626;
float l9_628;
if (Output_N73.z<=0.0)
...
{
l9_628=pow(Output_N73.z,Output_N70);
}
Output_N48=float3(l9_625,l9_627,l9_628);
...
{
float4 l9_629=gl_FragCoord;
float2 l9_630=floor(mod(l9_629.xy,float2(4.0)));
float l9_631=(mod(dot(l9_630,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_18<l9_631)
{
discard_fragment();
}
}
bool l9_632=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_632)
{
...
float4 l9_633=fast::max(param_19,float4(0.0));
float4 param_20=l9_633;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_636=fast::clamp(l9_635.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_636=fast::clamp(dot(l9_635.xyz,float3(l9_635.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_636=(1.0-dot(l9_635.xyz,float3(0.33333001)))*l9_635.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_636=(1.0-fast::clamp(dot(l9_635.xyz,float3(1.0)),0.0,1.0))*l9_635.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_636=fast::clamp(dot(l9_635.xyz,float3(1.0)),0.0,1.0)*l9_635.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_636=fast::clamp(dot(l9_635.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_636=dot(l9_635.xyz,float3(0.33333001))*l9_635.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_636=1.0-fast::clamp(dot(l9_635.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_637=l9_636;
float l9_638=l9_637;
float l9_639=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_638;
float3 l9_640=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_634.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_641=float4(l9_640.x,l9_640.y,l9_640.z,l9_639);
param_21=l9_641;
}
else
{
...
{
float4 l9_642=param_21;
float4 l9_643=float4(0.0);
float4 l9_644=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_645=out.FragColor0;
float4 l9_646=l9_645;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_646.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_648=gl_FragCoord;
float2 l9_649=l9_648.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
{
l9_653=in.varStereoViewID;
}
int l9_654=l9_653;
int l9_655=l9_654;
float3 l9_656=float3(l9_650,0.0);
int l9_657=l9_652;
int l9_658=l9_655;
if (l9_657==1)
{
l9_656.y=((2.0*l9_656.y)+float(l9_658))-1.0;
}
float2 l9_659=l9_656.xy;
l9_651=l9_659;
}
else
{
...
int l9_676=sc_ScreenTextureLayout_tmp;
int l9_677=l9_672;
float l9_678=l9_673;
...
float l9_686=l9_678;
float4 l9_687=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_685,bias(l9_686));
float4 l9_688=l9_687;
l9_674=l9_688;
float4 l9_689=l9_674;
...
{
l9_644.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_692=l9_644;
float4 l9_693=l9_692;
float3 l9_694=l9_693.xyz;
float3 l9_695=l9_694;
float3 l9_696=l9_642.xyz;
float3 l9_697=definedBlend(l9_695,l9_696,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_643=float4(l9_697.x,l9_697.y,l9_697.z,l9_643.w);
float3 l9_698=mix(l9_694,l9_643.xyz,float3(l9_642.w));
l9_643=float4(l9_698.x,l9_698.y,l9_698.z,l9_643.w);
l9_643.w=1.0;
float4 l9_699=l9_643;
param_21=l9_699;
}
else
{
float4 l9_700=param_21;
float4 l9_701=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_701=float4(mix(float3(1.0),l9_700.xyz,float3(l9_700.w)),l9_700.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_702=l9_700.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_702=fast::clamp(l9_702,0.0,1.0);
}
l9_701=float4(l9_700.xyz*l9_702,l9_702);
}
else
{
l9_701=l9_700;
...
float4 l9_703=l9_701;
param_21=l9_703;
}
}
}
float4 l9_704=param_21;
FinalColor=l9_704;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_705=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_705=float4(0.0);
...
float4 l9_707=param_24;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_707.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_707;
return out;
}
} // FRAGMENT SHADER
