...
//spec_const int sc_AmbientLightMode0 83 0
//spec_const int sc_AmbientLightMode1 84 0
//spec_const int sc_AmbientLightMode2 85 0
//spec_const int sc_AmbientLightMode_Constant 86 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 87 0
//spec_const int sc_AmbientLightMode_FromCamera 88 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 89 0
//spec_const int sc_AmbientLightsCount 90 0
//spec_const int sc_DepthBufferMode 91 0
//spec_const int sc_DirectionalLightsCount 92 0
//spec_const int sc_EnvLightMode 93 0
//spec_const int sc_EnvmapDiffuseLayout 94 0
//spec_const int sc_EnvmapSpecularLayout 95 0
//spec_const int sc_LightEstimationSGCount 96 0
//spec_const int sc_MaxTextureImageUnits 97 0
...
varColor=color;
float l9_28=((((sc_Time.x*Port_Multiplier_N086)-spritetimestamp)/(((spritetimestamp+(((Port_Value_N073+0.001)-0.001)*(floor(fract(sin(floor(floor((floor(spriteindex*10000.0)*9.9999997e-05)*Port_Scale_N083)*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05)))-spritetimestamp)+1e-06))*(Port_RangeMaxB_N085-Port_RangeMinB_N085))+Port_RangeMinB_N085;
float l9_29;
if (Port_RangeMaxB_N085>Port_RangeMinB_N085)
{
l9_29=clamp(l9_28,Port_RangeMinB_N085,Port_RangeMaxB_N085);
}
else
{
l9_29=clamp(l9_28,Port_RangeMaxB_N085,Port_RangeMinB_N085);
}
float l9_30=((Port_Value_N044+0.001)-0.001)*l9_29;
vec2 l9_31=l9_26-Port_Input1_N041;
vec2 l9_32=vec2((l9_30/Port_Input1_N045)*Port_Input1_N046)*l9_31;
vec2 l9_33=l9_31*Port_Input1_N099;
vec3 l9_34=vec3(l9_33.x,l9_33.y,vec3(0.0).z);
l9_34.z=Port_Value2_N100;
...
{
l9_40=varTangent.xyz;
l9_39=(sc_ModelMatrix*vec4(l9_37,1.0)).xyz;
l9_38=(sc_ModelMatrix*vec4(((normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz)*vec3(l9_32.y))+(normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][0].xyz)*vec3(l9_32.x)))+(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz,1.0)).xyz;
}
varPos=l9_38;
...
#if (sc_RenderingSpace==3)
{
l9_42=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_43;
#if (sc_RenderingSpace==2)
{
l9_43=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_44;
#if (sc_RenderingSpace==1)
{
l9_44=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
l9_44=l9_15;
...
#if (sc_RenderingSpace==4)
{
l9_46=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_47;
...
#if (sc_TAAEnabled)
{
vec2 l9_55=l9_51.xy+(sc_TAAJitterOffset*l9_51.w);
l9_54=vec4(l9_55.x,l9_55.y,l9_51.z,l9_51.w);
}
#else
{
l9_54=l9_51;
...
{
vec4 l9_57=l9_54;
l9_57.x=l9_54.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_56=l9_57;
}
#else
{
...
{
float l9_58=dot(l9_56,sc_StereoClipPlanes[sc_StereoViewID]);
