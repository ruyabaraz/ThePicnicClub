...
// @input Component.AudioComponent audioFoodAccepted
// @input Component.AudioComponent audioNotEdible
...
awakeEvent.bind(() => {
    ...
    checkUndefined("audioFoodAccepted", []);
    checkUndefined("audioNotEdible", []);
    if (script.onAwake) {
       script.onAwake();
    }
});
