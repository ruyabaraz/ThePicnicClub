...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,gParticle.Dead,l9_4,fract(abs(((l9_2*0.000488434)+0.151235)+(floor(((l9_5-l9_4)+20.0)*0.1)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))*vec2(0.00250627),float(((l9_0*((l9_0*1471343)+101146501))+1559861749)&2147483647)*4.65661e-10,l9_0,(l9_2+0.5)*0.0005,l9_2*0.00050025,l9_1,(l9_3+vec2(0.5))*vec2(0.00195312,0.25),l9_3*vec2(0.00195695,0.333333),vec3(0.0),false);
int l9_6=(vfxOffsetInstances+InstanceID)*4;
...
float l9_8=float(Interp_Particle_Index);
float l9_9;
if (overrideTimeEnabled==1)
{
...
float l9_10=l9_9-(l9_8*0.0050025);
int l9_11=int(Port_SpriteCount_N194.x);
int l9_12=int(Port_SpriteCount_N194.y);
int l9_13=l9_11*l9_12;
int l9_14=int(Port_MaxFrames_N194);
int l9_15=(l9_13<l9_14) ? l9_13 : l9_14;
int l9_16=int(fract(abs(((l9_8*0.000488434)+0.151235)+(floor((l9_10+20.0)*0.1)*4.32723)))*Port_Input1_N053);
float l9_17=1.0/float(l9_12);
int l9_18=l9_16-(l9_15*(l9_16/l9_15));
int l9_19=l9_18/l9_11;
int l9_20;
...
#endif
vec4 l9_21=ngsPixelShader(sc_SampleTextureBiasOrLevel(flipbookTexDims.xy,flipbookTexLayout,l9_20,mod(vec2((1.0/float(l9_11))*(l9_7.x+float(l9_18-(l9_11*l9_19))),((1.0-l9_17)-(float(l9_19)*l9_17))+(l9_17*l9_7.y)),vec2(1.0)),(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex),(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0),flipbookTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0),flipbookTexBorderColor,0.0,flipbookTex));
vec4 l9_22;
#if (sc_ShaderComplexityAnalyzer)
{
l9_22=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_22=vec4(0.0);
...
sc_writeFragData0(vec4(max(0.0,1.00392-l9_25),min(1.0,l9_25+0.00392157),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_26).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_27=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_26).xy);
float l9_28=packValue(l9_27);
vec4 l9_29=vec4(0.0);
l9_29.x=l9_28;
vec4 l9_31=l9_29;
l9_31.y=packValue(l9_27);
vec4 l9_33=l9_31;
l9_33.z=packValue(l9_27);
vec4 l9_35=l9_33;
l9_35.w=packValue(l9_27);
vec4 l9_37=vec4(0.0);
l9_37.x=packValue(l9_27);
vec4 l9_39=l9_37;
l9_39.y=packValue(l9_27);
vec4 l9_41=l9_39;
l9_41.z=packValue(l9_27);
vec4 l9_42=l9_41;
l9_42.w=packValue(l9_27);
int l9_43=int(l9_24.w*255.0);
...
vec4 l9_50=l9_49;
l9_50.w=packValue(l9_43);
sc_writeFragData0(l9_42);
sc_writeFragData1(l9_35);
sc_writeFragData2(l9_50);
...
if (l9_62==0)
{
l9_65=texture2D(sc_OITAlpha0,l9_51);
l9_64=texture2D(sc_OITDepthLow0,l9_51);
l9_63=texture2D(sc_OITDepthHigh0,l9_51);
}
else
{
l9_65=l9_58;
...
if (l9_62==1)
{
l9_61=texture2D(sc_OITAlpha1,l9_51);
l9_60=texture2D(sc_OITDepthLow1,l9_51);
l9_59=texture2D(sc_OITDepthHigh1,l9_51);
}
else
{
l9_61=l9_65;
...
{
int l9_66[8]=l9_52;
unpackValues(l9_59.w,l9_62,l9_66);
unpackValues(l9_59.z,l9_62,l9_66);
unpackValues(l9_59.y,l9_62,l9_66);
unpackValues(l9_59.x,l9_62,l9_66);
unpackValues(l9_60.w,l9_62,l9_66);
unpackValues(l9_60.z,l9_62,l9_66);
unpackValues(l9_60.y,l9_62,l9_66);
unpackValues(l9_60.x,l9_62,l9_66);
int l9_75[8]=l9_53;
unpackValues(l9_61.w,l9_62,l9_75);
unpackValues(l9_61.z,l9_62,l9_75);
unpackValues(l9_61.y,l9_62,l9_75);
unpackValues(l9_61.x,l9_62,l9_75);
}
l9_58=l9_61;
l9_57=l9_60;
l9_56=l9_59;
...
vec4 l9_80=texture2D(sc_OITFilteredDepthBoundsTexture,l9_51);
vec2 l9_81=l9_80.xy;
int l9_82;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_82=encodeDepth(((1.0-l9_80.x)*1000.0)+l9_83,l9_81);
}
#else
{
l9_82=0;
...
#endif
int l9_84=encodeDepth(viewSpaceDepth(),l9_81);
vec4 l9_85;
l9_85=l9_24*l9_24.w;
vec4 l9_86;
int l9_87=0;
...
if (l9_87<8)
{
int l9_88=l9_52[l9_87];
int l9_89=l9_84-l9_82;
...
if (l9_91)
{
vec3 l9_92=l9_85.xyz*(1.0-(float(l9_53[l9_87])*0.00392157));
