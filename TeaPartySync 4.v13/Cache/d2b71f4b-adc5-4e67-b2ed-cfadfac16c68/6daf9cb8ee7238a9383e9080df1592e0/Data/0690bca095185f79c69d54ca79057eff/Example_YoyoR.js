...
var __selfType = requireType("./Example_YoyoR");
...
let Example_YoyoTween = class Example_YoyoTween extends BaseScriptComponent {
    onAwake() {
        ...
        let destinationPosition = startPosition.add(new vec3(0, -20, 0));
        LSTween_1.LSTween.moveFromToLocal(this.getTransform(), startPosition, destinationPosition, 4500)
...
//# sourceMappingURL=Example_YoyoR.js.map