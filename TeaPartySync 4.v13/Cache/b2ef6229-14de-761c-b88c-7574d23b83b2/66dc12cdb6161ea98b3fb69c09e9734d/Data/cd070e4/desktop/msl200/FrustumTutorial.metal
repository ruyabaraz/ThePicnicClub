...
//float3x3 Tweak_N42Transform 4320
//float4 Tweak_N42UvMinMax 4368
//float4 Tweak_N42BorderColor 4384
//float Tweak_N80 4400
//float3x3 Tweak_N41Transform 4464
//float4 Tweak_N41UvMinMax 4512
//float4 Tweak_N41BorderColor 4528
//float4 Tweak_N46 4544
//float Tweak_N85 4560
//float3x3 Tweak_N99Transform 4624
//float4 Tweak_N99UvMinMax 4672
//float4 Tweak_N99BorderColor 4688
//float Port_Import_N057 4720
//float Port_RangeMinA_N070 4724
//float Port_RangeMaxA_N070 4728
//float Port_RangeMinB_N070 4732
//float Port_RangeMaxB_N070 4736
//float Port_Input1_N073 4744
//float Port_Import_N074 4748
//float Port_Input1_N075 4752
//float4 Port_Input1_N097 4768
//float2 Port_Seed_N083 4784
//float2 Port_Scale_N092 4792
//float2 Port_Center_N092 4800
//float depthRef 4808
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N42 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N99 33 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N41 35 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N42 36 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N99 37 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 38 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N41 39 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N42 40 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N99 41 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 42 0
//spec_const bool Tweak_N41HasSwappedViews 43 0
//spec_const bool Tweak_N42HasSwappedViews 44 0
//spec_const bool Tweak_N99HasSwappedViews 45 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N41 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N99 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N41 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N99 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 90 -1
//spec_const int Tweak_N41Layout 91 0
//spec_const int Tweak_N42Layout 92 0
//spec_const int Tweak_N99Layout 93 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N41 [[function_constant(83)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 [[function_constant(84)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N99 [[function_constant(85)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N41 [[function_constant(87)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 [[function_constant(88)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N99 [[function_constant(89)]];
...
bool l9_5=gl_FrontFacing;
Globals.gFrontFacing=float(l9_5);
}
else
{
Globals.Surface_UVCoord1=in.varPackedTex.zw;
Globals.Surface_UVCoord0=in.varPackedTex.xy;
bool l9_6=gl_FrontFacing;
Globals.gFrontFacing=float(l9_6);
}
...
float3 l9_96=l9_87;
HSV_N54=float4(l9_96,Value_N48.w);
float Value_N57=0.0;
Value_N57=fast::clamp((*sc_set0.UserUniforms).Port_Import_N057,-180.0,180.0);
float ValueOut_N70=0.0;
ValueOut_N70=(((Value_N57-(*sc_set0.UserUniforms).Port_RangeMinA_N070)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N070-(*sc_set0.UserUniforms).Port_RangeMinA_N070)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N070-(*sc_set0.UserUniforms).Port_RangeMinB_N070))+(*sc_set0.UserUniforms).Port_RangeMinB_N070;
...
float3 l9_103=l9_97;
RGB_N78=float4(l9_103,Output_N77.w);
...
float param_24=0.0;
bool l9_110=param_22&&(!param_20);
float l9_111=1.0;
float l9_112=param_16.x;
int l9_113=param_19.x;
if (l9_113==1)
{
l9_112=fract(l9_112);
}
...
param_16.x=l9_112;
float l9_117=param_16.y;
int l9_118=param_19.y;
if (l9_118==1)
{
l9_117=fract(l9_117);
}
...
float l9_124=param_16.x;
float l9_125=param_21.x;
float l9_126=param_21.z;
bool l9_127=l9_123;
float l9_128=l9_111;
...
float l9_133=param_16.y;
float l9_134=param_21.y;
float l9_135=param_21.w;
bool l9_136=l9_132;
float l9_137=l9_111;
...
float2 l9_140=param_16;
bool l9_141=param_17;
float3x3 l9_142=param_18;
if (l9_141)
{
...
param_16=l9_145;
float l9_146=param_16.x;
int l9_147=param_19.x;
bool l9_148=l9_110;
float l9_149=l9_111;
...
param_16.x=l9_146;
l9_111=l9_149;
float l9_157=param_16.y;
int l9_158=param_19.y;
bool l9_159=l9_110;
float l9_160=l9_111;
...
param_16.y=l9_157;
l9_111=l9_160;
float2 l9_168=param_16;
int l9_169=param_14;
int l9_170=param_15;
float l9_171=param_24;
...
float l9_179=l9_171;
float4 l9_180=sc_set0.Tweak_N41.sample(sc_set0.Tweak_N41SmpSC,l9_178,bias(l9_179));
float4 l9_181=l9_180;
float4 l9_182=l9_181;
if (param_22)
{
l9_182=mix(param_23,l9_182,float4(l9_111));
}
...
float param_37=0.0;
bool l9_190=param_35&&(!param_33);
float l9_191=1.0;
float l9_192=param_29.x;
int l9_193=param_32.x;
if (l9_193==1)
{
l9_192=fract(l9_192);
}
...
param_29.x=l9_192;
float l9_197=param_29.y;
int l9_198=param_32.y;
if (l9_198==1)
{
l9_197=fract(l9_197);
}
...
float l9_204=param_29.x;
float l9_205=param_34.x;
float l9_206=param_34.z;
bool l9_207=l9_203;
float l9_208=l9_191;
...
float l9_213=param_29.y;
float l9_214=param_34.y;
float l9_215=param_34.w;
bool l9_216=l9_212;
float l9_217=l9_191;
...
float2 l9_220=param_29;
bool l9_221=param_30;
float3x3 l9_222=param_31;
if (l9_221)
{
...
param_29=l9_225;
float l9_226=param_29.x;
int l9_227=param_32.x;
bool l9_228=l9_190;
float l9_229=l9_191;
...
param_29.x=l9_226;
l9_191=l9_229;
float l9_237=param_29.y;
int l9_238=param_32.y;
bool l9_239=l9_190;
float l9_240=l9_191;
...
param_29.y=l9_237;
l9_191=l9_240;
float2 l9_248=param_29;
int l9_249=param_27;
int l9_250=param_28;
float l9_251=param_37;
...
float l9_259=l9_251;
float4 l9_260=sc_set0.Tweak_N99.sample(sc_set0.Tweak_N99SmpSC,l9_258,bias(l9_259));
float4 l9_261=l9_260;
float4 l9_262=l9_261;
if (param_35)
{
l9_262=mix(param_36,l9_262,float4(l9_191));
}
...
float2 l9_264=param_38;
float param_40=(snoise(l9_264)*0.5)+0.5;
...
float3 l9_265=param_42.xyz*param_41.xyz;
float4 param_43;
param_43=float4(l9_265.x,l9_265.y,l9_265.z,param_43.w);
float3 l9_266=mix(param_41.xyz,param_43.xyz,float3(param_42.w));
param_43=float4(l9_266.x,l9_266.y,l9_266.z,param_43.w);
...
float2 l9_268=floor(mod(l9_267.xy,float2(4.0)));
float l9_269=(mod(dot(l9_268,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_44<l9_269)
{
discard_fragment();
}
}
bool l9_270=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_270)
{
...
float4 l9_271=fast::max(param_45,float4(0.0));
float4 param_46=l9_271;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_274=fast::clamp(l9_273.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_274=fast::clamp(dot(l9_273.xyz,float3(l9_273.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_274=(1.0-dot(l9_273.xyz,float3(0.33333001)))*l9_273.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_274=(1.0-fast::clamp(dot(l9_273.xyz,float3(1.0)),0.0,1.0))*l9_273.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_274=fast::clamp(dot(l9_273.xyz,float3(1.0)),0.0,1.0)*l9_273.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_274=fast::clamp(dot(l9_273.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_274=dot(l9_273.xyz,float3(0.33333001))*l9_273.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_274=1.0-fast::clamp(dot(l9_273.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_275=l9_274;
float l9_276=l9_275;
float l9_277=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_276;
float3 l9_278=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_272.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_279=float4(l9_278.x,l9_278.y,l9_278.z,l9_277);
param_47=l9_279;
}
else
{
...
{
float4 l9_280=param_47;
float4 l9_281=float4(0.0);
float4 l9_282=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_283=out.FragColor0;
float4 l9_284=l9_283;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_284.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_286=gl_FragCoord;
float2 l9_287=l9_286.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_292=l9_291;
int l9_293=l9_292;
float3 l9_294=float3(l9_288,0.0);
int l9_295=l9_290;
int l9_296=l9_293;
if (l9_295==1)
{
l9_294.y=((2.0*l9_294.y)+float(l9_296))-1.0;
}
float2 l9_297=l9_294.xy;
l9_289=l9_297;
}
else
{
...
float l9_324=l9_316;
float4 l9_325=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_323,bias(l9_324));
float4 l9_326=l9_325;
l9_312=l9_326;
float4 l9_327=l9_312;
...
{
l9_282.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_330=l9_282;
float4 l9_331=l9_330;
float3 l9_332=l9_331.xyz;
float3 l9_333=l9_332;
float3 l9_334=l9_280.xyz;
...
l9_281=float4(l9_335.x,l9_335.y,l9_335.z,l9_281.w);
float3 l9_336=mix(l9_332,l9_281.xyz,float3(l9_280.w));
l9_281=float4(l9_336.x,l9_336.y,l9_336.z,l9_281.w);
l9_281.w=1.0;
float4 l9_337=l9_281;
param_47=l9_337;
}
else
{
float4 l9_338=param_47;
float4 l9_339=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_339=float4(mix(float3(1.0),l9_338.xyz,float3(l9_338.w)),l9_338.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_340=l9_338.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_340=fast::clamp(l9_340,0.0,1.0);
}
l9_339=float4(l9_338.xyz*l9_340,l9_340);
}
else
{
l9_339=l9_338;
...
float4 l9_341=l9_339;
param_47=l9_341;
}
}
}
float4 l9_342=param_47;
FinalColor=l9_342;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_343=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_343=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_345.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_345;
return out;
}
} // FRAGMENT SHADER
