...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N3 33 0
...
//spec_const bool Tweak_N3HasSwappedViews 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 81 -1
...
#endif
bool l9_17=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0));
float l9_18=l9_15.x;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x);
float l9_19=l9_18;
float l9_20=l9_15.y;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y);
float l9_21=l9_20;
vec2 l9_22;
float l9_23;
...
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x==3;
}
#else
{
l9_24=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_25=l9_19;
float l9_26=1.0;
sc_ClampUV(l9_25,Tweak_N3UvMinMax.x,Tweak_N3UvMinMax.z,l9_24,l9_26);
float l9_27=l9_25;
float l9_28=l9_26;
bool l9_29;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_30=l9_21;
float l9_31=l9_28;
sc_ClampUV(l9_30,Tweak_N3UvMinMax.y,Tweak_N3UvMinMax.w,l9_29,l9_31);
l9_23=l9_31;
...
#endif
vec2 l9_32=sc_TransformUV(l9_22,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform);
float l9_33=l9_32.x;
float l9_34=l9_23;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x,l9_17,l9_34);
float l9_35=l9_32.y;
float l9_36=l9_34;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y,l9_17,l9_36);
float l9_37=l9_36;
vec3 l9_38=sc_SamplingCoordsViewToGlobal(vec2(l9_33,l9_35),Tweak_N3Layout,l9_16);
vec4 l9_39=texture2D(Tweak_N3,l9_38.xy,0.0);
vec4 l9_40;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_40=mix(Tweak_N3BorderColor,l9_39,vec4(l9_37));
}
#else
{
l9_40=l9_39;
...
{
l9_41=vec4(pow(l9_40.x,2.2),pow(l9_40.y,2.2),pow(l9_40.z,2.2),0.0);
}
#else
{
l9_41=l9_40*l9_40;
...
#endif
vec3 l9_42=vec3(Tweak_N79)*l9_41.xyz;
vec3 l9_43;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_43=vec3(pow(l9_42.x,0.45454544),pow(l9_42.y,0.45454544),pow(l9_42.z,0.45454544));
}
#else
{
l9_43=sqrt(l9_42);
...
l9_44.w=Port_Value2_N006;
vec4 l9_45=l9_44*vec4(clamp(Port_Import_N096,0.0,5.0));
float l9_46=max(pow(1.0-abs(dot(-l9_0,l9_3*Port_Normal_N041)),Tweak_N1),0.0)*Tweak_N8;
vec3 l9_47=mix(Port_Input0_N123,mix(vec4(dot(l9_45,Port_Input1_N119)),l9_45,vec4(clamp(Port_Import_N120,0.0,2.0))),vec4(clamp(Port_Import_N122,0.0,2.0))).xyz;
vec3 l9_48=mix(l9_47,(vec3(1.0)-((vec3(1.0)-l9_47)*(vec3(1.0)-vec4(l9_46).xyz))).xyz,vec3(l9_46));
...
{
l9_53=clamp(dot(l9_49.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_54;
...
{
l9_55=(1.0-dot(l9_49.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_56;
...
{
l9_56=(1.0-clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_57;
...
{
l9_57=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_58;
#if (sc_BlendMode_Add)
{
l9_58=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_59;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_59=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_60;
...
{
l9_60=dot(l9_49.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_61;
#if (sc_BlendMode_Min)
{
l9_61=1.0-clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_Max)
{
l9_62=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_62=1.0;
...
#endif
l9_50=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_49.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_51);
}
#else
{
vec4 l9_63;
...
#endif
vec3 l9_73=mix(l9_71.xyz,definedBlend(l9_71.xyz,l9_49.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_75=vec4(mix(vec3(1.0),l9_49.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_76;
...
#endif
l9_76=vec4(l9_49.xyz*l9_77,l9_77);
}
#else
{
l9_76=l9_49;
