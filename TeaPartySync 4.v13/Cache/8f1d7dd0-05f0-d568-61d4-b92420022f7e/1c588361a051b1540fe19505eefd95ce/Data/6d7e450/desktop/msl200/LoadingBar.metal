...
//float Tweak_N8 4420
//float alpha 4424
//float4 Port_Input0_N123 4432
//float3 Port_Import_N052 4464
//float3 Port_Input1_N058 4480
//float Port_Input1_N070 4512
//float Port_Input1_N075 4516
//float2 Port_Input1_N083 4520
//float Port_Import_N059 4528
//float Port_Import_N060 4532
//float Port_Value2_N006 4536
//float Port_Import_N096 4560
//float4 Port_Input1_N119 4576
//float Port_Import_N120 4592
//float Port_Import_N122 4596
//float3 Port_Normal_N041 4608
//float depthRef 4624
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 75 -1
//spec_const int Tweak_N3Layout 76 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 [[function_constant(74)]];
...
constant int Tweak_N3Layout [[function_constant(76)]];
...
float l9_5=dot(param_1,param_1);
float l9_6;
if (l9_5>0.0)
{
l9_6=1.0/sqrt(l9_5);
...
float param_17=0.0;
bool l9_15=param_15&&(!param_13);
float l9_16=1.0;
float l9_17=param_9.x;
int l9_18=param_12.x;
if (l9_18==1)
{
l9_17=fract(l9_17);
}
...
param_9.x=l9_17;
float l9_22=param_9.y;
int l9_23=param_12.y;
if (l9_23==1)
{
l9_22=fract(l9_22);
}
...
float l9_29=param_9.x;
float l9_30=param_14.x;
float l9_31=param_14.z;
bool l9_32=l9_28;
float l9_33=l9_16;
...
float l9_38=param_9.y;
float l9_39=param_14.y;
float l9_40=param_14.w;
bool l9_41=l9_37;
float l9_42=l9_16;
...
float2 l9_45=param_9;
bool l9_46=param_10;
float3x3 l9_47=param_11;
if (l9_46)
{
...
float2 l9_50=l9_49;
param_9=l9_50;
float l9_51=param_9.x;
int l9_52=param_12.x;
bool l9_53=l9_15;
float l9_54=l9_16;
if ((l9_52==0)||(l9_52==3))
{
...
param_9.x=l9_51;
l9_16=l9_54;
float l9_62=param_9.y;
int l9_63=param_12.y;
bool l9_64=l9_15;
float l9_65=l9_16;
if ((l9_63==0)||(l9_63==3))
{
...
param_9.y=l9_62;
l9_16=l9_65;
float2 l9_73=param_9;
int l9_74=param_7;
int l9_75=param_8;
float l9_76=param_17;
float2 l9_77=l9_73;
int l9_78=l9_74;
int l9_79=l9_75;
...
float l9_84=l9_76;
float4 l9_85=sc_set0.Tweak_N3.sample(sc_set0.Tweak_N3SmpSC,l9_83,bias(l9_84));
float4 l9_86=l9_85;
float4 l9_87=l9_86;
if (param_15)
{
l9_87=mix(param_16,l9_87,float4(l9_16));
}
float4 l9_88=l9_87;
Color_N98=l9_88;
...
{
l9_89=float4(pow(param_18.x,2.2),pow(param_18.y,2.2),pow(param_18.z,2.2),pow(param_18.w,2.2));
}
else
{
l9_89=param_18*param_18;
}
float4 l9_90=l9_89;
Output_N105=l9_90;
...
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_91=float3(pow(param_19.x,0.45454544),pow(param_19.y,0.45454544),pow(param_19.z,0.45454544));
}
else
{
l9_91=sqrt(param_19);
...
float l9_93=abs(dot(-param_26.ViewDirWS,param_22));
float param_25=pow(1.0-l9_93,param_23);
...
float3 l9_94=float3(1.0)-((float3(1.0)-param_27.xyz)*(float3(1.0)-param_28.xyz));
float4 param_29;
param_29=float4(l9_94.x,l9_94.y,l9_94.z,param_29.w);
float3 l9_95=mix(param_27.xyz,param_29.xyz,float3(param_28.w));
param_29=float4(l9_95.x,l9_95.y,l9_95.z,param_29.w);
...
float2 l9_97=floor(mod(l9_96.xy,float2(4.0)));
float l9_98=(mod(dot(l9_97,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_31<l9_98)
{
discard_fragment();
}
...
float4 l9_100=fast::max(param_32,float4(0.0));
float4 param_33=l9_100;
if (sc_ShaderCacheConstant_tmp!=0)
{
