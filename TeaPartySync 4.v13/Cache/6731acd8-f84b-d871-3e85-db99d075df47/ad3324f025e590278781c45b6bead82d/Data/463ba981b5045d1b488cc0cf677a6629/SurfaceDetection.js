...
var SurfaceDetection_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SurfaceDetection = void 0;
var __selfType = requireType("./SurfaceDetection");
function component(target) { target.getTypeName = function () { return __selfType; }; }
let SurfaceDetection = SurfaceDetection_1 = class SurfaceDetection extends BaseScriptComponent {
    ...
    onCalibrationComplete() {
        ...
        // Trigger custom event for button animations
        SurfaceDetection_1.trigger("ShowButtons");
    }
    __initialize() {
        super.__initialize();
...
// Static event system for communication between scripts
SurfaceDetection.eventListeners = {};
exports.SurfaceDetection = SurfaceDetection = SurfaceDetection_1 = __decorate([
    component
], SurfaceDetection);
