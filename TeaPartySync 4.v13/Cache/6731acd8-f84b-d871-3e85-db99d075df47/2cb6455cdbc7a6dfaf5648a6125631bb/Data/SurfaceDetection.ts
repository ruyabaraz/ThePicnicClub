...
export class SurfaceDetection extends BaseScriptComponent {
    ...
    startGroundCalibration(callback: (pos: vec3, rot: quat) => void) {
        ...
        this.animation.startCalibration(() => this.onCalibrationComplete());
    }
...
// ✅ Make startGroundCalibration() callable from JS scripts like SurfaceTweenRunnerWithDelay.js
//@ts-ignore
script.api.startGroundCalibration = (callback) => {
    (script.getComponent("SurfaceDetection") as SurfaceDetection).startGroundCalibration(callback);
};
