...
//float Port_Input2_N043 6356
//float Port_Input2_N062 6360
...
float4 l9_1934=fast::max(param_4,float4(0.0));
float4 param_5=l9_1934;
if (sc_ShaderCacheConstant_tmp!=0)
{
