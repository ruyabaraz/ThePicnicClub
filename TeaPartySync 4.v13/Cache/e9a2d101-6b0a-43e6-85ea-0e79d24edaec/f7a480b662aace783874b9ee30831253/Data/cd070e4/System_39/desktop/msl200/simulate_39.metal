...
//float Port_Condition_N019 7248
...
l9_104=(*sc_set0.UserUniforms).Port_Import_N038;
float3 l9_105=float3(0.0);
float3 l9_106=(*sc_set0.UserUniforms).Port_Min_N041;
float3 l9_107=(*sc_set0.UserUniforms).Port_Max_N041;
...
float3 l9_184=mix(l9_106,l9_107,l9_183.xyz);
l9_105=l9_184;
float l9_185=0.0;
l9_185=length(l9_105);
float3 l9_186=float3(0.0);
l9_186=l9_105/(float3(l9_185)+float3(1.234e-06));
float l9_187=0.0;
float l9_188=(*sc_set0.UserUniforms).Port_Min_N044;
float l9_189=(*sc_set0.UserUniforms).Port_Max_N044;
...
float l9_266=mix(l9_188,l9_189,l9_265.x);
l9_187=l9_266;
float l9_267=0.0;
float l9_268;
if (l9_187<=0.0)
...
l9_269=l9_270;
float l9_271=0.0;
l9_271=(*sc_set0.UserUniforms).Port_Import_N047;
float3 l9_272=float3(0.0);
l9_272=(*sc_set0.UserUniforms).Port_Import_N048;
float3 l9_273=float3(0.0);
l9_273=((l9_186*float3(l9_269))*float3(l9_271))*l9_272;
float3 l9_274=float3(0.0);
l9_274=l9_104+l9_273;
gParticle.Position=l9_274;
float l9_275=(*sc_set0.UserUniforms).Port_Condition_N019;
if ((l9_275*1.0)!=0.0)
{
gParticle.Dead=true;
}
...
float param_12=(*sc_set0.UserUniforms).SizeMax;
Output_N20=param_12;
...
float l9_290=0.0;
float l9_291=param_16.gTimeElapsed;
...
float param_15=mix(param_13,param_14,l9_358.x);
Random_N24=param_15;
...
float4 l9_362=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
...
float4 l9_375=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
...
float4 l9_380=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);
