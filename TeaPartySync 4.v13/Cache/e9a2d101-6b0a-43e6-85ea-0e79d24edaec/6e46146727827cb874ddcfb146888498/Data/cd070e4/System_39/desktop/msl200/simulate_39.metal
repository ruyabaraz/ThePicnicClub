...
float l9_192=0.0;
float l9_193=(*sc_set0.UserUniforms).Life;
l9_192=l9_193;
float l9_194=l9_192;
...
float4 l9_195=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_196=dot(l9_195,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_197=l9_196;
...
{
out.varClipDistance=l9_197;
}
}
float4 l9_198=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_198;
return out;
}
...
param_3*=(param_4*0.5);
float2 l9_200=param_3;
float param_5=(snoise(l9_200)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_201=param_6;
float param_8=(snoise(l9_201)*0.5)+0.5;
...
float2 l9_202=param_9;
float param_11=(snoise(l9_202)*0.5)+0.5;
...
bool l9_206=true;
float l9_207=24.0;
ssParticle l9_208=gParticle;
float l9_209=0.0;
float l9_210=param_15.gTimeElapsed;
float4 l9_211=float4(0.0);
float4 l9_212=float4(0.0);
if (l9_204)
{
l9_212.x=floor(fract(l9_210)*1000.0);
}
if (l9_206)
{
l9_212.y=float(l9_208.Index1D^((l9_208.Index1D*15299)+l9_208.Index1D));
}
if (l9_205)
{
l9_212.z=l9_207;
}
l9_212.w=l9_209*1000.0;
int l9_213=int(l9_212.x);
int l9_214=int(l9_212.y);
int l9_215=int(l9_212.z);
int l9_216=int(l9_212.w);
int l9_217=(((l9_213*15299)^(l9_214*30133))^(l9_215*17539))^(l9_216*12113);
int l9_218=l9_217;
if (l9_203==1)
{
int l9_219=l9_218;
...
int l9_234=l9_231;
float l9_235=float(l9_234)*4.6566129e-10;
float2 l9_236=float2(l9_233,l9_235);
l9_211=float4(l9_236.x,l9_236.y,l9_211.z,l9_211.w);
}
else
{
if (l9_203==3)
...
float3 l9_253=float3(l9_248,l9_250,l9_252);
l9_211=float4(l9_253.x,l9_253.y,l9_253.z,l9_211.w);
}
else
{
int l9_254=l9_218;
...
float4 l9_275=float4(l9_268,l9_270,l9_272,l9_274);
l9_211=l9_275;
}
}
}
float4 l9_276=l9_211;
float4 l9_277=l9_276;
float param_14=mix(param_12,param_13,l9_277.x);
Random_N24=param_14;
...
float4 l9_281=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);
...
{
l9_282=gParticle.Force.x;
}
gParticle.Force.x=l9_282;
float l9_283;
...
{
l9_283=gParticle.Force.y;
}
gParticle.Force.y=l9_283;
float l9_284;
...
{
l9_284=gParticle.Force.z;
}
gParticle.Force.z=l9_284;
...
{
l9_285=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_285;
float l9_286;
...
{
l9_286=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_286;
float l9_287;
...
{
l9_287=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_287;
...
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_288;
int particleRow=512;
...
float4 l9_291=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_292=dot(l9_291,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_293=l9_292;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_293;
}
}
float4 l9_294=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_294;
int l9_295=gl_InstanceIndex;
out.Interp_Particle_Index=l9_295;
...
float4 l9_296=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_297=dot(l9_296,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_298=l9_297;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_298;
}
}
float4 l9_299=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_299;
return out;
}
return out;
}
