...
float4 l9_278=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
...
param_3*=(param_4*0.5);
float2 l9_280=param_3;
float param_5=(snoise(l9_280)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_281=param_6;
float param_8=(snoise(l9_281)*0.5)+0.5;
...
float2 l9_282=param_9;
float param_11=(snoise(l9_282)*0.5)+0.5;
...
float l9_289=0.0;
float l9_290=param_16.gTimeElapsed;
...
float param_15=mix(param_13,param_14,l9_357.x);
Random_N24=param_15;
...
gParticle.Color=(*sc_set0.UserUniforms).Port_Value_N019;
...
float4 l9_361=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
...
{
l9_362=gParticle.Force.x;
}
gParticle.Force.x=l9_362;
float l9_363;
...
{
l9_363=gParticle.Force.y;
}
gParticle.Force.y=l9_363;
float l9_364;
...
{
l9_364=gParticle.Force.z;
}
gParticle.Force.z=l9_364;
...
{
l9_365=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_365;
float l9_366;
...
{
l9_366=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_366;
float l9_367;
...
{
l9_367=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_367;
...
int l9_368=gl_InstanceIndex;
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_368;
int particleRow=512;
...
float4 l9_374=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_374;
int l9_375=gl_InstanceIndex;
out.Interp_Particle_Index=l9_375;
...
float4 l9_376=param_20;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_377=dot(l9_376,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_378=l9_377;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_378;
}
}
float4 l9_379=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);
out.gl_Position=l9_379;
return out;
}
return out;
}
