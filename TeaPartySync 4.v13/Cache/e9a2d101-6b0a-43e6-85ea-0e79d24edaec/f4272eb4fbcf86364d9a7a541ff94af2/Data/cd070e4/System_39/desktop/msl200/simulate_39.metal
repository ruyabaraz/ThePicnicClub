...
float param_17=(*sc_set0.UserUniforms).Port_Value_N019;
gParticle.Life=param_17;
gParticle.Life=fast::clamp(gParticle.Life,0.1,10.0);
...
float4 l9_361=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
...
Vertex.y=l9_370;
Vertex+=Offset;
float4 param_20=float4((Vertex*2.0)-float2(1.0),1.0,1.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_374=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);
...
float4 l9_379=float4(param_21.x,-param_21.y,(param_21.z*0.5)+(param_21.w*0.5),param_21.w);
