...
//ubo int UserUniforms 0:31:7440 {
//float4 sc_Time 1376
...
//float3 Port_Import_N004 7264
//float3 Port_Import_N073 7280
//float3 Port_Import_N318 7296
//float Port_Multiplier_N319 7312
//float3 Port_Import_N322 7328
//float2 Port_Input1_N326 7344
//float2 Port_Scale_N327 7352
//float2 Port_Input1_N329 7360
//float2 Port_Scale_N330 7368
//float2 Port_Input1_N332 7376
//float2 Port_Scale_N333 7384
//float3 Port_Input1_N335 7392
//float Port_Import_N030 7408
//float Port_Import_N031 7412
//float Port_Min_N024 7416
//float Port_Max_N024 7420
//float Port_Import_N252 7428
//}
...
int l9_358=gl_InstanceIndex;
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_358/2000]*float4(gParticle.Position,1.0)).xyz;
int l9_359=gl_InstanceIndex;
int l9_360=l9_359/2000;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_360][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_360][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_360][2].xyz)*gParticle.Velocity;
int l9_361=gl_InstanceIndex;
int l9_362=l9_361/2000;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_362][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_362][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_362][2].xyz)*gParticle.Force;
int l9_363=gl_InstanceIndex;
int l9_364=gl_InstanceIndex;
int l9_365=gl_InstanceIndex;
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_363/2000][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_364/2000][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_365/2000][2].xyz)))*gParticle.Size;
int l9_366=gl_InstanceIndex;
int l9_367=l9_366/2000;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_367][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_367][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_367][2].xyz)*gParticle.Matrix;
...
float4 l9_368=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_369=dot(l9_368,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_370=l9_369;
...
{
out.varClipDistance=l9_370;
}
}
float4 l9_371=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_371;
return out;
}
...
param_3*=(param_4*0.5);
float2 l9_373=param_3;
float param_5=(snoise(l9_373)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_374=param_6;
float param_8=(snoise(l9_374)*0.5)+0.5;
...
float2 l9_375=param_9;
float param_11=(snoise(l9_375)*0.5)+0.5;
...
bool l9_379=true;
float l9_380=24.0;
ssParticle l9_381=gParticle;
float l9_382=0.0;
float l9_383=param_15.gTimeElapsed;
float4 l9_384=float4(0.0);
float4 l9_385=float4(0.0);
if (l9_377)
{
l9_385.x=floor(fract(l9_383)*1000.0);
}
if (l9_379)
{
l9_385.y=float(l9_381.Index1D^((l9_381.Index1D*15299)+l9_381.Index1D));
}
if (l9_378)
{
l9_385.z=l9_380;
}
l9_385.w=l9_382*1000.0;
int l9_386=int(l9_385.x);
int l9_387=int(l9_385.y);
int l9_388=int(l9_385.z);
int l9_389=int(l9_385.w);
int l9_390=(((l9_386*15299)^(l9_387*30133))^(l9_388*17539))^(l9_389*12113);
int l9_391=l9_390;
if (l9_376==1)
{
int l9_392=l9_391;
int l9_393=l9_392;
int l9_394=((l9_393*((l9_393*1471343)+101146501))+1559861749)&2147483647;
int l9_395=l9_394;
...
float2 l9_409=float2(l9_406,l9_408);
l9_384=float4(l9_409.x,l9_409.y,l9_384.z,l9_384.w);
}
else
{
if (l9_376==3)
...
l9_384=float4(l9_426.x,l9_426.y,l9_426.z,l9_384.w);
}
else
{
int l9_427=l9_391;
...
float4 l9_448=float4(l9_441,l9_443,l9_445,l9_447);
l9_384=l9_448;
}
}
}
float4 l9_449=l9_384;
float4 l9_450=l9_449;
float param_14=mix(param_12,param_13,l9_450.x);
Random_N24=param_14;
...
float4 l9_454=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);
...
{
l9_455=gParticle.Force.x;
}
gParticle.Force.x=l9_455;
float l9_456;
...
{
l9_456=gParticle.Force.y;
}
gParticle.Force.y=l9_456;
float l9_457;
...
{
l9_457=gParticle.Force.z;
}
gParticle.Force.z=l9_457;
...
{
l9_458=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_458;
float l9_459;
...
{
l9_459=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_459;
float l9_460;
...
{
l9_460=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_460;
...
int l9_461=gl_InstanceIndex;
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_461;
int particleRow=512;
...
float4 l9_464=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_465=dot(l9_464,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_466=l9_465;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_466;
}
}
float4 l9_467=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_467;
int l9_468=gl_InstanceIndex;
out.Interp_Particle_Index=l9_468;
...
float4 l9_469=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_470=dot(l9_469,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_471=l9_470;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_471;
}
}
float4 l9_472=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_472;
return out;
}
return out;
}
