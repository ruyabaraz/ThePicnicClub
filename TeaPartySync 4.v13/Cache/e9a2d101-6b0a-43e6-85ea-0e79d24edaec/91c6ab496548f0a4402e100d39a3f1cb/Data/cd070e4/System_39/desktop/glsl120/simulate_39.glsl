...
gParticle.Life=mix(Port_Import_N021,Port_Import_N023,ssGetParticleRandom(1,true,true,true,26.0,gParticle,0.0,sc_Time.x).x);
gParticle.Life=clamp(gParticle.Life,0.1,10.0);
...
int l9_19=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/2000;
gParticle.Velocity=mat3(vfxModelMatrix[l9_19][0].xyz,vfxModelMatrix[l9_19][1].xyz,vfxModelMatrix[l9_19][2].xyz)*gParticle.Velocity;
int l9_20=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/2000;
gParticle.Force=mat3(vfxModelMatrix[l9_20][0].xyz,vfxModelMatrix[l9_20][1].xyz,vfxModelMatrix[l9_20][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/2000][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/2000][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/2000][2].xyz)))*gParticle.Size;
int l9_21=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/2000;
gParticle.Matrix=mat3(vfxModelMatrix[l9_21][0].xyz,vfxModelMatrix[l9_21][1].xyz,vfxModelMatrix[l9_21][2].xyz)*gParticle.Matrix;
...
vec3 l9_22=((gParticle.Position+Port_Import_N073)+(Port_Import_N318*vec3(l9_3*Port_Multiplier_N319)))*(vec3(1.0)/Port_Import_N322);
vec2 l9_23=vec2(l9_22.xy)+Port_Input1_N326;
vec2 l9_24=vec2(l9_22.yz)+Port_Input1_N329;
vec2 l9_25=vec2(l9_22.zx)+Port_Input1_N332;
gParticle.Force+=(Port_Import_N004*((vec3(floor(((snoise(vec2(floor(l9_23.x*10000.0)*9.9999997e-05,floor(l9_23.y*10000.0)*9.9999997e-05)*(Port_Scale_N327*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_24.x*10000.0)*9.9999997e-05,floor(l9_24.y*10000.0)*9.9999997e-05)*(Port_Scale_N330*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_25.x*10000.0)*9.9999997e-05,floor(l9_25.y*10000.0)*9.9999997e-05)*(Port_Scale_N333*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N335)-vec3(1.0)));
vec4 l9_26=vec4(gParticle.Color.x,gParticle.Color.y,gParticle.Color.z,vec4(0.0).w);
l9_26.w=mix(Port_Import_N030,Port_Import_N031,clamp(gParticle.Age/gParticle.Life,0.0,1.0));
gParticle.Color=l9_26;
gParticle.Size=mix(mix(Port_Min_N024,Port_Max_N024,ssGetParticleRandom(1,false,true,true,24.0,gParticle,0.0,sc_Time.x).x),Port_Import_N252,clamp(gParticle.Age/gParticle.Life,0.0,1.0));
...
{
l9_27=gParticle.Force.x;
}
gParticle.Force.x=l9_27;
float l9_28;
...
{
l9_28=gParticle.Force.y;
}
gParticle.Force.y=l9_28;
float l9_29;
...
{
l9_29=gParticle.Force.z;
}
gParticle.Force.z=l9_29;
...
{
l9_30=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_30;
float l9_31;
...
{
l9_31=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_31;
float l9_32;
...
{
l9_32=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_32;
gParticle.Position+=(gParticle.Velocity*l9_1);
vec2 l9_33=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_34=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_35=vfxOffsetInstancesWrite+l9_34;
float l9_36;
if (texture0.x<0.5)
{
l9_36=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_36,l9_37)+(vec2(float(l9_35%512),float(l9_35/512))*l9_33))*2.0)-vec2(1.0),1.0,1.0));
