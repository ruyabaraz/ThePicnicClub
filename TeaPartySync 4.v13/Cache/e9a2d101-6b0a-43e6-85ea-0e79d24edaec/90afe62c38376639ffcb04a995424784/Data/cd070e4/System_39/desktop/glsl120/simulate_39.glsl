...
gParticle.Size=mix(mix(Port_Min_N024,ParticleMax,ssGetParticleRandom(1,false,true,true,24.0,gParticle,0.0,sc_Time.x).x),Port_Import_N252,clamp(gParticle.Age/gParticle.Life,0.0,1.0));
