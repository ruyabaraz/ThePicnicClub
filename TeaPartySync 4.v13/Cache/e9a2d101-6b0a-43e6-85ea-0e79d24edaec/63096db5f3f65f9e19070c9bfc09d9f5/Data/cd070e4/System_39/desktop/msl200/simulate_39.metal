...
float l9_8=float(l9_7)/1399.0;
param_1.Ratio1D=l9_8;
int l9_9=param_1.Index1DPerCopy;
float l9_10=float(l9_9)/1399.0;
...
l9_61=!(UserUniforms.vfxBatchEnable[l9_62/1400]!=0);
}
else
{
l9_61=l9_60;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/1400];
...
l9_269=l9_270;
float l9_271=0.0;
float l9_272=(*sc_set0.UserUniforms).Radius;
l9_271=l9_272;
float l9_273=0.0;
l9_273=l9_271;
...
l9_275=((l9_186*float3(l9_269))*float3(l9_273))*l9_274;
float3 l9_276=float3(0.0);
l9_276=l9_104+l9_275;
...
float4 l9_277=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_278=dot(l9_277,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_279=l9_278;
...
{
out.varClipDistance=l9_279;
}
}
float4 l9_280=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_280;
return out;
}
...
param_3*=(param_4*0.5);
float2 l9_282=param_3;
float param_5=(snoise(l9_282)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_283=param_6;
float param_8=(snoise(l9_283)*0.5)+0.5;
...
float2 l9_284=param_9;
float param_11=(snoise(l9_284)*0.5)+0.5;
...
bool l9_288=true;
float l9_289=24.0;
ssParticle l9_290=gParticle;
float l9_291=0.0;
float l9_292=param_15.gTimeElapsed;
float4 l9_293=float4(0.0);
float4 l9_294=float4(0.0);
if (l9_286)
{
l9_294.x=floor(fract(l9_292)*1000.0);
}
if (l9_288)
{
l9_294.y=float(l9_290.Index1D^((l9_290.Index1D*15299)+l9_290.Index1D));
}
if (l9_287)
{
l9_294.z=l9_289;
}
l9_294.w=l9_291*1000.0;
int l9_295=int(l9_294.x);
int l9_296=int(l9_294.y);
int l9_297=int(l9_294.z);
int l9_298=int(l9_294.w);
int l9_299=(((l9_295*15299)^(l9_296*30133))^(l9_297*17539))^(l9_298*12113);
int l9_300=l9_299;
if (l9_285==1)
{
int l9_301=l9_300;
...
float2 l9_318=float2(l9_315,l9_317);
l9_293=float4(l9_318.x,l9_318.y,l9_293.z,l9_293.w);
}
else
{
if (l9_285==3)
...
int l9_322=l9_321;
int l9_323=l9_319*1399;
int l9_324=((l9_323*((l9_323*1471343)+101146501))+1559861749)&2147483647;
int l9_325=l9_324;
int l9_326=l9_319*7177;
...
float3 l9_335=float3(l9_330,l9_332,l9_334);
l9_293=float4(l9_335.x,l9_335.y,l9_335.z,l9_293.w);
}
else
{
int l9_336=l9_300;
...
float4 l9_357=float4(l9_350,l9_352,l9_354,l9_356);
l9_293=l9_357;
}
}
}
float4 l9_358=l9_293;
float4 l9_359=l9_358;
float param_14=mix(param_12,param_13,l9_359.x);
Random_N24=param_14;
...
float4 l9_360=param_17;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_361=dot(l9_360,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_362=l9_361;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_362;
}
}
float4 l9_363=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);
out.gl_Position=l9_363;
return out;
}
float l9_364;
...
{
l9_364=gParticle.Force.x;
}
gParticle.Force.x=l9_364;
float l9_365;
...
{
l9_365=gParticle.Force.y;
}
gParticle.Force.y=l9_365;
float l9_366;
...
{
l9_366=gParticle.Force.z;
}
gParticle.Force.z=l9_366;
...
{
l9_367=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_367;
float l9_368;
...
{
l9_369=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_369;
...
int l9_370=gl_InstanceIndex;
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_370;
int particleRow=512;
...
float4 l9_373=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_374=dot(l9_373,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_375=l9_374;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_375;
}
}
float4 l9_376=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_376;
int l9_377=gl_InstanceIndex;
out.Interp_Particle_Index=l9_377;
...
float4 l9_378=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_379=dot(l9_378,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_380=l9_379;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_380;
}
}
float4 l9_381=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_381;
return out;
}
return out;
}
