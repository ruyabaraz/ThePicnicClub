...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/1400];
}
else
{
l9_15=l9_14;
...
float l9_12=floor(37.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_12))/37.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_12)/37.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Position=Port_Import_N038+((((l9_14/(vec3(length(l9_14))+vec3(1.234e-06)))*vec3(l9_18))*vec3(Radius))*Port_Import_N048);
