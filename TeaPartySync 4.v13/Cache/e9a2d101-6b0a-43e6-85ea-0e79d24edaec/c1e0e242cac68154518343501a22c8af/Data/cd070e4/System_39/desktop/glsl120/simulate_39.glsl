...
gParticle.Matrix=mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0));
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
gParticle.Life=mix(floor(Port_Input0_N019).x,Port_Import_N014,ssGetParticleRandom(1,true,true,true,16.0,gParticle,0.0,sc_Time.x).x);
