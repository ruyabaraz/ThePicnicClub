...
float4 l9_192=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_193=dot(l9_192,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_194=l9_193;
...
{
out.varClipDistance=l9_194;
}
}
float4 l9_195=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_195;
return out;
}
...
param_3*=(param_4*0.5);
float2 l9_197=param_3;
float param_5=(snoise(l9_197)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_198=param_6;
float param_8=(snoise(l9_198)*0.5)+0.5;
...
float2 l9_199=param_9;
float param_11=(snoise(l9_199)*0.5)+0.5;
...
float l9_206=0.0;
float l9_207=param_15.gTimeElapsed;
...
float param_14=mix(param_12,param_13,l9_274.x);
Random_N24=param_14;
...
float4 l9_278=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);
...
{
l9_279=gParticle.Force.x;
}
gParticle.Force.x=l9_279;
float l9_280;
...
{
l9_280=gParticle.Force.y;
}
gParticle.Force.y=l9_280;
float l9_281;
...
{
l9_281=gParticle.Force.z;
}
gParticle.Force.z=l9_281;
...
{
l9_282=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_282;
float l9_283;
...
{
l9_283=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_283;
float l9_284;
...
{
l9_284=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_284;
...
int l9_285=gl_InstanceIndex;
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_285;
int particleRow=512;
...
float4 l9_288=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_289=dot(l9_288,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_290=l9_289;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_290;
}
}
float4 l9_291=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_291;
int l9_292=gl_InstanceIndex;
out.Interp_Particle_Index=l9_292;
...
float4 l9_293=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_294=dot(l9_293,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_295=l9_294;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_295;
}
}
float4 l9_296=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_296;
return out;
}
return out;
}
