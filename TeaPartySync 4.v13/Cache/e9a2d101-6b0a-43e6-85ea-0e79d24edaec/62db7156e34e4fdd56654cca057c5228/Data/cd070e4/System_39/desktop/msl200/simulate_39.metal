...
float3 l9_23=(*sc_set0.UserUniforms).Port_Min_N041;
float3 l9_24=(*sc_set0.UserUniforms).Port_Max_N041;
...
float l9_104=0.0;
float l9_105=(*sc_set0.UserUniforms).Port_Min_N044;
float l9_106=(*sc_set0.UserUniforms).Port_Max_N044;
...
l9_186=l9_187;
float l9_188=0.0;
l9_188=(*sc_set0.UserUniforms).Port_Import_N047;
float3 l9_189=float3(0.0);
l9_189=(*sc_set0.UserUniforms).Port_Import_N048;
...
float l9_192=(*sc_set0.UserUniforms).Port_Value_N011;
...
float4 l9_193=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_194=dot(l9_193,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_195=l9_194;
...
{
out.varClipDistance=l9_195;
}
}
float4 l9_196=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_196;
return out;
}
...
param_3*=(param_4*0.5);
float2 l9_198=param_3;
float param_5=(snoise(l9_198)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_199=param_6;
float param_8=(snoise(l9_199)*0.5)+0.5;
...
float2 l9_200=param_9;
float param_11=(snoise(l9_200)*0.5)+0.5;
...
bool l9_204=true;
float l9_205=24.0;
ssParticle l9_206=gParticle;
float l9_207=0.0;
float l9_208=param_15.gTimeElapsed;
float4 l9_209=float4(0.0);
float4 l9_210=float4(0.0);
if (l9_202)
{
l9_210.x=floor(fract(l9_208)*1000.0);
}
if (l9_204)
{
l9_210.y=float(l9_206.Index1D^((l9_206.Index1D*15299)+l9_206.Index1D));
}
if (l9_203)
{
l9_210.z=l9_205;
}
l9_210.w=l9_207*1000.0;
int l9_211=int(l9_210.x);
int l9_212=int(l9_210.y);
int l9_213=int(l9_210.z);
int l9_214=int(l9_210.w);
int l9_215=(((l9_211*15299)^(l9_212*30133))^(l9_213*17539))^(l9_214*12113);
int l9_216=l9_215;
if (l9_201==1)
{
int l9_217=l9_216;
...
int l9_226=l9_225;
int l9_227=l9_223*1399;
int l9_228=((l9_227*((l9_227*1471343)+101146501))+1559861749)&2147483647;
int l9_229=l9_228;
int l9_230=l9_226;
float l9_231=float(l9_230)*4.6566129e-10;
int l9_232=l9_229;
float l9_233=float(l9_232)*4.6566129e-10;
float2 l9_234=float2(l9_231,l9_233);
l9_209=float4(l9_234.x,l9_234.y,l9_209.z,l9_209.w);
}
else
{
if (l9_201==3)
...
int l9_249=l9_244;
float l9_250=float(l9_249)*4.6566129e-10;
float3 l9_251=float3(l9_246,l9_248,l9_250);
l9_209=float4(l9_251.x,l9_251.y,l9_251.z,l9_209.w);
}
else
{
int l9_252=l9_216;
...
float4 l9_273=float4(l9_266,l9_268,l9_270,l9_272);
l9_209=l9_273;
}
}
}
float4 l9_274=l9_209;
float4 l9_275=l9_274;
float param_14=mix(param_12,param_13,l9_275.x);
Random_N24=param_14;
...
float4 l9_279=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);
...
{
l9_280=gParticle.Force.x;
}
gParticle.Force.x=l9_280;
float l9_281;
...
{
l9_281=gParticle.Force.y;
}
gParticle.Force.y=l9_281;
float l9_282;
...
{
l9_282=gParticle.Force.z;
}
gParticle.Force.z=l9_282;
...
{
l9_283=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_283;
float l9_284;
...
{
l9_284=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_284;
float l9_285;
...
{
l9_285=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_285;
...
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_286;
int particleRow=512;
...
float4 l9_289=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_290=dot(l9_289,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_291=l9_290;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_291;
}
}
float4 l9_292=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_292;
int l9_293=gl_InstanceIndex;
out.Interp_Particle_Index=l9_293;
...
float4 l9_294=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_295=dot(l9_294,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_296=l9_295;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_296;
}
}
float4 l9_297=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_297;
return out;
}
return out;
}
