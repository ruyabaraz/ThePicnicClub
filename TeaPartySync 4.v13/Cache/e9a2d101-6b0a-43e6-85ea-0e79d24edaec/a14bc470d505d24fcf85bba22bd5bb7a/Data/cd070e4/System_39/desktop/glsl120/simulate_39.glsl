...
uniform float ParticleMaxRadius;
...
gParticle.Position=Port_Import_N038+((((l9_14/(vec3(length(l9_14))+vec3(1.234e-06)))*vec3(l9_18))*vec3(ParticleMaxRadius))*Port_Import_N048);
