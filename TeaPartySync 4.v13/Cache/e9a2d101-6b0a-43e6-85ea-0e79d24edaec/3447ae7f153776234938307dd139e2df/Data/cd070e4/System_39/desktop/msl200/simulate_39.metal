...
float l9_4=(float(l9_3)+0.5)/1000.0;
...
float l9_8=float(l9_7)/999.0;
param_1.Ratio1D=l9_8;
int l9_9=param_1.Index1DPerCopy;
float l9_10=float(l9_9)/999.0;
...
l9_61=!(UserUniforms.vfxBatchEnable[l9_62/1000]!=0);
}
else
{
l9_61=l9_60;
...
float4 l9_361=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
...
param_3*=(param_4*0.5);
float2 l9_363=param_3;
float param_5=(snoise(l9_363)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_364=param_6;
float param_8=(snoise(l9_364)*0.5)+0.5;
...
float2 l9_365=param_9;
float param_11=(snoise(l9_365)*0.5)+0.5;
...
bool l9_369=true;
float l9_370=24.0;
ssParticle l9_371=gParticle;
float l9_372=0.0;
float l9_373=param_15.gTimeElapsed;
float4 l9_374=float4(0.0);
float4 l9_375=float4(0.0);
if (l9_367)
{
l9_375.x=floor(fract(l9_373)*1000.0);
}
if (l9_369)
{
l9_375.y=float(l9_371.Index1D^((l9_371.Index1D*15299)+l9_371.Index1D));
}
if (l9_368)
{
l9_375.z=l9_370;
}
l9_375.w=l9_372*1000.0;
int l9_376=int(l9_375.x);
int l9_377=int(l9_375.y);
int l9_378=int(l9_375.z);
int l9_379=int(l9_375.w);
int l9_380=(((l9_376*15299)^(l9_377*30133))^(l9_378*17539))^(l9_379*12113);
int l9_381=l9_380;
if (l9_366==1)
{
int l9_382=l9_381;
...
float2 l9_399=float2(l9_396,l9_398);
l9_374=float4(l9_399.x,l9_399.y,l9_374.z,l9_374.w);
}
else
{
if (l9_366==3)
...
int l9_403=l9_402;
int l9_404=l9_400*1399;
int l9_405=((l9_404*((l9_404*1471343)+101146501))+1559861749)&2147483647;
int l9_406=l9_405;
int l9_407=l9_400*7177;
int l9_408=((l9_407*((l9_407*1471343)+101146501))+1559861749)&2147483647;
int l9_409=l9_408;
int l9_410=l9_403;
...
int l9_414=l9_409;
float l9_415=float(l9_414)*4.6566129e-10;
float3 l9_416=float3(l9_411,l9_413,l9_415);
l9_374=float4(l9_416.x,l9_416.y,l9_416.z,l9_374.w);
}
else
{
int l9_417=l9_381;
...
int l9_436=l9_429;
float l9_437=float(l9_436)*4.6566129e-10;
float4 l9_438=float4(l9_431,l9_433,l9_435,l9_437);
l9_374=l9_438;
}
}
}
float4 l9_439=l9_374;
float4 l9_440=l9_439;
float param_14=mix(param_12,param_13,l9_440.x);
Random_N24=param_14;
...
float4 l9_444=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);
...
{
l9_445=gParticle.Force.x;
}
gParticle.Force.x=l9_445;
float l9_446;
...
{
l9_446=gParticle.Force.y;
}
gParticle.Force.y=l9_446;
float l9_447;
...
{
l9_447=gParticle.Force.z;
}
gParticle.Force.z=l9_447;
...
{
l9_448=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_448;
float l9_449;
...
{
l9_449=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_449;
float l9_450;
...
{
l9_450=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_450;
...
int l9_451=gl_InstanceIndex;
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_451;
int particleRow=512;
...
float4 l9_454=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_455=dot(l9_454,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_456=l9_455;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_456;
}
}
float4 l9_457=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_457;
int l9_458=gl_InstanceIndex;
out.Interp_Particle_Index=l9_458;
...
float4 l9_462=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
