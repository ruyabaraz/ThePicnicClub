...
float l9_291=0.0;
float l9_292=param_16.gTimeElapsed;
...
float param_15=mix(param_13,param_14,l9_359.x);
Random_N24=param_15;
...
float4 l9_363=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
...
float4 l9_376=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
...
float4 l9_381=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);
