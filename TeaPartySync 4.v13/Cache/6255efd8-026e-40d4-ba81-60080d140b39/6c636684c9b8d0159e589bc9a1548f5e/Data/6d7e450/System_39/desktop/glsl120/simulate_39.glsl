...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/1999];
}
else
{
l9_15=l9_14;
...
if (l9_1!=0.0)
{
ssGlobals l9_11=ssGlobals(sc_Time.x,l9_1,l9_3,overrideTimeElapsed[sc_GetLocalInstanceID()/1999]);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_13=floor(44.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_13))/44.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_13)/44.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
