...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/2000];
}
else
{
l9_15=l9_14;
...
if (l9_1!=0.0)
{
ssGlobals l9_11=ssGlobals(sc_Time.x,l9_1,l9_3,overrideTimeElapsed[sc_GetLocalInstanceID()/2000]);
