...
l9_58=!(UserUniforms.vfxBatchEnable[l9_59/16000]!=0);
}
else
{
l9_58=l9_57;
...
int InstanceID=l9_2;
int l9_3=InstanceID;
bool l9_4=l9_3>=(16000*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
int l9_6=gl_InstanceIndex;
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[l9_6/16000]!=0)==false;
}
else
{
l9_5=l9_4;
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_24/16000]*float4(gParticle.Position,1.0)).xyz;
int l9_25=gl_InstanceIndex;
int l9_26=l9_25/16000;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/16000];
