...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceID()/2];
}
else
{
l9_17=l9_16;
...
bool l9_3=l9_2>=(2*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/2]==false;
}
else
{
l9_4=l9_3;
...
float l9_5=float(l9_4)/1.0;
float l9_6;
if (overrideTimeEnabled==1)
{
l9_6=overrideTimeElapsed[l9_4/2];
}
else
{
l9_6=sc_Time.x;
...
float l9_40=(float(l9_4%2)/1.0)*(((sc_Time.x-((floor(fract(sin(dot(vec2(l9_5)*vec2(0.3452,0.52253997),vec2(0.98253,0.72662002)))*479.371)*10000.0)*9.9999997e-05)*min(overrideTimeDelta,0.5)))-0.0)*Port_Multiplier_N051);
