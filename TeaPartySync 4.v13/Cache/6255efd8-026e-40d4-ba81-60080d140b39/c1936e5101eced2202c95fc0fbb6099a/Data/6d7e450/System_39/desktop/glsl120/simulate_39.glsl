...
int l9_0=InstanceID/2;
int l9_1=InstanceID%2;
float l9_2=float(l9_1);
ivec2 l9_3=ivec2(l9_1,l9_0);
float l9_4=float(InstanceID);
vec2 l9_5=vec2(l9_3);
float l9_6=l9_4/1.0;
ssParticle l9_7=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,l9_6*1.0,0.0,gParticle.Seed2000,floor(fract(sin(dot(vec2(l9_6)*vec2(0.3452,0.52253997),vec2(0.98253,0.72662002)))*479.371)*10000.0)*9.9999997e-05,InstanceID,l9_1,l9_2,(2*(l9_0+1))-1,(l9_4+0.5)/2.0,l9_6,l9_2/1.0,l9_3,(l9_5+vec2(0.5))/vec2(2.0,1.0),l9_5/vec2(1.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/2];
}
else
{
l9_15=l9_14;
...
if (l9_1!=0.0)
{
ssGlobals l9_11=ssGlobals(sc_Time.x,l9_1,l9_3,overrideTimeElapsed[sc_GetLocalInstanceID()/2]);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_13=floor(1.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_13))/1.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_13)/1.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
