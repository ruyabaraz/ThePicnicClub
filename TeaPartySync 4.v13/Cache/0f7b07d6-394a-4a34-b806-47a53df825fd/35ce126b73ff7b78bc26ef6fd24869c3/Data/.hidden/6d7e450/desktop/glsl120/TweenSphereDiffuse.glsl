...
//spec_const bool SC_DISABLE_FRUSTUM_CULLING 40 0
//spec_const bool SC_GL_FRAGMENT_PRECISION_HIGH 41 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_baseTex 42 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_detailNormalTex 43 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 44 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_normalTex 45 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_opacityTex 46 0
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 47 0
//spec_const bool SC_USE_UV_MIN_MAX_detailNormalTex 48 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 49 0
//spec_const bool SC_USE_UV_MIN_MAX_normalTex 50 0
//spec_const bool SC_USE_UV_MIN_MAX_opacityTex 51 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 52 0
//spec_const bool SC_USE_UV_TRANSFORM_detailNormalTex 53 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 54 0
//spec_const bool SC_USE_UV_TRANSFORM_normalTex 55 0
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 56 0
//spec_const bool UseViewSpaceDepthVariant 57 1
//spec_const bool baseTexHasSwappedViews 58 0
//spec_const bool detailNormalTexHasSwappedViews 59 0
...
//spec_const bool sc_BlendMode_AddWithAlphaFactor 64 0
//spec_const bool sc_BlendMode_AlphaTest 65 0
//spec_const bool sc_BlendMode_AlphaToCoverage 66 0
//spec_const bool sc_BlendMode_ColoredGlass 67 0
//spec_const bool sc_BlendMode_Custom 68 0
//spec_const bool sc_BlendMode_Max 69 0
//spec_const bool sc_BlendMode_Min 70 0
//spec_const bool sc_BlendMode_Multiply 71 0
//spec_const bool sc_BlendMode_MultiplyOriginal 72 0
//spec_const bool sc_BlendMode_Normal 73 0
//spec_const bool sc_BlendMode_PremultipliedAlpha 74 0
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 75 0
//spec_const bool sc_BlendMode_PremultipliedAlphaHardware 76 0
//spec_const bool sc_BlendMode_Screen 77 0
//spec_const bool sc_BlendMode_Software 78 0
...
//spec_const int NODE_13_DROPLIST_ITEM 106 0
//spec_const int NODE_181_DROPLIST_ITEM 107 0
//spec_const int NODE_184_DROPLIST_ITEM 108 0
//spec_const int NODE_27_DROPLIST_ITEM 109 0
//spec_const int NODE_38_DROPLIST_ITEM 110 0
//spec_const int NODE_49_DROPLIST_ITEM 111 0
//spec_const int NODE_69_DROPLIST_ITEM 112 0
//spec_const int SC_DEVICE_CLASS 113 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 114 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 115 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 116 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 117 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 118 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 119 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 120 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 121 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 122 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 123 -1
//spec_const int baseTexLayout 124 0
//spec_const int detailNormalTexLayout 125 0
//spec_const int intensityTextureLayout 126 0
//spec_const int normalTexLayout 127 0
//spec_const int opacityTexLayout 128 0
//spec_const int sc_AmbientLightMode0 129 0
//spec_const int sc_AmbientLightMode1 130 0
//spec_const int sc_AmbientLightMode2 131 0
//spec_const int sc_AmbientLightMode_Constant 132 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 133 0
//spec_const int sc_AmbientLightMode_FromCamera 134 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 135 0
//spec_const int sc_AmbientLightsCount 136 0
//spec_const int sc_DepthBufferMode 137 0
//spec_const int sc_DirectionalLightsCount 138 0
//spec_const int sc_EnvLightMode 139 0
//spec_const int sc_EnvmapDiffuseLayout 140 0
//spec_const int sc_EnvmapSpecularLayout 141 0
//spec_const int sc_LightEstimationSGCount 142 0
//spec_const int sc_MaxTextureImageUnits 143 0
//spec_const int sc_PointLightsCount 144 0
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_267-0.0039215689)),min(1.0,l9_267+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_268=sc_ScreenCoordsGlobalToView(l9_1);
...
sc_writeFragData0Internal(vec4(packValue(l9_269),packValue(l9_269),packValue(l9_269),packValue(l9_269)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_281=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
