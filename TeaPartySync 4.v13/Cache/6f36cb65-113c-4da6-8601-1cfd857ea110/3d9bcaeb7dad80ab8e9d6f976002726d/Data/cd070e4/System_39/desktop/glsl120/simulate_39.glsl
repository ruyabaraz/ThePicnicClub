...
int l9_0=InstanceID/12000;
int l9_1=InstanceID%12000;
float l9_2=float(l9_1);
ivec2 l9_3=ivec2(InstanceID%512,InstanceID/512);
float l9_4=float(InstanceID);
vec2 l9_5=vec2(l9_3);
float l9_6=l9_4/11999.0;
ssParticle l9_7=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,l9_6*1.0,0.0,gParticle.Seed2000,floor(fract(sin(dot(vec2(l9_6)*vec2(0.3452,0.52253997),vec2(0.98253,0.72662002)))*479.371)*10000.0)*9.9999997e-05,InstanceID,l9_1,l9_2,(12000*(l9_0+1))-1,(l9_4+0.5)/12000.0,l9_6,l9_2/11999.0,l9_3,(l9_5+vec2(0.5))/vec2(512.0,24.0),l9_5/vec2(511.0,23.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000];
}
else
{
l9_15=l9_14;
...
gParticle.Size=0.0+(((DecodeFloat32(renderTarget0SampleViewIndexLevel(l9_20,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(120.0-0.0))/l9_17);
...
if (l9_1!=0.0)
{
ssGlobals l9_11=ssGlobals(sc_Time.x,l9_1,l9_3,overrideTimeElapsed[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000]);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_13=floor(109.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_13))/109.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_13)/109.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
int l9_65=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_66=vfxOffsetInstancesWrite+l9_65;
float l9_67;
if (texture0.x<0.5)
{
l9_67=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_67,l9_68)+(vec2(float(l9_66%512),float(l9_66/512))*l9_64))*2.0)-vec2(1.0),1.0,1.0));
