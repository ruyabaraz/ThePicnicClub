...
//spec_const bool sc_RenderAlphaToColor 56 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_colorrampTex 60 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 61 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTex 62 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_colorrampTex 63 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 64 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTex 65 -1
//spec_const int colorrampTexLayout 66 0
//spec_const int intensityTextureLayout 67 0
//spec_const int mainTexLayout 68 0
//spec_const int renderTarget0Layout 69 0
//spec_const int renderTarget1Layout 70 0
//spec_const int renderTarget2Layout 71 0
//spec_const int renderTarget3Layout 72 0
...
//spec_const int sc_StereoViewID 78 0
//SG_REFLECTION_END
...
gParticle.CopyId=float(InstanceID/12000);
...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000];
}
else
{
l9_17=l9_16;
...
gParticle.Size=0.0+(((DecodeFloat32(renderTarget0SampleViewIndexLevel(l9_22,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(120.0-0.0))/l9_19);
...
bool l9_1=l9_0>=(12000*(vfxNumCopies+1));
bool l9_2;
if (!l9_1)
{
l9_2=vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000]==false;
}
else
{
l9_2=l9_1;
...
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000]*vec4(gParticle.Position,1.0)).xyz;
int l9_7=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000;
gParticle.Velocity=mat3(vfxModelMatrix[l9_7][0].xyz,vfxModelMatrix[l9_7][1].xyz,vfxModelMatrix[l9_7][2].xyz)*gParticle.Velocity;
int l9_8=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000;
gParticle.Force=mat3(vfxModelMatrix[l9_8][0].xyz,vfxModelMatrix[l9_8][1].xyz,vfxModelMatrix[l9_8][2].xyz)*gParticle.Force;
int l9_9=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/12000;
...
float l9_5=float(l9_4)/11999.0;
float l9_6;
if (overrideTimeEnabled==1)
{
l9_6=overrideTimeElapsed[l9_4/12000];
}
else
{
l9_6=sc_Time.x;
...
float l9_40=(float(l9_4%12000)/11999.0)*(((sc_Time.x-((floor(fract(sin(dot(vec2(l9_5)*vec2(0.3452,0.52253997),vec2(0.98253,0.72662002)))*479.371)*10000.0)*9.9999997e-05)*min(overrideTimeDelta,0.5)))-0.0)*Port_Multiplier_N051);
