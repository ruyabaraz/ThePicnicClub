...
//spec_const bool Tweak_N1HasSwappedViews 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 83 -1
...
#endif
bool l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_16=l9_13.x;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_17=l9_16;
float l9_18=l9_13.y;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_19=l9_18;
vec2 l9_20;
float l9_21;
...
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_22=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_23=l9_17;
float l9_24=1.0;
sc_ClampUV(l9_23,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_22,l9_24);
float l9_25=l9_23;
float l9_26=l9_24;
bool l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_27=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_27=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_28=l9_19;
float l9_29=l9_26;
sc_ClampUV(l9_28,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_27,l9_29);
l9_21=l9_29;
...
#endif
vec2 l9_30=sc_TransformUV(l9_20,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_31=l9_30.x;
float l9_32=l9_21;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_15,l9_32);
float l9_33=l9_30.y;
float l9_34=l9_32;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_15,l9_34);
float l9_35=l9_34;
vec3 l9_36=sc_SamplingCoordsViewToGlobal(vec2(l9_31,l9_33),Tweak_N1Layout,l9_14);
vec4 l9_37=texture2D(Tweak_N1,l9_36.xy,0.0);
vec4 l9_38;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_38=mix(Tweak_N1BorderColor,l9_37,vec4(l9_35));
}
#else
{
l9_38=l9_37;
...
{
l9_39=vec4(pow(l9_38.x,2.2),pow(l9_38.y,2.2),pow(l9_38.z,2.2),0.0);
}
#else
{
l9_39=l9_38*l9_38;
...
#endif
vec3 l9_40=vec3(Port_Import_N062)*l9_39.xyz;
vec3 l9_41;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_41=vec3(pow(l9_40.x,0.45454544),pow(l9_40.y,0.45454544),pow(l9_40.z,0.45454544));
}
#else
{
l9_41=sqrt(l9_40);
...
#endif
vec3 l9_42=mix(baseColor.xyz,min(baseColor.xyz+l9_41.xyz,vec3(1.0)).xyz,vec3(Port_Value2_N003));
...
{
l9_46=clamp(baseColor.w*2.0,0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_47=clamp(dot(l9_43.xyz,vec3(baseColor.w)),0.0,1.0);
}
#else
{
float l9_48;
...
{
l9_49=(1.0-dot(l9_43.xyz,vec3(0.33333001)))*baseColor.w;
}
#else
{
float l9_50;
...
{
l9_50=(1.0-clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0))*baseColor.w;
}
#else
{
float l9_51;
...
{
l9_51=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_52;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_53=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_54;
...
{
l9_54=dot(l9_43.xyz,vec3(0.33333001))*baseColor.w;
}
#else
{
float l9_55;
...
#endif
vec3 l9_67=mix(l9_65.xyz,definedBlend(l9_65.xyz,l9_43.xyz).xyz,vec3(baseColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_69=vec4(mix(vec3(1.0),l9_43.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_70;
...
{
l9_71=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_71=baseColor.w;
