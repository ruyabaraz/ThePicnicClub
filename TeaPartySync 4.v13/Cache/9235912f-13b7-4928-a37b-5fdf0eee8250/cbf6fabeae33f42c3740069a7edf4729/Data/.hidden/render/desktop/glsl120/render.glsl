...
//texture texture2D baseTex 2:0:2:20
...
int l9_0=InstanceID;
ivec2 l9_1=ivec2(l9_0%300,l9_0/300);
float l9_2=float(l9_0);
vec2 l9_3=vec2(l9_1);
float l9_4=l9_2*0.0100334;
float l9_5;
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,gParticle.Dead,l9_4,fract(abs(((l9_2*0.00326548)+0.151235)+(floor(((l9_5-l9_4)+6.0)*0.333333)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))*vec2(0.00250627),float(((l9_0*((l9_0*1471343)+101146501))+1559861749)&2147483647)*4.65661e-10,l9_0,(l9_2+0.5)*0.00333333,l9_2*0.00334448,l9_1,(l9_3+vec2(0.5))*vec2(0.00333333,1.0),l9_3*vec2(0.00334448,1.0),vec3(0.0),false);
...
{
l9_8=vec2(1.0-varPackedTex.x,varPackedTex.y);
}
vec3 l9_9=normalize(l9_7);
int l9_10;
...
#endif
vec4 l9_11=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_10,l9_8,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
float l9_12=clamp(Port_Import_N102,0.0,1.0);
N106_SpecularStrength=clamp(Port_Import_N103,0.0,1.0);
N106_SpecHighlightSize=clamp(Port_Import_N104,0.001,10.0);
vec3 l9_13=normalize(varPos-sc_Camera.position);
vec3 l9_14;
...
{
l9_14=Port_Import_N099;
}
vec4 l9_16;
#if (sc_DirectionalLightsCount>0)
{
vec4 l9_17;
l9_17=vec4(0.0,0.0,0.0,1.0);
vec4 l9_18;
int l9_19=0;
bool l9_20;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_20=l9_19<sc_DirectionalLightsCount;
if (l9_20)
{
vec3 l9_21;
if (l9_20)
{
l9_21=-sc_DirectionalLights[l9_19].direction;
}
else
{
l9_21=vec3(0.0);
...
if (l9_20)
{
l9_23=sc_DirectionalLights[l9_19].color.xyz;
}
else
{
l9_23=vec3(0.0);
...
if (l9_20)
{
l9_24=sc_DirectionalLights[l9_19].color.w;
}
else
{
l9_24=0.0;
}
vec3 l9_25=l9_23*l9_24;
vec3 l9_26=(l9_17.xyz+(l9_25*(max(0.0,dot(l9_14,l9_22))*l9_12))).xyz+(l9_25*N106_getSpecular(l9_13,l9_14,l9_22));
l9_18=vec4(l9_26.x,l9_26.y,l9_26.z,l9_17.w);
l9_17=l9_18;
l9_19++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_31=l9_30<sc_PointLightsCount;
if (l9_31)
{
vec3 l9_32;
if (l9_31)
{
l9_32=sc_PointLights[l9_30].position;
}
else
{
l9_32=vec3(0.0);
...
if (l9_31)
{
l9_33=sc_PointLights[l9_30].color.xyz;
}
else
{
l9_33=vec3(0.0);
...
if (l9_31)
{
l9_34=sc_PointLights[l9_30].color.w;
}
else
{
l9_34=0.0;
}
vec3 l9_35=-normalize(varPos-l9_32);
vec3 l9_36=l9_33*l9_34;
vec3 l9_37=(l9_28.xyz+(l9_36*(max(0.0,dot(l9_14,l9_35))*l9_12))).xyz+(l9_36*N106_getSpecular(l9_13,l9_14,l9_35));
l9_29=vec4(l9_37.x,l9_37.y,l9_37.z,l9_28.w);
l9_28=l9_29;
l9_30++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_42=l9_41<sc_AmbientLightsCount;
if (l9_42)
{
vec3 l9_43;
if (l9_42)
{
l9_43=sc_AmbientLights[l9_41].color;
}
else
{
l9_43=vec3(0.0);
...
if (l9_42)
{
l9_44=sc_AmbientLights[l9_41].intensity;
}
else
{
l9_44=0.0;
}
vec3 l9_45=l9_39.xyz+((l9_43*l9_44)*clamp(Port_Import_N105,0.0,1.0));
l9_40=vec4(l9_45.x,l9_45.y,l9_45.z,l9_39.w);
l9_39=l9_40;
l9_41++;
continue;
}
...
#endif
vec4 l9_46=ngsPixelShader(l9_38*(Interp_Particle_Color*l9_11));
vec4 l9_47;
#if (sc_ShaderComplexityAnalyzer)
{
l9_47=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_47=vec4(0.0);
...
#if (sc_OITDepthBoundsPass)
{
float l9_50=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_50),min(1.0,l9_50+0.00392157),0.0,0.0));
}
#endif
}
#else
...
l9_54.x=l9_53;
vec4 l9_56=l9_54;
l9_56.y=packValue(l9_52);
vec4 l9_58=l9_56;
l9_58.z=packValue(l9_52);
vec4 l9_60=l9_58;
l9_60.w=packValue(l9_52);
vec4 l9_62=vec4(0.0);
l9_62.x=packValue(l9_52);
vec4 l9_64=l9_62;
l9_64.y=packValue(l9_52);
vec4 l9_66=l9_64;
l9_66.z=packValue(l9_52);
vec4 l9_67=l9_66;
l9_67.w=packValue(l9_52);
int l9_68=int(l9_49.w*255.0);
float l9_69=packValue(l9_68);
vec4 l9_70=vec4(0.0);
l9_70.x=l9_69;
vec4 l9_72=l9_70;
l9_72.y=packValue(l9_68);
vec4 l9_74=l9_72;
l9_74.z=packValue(l9_68);
vec4 l9_75=l9_74;
l9_75.w=packValue(l9_68);
sc_writeFragData0(l9_67);
sc_writeFragData1(l9_60);
sc_writeFragData2(l9_75);
...
if (l9_87==0)
{
l9_90=texture2D(sc_OITAlpha0,l9_76);
l9_89=texture2D(sc_OITDepthLow0,l9_76);
l9_88=texture2D(sc_OITDepthHigh0,l9_76);
}
else
{
l9_90=l9_83;
...
if (l9_87==1)
{
l9_86=texture2D(sc_OITAlpha1,l9_76);
l9_85=texture2D(sc_OITDepthLow1,l9_76);
l9_84=texture2D(sc_OITDepthHigh1,l9_76);
}
else
{
l9_86=l9_90;
...
{
int l9_91[8]=l9_77;
unpackValues(l9_84.w,l9_87,l9_91);
unpackValues(l9_84.z,l9_87,l9_91);
unpackValues(l9_84.y,l9_87,l9_91);
unpackValues(l9_84.x,l9_87,l9_91);
unpackValues(l9_85.w,l9_87,l9_91);
unpackValues(l9_85.z,l9_87,l9_91);
unpackValues(l9_85.y,l9_87,l9_91);
unpackValues(l9_85.x,l9_87,l9_91);
int l9_100[8]=l9_78;
unpackValues(l9_86.w,l9_87,l9_100);
unpackValues(l9_86.z,l9_87,l9_100);
unpackValues(l9_86.y,l9_87,l9_100);
unpackValues(l9_86.x,l9_87,l9_100);
}
l9_83=l9_86;
l9_82=l9_85;
l9_81=l9_84;
...
vec4 l9_105=texture2D(sc_OITFilteredDepthBoundsTexture,l9_76);
...
#endif
l9_107=encodeDepth(((1.0-l9_105.x)*1000.0)+l9_108,l9_106);
}
#else
{
l9_107=0;
...
#endif
int l9_109=encodeDepth(viewSpaceDepth(),l9_106);
vec4 l9_110;
l9_110=l9_49*l9_49.w;
vec4 l9_111;
int l9_112=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_112<8)
{
int l9_113=l9_77[l9_112];
int l9_114=l9_109-l9_107;
bool l9_115=l9_113<l9_114;
bool l9_116;
if (l9_115)
{
l9_116=l9_77[l9_112]>0;
}
else
{
l9_116=l9_115;
...
if (l9_116)
{
vec3 l9_117=l9_110.xyz*(1.0-(float(l9_78[l9_112])*0.00392157));
