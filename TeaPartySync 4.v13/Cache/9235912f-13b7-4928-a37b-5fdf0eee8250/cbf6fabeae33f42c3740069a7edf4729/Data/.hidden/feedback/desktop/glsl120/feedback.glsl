...
#endif
vec2 l9_1=l9_0*2.0;
vec4 l9_2=vec4(l9_1-vec2(1.0),1.0,1.0);
...
{
float l9_3=dot(l9_2,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_3);
}
#else
{
varClipDistance=l9_3;
}
#endif
}
#endif
...
#endif
vec2 l9_0=varPackedTex.xy*(oldRtSizeInv/newRtSizeInv);
int l9_1;
...
if (dot(((l9_2+l9_4)+l9_6)+l9_8,vec4(0.254232))==0.342318)
{
discard;
}
