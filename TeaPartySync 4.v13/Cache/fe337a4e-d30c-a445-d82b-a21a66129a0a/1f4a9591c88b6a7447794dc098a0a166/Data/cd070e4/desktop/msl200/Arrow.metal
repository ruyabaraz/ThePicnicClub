...
//float3 Port_Normal_N000 4272
//float Port_Exponent_N000 4288
//float Port_Intensity_N000 4292
//float depthRef 4296
//}
...
float l9_5=abs(dot(-param_4.ViewDirWS,param));
float param_3=pow(1.0-l9_5,param_1);
...
float4 l9_10=fast::max(param_6,float4(0.0));
float4 param_7=l9_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
