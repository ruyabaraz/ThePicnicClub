...
//sampler sampler sBoundarySmpSC 0:18
//sampler sampler sVelocitySmpSC 0:19
...
//texture texture2D sBoundary 0:1:0:18
//texture texture2D sVelocity 0:2:0:19
...
//spec_const bool SC_USE_UV_MIN_MAX_sVelocity 37 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 38 0
//spec_const bool SC_USE_UV_TRANSFORM_sBoundary 39 0
//spec_const bool SC_USE_UV_TRANSFORM_sVelocity 40 0
//spec_const bool UseViewSpaceDepthVariant 41 1
//spec_const bool intensityTextureHasSwappedViews 42 0
//spec_const bool sBoundaryHasSwappedViews 43 0
//spec_const bool sVelocityHasSwappedViews 44 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_sBoundary 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_sVelocity 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_sBoundary 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_sVelocity 88 -1
//spec_const int intensityTextureLayout 89 0
//spec_const int sBoundaryLayout 90 0
//spec_const int sVelocityLayout 91 0
...
int sVelocityGetStereoViewIndex()
{
int l9_0;
...
vec4 N8_sVelocity_sample(vec2 coords)
{
bool l9_0=(int(SC_USE_CLAMP_TO_BORDER_sVelocity)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sVelocity)!=0));
float l9_1=coords.x;
sc_SoftwareWrapEarly(l9_1,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).x);
float l9_2=l9_1;
float l9_3=coords.y;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).y);
float l9_4=l9_3;
vec2 l9_5;
float l9_6;
...
{
l9_7=ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).x==3;
}
#else
{
l9_7=(int(SC_USE_CLAMP_TO_BORDER_sVelocity)!=0);
}
#endif
float l9_8=l9_2;
float l9_9=1.0;
sc_ClampUV(l9_8,sVelocityUvMinMax.x,sVelocityUvMinMax.z,l9_7,l9_9);
float l9_10=l9_8;
float l9_11=l9_9;
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_sVelocity)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).y==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_sVelocity)!=0);
}
#endif
float l9_13=l9_4;
float l9_14=l9_11;
sc_ClampUV(l9_13,sVelocityUvMinMax.y,sVelocityUvMinMax.w,l9_12,l9_14);
l9_6=l9_14;
...
#endif
vec2 l9_15=sc_TransformUV(l9_5,(int(SC_USE_UV_TRANSFORM_sVelocity)!=0),sVelocityTransform);
float l9_16=l9_15.x;
float l9_17=l9_6;
sc_SoftwareWrapLate(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).x,l9_0,l9_17);
float l9_18=l9_15.y;
float l9_19=l9_17;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).y,l9_0,l9_19);
float l9_20=l9_19;
vec3 l9_21=sc_SamplingCoordsViewToGlobal(vec2(l9_16,l9_18),sVelocityLayout,sVelocityGetStereoViewIndex());
vec4 l9_22=texture2D(sVelocity,l9_21.xy,0.0);
vec4 l9_23;
#if (SC_USE_CLAMP_TO_BORDER_sVelocity)
{
l9_23=mix(sVelocityBorderColor,l9_22,vec4(l9_20));
}
#else
{
l9_23=l9_22;
...
vec4 l9_37=N8_sVelocity_sample(varPackedTex.xy+(sVelocitySize.zw*l9_25));
vec4 l9_38=N8_sVelocity_sample(varPackedTex.xy+(sVelocitySize.zw*l9_26));
vec4 l9_39=N8_sVelocity_sample(varPackedTex.xy+(sVelocitySize.zw*l9_31));
vec4 l9_40=N8_sVelocity_sample(varPackedTex.xy+(sVelocitySize.zw*l9_32));
float l9_41=velocityRange.y-velocityRange.x;
float l9_42=0.99998999-0.0;
float l9_43=DecodeFloat16(l9_37.zw,true);
vec2 l9_44=vec2(0.0,velocityRange.x+(((l9_43-0.0)*l9_41)/l9_42))*l9_27;
float l9_45=DecodeFloat16(l9_38.zw,true);
vec2 l9_46=vec2(0.0,velocityRange.x+(((l9_45-0.0)*l9_41)/l9_42))*l9_28;
float l9_47=DecodeFloat16(l9_39.xy,true);
vec2 l9_48=vec2(velocityRange.x+(((l9_47-0.0)*l9_41)/l9_42),0.0)*l9_33;
float l9_49=DecodeFloat16(l9_40.xy,true);
vec2 l9_50=vec2(velocityRange.x+(((l9_49-0.0)*l9_41)/l9_42),0.0)*l9_34;
float l9_51;
...
{
l9_51=((l9_44-l9_46).y+(l9_48-l9_50).x)*halfInverseCell;
}
float l9_52=clamp(l9_51,divergenceRange.x,divergenceRange.y);
vec4 l9_53=fract(vec4(1.0,255.0,65025.0,16581375.0)*(0.0+(((l9_52-divergenceRange.x)*l9_42)/(divergenceRange.y-divergenceRange.x))));
vec4 l9_54=l9_53-(l9_53.yzww*vec4(0.0039215689,0.0039215689,0.0039215689,0.0));
float l9_55=l9_54.w;
...
{
l9_59=clamp(dot(l9_54.xyz,vec3(l9_55)),0.0,1.0);
}
#else
{
float l9_60;
...
{
l9_61=(1.0-dot(l9_54.xyz,vec3(0.33333001)))*l9_55;
}
#else
{
float l9_62;
...
{
l9_62=(1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0))*l9_55;
}
#else
{
float l9_63;
...
{
l9_63=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_55;
}
#else
{
float l9_64;
#if (sc_BlendMode_Add)
{
l9_64=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_65=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_55;
}
#else
{
float l9_66;
...
{
l9_66=dot(l9_54.xyz,vec3(0.33333001))*l9_55;
}
#else
{
float l9_67;
#if (sc_BlendMode_Min)
{
l9_67=1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_68;
#if (sc_BlendMode_Max)
{
l9_68=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_68=1.0;
...
#endif
l9_56=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_54.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_57);
}
#else
{
vec4 l9_69;
...
#endif
vec3 l9_79=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_54.xyz).xyz,vec3(l9_55));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_81=vec4(mix(vec3(1.0),l9_54.xyz,vec3(l9_55)),l9_55);
}
#else
{
vec4 l9_82;
