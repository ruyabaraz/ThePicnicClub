...
var MAT_RENDER;
var VFX_OBJECT;
var INSTANCE_COUNT = 9000;
var TEXEL_COUNT = 6;
var DIMENSIONS = new vec2(2046.0, 27.0);
...
newEvent.bind(function() 
	{
		...
		simulatePass.vfxCameraAspect = renderCamera.aspect;
		simulatePass.vfxCameraNear = renderCamera.near;
		simulatePass.vfxCameraFar = renderCamera.far;
		...
		var projectionMatrix    = mat4.perspective(renderCamera.fov, renderCamera.aspect, renderCamera.near, renderCamera.far );
