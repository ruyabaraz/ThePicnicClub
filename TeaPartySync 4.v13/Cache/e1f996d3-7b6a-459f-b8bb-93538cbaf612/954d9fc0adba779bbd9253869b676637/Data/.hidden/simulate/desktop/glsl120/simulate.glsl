...
Particle.Seed+=(floor((l9_0-Particle.SpawnOffset)+2.0)*4.32723);
...
vec2 l9_2=vec2(l9_0);
float l9_3=l9_1*0.000111123;
ssParticle l9_4=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,gParticle.Quaternion,gParticle.Dead,l9_3,0.0,gParticle.Seed2000,floor(fract(sin(dot(vec2(l9_3)*vec2(0.3452,0.52254),vec2(0.98253,0.72662)))*479.371)*10000.0)*0.0001,InstanceID,(l9_1+0.5)*0.000111111,l9_3,l9_0,(l9_2+vec2(0.5))*vec2(0.00293255,0.037037),l9_2*vec2(0.00294118,0.0384615),vec3(0.0),false);
ssCalculateParticleSeed(l9_4);
gParticle=l9_4;
int l9_5=(vfxOffsetInstances+InstanceID)*6;
int l9_6=l9_5/ssTARGET_WIDTH_INT;
vec2 l9_7=(vec2(ivec2(l9_5-(l9_6*ssTARGET_WIDTH_INT),l9_6))+vec2(0.5))/vec2(2048.0,ssTARGET_SIZE_FLOAT.y);
...
vec2 l9_8=l9_7+vec2(0.000488281,0.0);
...
vec2 l9_9=l9_7+vec2(0.000976562,0.0);
...
vec2 l9_10=l9_7+vec2(0.00146484,0.0);
...
vec2 l9_11=l9_7+vec2(0.00195312,0.0);
...
vec2 l9_12=l9_7+vec2(0.00244141,0.0);
...
{
Random=mix(Min,Max,ssGetParticleRandom(1,true,true,true,378.0,gParticle.Seed2000,1.0,Globals.gTimeElapsed).x);
}
void Node83_Particle_Random(vec2 Min,vec2 Max,out vec2 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(2,true,true,true,83.0,gParticle.Seed2000,1.0,Globals.gTimeElapsed).xy);
}
...
if (l9_16)
{
ssGlobals l9_17=ssGlobals(l9_4,l9_5,l9_8);
ssCalculateParticleSeed(gParticle);
gParticle.Position=(vec3((float(gParticle.Index1D-((gParticle.Index1D/94)*94))*0.0212766)-1.0,(float(gParticle.Index1D/94)*0.0212766)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Matrix=mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0));
bool l9_19=float(0.0==Port_Input1_N324)!=0.0;
bool l9_20;
if (!l9_19)
{
l9_20=float(0.0==Port_Input1_N323)!=0.0;
}
else
{
l9_20=l9_19;
...
if (l9_19)
{
vec2 l9_23=radians(Port_Import_N375);
float l9_24;
Node378_Particle_Random(l9_23.x,l9_23.y,l9_24,l9_17);
float l9_25=l9_24;
float l9_26=1.0-clamp(Port_Import_N166,0.0,1.0);
float l9_27;
if (l9_26<=0.0)
{
l9_27=0.0;
...
{
l9_27=pow(l9_26,Port_Input1_N016);
}
vec2 l9_28=vec2(0.0);
l9_28.x=Port_Value1_N017;
vec2 l9_29=l9_28;
l9_29.y=l9_27;
vec2 l9_30;
Node83_Particle_Random(l9_29,Port_Max_N083,l9_30,l9_17);
vec2 l9_31=l9_30;
vec3 l9_32=vec3(0.0);
l9_32.x=sin(l9_25);
vec3 l9_33=l9_32;
...
l9_34.z=l9_31.x;
vec3 l9_35=vec3(0.0);
l9_35.x=Port_Import_N086;
vec3 l9_36=l9_35;
l9_36.y=Port_Import_N086;
vec3 l9_37=l9_36;
l9_37.z=Port_Import_N087;
float l9_38;
if (l9_31.y<=0.0)
{
l9_38=0.0;
...
l9_40.y=l9_38;
vec3 l9_41=l9_40;
l9_41.z=Port_Value3_N309;
l9_22=vec4((((Port_Import_N013*l9_34)*l9_37)*l9_41).zxy,0.0);
}
else
{
vec2 l9_42=radians(Port_Import_N375);
float l9_43;
Node378_Particle_Random(l9_42.x,l9_42.y,l9_43,l9_17);
float l9_44=l9_43;
float l9_45=1.0-clamp(Port_Import_N166,0.0,1.0);
float l9_46;
if (l9_45<=0.0)
{
l9_46=0.0;
...
{
l9_46=pow(l9_45,Port_Input1_N016);
}
vec2 l9_47=vec2(0.0);
l9_47.x=Port_Value1_N017;
vec2 l9_48=l9_47;
l9_48.y=l9_46;
vec2 l9_49;
Node83_Particle_Random(l9_48,Port_Max_N083,l9_49,l9_17);
vec2 l9_50=l9_49;
vec3 l9_51=vec3(0.0);
l9_51.x=sin(l9_44);
vec3 l9_52=l9_51;
...
l9_53.z=l9_50.x;
vec3 l9_54=vec3(0.0);
l9_54.x=Port_Import_N086;
vec3 l9_55=l9_54;
l9_55.y=Port_Import_N086;
vec3 l9_56=l9_55;
l9_56.z=Port_Import_N087;
float l9_57;
if (l9_50.y<=0.0)
{
l9_57=0.0;
...
l9_59.y=l9_57;
vec3 l9_60=l9_59;
l9_60.z=Port_Value3_N309;
l9_22=vec4((((Port_Import_N013*l9_53)*l9_56)*l9_60).xzy,0.0);
}
l9_21=l9_22;
}
else
{
vec2 l9_61=radians(Port_Import_N375);
float l9_62;
Node378_Particle_Random(l9_61.x,l9_61.y,l9_62,l9_17);
float l9_63=l9_62;
float l9_64=1.0-clamp(Port_Import_N166,0.0,1.0);
float l9_65;
if (l9_64<=0.0)
{
l9_65=0.0;
...
{
l9_65=pow(l9_64,Port_Input1_N016);
}
vec2 l9_66=vec2(0.0);
l9_66.x=Port_Value1_N017;
vec2 l9_67=l9_66;
l9_67.y=l9_65;
vec2 l9_68;
Node83_Particle_Random(l9_67,Port_Max_N083,l9_68,l9_17);
vec2 l9_69=l9_68;
vec3 l9_70=vec3(0.0);
l9_70.x=sin(l9_63);
vec3 l9_71=l9_70;
...
l9_72.z=l9_69.x;
vec3 l9_73=vec3(0.0);
l9_73.x=Port_Import_N086;
vec3 l9_74=l9_73;
l9_74.y=Port_Import_N086;
vec3 l9_75=l9_74;
l9_75.z=Port_Import_N087;
float l9_76;
if (l9_69.y<=0.0)
{
l9_76=0.0;
...
l9_78.y=l9_76;
vec3 l9_79=l9_78;
l9_79.z=Port_Value3_N309;
l9_21=vec4(((Port_Import_N013*l9_72)*l9_75)*l9_79,0.0);
}
gParticle.Position=Port_Import_N011+l9_21.xyz;
float l9_80=dot(direction,direction);
float l9_81;
if (l9_80>0.0)
{
...
float l9_82=((Port_TimeA_N002+Port_TimeTransition_N002)+Port_TimeB_N002)+0.0001;
gParticle.Force+=((direction*l9_81)*vec3(mix(Port_ValueA_N002,Port_ValueB_N002,smoothstep(Port_TimeA_N002/l9_82,1.0-(Port_TimeB_N002/l9_82),abs((mod((l9_8/l9_82)+Port_TimeBias_N002,1.0)*2.0)-1.0)))));
gParticle.Color=mix(Tweak_N26,Tweak_N27,ssGetParticleRandom(4,false,true,true,60.0,gParticle.Seed2000,1.0,l9_4));
vec3 l9_83=mix(Port_Import_N139,Port_Import_N140,ssGetParticleRandom(3,true,true,true,141.0,gParticle.Seed2000,1.0,l9_4).xyz);
float l9_84=radians(l9_83.x);
float l9_85=cos(l9_84);
float l9_86=sin(l9_84);
float l9_87=radians(l9_83.y);
float l9_88=cos(l9_87);
float l9_89=sin(l9_87);
float l9_90=radians(l9_83.z);
float l9_91=cos(l9_90);
float l9_92=sin(l9_90);
float l9_93=l9_86*l9_89;
float l9_94=l9_85*l9_89;
gParticle.Matrix=mat3(vec3(l9_88*l9_91,(l9_85*l9_92)+(l9_93*l9_91),(l9_86*l9_92)-(l9_94*l9_91)),vec3((-l9_88)*l9_92,(l9_85*l9_91)-(l9_93*l9_92),(l9_86*l9_91)+(l9_94*l9_92)),vec3(l9_89,(-l9_86)*l9_88,l9_85*l9_88));
...
float l9_95=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
gParticle.Size=mix(Port_Import_N092,Port_Import_N020,(clamp((l9_95*(Port_Input0_N032/(mix(Port_Min_N062,Port_Max_N062,ssGetParticleRandom(1,false,true,true,62.0,gParticle.Seed2000,1.0,l9_4).x)/gParticle.Life)))+0.001,Port_Input1_N034+0.001,Port_Input2_N034+0.001)-0.001)*(clamp(((1.0-l9_95)*(Port_Input0_N037/(mix(Port_Min_N063,Port_Max_N063,ssGetParticleRandom(1,false,true,true,63.0,gParticle.Seed2000,1.0,l9_4).x)/gParticle.Life)))+0.001,Port_Input1_N041+0.001,Port_Input2_N041+0.001)-0.001));
float l9_96=clamp(l9_5,0.0001,0.5);
float l9_97;
...
{
l9_97=gParticle.Force.x;
}
gParticle.Force.x=l9_97;
float l9_98;
...
{
l9_98=gParticle.Force.y;
}
gParticle.Force.y=l9_98;
float l9_99;
...
{
l9_99=gParticle.Force.z;
}
gParticle.Force.z=l9_99;
gParticle.Mass=max(0.005,gParticle.Mass);
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*l9_96);
float l9_100;
...
{
l9_100=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_100;
float l9_101;
...
{
l9_101=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_101;
float l9_102;
...
{
l9_102=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_102;
gParticle.Position+=(gParticle.Velocity*l9_96);
vec2 l9_103=vec2(6.0,1.0)/vec2(2048.0,ssTARGET_SIZE_FLOAT.y);
int l9_104=vfxOffsetInstances+sc_GetLocalInstanceID();
vec2 l9_105=vec2(0.0);
l9_105.x=float(l9_104%341);
vec2 l9_106=l9_105;
l9_106.y=float(l9_104/341);
float l9_107;
if (l9_1.x<0.5)
{
l9_107=0.0;
...
vec2 l9_110=l9_108;
l9_110.y=l9_109;
sc_SetClipPosition(vec4(((l9_110+(l9_106*l9_103))*2.0)-vec2(1.0),1.0,1.0));
...
{
l9_111=vec4((l9_1*2.0)-vec2(1.0),1.0,1.0);
}
else
{
l9_111=vec4(0.0);
}
sc_SetClipPosition(l9_111);
...
if (l9_1==0)
{
vec4 l9_18=ssEncodeFloat32(gParticle.Size,0.0,120.0,0.99999);
vec4 l9_19=ssEncodeFloat32(gParticle.Life,0.0,1.0,0.99999);
vec4 l9_20=ssEncodeFloat32(gParticle.Age,0.0,1.0,0.99999);
vec4 l9_21=ssEncodeFloat32(gParticle.Matrix[0].x,-100.0,100.0,0.99999);
l9_17=l9_21.w;
l9_16=l9_21.z;
l9_15=l9_21.y;
l9_14=l9_21.x;
...
if (l9_1==1)
{
vec4 l9_38=ssEncodeFloat32(gParticle.Matrix[0].y,-100.0,100.0,0.99999);
vec4 l9_39=ssEncodeFloat32(gParticle.Matrix[0].z,-100.0,100.0,0.99999);
vec4 l9_40=ssEncodeFloat32(gParticle.Matrix[1].x,-100.0,100.0,0.99999);
vec4 l9_41=ssEncodeFloat32(gParticle.Matrix[1].y,-100.0,100.0,0.99999);
l9_37=l9_41.w;
l9_36=l9_41.z;
l9_35=l9_41.y;
l9_34=l9_41.x;
...
if (l9_1==2)
{
vec4 l9_58=ssEncodeFloat32(gParticle.Matrix[1].z,-100.0,100.0,0.99999);
vec4 l9_59=ssEncodeFloat32(gParticle.Matrix[2].x,-100.0,100.0,0.99999);
vec4 l9_60=ssEncodeFloat32(gParticle.Matrix[2].y,-100.0,100.0,0.99999);
vec4 l9_61=ssEncodeFloat32(gParticle.Matrix[2].z,-100.0,100.0,0.99999);
l9_57=l9_61.w;
l9_56=l9_61.z;
l9_55=l9_61.y;
l9_54=l9_61.x;
...
if (l9_1==3)
{
vec4 l9_78=ssEncodeFloat32(gParticle.Color.x,0.0,1.0,0.99999);
vec4 l9_79=ssEncodeFloat32(gParticle.Color.y,0.0,1.0,0.99999);
vec4 l9_80=ssEncodeFloat32(gParticle.Color.z,0.0,1.0,0.99999);
vec4 l9_81=ssEncodeFloat32(gParticle.Color.w,0.0,1.0,0.99999);
l9_77=l9_81.w;
l9_76=l9_81.z;
l9_75=l9_81.y;
l9_74=l9_81.x;
...
if (l9_1==4)
{
vec4 l9_98=ssEncodeFloat32(gParticle.Position.x,-1000.0,1000.0,0.99999);
vec4 l9_99=ssEncodeFloat32(gParticle.Position.y,-1000.0,1000.0,0.99999);
vec4 l9_100=ssEncodeFloat32(gParticle.Position.z,-1000.0,1000.0,0.99999);
