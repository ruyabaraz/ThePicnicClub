...
#endif
l9_1=vec4(l9_25.www,Port_Value4_N023);
}
else
{
vec4 l9_26;
...
#endif
l9_26=vec4(l9_50.zzz,Port_Value4_N021);
}
else
{
vec4 l9_51;
...
{
bool l9_52=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_53=varPackedTex.x;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_54=l9_53;
float l9_55=varPackedTex.y;
...
float l9_68=l9_67.x;
float l9_69=l9_58;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_52,l9_69);
float l9_70=l9_67.y;
float l9_71=l9_69;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_52,l9_71);
float l9_72=l9_71;
vec3 l9_73=sc_SamplingCoordsViewToGlobal(vec2(l9_68,l9_70),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_74=texture2D(baseTex,l9_73.xy,0.0);
vec4 l9_75;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
l9_51=vec4(l9_75.yyy,Port_Value4_N017);
}
else
{
vec4 l9_76;
...
{
bool l9_77=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
...
float l9_93=l9_92.x;
float l9_94=l9_83;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_77,l9_94);
float l9_95=l9_92.y;
float l9_96=l9_94;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_77,l9_96);
float l9_97=l9_96;
...
#endif
l9_76=vec4(l9_100.xxx,Port_Value4_N016);
}
else
{
vec4 l9_101;
...
{
bool l9_102=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_103=varPackedTex.x;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_104=l9_103;
float l9_105=varPackedTex.y;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_106=l9_105;
vec2 l9_107;
float l9_108;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_110=l9_104;
float l9_111=1.0;
sc_ClampUV(l9_110,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_109,l9_111);
float l9_112=l9_110;
float l9_113=l9_111;
bool l9_114;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_114=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_114=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_115=l9_106;
float l9_116=l9_113;
sc_ClampUV(l9_115,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_114,l9_116);
l9_108=l9_116;
...
#endif
vec2 l9_117=sc_TransformUV(l9_107,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_118=l9_117.x;
float l9_119=l9_108;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_102,l9_119);
float l9_120=l9_117.y;
float l9_121=l9_119;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_102,l9_121);
float l9_122=l9_121;
vec3 l9_123=sc_SamplingCoordsViewToGlobal(vec2(l9_118,l9_120),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_124=texture2D(baseTex,l9_123.xy,0.0);
vec4 l9_125;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_125=mix(baseTexBorderColor,l9_124,vec4(l9_122));
}
#else
{
l9_125=l9_124;
...
{
bool l9_126=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_127=varPackedTex.x;
sc_SoftwareWrapEarly(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_128=l9_127;
float l9_129=varPackedTex.y;
sc_SoftwareWrapEarly(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_130=l9_129;
vec2 l9_131;
float l9_132;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_133=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_133=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_134=l9_128;
float l9_135=1.0;
sc_ClampUV(l9_134,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_133,l9_135);
float l9_136=l9_134;
float l9_137=l9_135;
bool l9_138;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_138=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_138=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_139=l9_130;
float l9_140=l9_137;
sc_ClampUV(l9_139,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_138,l9_140);
l9_132=l9_140;
...
#endif
vec2 l9_141=sc_TransformUV(l9_131,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_142=l9_141.x;
float l9_143=l9_132;
sc_SoftwareWrapLate(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_126,l9_143);
float l9_144=l9_141.y;
float l9_145=l9_143;
sc_SoftwareWrapLate(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_126,l9_145);
float l9_146=l9_145;
vec3 l9_147=sc_SamplingCoordsViewToGlobal(vec2(l9_142,l9_144),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_148=texture2D(baseTex,l9_147.xy,0.0);
vec4 l9_149;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_149=mix(baseTexBorderColor,l9_148,vec4(l9_146));
}
#else
{
l9_149=l9_148;
...
{
l9_152=clamp(l9_1.w*2.0,0.0,1.0);
}
#else
{
float l9_153;
...
{
l9_153=clamp(dot(l9_1.xyz,vec3(l9_1.w)),0.0,1.0);
}
#else
{
float l9_154;
...
{
l9_155=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_1.w;
}
#else
{
float l9_156;
...
{
l9_156=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_1.w;
}
#else
{
float l9_157;
...
{
l9_157=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_158;
#if (sc_BlendMode_Add)
{
l9_158=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_159;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_159=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_160;
...
{
l9_160=dot(l9_1.xyz,vec3(0.33333001))*l9_1.w;
}
#else
{
float l9_161;
#if (sc_BlendMode_Min)
{
l9_161=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_162;
#if (sc_BlendMode_Max)
{
l9_162=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_162=1.0;
...
#endif
l9_150=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_151);
}
#else
{
vec4 l9_163;
...
#if (sc_FramebufferFetch)
{
vec4 l9_166=sc_readFragData0_Platform();
vec4 l9_167;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_168=l9_166;
l9_168.x=l9_166.x+_sc_framebufferFetchMarker;
l9_167=l9_168;
}
#else
{
...
#endif
l9_165=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_169,sc_ScreenTextureLayout,l9_170).xy,0.0);
}
#endif
vec4 l9_171;
...
{
vec4 l9_172=l9_165;
l9_172.x=l9_165.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_171=l9_172;
}
#else
{
...
#endif
vec3 l9_173=mix(l9_171.xyz,definedBlend(l9_171.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
vec4 l9_174=vec4(l9_173.x,l9_173.y,l9_173.z,vec4(0.0).w);
l9_174.w=1.0;
l9_164=l9_174;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_175=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_176;
...
#endif
l9_176=vec4(l9_1.xyz*l9_177,l9_177);
}
#else
{
l9_176=l9_1;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_184-0.0039215689)),min(1.0,l9_184+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_186=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_185).xy);
float l9_187=packValue(l9_186);
int l9_194=int(l9_183.w*255.0);
float l9_195=packValue(l9_194);
sc_writeFragData0Internal(vec4(packValue(l9_186),packValue(l9_186),packValue(l9_186),packValue(l9_186)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
if (l9_203==0)
{
l9_206=texture2D(sc_OITAlpha0,l9_198);
l9_205=texture2D(sc_OITDepthLow0,l9_198);
l9_204=texture2D(sc_OITDepthHigh0,l9_198);
}
else
{
l9_206=vec4(0.0);
...
if (l9_203==1)
{
l9_209=texture2D(sc_OITAlpha1,l9_198);
l9_208=texture2D(sc_OITDepthLow1,l9_198);
l9_207=texture2D(sc_OITDepthHigh1,l9_198);
}
else
{
l9_209=l9_206;
...
vec4 l9_224=texture2D(sc_OITFilteredDepthBoundsTexture,l9_198);
...
sc_writeFragData0Internal(l9_228,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
