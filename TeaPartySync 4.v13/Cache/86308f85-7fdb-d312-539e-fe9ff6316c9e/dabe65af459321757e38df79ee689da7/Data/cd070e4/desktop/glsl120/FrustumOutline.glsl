...
{
vec2 l9_41;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_41,l9_2);
float l9_42;
Node67_Bool_Parameter(l9_42,l9_2);
l9_40=mix(varPackedTex.xy,l9_41,vec2(l9_42));
}
#else
{
vec2 l9_43;
...
{
vec2 l9_44;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_44,l9_2);
float l9_45;
Node11_Bool_Parameter(l9_45,l9_2);
l9_43=mix(varPackedTex.xy,l9_44,vec2(l9_45));
}
#else
{
l9_43=varPackedTex.xy;
}
#endif
l9_40=l9_43;
}
...
#endif
bool l9_47=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_48=l9_38.x;
sc_SoftwareWrapEarly(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_49=l9_48;
float l9_50=l9_38.y;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_51=l9_50;
vec2 l9_52;
float l9_53;
...
{
l9_54=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_55=l9_49;
float l9_56=1.0;
sc_ClampUV(l9_55,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_54,l9_56);
float l9_57=l9_55;
float l9_58=l9_56;
bool l9_59;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_59=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_59=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_60=l9_51;
float l9_61=l9_58;
sc_ClampUV(l9_60,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_59,l9_61);
l9_53=l9_61;
...
#endif
vec2 l9_62=sc_TransformUV(l9_52,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_63=l9_62.x;
float l9_64=l9_53;
sc_SoftwareWrapLate(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_47,l9_64);
float l9_65=l9_62.y;
float l9_66=l9_64;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_47,l9_66);
}
#else
{
}
#endif
vec4 l9_67=vec4(l9_37.x,l9_37.y,l9_37.z,vec4(0.0).w);
l9_67.w=alpha;
...
{
l9_71=clamp(dot(l9_67.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_72;
...
{
l9_73=(1.0-dot(l9_67.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_74;
...
{
l9_74=(1.0-clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_75;
...
{
l9_75=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_76;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_77=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_78;
...
{
l9_78=dot(l9_67.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_79;
...
#endif
vec3 l9_91=mix(l9_89.xyz,definedBlend(l9_89.xyz,l9_67.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_93=vec4(mix(vec3(1.0),l9_67.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_94;
