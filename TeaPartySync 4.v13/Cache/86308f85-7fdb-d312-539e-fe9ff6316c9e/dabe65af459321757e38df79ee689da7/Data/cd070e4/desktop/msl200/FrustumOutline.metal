...
float4 l9_628=fast::max(param_11,float4(0.0));
float4 param_12=l9_628;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_639.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
