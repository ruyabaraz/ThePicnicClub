...
ssGlobals l9_32=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_28,l9_30,normalize(sc_Camera.position-l9_30));
vec3 l9_33;
if ((l9_28.x*1.0)!=0.0)
{
vec3 l9_34;
Node63_If_else(0.0,vec3(0.0),vec3(0.0),l9_34,l9_32);
l9_33=l9_30-l9_34;
}
else
{
vec3 l9_35;
Node63_If_else(0.0,vec3(0.0),vec3(0.0),l9_35,l9_32);
l9_33=l9_30+l9_35;
}
vec3 l9_36;
vec3 l9_37;
...
#if (sc_TAAEnabled)
{
vec2 l9_53=l9_49.xy+(sc_TAAJitterOffset*l9_49.w);
l9_52=vec4(l9_53.x,l9_53.y,l9_49.z,l9_49.w);
}
#else
{
l9_52=l9_49;
...
{
vec4 l9_55=l9_52;
l9_55.x=l9_52.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_54=l9_55;
}
#else
{
