...
//sampler sampler sPressureSmpSC 0:17
...
//texture texture2D sPressure 0:1:0:17
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_sPressure 82 -1
//spec_const int intensityTextureLayout 83 0
//spec_const int sPressureLayout 84 0
...
#endif
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_sPressure)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sPressure)!=0));
float l9_2=varPackedTex.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_sPressure,SC_SOFTWARE_WRAP_MODE_V_sPressure).x);
float l9_3=l9_2;
float l9_4=varPackedTex.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_sPressure,SC_SOFTWARE_WRAP_MODE_V_sPressure).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_sPressure,SC_SOFTWARE_WRAP_MODE_V_sPressure).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_sPressure)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,sPressureUvMinMax.x,sPressureUvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_sPressure)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_sPressure,SC_SOFTWARE_WRAP_MODE_V_sPressure).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_sPressure)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,sPressureUvMinMax.y,sPressureUvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_sPressure)!=0),sPressureTransform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_sPressure,SC_SOFTWARE_WRAP_MODE_V_sPressure).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_sPressure,SC_SOFTWARE_WRAP_MODE_V_sPressure).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),sPressureLayout,l9_0);
vec4 l9_23=texture2D(sPressure,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_sPressure)
{
l9_24=mix(sPressureBorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
{
l9_28=(pressureRange.x+(((dot(floor(l9_25+vec4(0.5))/vec4(255.0),vec4(1.0,0.0039215689,1.53787e-05,6.0308629e-08))-0.0)*l9_26)/l9_27))*clearValue;
}
float l9_29=clamp(l9_28,pressureRange.x,pressureRange.y);
vec4 l9_30=fract(vec4(1.0,255.0,65025.0,16581375.0)*(0.0+(((l9_29-pressureRange.x)*l9_27)/l9_26)));
vec4 l9_31=l9_30-(l9_30.yzww*vec4(0.0039215689,0.0039215689,0.0039215689,0.0));
float l9_32=l9_31.w;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_67-0.0039215689)),min(1.0,l9_67+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_69),packValue(l9_69),packValue(l9_69),packValue(l9_69)),sc_UniformConstants.x,sc_ShaderCacheConstant);
