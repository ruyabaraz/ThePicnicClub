...
//}
//ubo int UserUniforms 0:33:4896 {
//float4 sc_Time 1376
...
//float Tweak_N12 4416
//float notification_tile_opacity 4420
//float Port_Input1_N018 4424
//float Port_Input1_N021 4428
...
//float4 Port_Import_N031 4784
//float4 Port_Import_N032 4800
//float Port_Input0_N049 4816
//float Port_Input1_N049 4820
//float Port_RangeMinA_N035 4824
//float Port_RangeMaxA_N035 4828
//float Port_RangeMinB_N035 4832
//float Port_RangeMaxB_N035 4836
//float2 Port_Import_N036 4840
//float2 Port_Center_N037 4848
//float2 Port_Import_N040 4856
//float2 Port_Import_N042 4864
//float Port_Input1_N048 4872
//float Port_Input2_N048 4876
//float depthRef 4888
//}
...
ValueOut_N35=(((UVCoord_N34-float2((*sc_set0.UserUniforms).Port_RangeMinA_N035))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N035-(*sc_set0.UserUniforms).Port_RangeMinA_N035)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N035-(*sc_set0.UserUniforms).Port_RangeMinB_N035))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N035);
...
float4 l9_95=param_42;
float4 l9_96=param_43;
float3 l9_97=l9_95.xyz*l9_95.w;
l9_95=float4(l9_97.x,l9_97.y,l9_97.z,l9_95.w);
float4 param_41=fast::min(l9_95+l9_96,float4(1.0));
Output_N30=param_41;
float4 Output_N53=float4(0.0);
float4 param_45=Export_N51;
float4 param_46=Output_N30;
float4 l9_98=param_45;
float4 l9_99=param_46;
float3 l9_100=l9_98.xyz*l9_98.w;
l9_98=float4(l9_100.x,l9_100.y,l9_100.z,l9_98.w);
float4 param_44=fast::min(l9_98+l9_99,float4(1.0));
Output_N53=param_44;
...
float4 l9_105=fast::max(param_48,float4(0.0));
float4 param_49=l9_105;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_116.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
