...
//sampler sampler sPressureSmpSC 0:20
//sampler sampler sVelocitySmpSC 0:21
...
//texture texture2D sPressure 0:2:0:20
//texture texture2D sVelocity 0:3:0:21
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_sVelocity 35 0
...
//spec_const bool SC_USE_UV_MIN_MAX_sVelocity 39 0
...
//spec_const bool SC_USE_UV_TRANSFORM_sVelocity 43 0
...
//spec_const bool sVelocityHasSwappedViews 48 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_sVelocity 90 -1
...
vec4 N56_sPressure_sample(vec2 coords)
{
...
float N56_samplePressure(vec2 coord,vec2 direction)
{
coord+=(sVelocitySize.zw*direction);
return N56_pressureRange.x+(((DecodeFloat32(N56_sPressure_sample(coord),true)-0.0)*(N56_pressureRange.y-N56_pressureRange.x))/(0.99998999-0.0));
}
...
#endif
N56_pressureRange=pressureRange;
int l9_0;
...
#endif
float l9_25=N56_samplePressure(varPackedTex.xy,vec2(0.0,1.0));
float l9_26=N56_samplePressure(varPackedTex.xy,vec2(0.0,-1.0));
float l9_27=N56_samplePressure(varPackedTex.xy,vec2(1.0,0.0));
float l9_28=N56_samplePressure(varPackedTex.xy,vec2(-1.0,0.0));
int l9_29;
...
#endif
bool l9_30=(int(SC_USE_CLAMP_TO_BORDER_sVelocity)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sVelocity)!=0));
float l9_31=varPackedTex.x;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).x);
float l9_32=l9_31;
float l9_33=varPackedTex.y;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).y);
float l9_34=l9_33;
vec2 l9_35;
float l9_36;
...
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).x==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_sVelocity)!=0);
}
#endif
float l9_38=l9_32;
float l9_39=1.0;
sc_ClampUV(l9_38,sVelocityUvMinMax.x,sVelocityUvMinMax.z,l9_37,l9_39);
float l9_40=l9_38;
float l9_41=l9_39;
bool l9_42;
#if (SC_USE_CLAMP_TO_BORDER_sVelocity)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).y==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_sVelocity)!=0);
}
#endif
float l9_43=l9_34;
float l9_44=l9_41;
sc_ClampUV(l9_43,sVelocityUvMinMax.y,sVelocityUvMinMax.w,l9_42,l9_44);
l9_36=l9_44;
...
#endif
vec2 l9_45=sc_TransformUV(l9_35,(int(SC_USE_UV_TRANSFORM_sVelocity)!=0),sVelocityTransform);
float l9_46=l9_45.x;
float l9_47=l9_36;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).x,l9_30,l9_47);
float l9_48=l9_45.y;
float l9_49=l9_47;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_sVelocity,SC_SOFTWARE_WRAP_MODE_V_sVelocity).y,l9_30,l9_49);
float l9_50=l9_49;
vec3 l9_51=sc_SamplingCoordsViewToGlobal(vec2(l9_46,l9_48),sVelocityLayout,l9_29);
vec4 l9_52=texture2D(sVelocity,l9_51.xy,0.0);
vec4 l9_53;
#if (SC_USE_CLAMP_TO_BORDER_sVelocity)
{
l9_53=mix(sVelocityBorderColor,l9_52,vec4(l9_50));
}
#else
{
l9_53=l9_52;
...
#endif
float l9_54=DecodeFloat16(l9_53.xy,true);
float l9_55=velocityRange.y-velocityRange.x;
float l9_56=0.99998999-0.0;
float l9_57=DecodeFloat16(l9_53.zw,true);
vec2 l9_58;
...
{
l9_58=vec2(velocityRange.x+(((l9_54-0.0)*l9_55)/l9_56),velocityRange.x+(((l9_57-0.0)*l9_55)/l9_56))-(vec2(mix(l9_27,l9_28,l9_24.z)-mix(l9_28,l9_27,l9_24.w),mix(l9_25,l9_26,l9_24.x)-mix(l9_26,l9_25,l9_24.y))*gradientScale);
}
vec2 l9_59=ssEncodeFloat16(l9_58.x,velocityRange.x,velocityRange.y,0.99998999);
vec2 l9_60=ssEncodeFloat16(l9_58.y,velocityRange.x,velocityRange.y,0.99998999);
float l9_61=l9_60.y;
vec4 l9_62=vec4(l9_59,l9_60.x,l9_61);
