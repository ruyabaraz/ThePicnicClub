...
//texture texture2D screenTex 0:19:0:30
...
//float3x3 screenTexTransform 4336
//float4 screenTexUvMinMax 4384
//float4 screenTexBorderColor 4400
//float2 impulseRange 4416
//float4x4 fluidGeoMat 4432
//float4x4 fluidGeoMatInv 4496
//float fluidGeoBboxDim 4560
//float3 locatorPos 4576
//float3 locatorPosPrev 4592
//float timeMult 4624
//float touchRadius 4628
//bool speedToRadius 4632
//float speedScale 4636
//float softness 4640
//float velocityMult 4644
//float depthRef 4652
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_screenTex 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_screenTex 77 -1
...
//spec_const int screenTexLayout 86 0
//SG_REFLECTION_END
...
constant int SC_SOFTWARE_WRAP_MODE_U_screenTex [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_screenTex [[function_constant(77)]];
...
constant int screenTexLayout [[function_constant(86)]];
...
float2 param=(*sc_set0.UserUniforms).impulseRange;
Output_N86=param;
float4x4 Output_N2=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
float4x4 param_1=(*sc_set0.UserUniforms).fluidGeoMat;
Output_N2=param_1;
float4x4 Output_N7=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
float4x4 param_2=(*sc_set0.UserUniforms).fluidGeoMatInv;
Output_N7=param_2;
float Output_N9=0.0;
float param_3=(*sc_set0.UserUniforms).fluidGeoBboxDim;
Output_N9=param_3;
float3 Output_N0=float3(0.0);
float3 param_4=(*sc_set0.UserUniforms).locatorPos;
Output_N0=param_4;
float3 Output_N8=float3(0.0);
float3 param_5=(*sc_set0.UserUniforms).locatorPosPrev;
Output_N8=param_5;
float Output_N80=0.0;
float param_6=(*sc_set0.UserUniforms).timeMult;
Output_N80=param_6;
float Output_N3=0.0;
float param_7=(*sc_set0.UserUniforms).touchRadius;
Output_N3=param_7;
float Output_N73=0.0;
float param_8=float((*sc_set0.UserUniforms).speedToRadius!=0);
Output_N73=param_8;
float Output_N78=0.0;
float param_9=(*sc_set0.UserUniforms).speedScale;
Output_N78=param_9;
float Output_N12=0.0;
float param_10=(*sc_set0.UserUniforms).softness;
Output_N12=param_10;
float Output_N74=0.0;
float param_11=(*sc_set0.UserUniforms).velocityMult;
Output_N74=param_11;
float4 impulseOut_N81=float4(0.0);
float2 param_12=Output_N86;
float4x4 param_13=Output_N2;
float4x4 param_14=Output_N7;
float param_15=Output_N9;
float3 param_16=Output_N0;
float3 param_17=Output_N8;
float param_18=Output_N80;
float param_19=Output_N3;
float param_20=Output_N73;
float param_21=Output_N78;
float param_22=Output_N12;
float param_23=Output_N74;
ssGlobals param_25=Globals;
ssGlobals tempGlobals=param_25;
float4 param_24=float4(0.0);
N81_impulseRange=param_12;
float4x4 N81_fluidGeoMat=param_13;
float4x4 N81_fluidGeoMatInv=param_14;
N81_fluidGeoBboxDim=param_15;
N81_locatorPos=param_16;
N81_locatorPosPrev=param_17;
N81_timeMult=param_18;
N81_touchRadius=param_19;
N81_speedToRadius=param_20!=0.0;
N81_speedScale=param_21;
N81_softness=param_22;
N81_velocityMult=param_23;
...
int l9_14=l9_9;
int l9_15=screenTexLayout_tmp;
int l9_16=l9_14;
float2 l9_17=l9_7;
bool l9_18=(int(SC_USE_UV_TRANSFORM_screenTex_tmp)!=0);
float3x3 l9_19=(*sc_set0.UserUniforms).screenTexTransform;
int2 l9_20=int2(SC_SOFTWARE_WRAP_MODE_U_screenTex_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTex_tmp);
bool l9_21=(int(SC_USE_UV_MIN_MAX_screenTex_tmp)!=0);
float4 l9_22=(*sc_set0.UserUniforms).screenTexUvMinMax;
bool l9_23=(int(SC_USE_CLAMP_TO_BORDER_screenTex_tmp)!=0);
float4 l9_24=(*sc_set0.UserUniforms).screenTexBorderColor;
float l9_25=0.0;
...
float l9_95=l9_87;
float4 l9_96=sc_set0.screenTex.sample(sc_set0.screenTexSmpSC,l9_94,bias(l9_95));
float4 l9_97=l9_96;
float4 l9_98=l9_97;
if (l9_23)
{
...
float l9_103=N81_impulseRange.x;
float l9_104=N81_impulseRange.y;
float l9_105=0.0;
float2 l9_106=l9_102;
float l9_107=l9_103;
float l9_108=l9_104;
float l9_109=0.99998999;
float2 l9_110=l9_106;
#if (1)
{
l9_110=floor((l9_110*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_111=dot(l9_110,float2(1.0,0.0039215689));
float l9_112=l9_111;
float l9_113=0.0;
float l9_114=l9_109;
float l9_115=l9_107;
float l9_116=l9_108;
float l9_117=l9_115+(((l9_112-l9_113)*(l9_116-l9_115))/(l9_114-l9_113));
float l9_118=l9_117;
l9_105=l9_118;
float l9_119=l9_105;
float l9_120=l9_119;
float2 l9_121=l9_101.zw;
float l9_122=N81_impulseRange.x;
float l9_123=N81_impulseRange.y;
float l9_124=0.0;
...
#if (1)
{
l9_129=floor((l9_129*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_130=dot(l9_129,float2(1.0,0.0039215689));
float l9_131=l9_130;
float l9_132=0.0;
float l9_133=l9_128;
float l9_134=l9_126;
...
l9_124=l9_137;
float l9_138=l9_124;
float2 l9_139=float2(l9_120,l9_138);
float3 l9_140=N81_locatorPos;
float3 l9_141=N81_locatorPosPrev;
float l9_142=tempGlobals.gTimeDelta;
float3 l9_143=(l9_140-l9_141)/float3(N81_timeMult*l9_142);
float4 l9_144=N81_fluidGeoMat*float4(((l9_6*2.0)-float2(1.0))*N81_fluidGeoBboxDim,0.0,1.0);
float l9_145;
if (N81_speedToRadius)
{
l9_145=(length(l9_143+float3(9.9999997e-06))*N81_speedScale)*0.001;
}
else
{
l9_145=0.0;
...
float l9_146=l9_145;
l9_146=fast::max(l9_146,9.9999997e-06);
float l9_147=1.0-fast::clamp(N81_touchRadius+l9_146,0.0,1.0);
float l9_148=fast::clamp(distance(l9_144.xyz,l9_140),0.0,N81_fluidGeoBboxDim+10.0);
l9_148=1.0-(l9_148/(N81_fluidGeoBboxDim+10.0));
l9_148=smoothstep(l9_147,mix(l9_147,1.0,N81_softness*2.0),l9_148);
l9_143*=((N81_velocityMult*l9_148)*1.0);
float3x3 l9_149;
l9_149[0]=N81_fluidGeoMatInv[0].xyz;
l9_149[1]=N81_fluidGeoMatInv[1].xyz;
l9_149[2]=N81_fluidGeoMatInv[2].xyz;
l9_143=l9_149*l9_143;
l9_139+=l9_143.xy;
float l9_150=l9_139.x;
float l9_151=N81_impulseRange.x;
float l9_152=N81_impulseRange.y;
float2 l9_153=float2(0.0);
float l9_154=l9_150;
float l9_155=l9_151;
float l9_156=l9_152;
float l9_157=0.99998999;
float l9_158=fast::clamp(l9_154,l9_155,l9_156);
float l9_159=l9_155;
float l9_160=l9_156;
float l9_161=0.0;
float l9_162=l9_157;
float l9_163=l9_161+(((l9_158-l9_159)*(l9_162-l9_161))/(l9_160-l9_159));
float l9_164=l9_163;
float4 l9_165=float4(1.0,255.0,65025.0,16581375.0)*l9_164;
l9_165=fract(l9_165);
l9_165-=(l9_165.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_166=l9_165.xy;
float2 l9_167=l9_166;
l9_153=l9_167;
float2 l9_168=l9_153;
float l9_169=l9_139.y;
float l9_170=N81_impulseRange.x;
float l9_171=N81_impulseRange.y;
float2 l9_172=float2(0.0);
float l9_173=l9_169;
float l9_174=l9_170;
float l9_175=l9_171;
float l9_176=0.99998999;
float l9_177=fast::clamp(l9_173,l9_174,l9_175);
float l9_178=l9_174;
float l9_179=l9_175;
float l9_180=0.0;
float l9_181=l9_176;
float l9_182=l9_180+(((l9_177-l9_178)*(l9_181-l9_180))/(l9_179-l9_178));
float l9_183=l9_182;
float4 l9_184=float4(1.0,255.0,65025.0,16581375.0)*l9_183;
l9_184=fract(l9_184);
l9_184-=(l9_184.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_185=l9_184.xy;
float2 l9_186=l9_185;
l9_172=l9_186;
float2 l9_187=l9_172;
N81_impulseOut=float4(l9_168,l9_187);
param_24=N81_impulseOut;
impulseOut_N81=param_24;
...
float4 l9_192=fast::max(param_27,float4(0.0));
float4 param_28=l9_192;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_203.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
