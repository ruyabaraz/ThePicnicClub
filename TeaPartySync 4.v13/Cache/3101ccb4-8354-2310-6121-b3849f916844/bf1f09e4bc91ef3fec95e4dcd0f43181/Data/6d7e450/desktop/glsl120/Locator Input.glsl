...
//spec_const bool SC_USE_UV_MIN_MAX_screenTex 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool SC_USE_UV_TRANSFORM_screenTex 37 0
...
//spec_const bool screenTexHasSwappedViews 78 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_screenTex 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_screenTex 82 -1
...
//spec_const int screenTexLayout 92 0
//SG_REFLECTION_END
...
uniform mat4 fluidGeoMat;
uniform mat4 fluidGeoMatInv;
uniform float fluidGeoBboxDim;
uniform vec3 locatorPos;
uniform vec3 locatorPosPrev;
uniform float timeMult;
uniform float touchRadius;
uniform bool speedToRadius;
...
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),screenTexLayout,l9_0);
vec4 l9_23=texture2D(screenTex,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_screenTex)
{
...
#endif
float l9_25=DecodeFloat16(l9_24.xy,true);
float l9_26=impulseRange.y-impulseRange.x;
float l9_27=0.99998999-0.0;
float l9_28=DecodeFloat16(l9_24.zw,true);
vec3 l9_29=(locatorPos-locatorPosPrev)/vec3(timeMult*sc_Time.y);
float l9_30;
if (float(speedToRadius)!=0.0)
{
l9_30=(length(l9_29+vec3(9.9999997e-06))*speedScale)*0.001;
}
else
{
l9_30=0.0;
}
float l9_31=1.0-clamp(touchRadius+max(l9_30,9.9999997e-06),0.0,1.0);
float l9_32=fluidGeoBboxDim+10.0;
vec2 l9_33=vec2(impulseRange.x+(((l9_25-0.0)*l9_26)/l9_27),impulseRange.x+(((l9_28-0.0)*l9_26)/l9_27))+(mat3(fluidGeoMatInv[0].xyz,fluidGeoMatInv[1].xyz,fluidGeoMatInv[2].xyz)*(l9_29*((velocityMult*smoothstep(l9_31,mix(l9_31,1.0,softness*2.0),1.0-(clamp(distance((fluidGeoMat*vec4(((varPackedTex.xy*2.0)-vec2(1.0))*fluidGeoBboxDim,0.0,1.0)).xyz,locatorPos),0.0,l9_32)/l9_32)))*1.0))).xy;
vec2 l9_34=ssEncodeFloat16(l9_33.x,impulseRange.x,impulseRange.y,0.99998999);
vec2 l9_35=ssEncodeFloat16(l9_33.y,impulseRange.x,impulseRange.y,0.99998999);
float l9_36=l9_35.y;
vec4 l9_37=vec4(l9_34,l9_35.x,l9_36);
