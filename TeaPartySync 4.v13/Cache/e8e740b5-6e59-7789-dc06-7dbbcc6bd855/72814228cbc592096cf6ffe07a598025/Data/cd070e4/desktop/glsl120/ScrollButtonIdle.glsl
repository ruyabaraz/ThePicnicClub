...
float l9_60=clamp(length((varPackedTex.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_61;
...
vec4 l9_98=mix(l9_96,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
...
#endif
l9_121=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_125,sc_ScreenTextureLayout,l9_126).xy,0.0);
}
#endif
vec4 l9_127;
...
{
vec4 l9_128=l9_121;
l9_128.x=l9_121.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_127=l9_128;
}
#else
{
...
#endif
vec3 l9_129=mix(l9_127.xyz,definedBlend(l9_127.xyz,l9_104.xyz).xyz,vec3(l9_105));
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_141).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_142=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_141).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_154).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_159==0)
{
l9_162=texture2D(sc_OITAlpha0,l9_154);
l9_161=texture2D(sc_OITDepthLow0,l9_154);
l9_160=texture2D(sc_OITDepthHigh0,l9_154);
}
else
{
l9_162=vec4(0.0);
...
if (l9_159==1)
{
l9_165=texture2D(sc_OITAlpha1,l9_154);
l9_164=texture2D(sc_OITDepthLow1,l9_154);
l9_163=texture2D(sc_OITDepthHigh1,l9_154);
}
else
{
l9_165=l9_162;
...
vec4 l9_180=texture2D(sc_OITFilteredDepthBoundsTexture,l9_154);
