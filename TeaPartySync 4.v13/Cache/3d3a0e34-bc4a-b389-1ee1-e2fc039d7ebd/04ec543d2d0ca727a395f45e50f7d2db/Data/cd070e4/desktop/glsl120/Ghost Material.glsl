...
float l9_73=l9_72*max(smoothstep(blur,blur*Port_Input1_N098,length(max(abs(varPackedTex.xy-Port_Input1_N085)-(boxSize-vec2(cornerRadius)),Port_Input1_N089))-cornerRadius),Port_Input1_N094);
vec4 l9_74=vec4(l9_37.x,l9_37.y,l9_37.z,vec4(0.0).w);
l9_74.w=l9_73;
vec3 l9_75=smoothstep(Port_Input0_N073,Port_Input1_N073,vec3(distance(Port_Input0_N042,(varPackedTex.xy-Port_Input1_N046)*vec2(Port_Input1_N047))));
...
vec3 l9_84=mix(vec3(l9_79,l9_81,l9_83),vec3(floor(fract(sin(floor(dot(floor((floor(varPackedTex.xy*10000.0)*9.9999997e-05)*Port_Scale_N081),vec2(0.98000002,0.72000003))*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05),vec3(Port_Input2_N082));
...
#if (sc_FramebufferFetch)
{
vec4 l9_104=sc_readFragData0_Platform();
vec4 l9_105;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_106=l9_104;
l9_106.x=l9_104.x+_sc_framebufferFetchMarker;
l9_105=l9_106;
}
#else
{
...
#else
{
vec2 l9_107=sc_ScreenCoordsGlobalToView(l9_0);
int l9_108;
...
#endif
l9_103=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_107,sc_ScreenTextureLayout,l9_108).xy,0.0);
}
#endif
vec4 l9_109;
...
{
vec4 l9_110=l9_103;
l9_110.x=l9_103.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_109=l9_110;
}
#else
{
...
#endif
vec3 l9_111=mix(l9_109.xyz,definedBlend(l9_109.xyz,l9_86.xyz).xyz,vec3(l9_87));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_113=vec4(mix(vec3(1.0),l9_86.xyz,vec3(l9_87)),l9_87);
}
#else
{
vec4 l9_114;
...
#endif
l9_114=vec4(l9_86.xyz*l9_115,l9_115);
}
#else
{
l9_114=l9_86;
