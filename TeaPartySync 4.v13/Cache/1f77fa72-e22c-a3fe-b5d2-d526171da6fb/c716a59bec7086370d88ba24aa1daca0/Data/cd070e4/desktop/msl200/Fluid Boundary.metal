...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_boundaryTex 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_boundaryTex 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int boundaryTexLayout 77 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_boundaryTex [[function_constant(73)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_boundaryTex [[function_constant(75)]];
...
constant int boundaryTexLayout [[function_constant(77)]];
...
{
l9_493.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
