...
//sampler sampler boundaryTexSmpSC 0:16
...
//texture texture2D boundaryTex 0:0:0:16
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_boundaryTex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_boundaryTex 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int boundaryTexLayout 83 0
...
#endif
#ifndef boundaryTexHasSwappedViews
#define boundaryTexHasSwappedViews 0
#elif boundaryTexHasSwappedViews==1
#undef boundaryTexHasSwappedViews
#define boundaryTexHasSwappedViews 1
#endif
#ifndef boundaryTexLayout
#define boundaryTexLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_boundaryTex
#define SC_USE_UV_TRANSFORM_boundaryTex 0
#elif SC_USE_UV_TRANSFORM_boundaryTex==1
#undef SC_USE_UV_TRANSFORM_boundaryTex
#define SC_USE_UV_TRANSFORM_boundaryTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_boundaryTex
#define SC_SOFTWARE_WRAP_MODE_U_boundaryTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_boundaryTex
#define SC_SOFTWARE_WRAP_MODE_V_boundaryTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_boundaryTex
#define SC_USE_UV_MIN_MAX_boundaryTex 0
#elif SC_USE_UV_MIN_MAX_boundaryTex==1
#undef SC_USE_UV_MIN_MAX_boundaryTex
#define SC_USE_UV_MIN_MAX_boundaryTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_boundaryTex
#define SC_USE_CLAMP_TO_BORDER_boundaryTex 0
#elif SC_USE_CLAMP_TO_BORDER_boundaryTex==1
#undef SC_USE_CLAMP_TO_BORDER_boundaryTex
#define SC_USE_CLAMP_TO_BORDER_boundaryTex 1
#endif
#ifndef sc_DepthOnly
...
uniform mat3 boundaryTexTransform;
uniform vec4 boundaryTexUvMinMax;
uniform vec4 boundaryTexBorderColor;
uniform vec2 resInv;
uniform bool useBoundaryTexture;
...
int boundaryTexGetStereoViewIndex()
{
int l9_0;
#if (boundaryTexHasSwappedViews)
{
...
vec4 N8_userBoundaryTex_sample(vec2 coords)
{
bool l9_0=(int(SC_USE_CLAMP_TO_BORDER_boundaryTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_boundaryTex)!=0));
float l9_1=coords.x;
sc_SoftwareWrapEarly(l9_1,ivec2(SC_SOFTWARE_WRAP_MODE_U_boundaryTex,SC_SOFTWARE_WRAP_MODE_V_boundaryTex).x);
float l9_2=l9_1;
float l9_3=coords.y;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_boundaryTex,SC_SOFTWARE_WRAP_MODE_V_boundaryTex).y);
float l9_4=l9_3;
vec2 l9_5;
float l9_6;
#if (SC_USE_UV_MIN_MAX_boundaryTex)
{
bool l9_7;
#if (SC_USE_CLAMP_TO_BORDER_boundaryTex)
{
l9_7=ivec2(SC_SOFTWARE_WRAP_MODE_U_boundaryTex,SC_SOFTWARE_WRAP_MODE_V_boundaryTex).x==3;
}
#else
{
l9_7=(int(SC_USE_CLAMP_TO_BORDER_boundaryTex)!=0);
}
#endif
float l9_8=l9_2;
float l9_9=1.0;
sc_ClampUV(l9_8,boundaryTexUvMinMax.x,boundaryTexUvMinMax.z,l9_7,l9_9);
float l9_10=l9_8;
float l9_11=l9_9;
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_boundaryTex)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_boundaryTex,SC_SOFTWARE_WRAP_MODE_V_boundaryTex).y==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_boundaryTex)!=0);
}
#endif
float l9_13=l9_4;
float l9_14=l9_11;
sc_ClampUV(l9_13,boundaryTexUvMinMax.y,boundaryTexUvMinMax.w,l9_12,l9_14);
l9_6=l9_14;
...
#endif
vec2 l9_15=sc_TransformUV(l9_5,(int(SC_USE_UV_TRANSFORM_boundaryTex)!=0),boundaryTexTransform);
float l9_16=l9_15.x;
float l9_17=l9_6;
sc_SoftwareWrapLate(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_boundaryTex,SC_SOFTWARE_WRAP_MODE_V_boundaryTex).x,l9_0,l9_17);
float l9_18=l9_15.y;
float l9_19=l9_17;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_boundaryTex,SC_SOFTWARE_WRAP_MODE_V_boundaryTex).y,l9_0,l9_19);
float l9_20=l9_19;
vec3 l9_21=sc_SamplingCoordsViewToGlobal(vec2(l9_16,l9_18),boundaryTexLayout,boundaryTexGetStereoViewIndex());
vec4 l9_22=texture2D(boundaryTex,l9_21.xy,0.0);
vec4 l9_23;
#if (SC_USE_CLAMP_TO_BORDER_boundaryTex)
{
l9_23=mix(boundaryTexBorderColor,l9_22,vec4(l9_20));
}
#else
{
l9_23=l9_22;
...
#endif
vec2 l9_0=varPackedTex.xy+(resInv*vec2(0.0,1.0));
vec2 l9_1=varPackedTex.xy+(resInv*vec2(0.0,-1.0));
vec2 l9_2=varPackedTex.xy+(resInv*vec2(1.0,0.0));
vec2 l9_3=varPackedTex.xy+(resInv*vec2(-1.0,0.0));
vec4 l9_4;
if (int(float(wrapMode))==1)
{
l9_4=vec4(step(1.0,l9_0.y),step(l9_1.y,0.0),step(1.0,l9_2.x),step(l9_3.x,0.0));
}
else
{
l9_4=vec4(0.0);
...
vec4 l9_5;
if (float(useBoundaryTexture)!=0.0)
{
vec4 l9_6=l9_4+vec4(N8_userBoundaryTex_sample(varPackedTex.xy).x);
l9_5=vec4(l9_6.x+step(0.001,N8_userBoundaryTex_sample(l9_0).x),l9_6.y+step(0.001,N8_userBoundaryTex_sample(l9_1).x),l9_6.z+step(0.001,N8_userBoundaryTex_sample(l9_2).x),l9_6.w+step(0.001,N8_userBoundaryTex_sample(l9_3).x));
}
else
{
l9_5=l9_4;
...
{
l9_10=clamp(dot(l9_5.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_15;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_5.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_18;
...
#endif
l9_22=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_26,sc_ScreenTextureLayout,l9_27).xy,0.0);
}
#endif
vec4 l9_28;
...
#endif
vec3 l9_30=mix(l9_28.xyz,definedBlend(l9_28.xyz,l9_5.xyz).xyz,vec3(l9_5.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_32=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_33;
