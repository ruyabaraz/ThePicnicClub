...
float l9_68=clamp(l9_62.x,0.0,1.0);
float l9_69;
...
vec4 l9_72=vec4(l9_62.x,l9_62.y,l9_62.z,vec4(0.0).w);
l9_72.w=l9_69;
vec2 l9_73=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
bool l9_74=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_75=l9_73.x;
float l9_76=l9_75;
...
{
l9_82=1.0;
l9_81=vec2(l9_77,l9_80);
}
#endif
vec2 l9_91=sc_TransformUV(l9_81,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_92=l9_91.x;
float l9_93=l9_82;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_74,l9_93);
float l9_94=l9_91.y;
float l9_95=l9_93;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_74,l9_95);
float l9_96=l9_95;
vec3 l9_97=sc_SamplingCoordsViewToGlobal(vec2(l9_92,l9_94),iconLayout,iconGetStereoViewIndex());
vec4 l9_98=texture2D(icon,l9_97.xy,0.0);
vec4 l9_99;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
float l9_117=l9_106;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_74,l9_117);
float l9_118=l9_115.y;
float l9_119=l9_117;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_74,l9_119);
float l9_120=l9_119;
vec3 l9_121=sc_SamplingCoordsViewToGlobal(vec2(l9_116,l9_118),iconLayout,iconGetStereoViewIndex());
vec4 l9_122=texture2D(icon,l9_121.xy,0.0);
vec4 l9_123;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
{
l9_100=Port_Input2_N003;
}
vec4 l9_124=vec4(l9_100);
vec4 l9_125=mix(mix(l9_32,l9_60,vec4(Port_Input2_N005))+mix(l9_72,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031)),l9_99,l9_124);
...
#endif
l9_142=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_146,sc_ScreenTextureLayout,l9_147).xy,0.0);
}
#endif
vec4 l9_148;
...
{
vec4 l9_149=l9_142;
l9_149.x=l9_142.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_148=l9_149;
}
#else
{
...
#endif
vec3 l9_150=mix(l9_148.xyz,definedBlend(l9_148.xyz,l9_125.xyz).xyz,vec3(l9_126));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_152=vec4(mix(vec3(1.0),l9_125.xyz,vec3(l9_126)),l9_126);
}
#else
{
vec4 l9_153;
...
#endif
l9_153=vec4(l9_125.xyz*l9_154,l9_154);
}
#else
{
l9_153=l9_125;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_161-0.0039215689)),min(1.0,l9_161+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_163=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_162).xy);
float l9_164=packValue(l9_163);
int l9_171=int(l9_160.w*255.0);
float l9_172=packValue(l9_171);
sc_writeFragData0Internal(vec4(packValue(l9_163),packValue(l9_163),packValue(l9_163),packValue(l9_163)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
if (l9_180==0)
{
l9_183=texture2D(sc_OITAlpha0,l9_175);
l9_182=texture2D(sc_OITDepthLow0,l9_175);
l9_181=texture2D(sc_OITDepthHigh0,l9_175);
}
else
{
l9_183=vec4(0.0);
...
if (l9_180==1)
{
l9_186=texture2D(sc_OITAlpha1,l9_175);
l9_185=texture2D(sc_OITDepthLow1,l9_175);
l9_184=texture2D(sc_OITDepthHigh1,l9_175);
}
else
{
l9_186=l9_183;
...
vec4 l9_201=texture2D(sc_OITFilteredDepthBoundsTexture,l9_175);
