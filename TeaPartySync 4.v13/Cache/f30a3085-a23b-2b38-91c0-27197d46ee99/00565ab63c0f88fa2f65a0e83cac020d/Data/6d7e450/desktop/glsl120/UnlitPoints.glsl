...
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N42 34 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N42 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool Tweak_N42HasSwappedViews 38 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int Tweak_N42Layout 83 0
...
#endif
bool l9_2=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N42)!=0));
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,Tweak_N42UvMinMax.x,Tweak_N42UvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N42)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,Tweak_N42UvMinMax.y,Tweak_N42UvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_Tweak_N42)!=0),Tweak_N42Transform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).x,l9_2,l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).y,l9_2,l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),Tweak_N42Layout,l9_1);
vec4 l9_24=texture2D(Tweak_N42,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N42)
{
l9_25=mix(Tweak_N42BorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#endif
vec4 l9_26=l9_25*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_27=mix(Port_Input0_N102,mix(vec4(dot(l9_26,Port_Input1_N094)),l9_26,vec4(clamp(Tweak_N2,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*baseColor;
...
{
l9_31=clamp(Tweak_N41*2.0,0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_32=clamp(dot(l9_28.xyz,vec3(Tweak_N41)),0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_34=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*Tweak_N41;
}
#else
{
float l9_35;
...
{
l9_35=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*Tweak_N41;
}
#else
{
float l9_36;
...
{
l9_36=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_37;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_38=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_39;
...
{
l9_39=dot(l9_28.xyz,vec3(0.33333001))*Tweak_N41;
}
#else
{
float l9_40;
...
#endif
vec3 l9_52=mix(l9_50.xyz,definedBlend(l9_50.xyz,l9_28.xyz).xyz,vec3(Tweak_N41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_54=vec4(mix(vec3(1.0),l9_28.xyz,vec3(Tweak_N41)),Tweak_N41);
}
#else
{
vec4 l9_55;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_63-0.0039215689)),min(1.0,l9_63+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_65),packValue(l9_65),packValue(l9_65),packValue(l9_65)),sc_UniformConstants.x,sc_ShaderCacheConstant);
