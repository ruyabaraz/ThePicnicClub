...
//float Tweak_N47 4400
//float Tweak_N2 4404
//float4 baseColor 4416
//float Tweak_N41 4432
//float4 Port_Input0_N102 4448
//float2 Port_Center_N046 4464
//float Port_Import_N092 4496
//float4 Port_Input1_N094 4512
//float Port_Import_N100 4532
//float depthRef 4536
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 77 -1
//spec_const int Tweak_N42Layout 78 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 [[function_constant(74)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 [[function_constant(76)]];
...
constant int Tweak_N42Layout [[function_constant(78)]];
...
float l9_80=l9_72;
float4 l9_81=sc_set0.Tweak_N42.sample(sc_set0.Tweak_N42SmpSC,l9_79,bias(l9_80));
float4 l9_82=l9_81;
float4 l9_83=l9_82;
if (param_9)
{
...
float4 l9_89=fast::max(param_16,float4(0.0));
float4 param_17=l9_89;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_100.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
