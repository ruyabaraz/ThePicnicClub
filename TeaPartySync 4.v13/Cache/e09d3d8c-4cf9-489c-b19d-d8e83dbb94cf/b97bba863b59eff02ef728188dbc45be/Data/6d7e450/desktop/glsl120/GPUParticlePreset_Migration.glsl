...
float l9_89=l9_88;
vec3 l9_90=sc_SamplingCoordsViewToGlobal(vec2(l9_85,l9_87),sizeRampTextureLayout,l9_68);
vec4 l9_91;
...
float l9_100=fract((l9_43*654.15588)+l9_42);
vec3 l9_101;
if (l9_95!=0.0)
{
...
if (l9_97!=0.0)
{
l9_102=spawnBox*(fract((vec3(fract((l9_43*82.124229)+l9_42),fract((l9_43*9115.2148)+l9_42),l9_100)*313.13324)+vec3(l9_42))-vec3(0.5));
}
else
{
l9_102=vec3(0.0);
...
if (l9_99!=0.0)
{
l9_103=spawnSphere*(vec3(l9_30.xyz)-vec3(0.5));
}
else
{
l9_103=vec3(0.0);
...
float l9_112=fract((l9_43*18.984529)+l9_42);
float l9_113=fract((l9_43*45.722408)+l9_42);
vec3 l9_114=vec3(l9_100,l9_113,l9_112);
vec3 l9_115=(l9_114-vec3(0.5))*2.0;
vec3 l9_116;
if (l9_109!=0.0)
{
l9_116=vec3(0.0)+((vec3(sin(l9_50*noiseFrequency.x),sin(l9_50*noiseFrequency.y),sin(l9_50*noiseFrequency.z))*noiseMult)*l9_115);
}
else
{
l9_116=vec3(0.0);
...
if (l9_111!=0.0)
{
l9_117=l9_116+((vec3(N32_sNoise(vec2(l9_112*l9_46,sNoiseFrequency.x)),N32_sNoise(vec2(l9_100*l9_46,sNoiseFrequency.y)),N32_sNoise(vec2(l9_113*l9_46,sNoiseFrequency.z)))*sNoiseMult)*l9_115);
}
else
{
l9_117=l9_116;
...
{
l9_121=pow(l9_46,velocityDrag.x);
}
float l9_122;
if (l9_120)
{
...
{
l9_122=pow(l9_46,velocityDrag.y);
}
float l9_123;
if (l9_120)
{
...
{
l9_123=pow(l9_46,velocityDrag.z);
}
...
vec2 l9_128=l9_127+vec2(floor(l9_50*10000.0)/10000.0,0.0);
int l9_129;
...
#endif
bool l9_130=(int(SC_USE_CLAMP_TO_BORDER_velRampTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_velRampTexture)!=0));
float l9_131=l9_128.x;
sc_SoftwareWrapEarly(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_velRampTexture,SC_SOFTWARE_WRAP_MODE_V_velRampTexture).x);
float l9_132=l9_131;
float l9_133=l9_128.y;
sc_SoftwareWrapEarly(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_velRampTexture,SC_SOFTWARE_WRAP_MODE_V_velRampTexture).y);
float l9_134=l9_133;
vec2 l9_135;
float l9_136;
...
{
l9_137=ivec2(SC_SOFTWARE_WRAP_MODE_U_velRampTexture,SC_SOFTWARE_WRAP_MODE_V_velRampTexture).x==3;
}
#else
{
l9_137=(int(SC_USE_CLAMP_TO_BORDER_velRampTexture)!=0);
}
#endif
float l9_138=l9_132;
float l9_139=1.0;
sc_ClampUV(l9_138,velRampTextureUvMinMax.x,velRampTextureUvMinMax.z,l9_137,l9_139);
float l9_140=l9_138;
float l9_141=l9_139;
bool l9_142;
#if (SC_USE_CLAMP_TO_BORDER_velRampTexture)
{
l9_142=ivec2(SC_SOFTWARE_WRAP_MODE_U_velRampTexture,SC_SOFTWARE_WRAP_MODE_V_velRampTexture).y==3;
}
#else
{
l9_142=(int(SC_USE_CLAMP_TO_BORDER_velRampTexture)!=0);
}
#endif
float l9_143=l9_134;
float l9_144=l9_141;
sc_ClampUV(l9_143,velRampTextureUvMinMax.y,velRampTextureUvMinMax.w,l9_142,l9_144);
l9_136=l9_144;
...
#endif
vec2 l9_145=sc_TransformUV(l9_135,(int(SC_USE_UV_TRANSFORM_velRampTexture)!=0),velRampTextureTransform);
float l9_146=l9_145.x;
float l9_147=l9_136;
sc_SoftwareWrapLate(l9_146,ivec2(SC_SOFTWARE_WRAP_MODE_U_velRampTexture,SC_SOFTWARE_WRAP_MODE_V_velRampTexture).x,l9_130,l9_147);
float l9_148=l9_145.y;
float l9_149=l9_147;
sc_SoftwareWrapLate(l9_148,ivec2(SC_SOFTWARE_WRAP_MODE_U_velRampTexture,SC_SOFTWARE_WRAP_MODE_V_velRampTexture).y,l9_130,l9_149);
float l9_150=l9_149;
vec3 l9_151=sc_SamplingCoordsViewToGlobal(vec2(l9_146,l9_148),velRampTextureLayout,l9_129);
vec4 l9_152;
#if (sc_CanUseTextureLod)
{
l9_152=texture2DLod(velRampTexture,l9_151.xy,0.0);
}
#else
{
l9_152=vec4(0.0);
...
#if (SC_USE_CLAMP_TO_BORDER_velRampTexture)
{
l9_153=mix(velRampTextureBorderColor,l9_152,vec4(l9_150));
}
#else
{
l9_153=l9_152;
...
#if (!((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH))
{
l9_154=l9_119*l9_124;
}
#else
{
l9_154=l9_125*l9_153.xyz;
}
#endif
l9_126=l9_154;
}
...
#endif
float l9_158=l9_157-0.001;
float l9_159=fract((l9_43*15.32451)+l9_42);
float l9_160;
if (l9_56!=0.0)
{
bool l9_161=l9_54>=0.99000001;
float l9_162;
if (l9_161||(((fract((l9_43*1231.1232)+l9_42)*1000.0)+1.0)>=spawnMaxParticles))
{
l9_162=0.0;
}
else
...
float l9_164=(gravity/2.0)*l9_46;
float l9_165=l9_164*l9_46;
vec3 l9_166=vec3(0.0,l9_165,0.0);
vec3 l9_167;
if (l9_156!=0.0)
{
l9_167=((localForce/vec3(2.0))*l9_46)*l9_46;
}
else
{
l9_167=vec3(0.0);
}
float l9_168=length(sc_ModelMatrix[0].xyz);
vec2 l9_169=l9_28-vec2(0.5);
vec2 l9_170=l9_169*l9_160;
vec2 l9_171=l9_170*l9_65;
vec2 l9_172=l9_171*l9_168;
vec3 l9_173=normalize(vec3(sc_ViewMatrixArray[sc_GetStereoViewIndex()][0].z,sc_ViewMatrixArray[sc_GetStereoViewIndex()][1].z,sc_ViewMatrixArray[sc_GetStereoViewIndex()][2].z+1e-06));
vec3 l9_174=normalize(cross(l9_173,vec3(0.0,-1.0,0.0)));
vec3 l9_175;
vec3 l9_176;
if (float(ALIGNTOX)!=0.0)
{
l9_176=vec3(0.0,1.0,0.0);
l9_175=vec3(0.0,0.0,1.0);
}
else
{
l9_176=normalize(cross(l9_174,l9_173));
l9_175=l9_174;
}
vec3 l9_177;
vec3 l9_178;
...
{
l9_180=vec3(0.0,1.0,0.0);
l9_179=vec3(1.0,0.0,0.0);
}
else
{
l9_180=l9_178;
...
float l9_181=ssPow(1.0-l9_50,rotationDrag);
float l9_182=3.1415927*(((((mix(rotationRate.x,rotationRate.y,l9_159)*l9_181)*l9_50)*2.0)+mix(rotationRandom.x,rotationRandom.y,l9_159))-0.5);
float l9_183=cos(l9_182);
float l9_184=sin(l9_182);
vec3 l9_185=l9_179*l9_183;
vec3 l9_186=l9_180*l9_184;
vec3 l9_187=l9_179*(-l9_184);
vec3 l9_188=l9_180*l9_183;
vec3 l9_189=l9_126+l9_166;
vec3 l9_190=l9_189+l9_167;
mat3 l9_191=N2_transposeMatrix(sc_ModelMatrix);
vec3 l9_192;
#if (NODE_67_DROPLIST_ITEM==2)
{
l9_192=((l9_126*N2_transposeMatrix(sc_ModelMatrix))+l9_166)+l9_167;
}
#else
{
...
{
l9_193=((l9_126*vec3(l9_168,length(sc_ModelMatrix[1].xyz),length(sc_ModelMatrix[2].xyz)))+l9_166)+l9_167;
}
#else
{
l9_193=l9_192;
...
#if (VELOCITYDIR)
{
vec3 l9_197=l9_193+l9_166;
vec3 l9_198=l9_197+l9_167;
vec3 l9_199=normalize(l9_198+vec3(1e-06));
float l9_200=l9_46-0.0099999998;
vec3 l9_201=l9_193*l9_200;
float l9_202=l9_46+0.0099999998;
vec3 l9_203=l9_193*l9_202;
float l9_204;
if (l9_158!=0.0)
{
l9_204=sizeVelScale;
...
{
l9_204=length(l9_203-l9_201)*sizeVelScale;
}
l9_196=l9_204;
l9_195=l9_199;
l9_194=normalize(cross(l9_199,l9_173));
}
#else
{
l9_196=1.0;
l9_195=l9_185+l9_186;
l9_194=l9_187+l9_188;
}
#endif
vec3 l9_205=(sc_ModelMatrix*vec4(l9_105,1.0)).xyz+l9_193;
vec3 l9_206=l9_194*l9_172.x;
float l9_207=l9_172.y*l9_196;
vec3 l9_208=l9_195*l9_207;
vec3 l9_209;
vec3 l9_210;
vec3 l9_211;
if (l9_27)
{
l9_211=varTangent.xyz;
l9_210=varNormal;
l9_209=varPos;
}
else
...
l9_211=varTangent.xyz;
l9_210=l9_31;
l9_209=(l9_205+l9_206)+l9_208;
}
varPos=l9_209;
varNormal=normalize(l9_210);
vec3 l9_212=normalize(l9_211);
varTangent=vec4(l9_212.x,l9_212.y,l9_212.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_213=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_214;
#if (sc_RenderingSpace==2)
{
l9_214=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_215;
#if (sc_RenderingSpace==1)
{
l9_215=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_215=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_217=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_218;
...
#if (sc_RenderingSpace==1)
{
l9_219=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_219=vec4(0.0);
...
#endif
vec4 l9_221=sc_ProjectorMatrix*l9_220;
varShadowTex=((l9_221.xy/vec2(l9_221.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_222;
...
{
vec4 l9_224=l9_216;
l9_224.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_216.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_216.w;
l9_223=l9_224;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_226=l9_222.xy+(sc_TAAJitterOffset*l9_222.w);
l9_225=vec4(l9_226.x,l9_226.y,l9_222.z,l9_222.w);
}
#else
{
l9_225=l9_222;
...
{
vec4 l9_228=l9_225;
l9_228.x=l9_225.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_227=l9_228;
}
#else
{
...
{
float l9_229=dot(l9_227,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_229);
}
#else
{
varClipDistance=l9_229;
}
#endif
}
#endif
