...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_cursorTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_cursorTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int cursorTextureLayout 82 0
...
float l9_4=l9_3;
vec2 l9_5=((((varPackedTex.xy-vec2(Port_RangeMinA_N013))/vec2((Port_RangeMaxA_N013-Port_RangeMinA_N013)+1e-06))*(Port_RangeMaxB_N013-Port_RangeMinB_N013))+vec2(Port_RangeMinB_N013))-Port_Center_N019;
...
{
float l9_44=distance(((((((varPackedTex.xy-vec2(Port_RangeMinA_N001))/vec2((Port_RangeMaxA_N001-Port_RangeMinA_N001)+1e-06))*(Port_RangeMaxB_N001-Port_RangeMinB_N001))+vec2(Port_RangeMinB_N001))-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002,vec2(Port_Value1_N046,Port_Value2_N046));
float l9_45;
...
#endif
vec3 l9_79=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_81=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_82;
...
#endif
l9_82=vec4(l9_1.xyz*l9_83,l9_83);
}
#else
{
l9_82=l9_1;
