...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTex 81 -1
//spec_const int intensityTextureLayout 82 0
//spec_const int mainTexLayout 83 0
...
#endif
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0));
float l9_2=varPackedTex.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x);
float l9_3=l9_2;
float l9_4=varPackedTex.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,mainTexUvMinMax.x,mainTexUvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,mainTexUvMinMax.y,mainTexUvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),mainTexLayout,l9_0);
vec4 l9_23=texture2D(mainTex,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_24=mix(mainTexBorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
#endif
vec3 l9_25=vec3(l9_24.xyz)*vec3(glowColor.xyz);
float l9_26=((glowColor.w*l9_24.w)*brightness)*max(pinchBrightness,pokeBrightness);
vec4 l9_27=vec4(l9_25.x,l9_25.y,l9_25.z,vec4(0.0).w);
l9_27.w=l9_26;
...
{
l9_31=clamp(dot(l9_27.xyz,vec3(l9_26)),0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_33=(1.0-dot(l9_27.xyz,vec3(0.33333001)))*l9_26;
}
#else
{
float l9_34;
...
{
l9_34=(1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0))*l9_26;
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_36;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_37=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_38;
...
{
l9_38=dot(l9_27.xyz,vec3(0.33333001))*l9_26;
}
#else
{
float l9_39;
...
#endif
vec3 l9_51=mix(l9_49.xyz,definedBlend(l9_49.xyz,l9_27.xyz).xyz,vec3(l9_26));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_27.xyz,vec3(l9_26)),l9_26);
}
#else
{
vec4 l9_54;
