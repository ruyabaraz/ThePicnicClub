...
float l9_31=snoise(vec2(floor((sc_Time.x*Port_Multiplier_N012)*10000.0)*9.9999997e-05)*(Port_Scale_N013*0.5));
float l9_32=((glow_scale*Port_Input1_N021)/(Port_Input1_N019+1.234e-06))+Port_Input1_N020;
vec3 l9_33;
vec3 l9_34;
vec3 l9_35;
if (l9_27)
...
l9_35=varTangent.xyz;
l9_34=l9_30;
l9_33=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(((((floor(((l9_31*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N015)/((Port_RangeMaxA_N015-Port_RangeMinA_N015)+1e-06))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015))*vec3(Port_Value1_N018,((((Port_ValueIn_N035-vec4(Port_RangeMinA_N035))/vec4((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*((l9_32+Port_Input1_N017)-l9_32))+vec4(l9_32)).x,Port_Value3_N018),1.0)).xyz;
}
varPos=l9_33;
...
#if (sc_TAAEnabled)
{
vec2 l9_50=l9_46.xy+(sc_TAAJitterOffset*l9_46.w);
l9_49=vec4(l9_50.x,l9_50.y,l9_46.z,l9_46.w);
}
#else
{
l9_49=l9_46;
...
{
vec4 l9_52=l9_49;
l9_52.x=l9_49.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_51=l9_52;
}
#else
{
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_44-0.0039215689)),min(1.0,l9_44+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_46),packValue(l9_46),packValue(l9_46),packValue(l9_46)),sc_UniformConstants.x,sc_ShaderCacheConstant);
