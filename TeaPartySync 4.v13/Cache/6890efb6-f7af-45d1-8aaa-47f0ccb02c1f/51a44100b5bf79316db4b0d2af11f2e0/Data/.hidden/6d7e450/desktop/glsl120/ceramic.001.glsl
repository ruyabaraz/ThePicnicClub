...
//spec_const bool SC_DISABLE_FRUSTUM_CULLING 43 0
//spec_const bool SC_GL_FRAGMENT_PRECISION_HIGH 44 0
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_materialParamsTex 49 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_normalTex 50 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_opacityTex 51 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_reflectionModulationTex 52 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_reflectionTex 53 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_rimColorTex 54 0
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 55 0
//spec_const bool SC_USE_UV_MIN_MAX_detailNormalTex 56 0
//spec_const bool SC_USE_UV_MIN_MAX_emissiveTex 57 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 58 0
//spec_const bool SC_USE_UV_MIN_MAX_materialParamsTex 59 0
//spec_const bool SC_USE_UV_MIN_MAX_normalTex 60 0
//spec_const bool SC_USE_UV_MIN_MAX_opacityTex 61 0
//spec_const bool SC_USE_UV_MIN_MAX_reflectionModulationTex 62 0
//spec_const bool SC_USE_UV_MIN_MAX_reflectionTex 63 0
//spec_const bool SC_USE_UV_MIN_MAX_rimColorTex 64 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 65 0
//spec_const bool SC_USE_UV_TRANSFORM_detailNormalTex 66 0
//spec_const bool SC_USE_UV_TRANSFORM_emissiveTex 67 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 68 0
//spec_const bool SC_USE_UV_TRANSFORM_materialParamsTex 69 0
//spec_const bool SC_USE_UV_TRANSFORM_normalTex 70 0
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 71 0
//spec_const bool SC_USE_UV_TRANSFORM_reflectionModulationTex 72 0
//spec_const bool SC_USE_UV_TRANSFORM_reflectionTex 73 0
//spec_const bool SC_USE_UV_TRANSFORM_rimColorTex 74 0
//spec_const bool Tweak_N177 75 0
//spec_const bool Tweak_N216 76 0
...
//spec_const bool sc_CanUseStandardDerivatives 104 0
...
#endif
l9_149=N7_vec3srgbToLinear(l9_184)*reflectionIntensity;
}
#else
{
l9_149=vec3(0.0);
...
l9_211=vec3(0.0)+(N7_vec3srgbToLinear(l9_213)*ssPow(l9_243,rimExponent));
}
#else
{
l9_211=vec3(0.0);
...
#endif
vec3 l9_244=ssPow((l9_148+l9_149)+l9_211,vec3(0.45454547));
vec2 l9_245=N7_getUV(NODE_221_DROPLIST_ITEM);
int l9_246;
#if (materialParamsTexHasSwappedViews)
{
l9_246=1-sc_GetStereoViewIndex();
}
#else
{
l9_246=sc_GetStereoViewIndex();
}
#endif
bool l9_247=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_248=l9_245.x;
sc_SoftwareWrapEarly(l9_248,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_249=l9_248;
float l9_250=l9_245.y;
sc_SoftwareWrapEarly(l9_250,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_251=l9_250;
vec2 l9_252;
float l9_253;
...
{
l9_254=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
...
float l9_255=l9_249;
float l9_256=1.0;
sc_ClampUV(l9_255,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_254,l9_256);
float l9_257=l9_255;
float l9_258=l9_256;
bool l9_259;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_259=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_260=l9_251;
float l9_261=l9_258;
sc_ClampUV(l9_260,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_259,l9_261);
l9_253=l9_261;
...
#endif
vec2 l9_262=sc_TransformUV(l9_252,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_263=l9_262.x;
float l9_264=l9_253;
sc_SoftwareWrapLate(l9_263,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_247,l9_264);
float l9_265=l9_262.y;
float l9_266=l9_264;
sc_SoftwareWrapLate(l9_265,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_247,l9_266);
float l9_267=l9_266;
vec3 l9_268=sc_SamplingCoordsViewToGlobal(vec2(l9_263,l9_265),materialParamsTexLayout,l9_246);
vec4 l9_269=texture2D(materialParamsTex,l9_268.xy,0.0);
vec4 l9_270;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_270=mix(materialParamsTexBorderColor,l9_269,vec4(l9_267));
}
#else
{
l9_270=l9_269;
...
#endif
float l9_271=l9_270.x*metallic;
vec3 l9_272;
if (NODE_38_DROPLIST_ITEM==3)
{
l9_272=vec3(l9_270.z)*tempGlobals.VertexColor.xyz;
}
else
{
l9_272=vec3(l9_270.z);
}
vec3 l9_273;
#if (ENABLE_SPECULAR_AO)
{
vec3 l9_274=mix(vec3(0.039999999),l9_61.xyz*l9_271,vec3(l9_271));
l9_273=mix(vec3(1.0),mix((l9_274*(1.0-specularAoDarkening))*l9_274,vec3(1.0),vec3(l9_272.x)),vec3(specularAoIntensity));
}
#else
{
l9_273=vec3(1.0);
...
#endif
float l9_277=clamp(l9_62,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_277<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_277<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_278=max(l9_61.xyz,vec3(0.0));
vec4 l9_279;
#if (sc_ProjectiveShadowsCaster)
{
l9_279=vec4(l9_278,l9_277);
}
#else
{
float l9_280=clamp(l9_271,0.0,1.0);
float l9_281=clamp(l9_270.y*roughness,0.0,1.0);
vec3 l9_282=clamp(l9_272,vec3(0.0),vec3(1.0));
vec3 l9_283=clamp(l9_275,vec3(0.0),vec3(1.0));
vec3 l9_284=ssSRGB_to_Linear(l9_278);
vec3 l9_285=normalize(l9_276);
vec3 l9_286=ssSRGB_to_Linear(max(l9_244,vec3(0.0)));
vec3 l9_287;
#if (sc_SSAOEnabled)
{
l9_287=evaluateSSAO(varPos);
}
#else
{
l9_287=l9_282;
...
#endif
vec3 l9_288=vec3(l9_280);
vec3 l9_289=mix(vec3(0.039999999),l9_284*l9_280,l9_288);
vec3 l9_290=mix(l9_284*(1.0-l9_280),vec3(0.0),l9_288);
SurfaceProperties l9_291=SurfaceProperties(l9_290,l9_277,l9_285,varPos,l9_3,l9_280,l9_281,l9_286,l9_287,l9_283,vec3(1.0),l9_289);
vec4 l9_292=vec4(1.0);
vec3 l9_293;
vec3 l9_294;
vec3 l9_295;
vec3 l9_296;
...
l9_301=vec3(0.0);
l9_300=vec3(0.0);
LightingComponents l9_307;
LightProperties l9_308;
SurfaceProperties l9_309;
vec3 l9_310;
int l9_311=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_311<sc_DirectionalLightsCount)
{
LightingComponents l9_312=accumulateLight(LightingComponents(l9_300,l9_301,l9_306,l9_305,l9_303,l9_302),LightProperties(sc_DirectionalLights[l9_311].direction,sc_DirectionalLights[l9_311].color.xyz,sc_DirectionalLights[l9_311].color.w*l9_292[(l9_304<3) ? l9_304 : 3]),l9_291,l9_3);
l9_306=l9_312.indirectDiffuse;
l9_305=l9_312.indirectSpecular;
l9_304++;
l9_303=l9_312.emitted;
l9_302=l9_312.transmitted;
l9_301=l9_312.directSpecular;
l9_300=l9_312.directDiffuse;
l9_311++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_329<sc_PointLightsCount)
{
vec3 l9_331=sc_PointLights[l9_329].position-varPos;
vec3 l9_332=normalize(l9_331);
float l9_333=l9_292[(l9_330<3) ? l9_330 : 3];
float l9_334=clamp((dot(l9_332,sc_PointLights[l9_329].direction)*sc_PointLights[l9_329].angleScale)+sc_PointLights[l9_329].angleOffset,0.0,1.0);
float l9_335=(sc_PointLights[l9_329].color.w*l9_333)*(l9_334*l9_334);
float l9_336;
if (sc_PointLights[l9_329].falloffEnabled)
{
l9_336=l9_335*computeDistanceAttenuation(length(l9_331),sc_PointLights[l9_329].falloffEndDistance);
}
else
{
l9_336=l9_335;
...
l9_322=l9_330+1;
LightingComponents l9_337=accumulateLight(LightingComponents(l9_316,l9_317,l9_321,l9_320,l9_319,l9_318),LightProperties(l9_332,sc_PointLights[l9_329].color.xyz,l9_336),l9_291,l9_3);
l9_323=l9_337.directDiffuse;
l9_324=l9_337.directSpecular;
l9_325=l9_337.indirectDiffuse;
l9_326=l9_337.indirectSpecular;
l9_327=l9_337.emitted;
l9_328=l9_337.transmitted;
l9_321=l9_325;
l9_320=l9_326;
l9_330=l9_322;
l9_319=l9_327;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_341=abs(varShadowTex-vec2(0.5));
vec4 l9_342=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_341.x,l9_341.y),0.5);
l9_340=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_342.xyz,vec3(sc_ShadowColor.w)),vec3(l9_342.w*sc_ShadowDensity));
}
#else
{
l9_340=vec3(1.0);
...
#endif
l9_339=l9_313*l9_340;
l9_338=l9_314*l9_340;
}
#else
{
l9_339=l9_313;
...
{
vec2 l9_344=calcPanoramicTexCoordsFromDir(l9_285,sc_EnvmapRotation.y);
vec4 l9_345;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_346=calcSeamlessPanoramicUvsForSampling(l9_344,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_346=l9_344;
...
#endif
l9_345=sc_EnvmapSpecularSampleViewIndexBias(l9_346,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_347;
...
{
vec2 l9_348=calcSeamlessPanoramicUvsForSampling(l9_344,sc_EnvmapDiffuseSize.xy,0.0);
int l9_349;
#if (sc_EnvmapDiffuseHasSwappedViews)
{
l9_349=1-sc_GetStereoViewIndex();
}
#else
{
l9_349=sc_GetStereoViewIndex();
}
#endif
l9_347=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_348,sc_EnvmapDiffuseLayout,l9_349).xy,-13.0);
}
#else
{
l9_347=sc_EnvmapSpecularSampleViewIndexBias(l9_344,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_345=l9_347;
}
#endif
l9_343=(l9_345.xyz*(1.0/l9_345.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_350;
...
l9_350=(((((((sc_Sh[8]*0.42904299)*((l9_352*l9_352)-(l9_353*l9_353)))+((sc_Sh[6]*0.74312502)*(l9_354*l9_354)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_352*l9_353))+(sc_Sh[7]*(l9_352*l9_354)))+(sc_Sh[5]*(l9_353*l9_354)))*0.85808599))+((((sc_Sh[3]*l9_352)+(sc_Sh[1]*l9_353))+(sc_Sh[2]*l9_354))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_350=vec3(0.0);
...
{
l9_356=l9_343+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_357=l9_343;
l9_357.x=l9_343.x+(1e-06*sc_AmbientLights[0].color.x);
l9_356=l9_357;
}
#endif
l9_355=l9_356;
...
{
l9_359=l9_355+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_360=l9_355;
l9_360.x=l9_355.x+(1e-06*sc_AmbientLights[1].color.x);
l9_359=l9_360;
}
#endif
l9_358=l9_359;
...
{
l9_362=l9_358+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_363=l9_358;
l9_363.x=l9_358.x+(1e-06*sc_AmbientLights[2].color.x);
l9_362=l9_363;
}
#endif
l9_361=l9_362;
...
{
vec3 l9_365;
l9_365=sc_LightEstimationData.ambientLight;
vec3 l9_366;
int l9_367=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_367<sc_LightEstimationSGCount)
{
float l9_368=dot(sc_LightEstimationData.sg[l9_367].axis,l9_285);
float l9_369=exp(-sc_LightEstimationData.sg[l9_367].sharpness);
float l9_370=l9_369*l9_369;
float l9_371=1.0/sc_LightEstimationData.sg[l9_367].sharpness;
float l9_372=(1.0+(2.0*l9_370))-l9_371;
float l9_373=sqrt(1.0-l9_372);
float l9_374=0.36000001*l9_368;
float l9_375=(1.0/(4.0*0.36000001))*l9_373;
float l9_376=l9_374+l9_375;
float l9_377;
if (step(abs(l9_374),l9_375)>0.5)
{
l9_377=(l9_376*l9_376)/l9_373;
}
else
{
l9_377=clamp(l9_368,0.0,1.0);
}
l9_366=l9_365+((((sc_LightEstimationData.sg[l9_367].color/vec3(sc_LightEstimationData.sg[l9_367].sharpness))*6.2831855)*((l9_372*l9_377)+(((l9_369-l9_370)*l9_371)-l9_370)))/vec3(3.1415927));
l9_365=l9_366;
l9_367++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_379=clamp(pow(l9_281,0.66666669),0.0,1.0)*5.0;
vec2 l9_380=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_285,reflect(-l9_3,l9_285),l9_281),sc_EnvmapRotation.y);
vec4 l9_381;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_382=floor(l9_379);
float l9_383=ceil(l9_379);
l9_381=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_380,sc_EnvmapSpecularSize.xy,l9_382),sc_EnvmapSpecularGetStereoViewIndex(),l9_382),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_380,sc_EnvmapSpecularSize.xy,l9_383),sc_EnvmapSpecularGetStereoViewIndex(),l9_383),vec4(l9_379-l9_382));
}
#else
{
l9_381=sc_EnvmapSpecularSampleViewIndexLevel(l9_380,sc_EnvmapSpecularGetStereoViewIndex(),l9_379);
}
#endif
l9_378=vec3(0.0)+((((l9_381.xyz*(1.0/l9_381.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_291,abs(dot(l9_285,l9_3))));
}
#else
{
l9_378=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_385=clamp(l9_281*l9_281,0.0099999998,1.0);
vec3 l9_386;
l9_386=sc_LightEstimationData.ambientLight*l9_289;
int l9_387=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_387<sc_LightEstimationSGCount)
{
float l9_388=l9_385*l9_385;
vec3 l9_389=reflect(-l9_3,l9_285);
float l9_390=dot(l9_285,l9_3);
float l9_391=(2.0/l9_388)/(4.0*max(l9_390,9.9999997e-05));
float l9_392=length((l9_389*l9_391)+(sc_LightEstimationData.sg[l9_387].axis*sc_LightEstimationData.sg[l9_387].sharpness));
float l9_393=clamp(dot(l9_285,l9_389),0.0,1.0);
float l9_394=clamp(l9_390,0.0,1.0);
float l9_395=1.0-l9_388;
l9_386+=((((((((vec3(1.0/(3.1415927*l9_388))*exp((l9_392-l9_391)-sc_LightEstimationData.sg[l9_387].sharpness))*sc_LightEstimationData.sg[l9_387].color)*6.2831855)*(1.0-exp((-2.0)*l9_392)))/vec3(l9_392))*((1.0/(l9_393+sqrt(l9_388+((l9_395*l9_393)*l9_393))))*(1.0/(l9_394+sqrt(l9_388+((l9_395*l9_394)*l9_394))))))*(l9_289+((vec3(1.0)-l9_289)*pow(1.0-clamp(dot(l9_389,normalize(l9_389+l9_3)),0.0,1.0),5.0))))*l9_393);
l9_387++;
continue;
}
else
...
l9_399=vec3(0.0);
l9_398=vec3(0.0);
l9_397=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_290,vec3(l9_277));
l9_396=1.0;
}
#else
{
...
#endif
vec3 l9_401=l9_398*l9_287;
vec3 l9_402=l9_399+l9_401;
vec3 l9_403=l9_290*l9_402;
vec3 l9_404=l9_384*l9_283;
vec3 l9_405=l9_338+l9_404;
vec3 l9_406;
if (l9_400)
{
l9_406=l9_403*srgbToLinear(l9_396);
}
else
{
l9_406=l9_403;
}
vec3 l9_407=l9_406+l9_405;
vec3 l9_408=(l9_407+l9_286)+l9_397;
float l9_409=l9_408.x;
vec4 l9_410=vec4(l9_409,l9_408.yz,l9_396);
vec4 l9_411;
#if (sc_IsEditor)
{
vec4 l9_412=l9_410;
l9_412.x=l9_409+((l9_287.x*l9_283.x)*9.9999997e-06);
l9_411=l9_412;
}
#else
{
...
{
vec3 l9_414=l9_411.xyz*1.8;
vec3 l9_415=(l9_411.xyz*(l9_414+vec3(1.4)))/((l9_411.xyz*(l9_414+vec3(0.5)))+vec3(1.5));
l9_413=vec4(l9_415.x,l9_415.y,l9_415.z,l9_411.w);
}
#else
{
l9_413=l9_411;
...
#endif
vec3 l9_416=vec3(linearToSrgb(l9_413.x),linearToSrgb(l9_413.y),linearToSrgb(l9_413.z));
l9_279=vec4(l9_416.x,l9_416.y,l9_416.z,l9_413.w);
}
#endif
vec4 l9_417=max(l9_279,vec4(0.0));
vec4 l9_418;
#if (sc_ProjectiveShadowsCaster)
{
float l9_419;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_420=clamp(l9_417.w*2.0,0.0,1.0);
}
#else
{
float l9_421;
...
{
l9_421=clamp(dot(l9_417.xyz,vec3(l9_417.w)),0.0,1.0);
}
#else
{
float l9_422;
...
#if (sc_BlendMode_Multiply)
{
l9_423=(1.0-dot(l9_417.xyz,vec3(0.33333001)))*l9_417.w;
}
#else
{
float l9_424;
...
{
l9_424=(1.0-clamp(dot(l9_417.xyz,vec3(1.0)),0.0,1.0))*l9_417.w;
}
#else
{
float l9_425;
#if (sc_BlendMode_ColoredGlass)
{
l9_425=clamp(dot(l9_417.xyz,vec3(1.0)),0.0,1.0)*l9_417.w;
}
#else
{
float l9_426;
#if (sc_BlendMode_Add)
{
l9_426=clamp(dot(l9_417.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_427;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_427=clamp(dot(l9_417.xyz,vec3(1.0)),0.0,1.0)*l9_417.w;
}
#else
{
float l9_428;
...
{
l9_428=dot(l9_417.xyz,vec3(0.33333001))*l9_417.w;
}
#else
{
float l9_429;
#if (sc_BlendMode_Min)
{
l9_429=1.0-clamp(dot(l9_417.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_430;
#if (sc_BlendMode_Max)
{
l9_430=clamp(dot(l9_417.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_430=1.0;
...
#endif
l9_418=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_417.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_419);
}
#else
{
vec4 l9_431;
...
{
vec3 l9_433=sc_GetFramebufferColor().xyz;
vec3 l9_434=mix(l9_433,definedBlend(l9_433,l9_417.xyz).xyz,vec3(l9_417.w));
vec4 l9_435=vec4(l9_434.x,l9_434.y,l9_434.z,vec4(0.0).w);
l9_435.w=1.0;
l9_432=l9_435;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_437=l9_417.w;
l9_436=vec4(mix(vec3(1.0),l9_417.xyz,vec3(l9_437)),l9_437);
}
#else
{
vec4 l9_438;
...
{
float l9_439=l9_417.w;
float l9_440;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_440=clamp(l9_439,0.0,1.0);
}
#else
{
l9_440=l9_439;
...
#endif
l9_438=vec4(l9_417.xyz*l9_440,l9_440);
}
#else
{
l9_438=l9_417;
...
{
l9_443=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_443=vec4(0.0);
...
vec4 l9_445=outputMotionVectorsIfNeeded(varPos,max(l9_444,vec4(0.0)));
vec4 l9_446=clamp(l9_445,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_447=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_447-0.0039215689)),min(1.0,l9_447+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_448=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_448).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_449=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_448).xy);
float l9_450=packValue(l9_449);
int l9_457=int(l9_446.w*255.0);
float l9_458=packValue(l9_457);
sc_writeFragData0Internal(vec4(packValue(l9_449),packValue(l9_449),packValue(l9_449),packValue(l9_449)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_450,packValue(l9_449),packValue(l9_449),packValue(l9_449)));
sc_writeFragData2(vec4(l9_458,packValue(l9_457),packValue(l9_457),packValue(l9_457)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_461=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_461).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_466==0)
{
l9_469=texture2D(sc_OITAlpha0,l9_461);
l9_468=texture2D(sc_OITDepthLow0,l9_461);
l9_467=texture2D(sc_OITDepthHigh0,l9_461);
}
else
{
l9_469=vec4(0.0);
...
if (l9_466==1)
{
l9_472=texture2D(sc_OITAlpha1,l9_461);
l9_471=texture2D(sc_OITDepthLow1,l9_461);
l9_470=texture2D(sc_OITDepthHigh1,l9_461);
}
else
{
l9_472=l9_469;
...
if (any(notEqual(l9_470,vec4(0.0)))||any(notEqual(l9_471,vec4(0.0))))
{
int l9_473[8]=l9_462;
unpackValues(l9_470.w,l9_466,l9_473);
unpackValues(l9_470.z,l9_466,l9_473);
unpackValues(l9_470.y,l9_466,l9_473);
unpackValues(l9_470.x,l9_466,l9_473);
unpackValues(l9_471.w,l9_466,l9_473);
unpackValues(l9_471.z,l9_466,l9_473);
unpackValues(l9_471.y,l9_466,l9_473);
unpackValues(l9_471.x,l9_466,l9_473);
int l9_482[8]=l9_463;
unpackValues(l9_472.w,l9_466,l9_482);
unpackValues(l9_472.z,l9_466,l9_482);
unpackValues(l9_472.y,l9_466,l9_482);
unpackValues(l9_472.x,l9_466,l9_482);
}
l9_466++;
continue;
}
...
vec4 l9_487=texture2D(sc_OITFilteredDepthBoundsTexture,l9_461);
vec2 l9_488=l9_487.xy;
int l9_489;
#if (sc_SkinBonesCount>0)
{
l9_489=encodeDepth(((1.0-l9_487.x)*1000.0)+getDepthOrderingEpsilon(),l9_488);
}
#else
{
l9_489=0;
...
#endif
int l9_490=encodeDepth(viewSpaceDepth(),l9_488);
vec4 l9_491;
l9_491=l9_446*l9_446.w;
vec4 l9_492;
int l9_493=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_493<8)
{
int l9_494=l9_462[l9_493];
int l9_495=l9_490-l9_489;
bool l9_496=l9_494<l9_495;
bool l9_497;
if (l9_496)
{
l9_497=l9_462[l9_493]>0;
}
else
{
l9_497=l9_496;
...
if (l9_497)
{
vec3 l9_498=l9_491.xyz*(1.0-(float(l9_463[l9_493])/255.0));
l9_492=vec4(l9_498.x,l9_498.y,l9_498.z,l9_491.w);
}
else
{
l9_492=l9_491;
...
sc_writeFragData0Internal(l9_491,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_446,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_445,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
