...
SurfaceProperties l9_40=SurfaceProperties(l9_39,l9_28,l9_34,varPos,l9_0,l9_31,l9_32,l9_35,l9_36,Port_SpecularAO_N006,vec3(1.0),l9_38);
vec4 l9_41=vec4(1.0);
vec3 l9_42;
vec3 l9_43;
vec3 l9_44;
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_186=l9_166.w;
l9_185=vec4(mix(vec3(1.0),l9_166.xyz,vec3(l9_186)),l9_186);
}
#else
{
vec4 l9_187;
...
#endif
l9_187=vec4(l9_166.xyz*l9_189,l9_189);
}
#else
{
l9_187=l9_166;
...
{
l9_192=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_192=vec4(0.0);
...
vec4 l9_194=outputMotionVectorsIfNeeded(varPos,max(l9_193,vec4(0.0)));
vec4 l9_195=clamp(l9_194,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_196=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_196-0.0039215689)),min(1.0,l9_196+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_197).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_198=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_197).xy);
float l9_199=packValue(l9_198);
int l9_206=int(l9_195.w*255.0);
float l9_207=packValue(l9_206);
sc_writeFragData0Internal(vec4(packValue(l9_198),packValue(l9_198),packValue(l9_198),packValue(l9_198)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_199,packValue(l9_198),packValue(l9_198),packValue(l9_198)));
sc_writeFragData2(vec4(l9_207,packValue(l9_206),packValue(l9_206),packValue(l9_206)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_210).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_215==0)
{
l9_218=texture2D(sc_OITAlpha0,l9_210);
l9_217=texture2D(sc_OITDepthLow0,l9_210);
l9_216=texture2D(sc_OITDepthHigh0,l9_210);
}
else
{
l9_218=vec4(0.0);
...
if (l9_215==1)
{
l9_221=texture2D(sc_OITAlpha1,l9_210);
l9_220=texture2D(sc_OITDepthLow1,l9_210);
l9_219=texture2D(sc_OITDepthHigh1,l9_210);
}
else
{
l9_221=l9_218;
...
if (any(notEqual(l9_219,vec4(0.0)))||any(notEqual(l9_220,vec4(0.0))))
{
int l9_222[8]=l9_211;
unpackValues(l9_219.w,l9_215,l9_222);
unpackValues(l9_219.z,l9_215,l9_222);
unpackValues(l9_219.y,l9_215,l9_222);
unpackValues(l9_219.x,l9_215,l9_222);
unpackValues(l9_220.w,l9_215,l9_222);
unpackValues(l9_220.z,l9_215,l9_222);
unpackValues(l9_220.y,l9_215,l9_222);
unpackValues(l9_220.x,l9_215,l9_222);
int l9_231[8]=l9_212;
unpackValues(l9_221.w,l9_215,l9_231);
unpackValues(l9_221.z,l9_215,l9_231);
unpackValues(l9_221.y,l9_215,l9_231);
unpackValues(l9_221.x,l9_215,l9_231);
}
l9_215++;
continue;
}
...
vec4 l9_236=texture2D(sc_OITFilteredDepthBoundsTexture,l9_210);
vec2 l9_237=l9_236.xy;
int l9_238;
#if (sc_SkinBonesCount>0)
{
l9_238=encodeDepth(((1.0-l9_236.x)*1000.0)+getDepthOrderingEpsilon(),l9_237);
}
#else
{
l9_238=0;
...
#endif
int l9_239=encodeDepth(viewSpaceDepth(),l9_237);
vec4 l9_240;
l9_240=l9_195*l9_195.w;
vec4 l9_241;
int l9_242=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_242<8)
{
int l9_243=l9_211[l9_242];
int l9_244=l9_239-l9_238;
bool l9_245=l9_243<l9_244;
bool l9_246;
if (l9_245)
{
l9_246=l9_211[l9_242]>0;
}
else
{
l9_246=l9_245;
...
if (l9_246)
{
vec3 l9_247=l9_240.xyz*(1.0-(float(l9_212[l9_242])/255.0));
l9_241=vec4(l9_247.x,l9_247.y,l9_247.z,l9_240.w);
}
else
{
l9_241=l9_240;
