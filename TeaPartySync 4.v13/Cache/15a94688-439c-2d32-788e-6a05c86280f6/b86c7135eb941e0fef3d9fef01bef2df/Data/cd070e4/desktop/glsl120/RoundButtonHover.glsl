...
vec4 l9_38=mix(l9_35,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_39=l9_38.w;
...
#endif
vec3 l9_65=mix(l9_63.xyz,definedBlend(l9_63.xyz,l9_41.xyz).xyz,vec3(l9_39));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_67=vec4(mix(vec3(1.0),l9_41.xyz,vec3(l9_39)),l9_39);
}
#else
{
vec4 l9_68;
