...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/54];
}
else
{
l9_15=l9_14;
...
gParticle.Life=mix(LifeMin,LifeMax,ssGetParticleRandom(1,true,true,true,9.0,gParticle,0.0,sc_Time.x).x);
...
l9_31.w=mix(Port_Import_N041,Port_Import_N059,(clamp((l9_29*(Port_Input0_N063/((Port_Import_N185/l9_30)+1.234e-06)))+0.001,Port_Input1_N227+0.001,Port_Input2_N227+0.001)-0.001)*(clamp(((1.0-l9_29)*(Port_Input0_N066/((Port_Import_N188/l9_30)+1.234e-06)))+0.001,Port_Input1_N236+0.001,Port_Input2_N236+0.001)-0.001));
...
int l9_61=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_62=vfxOffsetInstancesWrite+l9_61;
float l9_63;
if (texture0.x<0.5)
{
l9_63=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_63,l9_64)+(vec2(float(l9_62%512),float(l9_62/512))*l9_60))*2.0)-vec2(1.0),1.0,1.0));
