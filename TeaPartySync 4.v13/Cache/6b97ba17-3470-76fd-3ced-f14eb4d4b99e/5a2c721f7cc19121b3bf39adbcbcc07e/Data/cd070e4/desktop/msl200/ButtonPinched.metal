...
//float Port_Import_N062 4532
//float3 Port_Import_N068 4544
//float Port_Input1_N073 4560
//float Port_Input2_N073 4564
//float2 Port_Input1_N009 4568
//float2 Port_Input2_N009 4576
//float4 Port_Value0_N014 4592
//float Port_Position1_N014 4608
//float4 Port_Value1_N014 4624
//float Port_Position2_N014 4640
//float4 Port_Value2_N014 4656
//float4 Port_Value3_N014 4672
//float2 Port_Scale_N002 4688
//float2 Port_Center_N002 4696
//float Port_Input2_N003 4704
//float depthRef 4708
//}
...
int l9_9=l9_8;
VectorOut_N71=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_9]*float4(Output_N70,0.0)).xyz;
...
float param_31=0.0;
bool l9_96=param_29&&(!param_27);
float l9_97=1.0;
float l9_98=param_23.x;
int l9_99=param_26.x;
if (l9_99==1)
{
l9_98=fract(l9_98);
}
...
param_23.x=l9_98;
float l9_103=param_23.y;
int l9_104=param_26.y;
if (l9_104==1)
{
l9_103=fract(l9_103);
}
...
float l9_110=param_23.x;
float l9_111=param_28.x;
float l9_112=param_28.z;
bool l9_113=l9_109;
float l9_114=l9_97;
...
float l9_119=param_23.y;
float l9_120=param_28.y;
float l9_121=param_28.w;
bool l9_122=l9_118;
float l9_123=l9_97;
...
float2 l9_126=param_23;
bool l9_127=param_24;
float3x3 l9_128=param_25;
if (l9_127)
{
...
param_23=l9_131;
float l9_132=param_23.x;
int l9_133=param_26.x;
bool l9_134=l9_96;
float l9_135=l9_97;
...
param_23.x=l9_132;
l9_97=l9_135;
float l9_143=param_23.y;
int l9_144=param_26.y;
bool l9_145=l9_96;
float l9_146=l9_97;
...
param_23.y=l9_143;
l9_97=l9_146;
float2 l9_154=param_23;
int l9_155=param_21;
int l9_156=param_22;
float l9_157=param_31;
...
float l9_165=l9_157;
float4 l9_166=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_164,bias(l9_165));
float4 l9_167=l9_166;
float4 l9_168=l9_167;
if (param_29)
{
l9_168=mix(param_30,l9_168,float4(l9_97));
}
...
float l9_170=0.0;
float l9_171=float((*sc_set0.UserUniforms).iconEnabled!=0);
l9_170=l9_171;
param_32=l9_170;
float param_35;
if ((param_32*1.0)!=0.0)
...
l9_172=param_36.Surface_UVCoord1;
float2 l9_173=float2(0.0);
l9_173=((l9_172-(*sc_set0.UserUniforms).Port_Center_N002)*(*sc_set0.UserUniforms).Port_Scale_N002)+(*sc_set0.UserUniforms).Port_Center_N002;
...
int l9_180=l9_175;
int l9_181=iconLayout_tmp;
int l9_182=l9_180;
float2 l9_183=l9_173;
bool l9_184=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 l9_185=(*sc_set0.UserUniforms).iconTransform;
int2 l9_186=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool l9_187=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 l9_188=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_189=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_190=(*sc_set0.UserUniforms).iconBorderColor;
float l9_191=0.0;
...
float l9_261=l9_253;
float4 l9_262=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_260,bias(l9_261));
float4 l9_263=l9_262;
float4 l9_264=l9_263;
if (l9_189)
{
l9_264=mix(l9_190,l9_264,float4(l9_193));
}
float4 l9_265=l9_264;
l9_174=l9_265;
float l9_266=0.0;
float4 l9_267=l9_174;
float l9_268=l9_267.w;
l9_266=l9_268;
param_33=l9_266;
param_35=param_33;
}
...
float4 l9_273=fast::max(param_38,float4(0.0));
float4 param_39=l9_273;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_284.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
