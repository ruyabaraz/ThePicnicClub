...
vec2 l9_37=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
...
#endif
vec3 l9_114=mix(l9_112.xyz,definedBlend(l9_112.xyz,l9_89.xyz).xyz,vec3(l9_90));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_116=vec4(mix(vec3(1.0),l9_89.xyz,vec3(l9_90)),l9_90);
}
#else
{
vec4 l9_117;
...
#endif
l9_117=vec4(l9_89.xyz*l9_118,l9_118);
}
#else
{
l9_117=l9_89;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_125-0.0039215689)),min(1.0,l9_125+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_127),packValue(l9_127),packValue(l9_127),packValue(l9_127)),sc_UniformConstants.x,sc_ShaderCacheConstant);
