...
//float4 Tweak_N119 4272
//float Tweak_N1 4288
//float Tweak_N8 4292
//float alpha 4296
//float3 Port_Normal_N041 4304
//float depthRef 4320
//}
...
float l9_5=abs(dot(-param_7.ViewDirWS,param_3));
float param_6=pow(1.0-l9_5,param_4);
...
float4 l9_10=fast::max(param_10,float4(0.0));
float4 param_11=l9_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
