...
vec4 l9_40=l9_29+l9_34;
vec4 l9_41=baseColor*l9_34;
float l9_42=clamp((l9_30*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_43;
if (l9_42<=0.0)
{
l9_43=0.0;
...
float l9_64=l9_63.x;
float l9_65=l9_54;
sc_SoftwareWrapLate(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_48,l9_65);
float l9_66=l9_63.y;
float l9_67=l9_65;
sc_SoftwareWrapLate(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_48,l9_67);
float l9_68=l9_67;
vec3 l9_69=sc_SamplingCoordsViewToGlobal(vec2(l9_64,l9_66),iconLayout,l9_47);
...
#endif
vec4 l9_72=mix(mix(mix(baseColor*(l9_40*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_41)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_45)),vec4(l9_71.xyz,0.0),vec4(l9_71.w));
float l9_73=max(l9_43,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_74=max(l9_71.w,l9_73)*alpha;
vec4 l9_75=vec4(l9_72.x,l9_72.y,l9_72.z,vec4(0.0).w);
l9_75.w=l9_74;
...
{
l9_79=clamp(dot(l9_75.xyz,vec3(l9_74)),0.0,1.0);
}
#else
{
float l9_80;
...
{
l9_81=(1.0-dot(l9_75.xyz,vec3(0.33333001)))*l9_74;
}
#else
{
float l9_82;
...
{
l9_82=(1.0-clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0))*l9_74;
}
#else
{
float l9_83;
...
{
l9_83=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0)*l9_74;
}
#else
{
float l9_84;
#if (sc_BlendMode_Add)
{
l9_84=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_85;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_85=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0)*l9_74;
}
#else
{
float l9_86;
...
{
l9_86=dot(l9_75.xyz,vec3(0.33333001))*l9_74;
}
#else
{
float l9_87;
#if (sc_BlendMode_Min)
{
l9_87=1.0-clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_88;
#if (sc_BlendMode_Max)
{
l9_88=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_88=1.0;
...
#endif
l9_76=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_75.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_77);
}
#else
{
vec4 l9_89;
...
#endif
vec3 l9_99=mix(l9_97.xyz,definedBlend(l9_97.xyz,l9_75.xyz).xyz,vec3(l9_74));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_101=vec4(mix(vec3(1.0),l9_75.xyz,vec3(l9_74)),l9_74);
}
#else
{
vec4 l9_102;
