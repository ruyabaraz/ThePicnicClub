...
vec4 l9_96=mix(l9_92,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
