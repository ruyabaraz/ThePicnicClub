...
//spec_const bool SC_USE_CLAMP_TO_BORDER_icon 33 0
...
//spec_const bool SC_USE_UV_MIN_MAX_icon 36 0
...
//spec_const bool SC_USE_UV_TRANSFORM_icon 39 0
...
//spec_const bool iconHasSwappedViews 43 0
...
float l9_41=clamp(l9_35.x,0.0,1.0);
float l9_42;
...
vec4 l9_45=vec4(l9_35.x,l9_35.y,l9_35.z,vec4(0.0).w);
l9_45.w=l9_42;
vec2 l9_46=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
bool l9_47=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_48=l9_46.x;
float l9_49=l9_48;
sc_SoftwareWrapEarly(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_50=l9_49;
float l9_51=l9_46.y;
float l9_52=l9_51;
...
{
l9_55=1.0;
l9_54=vec2(l9_50,l9_53);
}
#endif
vec2 l9_64=sc_TransformUV(l9_54,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_65=l9_64.x;
float l9_66=l9_55;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_47,l9_66);
float l9_67=l9_64.y;
float l9_68=l9_66;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_47,l9_68);
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),iconLayout,iconGetStereoViewIndex());
...
float l9_75=l9_74;
float l9_76=l9_51;
sc_SoftwareWrapEarly(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_77=l9_76;
vec2 l9_78;
float l9_79;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_80=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_80=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_81=l9_75;
float l9_82=1.0;
sc_ClampUV(l9_81,iconUvMinMax.x,iconUvMinMax.z,l9_80,l9_82);
float l9_83=l9_81;
float l9_84=l9_82;
bool l9_85;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_85=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_86=l9_77;
float l9_87=l9_84;
sc_ClampUV(l9_86,iconUvMinMax.y,iconUvMinMax.w,l9_85,l9_87);
l9_79=l9_87;
...
#endif
vec2 l9_88=sc_TransformUV(l9_78,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_89=l9_88.x;
float l9_90=l9_79;
sc_SoftwareWrapLate(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_47,l9_90);
float l9_91=l9_88.y;
float l9_92=l9_90;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_47,l9_92);
float l9_93=l9_92;
vec3 l9_94=sc_SamplingCoordsViewToGlobal(vec2(l9_89,l9_91),iconLayout,iconGetStereoViewIndex());
vec4 l9_95=texture2D(icon,l9_94.xy,0.0);
vec4 l9_96;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_96=mix(iconBorderColor,l9_95,vec4(l9_93));
}
#else
{
l9_96=l9_95;
...
{
l9_73=Port_Input2_N003;
}
vec4 l9_97=vec4(l9_73);
vec4 l9_98=mix(l9_33+l9_45,l9_72,l9_97);
float l9_99=l9_98.w;
...
#if (sc_FramebufferFetch)
{
vec4 l9_116=sc_readFragData0_Platform();
vec4 l9_117;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_118=l9_116;
l9_118.x=l9_116.x+_sc_framebufferFetchMarker;
l9_117=l9_118;
}
#else
{
...
#endif
l9_115=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_119,sc_ScreenTextureLayout,l9_120).xy,0.0);
}
#endif
vec4 l9_121;
...
{
vec4 l9_122=l9_115;
l9_122.x=l9_115.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_121=l9_122;
}
#else
{
...
#endif
vec3 l9_123=mix(l9_121.xyz,definedBlend(l9_121.xyz,l9_98.xyz).xyz,vec3(l9_99));
vec4 l9_124=vec4(l9_123.x,l9_123.y,l9_123.z,vec4(0.0).w);
l9_124.w=1.0;
l9_114=l9_124;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_125=vec4(mix(vec3(1.0),l9_98.xyz,vec3(l9_99)),l9_99);
}
#else
{
vec4 l9_126;
...
#endif
l9_126=vec4(l9_98.xyz*l9_127,l9_127);
}
#else
{
l9_126=l9_98;
...
{
l9_130=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_130=vec4(0.0);
...
vec4 l9_132=outputMotionVectorsIfNeeded(varPos,max(l9_131,vec4(0.0)));
...
#endif
int l9_136=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_135).xy);
...
if (l9_153==0)
{
l9_156=texture2D(sc_OITAlpha0,l9_148);
l9_155=texture2D(sc_OITDepthLow0,l9_148);
l9_154=texture2D(sc_OITDepthHigh0,l9_148);
}
else
{
l9_156=vec4(0.0);
...
if (l9_153==1)
{
l9_159=texture2D(sc_OITAlpha1,l9_148);
l9_158=texture2D(sc_OITDepthLow1,l9_148);
l9_157=texture2D(sc_OITDepthHigh1,l9_148);
}
else
{
l9_159=l9_156;
...
vec4 l9_174=texture2D(sc_OITFilteredDepthBoundsTexture,l9_148);
