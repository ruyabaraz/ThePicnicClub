...
//spec_const bool simple_round_buttonHasSwappedViews 77 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_simple_round_button 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_simple_round_button 81 -1
...
//spec_const int simple_round_buttonLayout 91 0
//SG_REFLECTION_END
...
float l9_34=clamp(length((varPackedTex.xy*Port_Input1_N010)+Port_Input2_N010),0.0,1.0);
vec4 l9_35;
...
vec4 l9_36=mix(l9_35,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_37=l9_36.w;
...
#endif
vec3 l9_63=mix(l9_61.xyz,definedBlend(l9_61.xyz,l9_39.xyz).xyz,vec3(l9_37));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_65=vec4(mix(vec3(1.0),l9_39.xyz,vec3(l9_37)),l9_37);
}
#else
{
vec4 l9_66;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_74-0.0039215689)),min(1.0,l9_74+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_76),packValue(l9_76),packValue(l9_76),packValue(l9_76)),sc_UniformConstants.x,sc_ShaderCacheConstant);
