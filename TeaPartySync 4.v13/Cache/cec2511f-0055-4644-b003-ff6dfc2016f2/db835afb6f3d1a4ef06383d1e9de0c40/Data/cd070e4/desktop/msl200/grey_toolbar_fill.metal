...
constant bool sc_BlendMode_Software [[function_constant(61)]];
...
constant bool sc_GetFramebufferColorInvalidUsageMarker [[function_constant(64)]];
...
float l9_92=l9_84;
float4 l9_93=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_91,bias(l9_92));
float4 l9_94=l9_93;
float4 l9_95=l9_94;
if (l9_20)
{
...
int l9_103=l9_98;
int l9_104=opacityTexLayout_tmp;
int l9_105=l9_103;
float2 l9_106=param_8.Surface_UVCoord0;
bool l9_107=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_108=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_109=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_110=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_111=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_112=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_113=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_114=0.0;
...
float l9_184=l9_176;
float4 l9_185=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_183,bias(l9_184));
...
float4 l9_193=fast::max(param_10,float4(0.0));
float4 param_11=l9_193;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_204.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
