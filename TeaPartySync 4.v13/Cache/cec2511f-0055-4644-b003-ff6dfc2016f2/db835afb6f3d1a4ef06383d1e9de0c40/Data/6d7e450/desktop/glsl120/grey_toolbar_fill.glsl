...
#endif
vec4 l9_52=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_52.w=l9_26.x;
vec4 l9_53=baseColor*l9_52;
float l9_54=l9_53.w;
...
{
l9_58=clamp(dot(l9_53.xyz,vec3(l9_54)),0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_60=(1.0-dot(l9_53.xyz,vec3(0.33333001)))*l9_54;
}
#else
{
float l9_61;
...
{
l9_61=(1.0-clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0))*l9_54;
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*l9_54;
}
#else
{
float l9_63;
#if (sc_BlendMode_Add)
{
l9_63=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_64;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_64=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*l9_54;
}
#else
{
float l9_65;
...
{
l9_65=dot(l9_53.xyz,vec3(0.33333001))*l9_54;
}
#else
{
float l9_66;
#if (sc_BlendMode_Min)
{
l9_66=1.0-clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_67;
#if (sc_BlendMode_Max)
{
l9_67=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_67=1.0;
...
#endif
l9_55=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_53.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_56);
}
#else
{
vec4 l9_68;
...
#endif
vec3 l9_78=mix(l9_76.xyz,definedBlend(l9_76.xyz,l9_53.xyz).xyz,vec3(l9_54));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_80=vec4(mix(vec3(1.0),l9_53.xyz,vec3(l9_54)),l9_54);
}
#else
{
vec4 l9_81;
