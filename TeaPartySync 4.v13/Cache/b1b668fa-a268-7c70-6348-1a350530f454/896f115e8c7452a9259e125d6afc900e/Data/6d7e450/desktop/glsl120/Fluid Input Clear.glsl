...
uniform float Port_Min1_N000;
uniform float Port_Max1_N000;
uniform float Port_Value2_N000;
uniform float Port_Min2_N000;
uniform float Port_Max2_N000;
uniform int PreviewEnabled;
...
#endif
vec2 l9_0=ssEncodeFloat16(Port_Value1_N000,Port_Min1_N000,Port_Max1_N000,0.99998999);
vec2 l9_1=ssEncodeFloat16(Port_Value2_N000,Port_Min2_N000,Port_Max2_N000,0.99998999);
vec4 l9_2=vec4(l9_0.x,l9_0.y,l9_1.x,l9_1.y);
float l9_3=l9_1.y;
