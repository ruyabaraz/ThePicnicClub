...
//spec_const bool sc_DepthOnly 104 0
//spec_const bool sc_EnvmapDiffuseHasSwappedViews 105 0
//spec_const bool sc_EnvmapSpecularHasSwappedViews 106 0
//spec_const bool sc_FramebufferFetch 107 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 108 0
//spec_const bool sc_HasDiffuseEnvmap 109 0
//spec_const bool sc_IsEditor 110 0
//spec_const bool sc_LightEstimation 111 0
//spec_const bool sc_MotionVectorsPass 112 0
//spec_const bool sc_OITCompositingPass 113 0
//spec_const bool sc_OITDepthBoundsPass 114 0
//spec_const bool sc_OITDepthGatherPass 115 0
//spec_const bool sc_OITDepthPrepass 116 0
//spec_const bool sc_OITFrontLayerPass 117 0
//spec_const bool sc_OITMaxLayers4Plus1 118 0
//spec_const bool sc_OITMaxLayers8 119 0
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 120 0
//spec_const bool sc_ProjectiveShadowsCaster 121 0
//spec_const bool sc_ProjectiveShadowsReceiver 122 0
...
//spec_const bool sc_ShaderComplexityAnalyzer 126 0
//spec_const bool sc_TAAEnabled 127 0
//spec_const bool sc_UseFramebufferFetchMarker 128 0
...
//spec_const int sc_MaxTextureImageUnits 189 0
...
{
vec2 l9_246=N7_getUV(NODE_221_DROPLIST_ITEM);
int l9_247;
#if (materialParamsTexHasSwappedViews)
{
l9_247=1-sc_GetStereoViewIndex();
}
#else
{
l9_247=sc_GetStereoViewIndex();
}
#endif
...
#endif
float l9_269=clamp(l9_62,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_269<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_269<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_270=max(l9_61.xyz,vec3(0.0));
vec4 l9_271;
#if (sc_ProjectiveShadowsCaster)
{
l9_271=vec4(l9_270,l9_269);
}
#else
{
vec3 l9_272=ssSRGB_to_Linear(l9_270);
vec3 l9_273=normalize(l9_268);
vec3 l9_274=ssSRGB_to_Linear(max(l9_245,vec3(0.0)));
vec3 l9_275;
#if (sc_SSAOEnabled)
{
...
SurfaceProperties l9_277=SurfaceProperties(l9_276,l9_269,l9_273,varPos,l9_3,0.0,1.0,l9_274,l9_275,vec3(1.0),vec3(1.0),vec3(0.039999999));
...
{
LightingComponents l9_298=accumulateLight(LightingComponents(l9_286,l9_287,l9_292,l9_290,l9_289,l9_288),LightProperties(sc_DirectionalLights[l9_297].direction,sc_DirectionalLights[l9_297].color.xyz,sc_DirectionalLights[l9_297].color.w*l9_278[(l9_291<3) ? l9_291 : 3]),l9_277,l9_3);
...
l9_308=l9_316+1;
LightingComponents l9_323=accumulateLight(LightingComponents(l9_302,l9_303,l9_307,l9_306,l9_305,l9_304),LightProperties(l9_318,sc_PointLights[l9_315].color.xyz,l9_322),l9_277,l9_3);
...
l9_370=vec3(0.0);
l9_369=vec3(0.0);
l9_368=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_276,vec3(l9_269));
l9_367=1.0;
}
#else
{
...
l9_271=vec4(l9_386.x,l9_386.y,l9_386.z,l9_383.w);
}
#endif
vec4 l9_387=max(l9_271,vec4(0.0));
vec4 l9_388;
#if (sc_ProjectiveShadowsCaster)
{
float l9_389;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_418=sc_ScreenCoordsGlobalToView(l9_2);
...
#if (sc_OITCompositingPass)
{
vec2 l9_431=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
