...
vec4 l9_95=mix(l9_92,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_132-0.0039215689)),min(1.0,l9_132+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_134),packValue(l9_134),packValue(l9_134),packValue(l9_134)),sc_UniformConstants.x,sc_ShaderCacheConstant);
