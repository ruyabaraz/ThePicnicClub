...
//sampler sampler sTextureSmpSC 0:17
...
//texture texture2D sTexture 0:1:0:17
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_sTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_sTexture 82 -1
//spec_const int intensityTextureLayout 83 0
//spec_const int sTextureLayout 84 0
...
#endif
#ifndef sTextureHasSwappedViews
#define sTextureHasSwappedViews 0
#elif sTextureHasSwappedViews==1
#undef sTextureHasSwappedViews
#define sTextureHasSwappedViews 1
#endif
#ifndef sTextureLayout
#define sTextureLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_sTexture
#define SC_USE_UV_TRANSFORM_sTexture 0
#elif SC_USE_UV_TRANSFORM_sTexture==1
#undef SC_USE_UV_TRANSFORM_sTexture
#define SC_USE_UV_TRANSFORM_sTexture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_sTexture
#define SC_SOFTWARE_WRAP_MODE_U_sTexture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_sTexture
#define SC_SOFTWARE_WRAP_MODE_V_sTexture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_sTexture
#define SC_USE_UV_MIN_MAX_sTexture 0
#elif SC_USE_UV_MIN_MAX_sTexture==1
#undef SC_USE_UV_MIN_MAX_sTexture
#define SC_USE_UV_MIN_MAX_sTexture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_sTexture
#define SC_USE_CLAMP_TO_BORDER_sTexture 0
#elif SC_USE_CLAMP_TO_BORDER_sTexture==1
#undef SC_USE_CLAMP_TO_BORDER_sTexture
#define SC_USE_CLAMP_TO_BORDER_sTexture 1
#endif
...
uniform mat3 sTextureTransform;
uniform vec4 sTextureUvMinMax;
uniform vec4 sTextureBorderColor;
uniform int PreviewEnabled;
...
#endif
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_sTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sTexture)!=0));
float l9_2=varPackedTex.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_sTexture,SC_SOFTWARE_WRAP_MODE_V_sTexture).x);
float l9_3=l9_2;
float l9_4=varPackedTex.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_sTexture,SC_SOFTWARE_WRAP_MODE_V_sTexture).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
#if (SC_USE_UV_MIN_MAX_sTexture)
{
bool l9_8;
#if (SC_USE_CLAMP_TO_BORDER_sTexture)
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_sTexture,SC_SOFTWARE_WRAP_MODE_V_sTexture).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_sTexture)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,sTextureUvMinMax.x,sTextureUvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_sTexture)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_sTexture,SC_SOFTWARE_WRAP_MODE_V_sTexture).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_sTexture)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,sTextureUvMinMax.y,sTextureUvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_sTexture)!=0),sTextureTransform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_sTexture,SC_SOFTWARE_WRAP_MODE_V_sTexture).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_sTexture,SC_SOFTWARE_WRAP_MODE_V_sTexture).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),sTextureLayout,l9_0);
vec4 l9_23=texture2D(sTexture,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_sTexture)
{
l9_24=mix(sTextureBorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
{
if (l9_24.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_27=clamp(l9_24.w*2.0,0.0,1.0);
}
#else
{
float l9_28;
...
{
l9_28=clamp(dot(l9_24.xyz,vec3(l9_24.w)),0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_30=(1.0-dot(l9_24.xyz,vec3(0.33333001)))*l9_24.w;
}
#else
{
float l9_31;
...
{
l9_31=(1.0-clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0))*l9_24.w;
}
#else
{
float l9_32;
...
{
l9_32=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*l9_24.w;
}
#else
{
float l9_33;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_34=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*l9_24.w;
}
#else
{
float l9_35;
...
{
l9_35=dot(l9_24.xyz,vec3(0.33333001))*l9_24.w;
}
#else
{
float l9_36;
...
#endif
vec3 l9_48=mix(l9_46.xyz,definedBlend(l9_46.xyz,l9_24.xyz).xyz,vec3(l9_24.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_50=vec4(mix(vec3(1.0),l9_24.xyz,vec3(l9_24.w)),l9_24.w);
}
#else
{
vec4 l9_51;
...
#endif
l9_51=vec4(l9_24.xyz*l9_52,l9_52);
}
#else
{
l9_51=l9_24;
