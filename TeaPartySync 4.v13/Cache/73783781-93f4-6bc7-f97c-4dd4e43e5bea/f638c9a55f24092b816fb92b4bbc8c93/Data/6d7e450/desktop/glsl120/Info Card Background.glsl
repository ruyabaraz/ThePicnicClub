...
{
l9_10=0.0+(((varPackedTex.x-0.0)*(sliceSizeLeft-0.0))/((l9_4-0.0)+1e-06));
}
else
{
l9_10=(varPackedTex.x<l9_5) ? (sliceSizeLeft+(((varPackedTex.x-l9_4)*(l9_8-sliceSizeLeft))/((l9_5-l9_4)+1e-06))) : (l9_8+(((varPackedTex.x-l9_5)*(1.0-l9_8))/((1.0-l9_5)+1e-06)));
}
float l9_11;
if (varPackedTex.y<l9_6)
{
l9_11=0.0+(((varPackedTex.y-0.0)*(sliceSizeBottom-0.0))/((l9_6-0.0)+1e-06));
}
else
{
l9_11=(varPackedTex.y<l9_7) ? (sliceSizeBottom+(((varPackedTex.y-l9_6)*(l9_9-sliceSizeBottom))/((l9_7-l9_6)+1e-06))) : (l9_9+(((varPackedTex.y-l9_7)*(1.0-l9_9))/((1.0-l9_7)+1e-06)));
}
int l9_12;
...
{
if (l9_36.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_39=clamp(l9_36.w*2.0,0.0,1.0);
}
#else
{
float l9_40;
...
{
l9_40=clamp(dot(l9_36.xyz,vec3(l9_36.w)),0.0,1.0);
}
#else
{
float l9_41;
...
{
l9_42=(1.0-dot(l9_36.xyz,vec3(0.33333001)))*l9_36.w;
}
#else
{
float l9_43;
...
{
l9_43=(1.0-clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0))*l9_36.w;
}
#else
{
float l9_44;
...
{
l9_44=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*l9_36.w;
}
#else
{
float l9_45;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_46=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*l9_36.w;
}
#else
{
float l9_47;
...
{
l9_47=dot(l9_36.xyz,vec3(0.33333001))*l9_36.w;
}
#else
{
float l9_48;
...
#endif
vec3 l9_60=mix(l9_58.xyz,definedBlend(l9_58.xyz,l9_36.xyz).xyz,vec3(l9_36.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_62=vec4(mix(vec3(1.0),l9_36.xyz,vec3(l9_36.w)),l9_36.w);
}
#else
{
vec4 l9_63;
