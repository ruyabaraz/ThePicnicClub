...
float l9_10=N24_BorderScale;
float l9_11=l9_9.x;
float l9_12=l9_9.y;
float l9_13=fast::min(fast::min(l9_10,l9_11/2.0),l9_12/2.0);
float l9_14=l9_13;
float2 l9_15=N24_TextureSize;
float l9_16=l9_14;
float2 l9_17=float2((l9_15.x/l9_15.y)*l9_16,l9_16);
float2 l9_18=l9_17;
float l9_19=((N24_SliceLeft*l9_18.x)*2.0)/l9_9.x;
float l9_20=1.0-(((N24_SliceRight*l9_18.x)*2.0)/l9_9.x);
float l9_21=((N24_SliceBottom*l9_18.y)*2.0)/l9_9.y;
float l9_22=1.0-(((N24_SliceTop*l9_18.y)*2.0)/l9_9.y);
float l9_23=0.0+(((N24_UV.x-0.0)*(N24_SliceLeft-0.0))/((l9_19-0.0)+1e-06));
float l9_24=N24_SliceLeft+(((N24_UV.x-l9_19)*((1.0-N24_SliceRight)-N24_SliceLeft))/((l9_20-l9_19)+1e-06));
float l9_25=(1.0-N24_SliceRight)+(((N24_UV.x-l9_20)*(1.0-(1.0-N24_SliceRight)))/((1.0-l9_20)+1e-06));
float l9_26=0.0+(((N24_UV.y-0.0)*(N24_SliceBottom-0.0))/((l9_21-0.0)+1e-06));
float l9_27=N24_SliceBottom+(((N24_UV.y-l9_21)*((1.0-N24_SliceTop)-N24_SliceBottom))/((l9_22-l9_21)+1e-06));
float l9_28=(1.0-N24_SliceTop)+(((N24_UV.y-l9_22)*(1.0-(1.0-N24_SliceTop)))/((1.0-l9_22)+1e-06));
float l9_29;
if (N24_UV.x<l9_19)
{
l9_29=l9_23;
...
{
l9_29=(N24_UV.x<l9_20) ? l9_24 : l9_25;
}
float l9_30=l9_29;
float l9_31;
if (N24_UV.y<l9_21)
...
{
l9_31=(N24_UV.y<l9_22) ? l9_27 : l9_28;
}
float l9_32=l9_31;
N24_Result=float2(l9_30,l9_32);
param_13=N24_Result;
Result_N24=param_13;
...
float param_24=0.0;
bool l9_39=param_22&&(!param_20);
float l9_40=1.0;
float l9_41=param_16.x;
int l9_42=param_19.x;
if (l9_42==1)
{
l9_41=fract(l9_41);
}
...
param_16.x=l9_41;
float l9_46=param_16.y;
int l9_47=param_19.y;
if (l9_47==1)
{
l9_46=fract(l9_46);
}
...
float l9_53=param_16.x;
float l9_54=param_21.x;
float l9_55=param_21.z;
bool l9_56=l9_52;
float l9_57=l9_40;
...
float l9_63=param_21.y;
float l9_64=param_21.w;
bool l9_65=l9_61;
float l9_66=l9_40;
...
float2 l9_69=param_16;
bool l9_70=param_17;
float3x3 l9_71=param_18;
if (l9_70)
{
...
float2 l9_74=l9_73;
param_16=l9_74;
float l9_75=param_16.x;
int l9_76=param_19.x;
bool l9_77=l9_39;
float l9_78=l9_40;
if ((l9_76==0)||(l9_76==3))
{
...
param_16.x=l9_75;
l9_40=l9_78;
float l9_86=param_16.y;
int l9_87=param_19.y;
bool l9_88=l9_39;
float l9_89=l9_40;
if ((l9_87==0)||(l9_87==3))
{
...
param_16.y=l9_86;
l9_40=l9_89;
float2 l9_97=param_16;
int l9_98=param_14;
int l9_99=param_15;
float l9_100=param_24;
float2 l9_101=l9_97;
int l9_102=l9_98;
int l9_103=l9_99;
...
float2 l9_107=l9_106.xy;
float l9_108=l9_100;
float4 l9_109=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_107,bias(l9_108));
float4 l9_110=l9_109;
float4 l9_111=l9_110;
if (param_22)
{
l9_111=mix(param_23,l9_111,float4(l9_40));
}
...
{
float4 l9_113=gl_FragCoord;
float2 l9_114=floor(mod(l9_113.xy,float2(4.0)));
float l9_115=(mod(dot(l9_114,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_25<l9_115)
{
discard_fragment();
}
}
bool l9_116=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_116)
{
...
float4 l9_117=fast::max(param_26,float4(0.0));
float4 param_27=l9_117;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_120=fast::clamp(l9_119.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_120=fast::clamp(dot(l9_119.xyz,float3(l9_119.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_120=(1.0-dot(l9_119.xyz,float3(0.33333001)))*l9_119.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_120=(1.0-fast::clamp(dot(l9_119.xyz,float3(1.0)),0.0,1.0))*l9_119.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_120=fast::clamp(dot(l9_119.xyz,float3(1.0)),0.0,1.0)*l9_119.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_120=fast::clamp(dot(l9_119.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_120=dot(l9_119.xyz,float3(0.33333001))*l9_119.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_120=1.0-fast::clamp(dot(l9_119.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_121=l9_120;
float l9_122=l9_121;
float l9_123=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_122;
float3 l9_124=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_118.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_125=float4(l9_124.x,l9_124.y,l9_124.z,l9_123);
param_28=l9_125;
}
else
{
...
{
float4 l9_126=param_28;
float4 l9_127=float4(0.0);
float4 l9_128=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_129=out.FragColor0;
float4 l9_130=l9_129;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_130.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_133=l9_132.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_138=l9_137;
int l9_139=l9_138;
float3 l9_140=float3(l9_134,0.0);
int l9_141=l9_136;
int l9_142=l9_139;
if (l9_141==1)
{
l9_140.y=((2.0*l9_140.y)+float(l9_142))-1.0;
}
float2 l9_143=l9_140.xy;
l9_135=l9_143;
}
else
{
...
float l9_170=l9_162;
float4 l9_171=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_169,bias(l9_170));
...
{
l9_128.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_176=l9_128;
float4 l9_177=l9_176;
float3 l9_178=l9_177.xyz;
float3 l9_179=l9_178;
float3 l9_180=l9_126.xyz;
float3 l9_181=definedBlend(l9_179,l9_180,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_127=float4(l9_181.x,l9_181.y,l9_181.z,l9_127.w);
float3 l9_182=mix(l9_178,l9_127.xyz,float3(l9_126.w));
l9_127=float4(l9_182.x,l9_182.y,l9_182.z,l9_127.w);
l9_127.w=1.0;
float4 l9_183=l9_127;
param_28=l9_183;
}
else
{
float4 l9_184=param_28;
...
{
l9_189=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_189=float4(0.0);
