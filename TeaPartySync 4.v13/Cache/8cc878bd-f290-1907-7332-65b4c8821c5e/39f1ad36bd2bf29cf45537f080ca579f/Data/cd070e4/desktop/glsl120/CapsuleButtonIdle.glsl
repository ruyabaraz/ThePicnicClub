...
float l9_95=clamp(length((varPackedTex.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_96;
...
#endif
l9_122=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_126,sc_ScreenTextureLayout,l9_127).xy,0.0);
}
#endif
vec4 l9_128;
...
{
vec4 l9_129=l9_122;
l9_129.x=l9_122.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_128=l9_129;
}
#else
{
...
#endif
vec3 l9_130=mix(l9_128.xyz,definedBlend(l9_128.xyz,l9_105.xyz).xyz,vec3(l9_106));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_132=vec4(mix(vec3(1.0),l9_105.xyz,vec3(l9_106)),l9_106);
}
#else
{
vec4 l9_133;
...
#endif
l9_133=vec4(l9_105.xyz*l9_134,l9_134);
}
#else
{
l9_133=l9_105;
...
#endif
int l9_143=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_142).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_155).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_160==0)
{
l9_163=texture2D(sc_OITAlpha0,l9_155);
l9_162=texture2D(sc_OITDepthLow0,l9_155);
l9_161=texture2D(sc_OITDepthHigh0,l9_155);
}
else
{
l9_163=vec4(0.0);
...
if (l9_160==1)
{
l9_166=texture2D(sc_OITAlpha1,l9_155);
l9_165=texture2D(sc_OITDepthLow1,l9_155);
l9_164=texture2D(sc_OITDepthHigh1,l9_155);
}
else
{
l9_166=l9_163;
...
vec4 l9_181=texture2D(sc_OITFilteredDepthBoundsTexture,l9_155);
