...
//float3 recolorRed 4416
//float3 recolorGreen 4432
//float3 recolorBlue 4448
//float3x3 opacityTexTransform 4512
//float4 opacityTexUvMinMax 4560
//float4 opacityTexBorderColor 4576
//float3x3 emissiveTexTransform 4640
//float4 emissiveTexUvMinMax 4688
//float4 emissiveTexBorderColor 4704
//float3 emissiveColor 4720
//float emissiveIntensity 4736
//float2 uv2Scale 4744
//float2 uv2Offset 4752
//float2 uv3Scale 4760
//float2 uv3Offset 4768
//float depthRef 4776
//}
...
constant bool sc_BlendMode_Software [[function_constant(69)]];
constant bool sc_BlendMode_Software_tmp = is_function_constant_defined(sc_BlendMode_Software) ? sc_BlendMode_Software : false;
constant bool sc_DepthOnly [[function_constant(70)]];
constant bool sc_DepthOnly_tmp = is_function_constant_defined(sc_DepthOnly) ? sc_DepthOnly : false;
constant bool sc_FramebufferFetch [[function_constant(71)]];
constant bool sc_FramebufferFetch_tmp = is_function_constant_defined(sc_FramebufferFetch) ? sc_FramebufferFetch : false;
constant bool sc_GetFramebufferColorInvalidUsageMarker [[function_constant(72)]];
...
constant bool sc_ProxyAlphaOne [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_emissiveTex [[function_constant(97)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_opacityTex [[function_constant(99)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_emissiveTex [[function_constant(101)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_opacityTex [[function_constant(103)]];
...
constant int baseTexLayout [[function_constant(104)]];
constant int baseTexLayout_tmp = is_function_constant_defined(baseTexLayout) ? baseTexLayout : 0;
constant int emissiveTexLayout [[function_constant(105)]];
...
{
int l9_262=N7_EmissiveUVSwitch;
...
int l9_275=l9_270;
int l9_276=emissiveTexLayout_tmp;
int l9_277=l9_275;
float2 l9_278=l9_268;
bool l9_279=(int(SC_USE_UV_TRANSFORM_emissiveTex_tmp)!=0);
float3x3 l9_280=(*sc_set0.UserUniforms).emissiveTexTransform;
int2 l9_281=int2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex_tmp,SC_SOFTWARE_WRAP_MODE_V_emissiveTex_tmp);
bool l9_282=(int(SC_USE_UV_MIN_MAX_emissiveTex_tmp)!=0);
float4 l9_283=(*sc_set0.UserUniforms).emissiveTexUvMinMax;
bool l9_284=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex_tmp)!=0);
float4 l9_285=(*sc_set0.UserUniforms).emissiveTexBorderColor;
float l9_286=0.0;
...
float l9_356=l9_348;
float4 l9_357=sc_set0.emissiveTex.sample(sc_set0.emissiveTexSmpSC,l9_355,bias(l9_356));
...
N7_Emissive=l9_361.xyz;
}
if (N7_VertexColorSwitch==2)
{
float4 l9_362=tempGlobals.VertexColor;
N7_Emissive+=l9_362.xyz;
}
if ((N7_VertexColorSwitch==2)||N7_EnableEmissiveTexture)
{
float3 l9_363=(N7_Emissive*N7_EmissiveColor)*float3(N7_EmissiveIntensity);
float3 l9_364=float3(2.2);
float l9_365;
if (l9_363.x<=0.0)
{
l9_365=0.0;
...
{
l9_369=pow(l9_363.z,l9_364.z);
}
float3 l9_370=float3(l9_366,l9_368,l9_369);
N7_Emissive=l9_370;
}
float3 l9_371=(N7_Emissive+l9_260)+l9_261;
float3 l9_372=float3(0.45454547);
float l9_373;
if (l9_371.x<=0.0)
{
l9_373=0.0;
...
{
l9_377=pow(l9_371.z,l9_372.z);
}
float3 l9_378=float3(l9_374,l9_376,l9_377);
N7_Emissive=l9_378;
param_20=N7_Albedo;
param_21=N7_Opacity;
...
float2 l9_380=floor(mod(l9_379.xy,float2(4.0)));
float l9_381=(mod(dot(l9_380,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_24<l9_381)
{
discard_fragment();
}
}
bool l9_382=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_382)
{
...
float4 l9_383=fast::max(param_25,float4(0.0));
float4 param_26=l9_383;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_386=fast::clamp(l9_385.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_386=fast::clamp(dot(l9_385.xyz,float3(l9_385.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_386=(1.0-dot(l9_385.xyz,float3(0.33333001)))*l9_385.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_386=(1.0-fast::clamp(dot(l9_385.xyz,float3(1.0)),0.0,1.0))*l9_385.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_386=fast::clamp(dot(l9_385.xyz,float3(1.0)),0.0,1.0)*l9_385.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_386=fast::clamp(dot(l9_385.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_386=dot(l9_385.xyz,float3(0.33333001))*l9_385.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_386=1.0-fast::clamp(dot(l9_385.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_387=l9_386;
float l9_388=l9_387;
float l9_389=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_388;
float3 l9_390=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_384.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_391=float4(l9_390.x,l9_390.y,l9_390.z,l9_389);
param_27=l9_391;
}
else
{
...
{
float4 l9_392=param_27;
float4 l9_393=float4(0.0);
float4 l9_394=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_395=out.FragColor0;
float4 l9_396=l9_395;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_396.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_399=l9_398.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_404=l9_403;
int l9_405=l9_404;
float3 l9_406=float3(l9_400,0.0);
int l9_407=l9_402;
int l9_408=l9_405;
if (l9_407==1)
{
l9_406.y=((2.0*l9_406.y)+float(l9_408))-1.0;
}
float2 l9_409=l9_406.xy;
l9_401=l9_409;
}
else
{
...
int l9_426=sc_ScreenTextureLayout_tmp;
int l9_427=l9_422;
float l9_428=l9_423;
float2 l9_429=l9_425;
int l9_430=l9_426;
int l9_431=l9_427;
float3 l9_432=float3(0.0);
if (l9_430==0)
{
l9_432=float3(l9_429,0.0);
}
else
{
if (l9_430==1)
{
l9_432=float3(l9_429.x,(l9_429.y*0.5)+(0.5-(float(l9_431)*0.5)),0.0);
}
else
{
l9_432=float3(l9_429,float(l9_431));
}
}
float3 l9_433=l9_432;
float3 l9_434=l9_433;
float2 l9_435=l9_434.xy;
float l9_436=l9_428;
float4 l9_437=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_435,bias(l9_436));
float4 l9_438=l9_437;
l9_424=l9_438;
float4 l9_439=l9_424;
...
{
l9_394.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_442=l9_394;
float4 l9_443=l9_442;
float3 l9_444=l9_443.xyz;
float3 l9_445=l9_444;
float3 l9_446=l9_392.xyz;
float3 l9_447=definedBlend(l9_445,l9_446,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_393=float4(l9_447.x,l9_447.y,l9_447.z,l9_393.w);
float3 l9_448=mix(l9_444,l9_393.xyz,float3(l9_392.w));
l9_393=float4(l9_448.x,l9_448.y,l9_448.z,l9_393.w);
l9_393.w=1.0;
float4 l9_449=l9_393;
param_27=l9_449;
}
else
{
float4 l9_450=param_27;
float4 l9_451=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_451=float4(mix(float3(1.0),l9_450.xyz,float3(l9_450.w)),l9_450.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_452=l9_450.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_452=fast::clamp(l9_452,0.0,1.0);
}
l9_451=float4(l9_450.xyz*l9_452,l9_452);
}
else
{
l9_451=l9_450;
...
float4 l9_453=l9_451;
param_27=l9_453;
}
}
}
float4 l9_454=param_27;
FinalColor=l9_454;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_455=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_455=float4(0.0);
...
float4 l9_457=param_30;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_457.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_457;
return out;
}
} // FRAGMENT SHADER
