...
//spec_const bool SC_DISABLE_FRUSTUM_CULLING 37 0
...
//spec_const bool emissiveTexHasSwappedViews 52 0
//spec_const bool intensityTextureHasSwappedViews 53 0
//spec_const bool opacityTexHasSwappedViews 54 0
//spec_const bool sc_BlendMode_Add 55 0
//spec_const bool sc_BlendMode_AddWithAlphaFactor 56 0
//spec_const bool sc_BlendMode_AlphaTest 57 0
//spec_const bool sc_BlendMode_AlphaToCoverage 58 0
//spec_const bool sc_BlendMode_ColoredGlass 59 0
//spec_const bool sc_BlendMode_Custom 60 0
//spec_const bool sc_BlendMode_Max 61 0
//spec_const bool sc_BlendMode_Min 62 0
//spec_const bool sc_BlendMode_Multiply 63 0
//spec_const bool sc_BlendMode_MultiplyOriginal 64 0
//spec_const bool sc_BlendMode_Normal 65 0
//spec_const bool sc_BlendMode_PremultipliedAlpha 66 0
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 67 0
//spec_const bool sc_BlendMode_PremultipliedAlphaHardware 68 0
//spec_const bool sc_BlendMode_Screen 69 0
//spec_const bool sc_BlendMode_Software 70 0
//spec_const bool sc_DepthOnly 71 0
//spec_const bool sc_FramebufferFetch 72 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 73 0
...
#endif
l9_107=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_111,sc_ScreenTextureLayout,l9_112).xy,0.0);
}
#endif
vec4 l9_113;
...
{
vec4 l9_114=l9_107;
l9_114.x=l9_107.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_113=l9_114;
}
#else
{
...
#endif
vec3 l9_115=mix(l9_113.xyz,definedBlend(l9_113.xyz,l9_91.xyz).xyz,vec3(l9_59));
vec4 l9_116=vec4(l9_115.x,l9_115.y,l9_115.z,vec4(0.0).w);
l9_116.w=1.0;
l9_106=l9_116;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_117=vec4(mix(vec3(1.0),l9_91.xyz,vec3(l9_59)),l9_59);
}
#else
{
vec4 l9_118;
...
#endif
l9_118=vec4(l9_91.xyz*l9_119,l9_119);
}
#else
{
l9_118=l9_91;
...
{
l9_122=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_122=vec4(0.0);
...
vec4 l9_124=outputMotionVectorsIfNeeded(varPos,max(l9_123,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_127).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_128=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_127).xy);
...
if (l9_145==0)
{
l9_148=texture2D(sc_OITAlpha0,l9_140);
l9_147=texture2D(sc_OITDepthLow0,l9_140);
l9_146=texture2D(sc_OITDepthHigh0,l9_140);
}
else
{
l9_148=vec4(0.0);
...
if (l9_145==1)
{
l9_151=texture2D(sc_OITAlpha1,l9_140);
l9_150=texture2D(sc_OITDepthLow1,l9_140);
l9_149=texture2D(sc_OITDepthHigh1,l9_140);
}
else
{
l9_151=l9_148;
...
vec4 l9_166=texture2D(sc_OITFilteredDepthBoundsTexture,l9_140);
