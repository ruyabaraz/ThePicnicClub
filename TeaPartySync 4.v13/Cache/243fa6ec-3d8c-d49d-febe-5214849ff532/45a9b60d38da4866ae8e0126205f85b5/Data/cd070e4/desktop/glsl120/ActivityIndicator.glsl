...
float l9_26=((((1.0-l9_17)-Port_RangeMinA_N000)/((Port_RangeMaxA_N000-Port_RangeMinA_N000)+1e-06))*(Port_RangeMaxB_N000-Port_RangeMinB_N000))+Port_RangeMinB_N000;
float l9_27;
if (Port_RangeMaxB_N000>Port_RangeMinB_N000)
{
l9_27=clamp(l9_26,Port_RangeMinB_N000,Port_RangeMaxB_N000);
}
else
{
l9_27=clamp(l9_26,Port_RangeMaxB_N000,Port_RangeMinB_N000);
}
float l9_28=clamp(Interpolator_gInstanceRatio,0.0,1.0);
vec3 l9_29;
if (l9_28<Port_Position1_N055)
{
l9_29=mix(Port_Value0_N055,Port_Value1_N055,vec3(clamp(l9_28/Port_Position1_N055,0.0,1.0)));
}
else
{
vec3 l9_30;
if (l9_28<Port_Position2_N055)
{
l9_30=mix(Port_Value1_N055,Port_Value2_N055,vec3(clamp((l9_28-Port_Position1_N055)/(Port_Position2_N055-Port_Position1_N055),0.0,1.0)));
}
else
{
vec3 l9_31;
if (l9_28<Port_Position3_N055)
{
l9_31=mix(Port_Value2_N055,Port_Value3_N055,vec3(clamp((l9_28-Port_Position2_N055)/(Port_Position3_N055-Port_Position2_N055),0.0,1.0)));
}
else
{
vec3 l9_32;
if (l9_28<Port_Position4_N055)
{
l9_32=mix(Port_Value3_N055,Port_Value4_N055,vec3(clamp((l9_28-Port_Position3_N055)/(Port_Position4_N055-Port_Position3_N055),0.0,1.0)));
}
else
{
l9_32=mix(Port_Value4_N055,Port_Value5_N055,vec3(clamp((l9_28-Port_Position4_N055)/(1.0-Port_Position4_N055),0.0,1.0)));
}
l9_31=l9_32;
}
l9_30=l9_31;
...
bool l9_34;
vec4 l9_35;
if (l9_33&&(55==PreviewNodeID))
{
l9_35=vec4(l9_29,1.0);
l9_34=true;
}
else
{
...
float l9_36=(((Interpolator_gInstanceRatio-Port_RangeMinA_N083)/((Port_RangeMaxA_N083-Port_RangeMinA_N083)+1e-06))*(Port_RangeMaxB_N083-Port_RangeMinB_N083))+Port_RangeMinB_N083;
float l9_37;
if (Port_RangeMaxB_N083>Port_RangeMinB_N083)
{
l9_37=clamp(l9_36,Port_RangeMinB_N083,Port_RangeMaxB_N083);
}
else
{
l9_37=clamp(l9_36,Port_RangeMaxB_N083,Port_RangeMinB_N083);
}
float l9_38=l9_18*l9_37;
float l9_39=clamp(l9_38,0.0,1.0);
vec3 l9_40;
if (l9_39<Port_Position1_N084)
{
l9_40=mix(Port_Value0_N084,Port_Value1_N084,vec3(clamp(l9_39/Port_Position1_N084,0.0,1.0)));
}
else
{
vec3 l9_41;
if (l9_39<Port_Position2_N084)
{
l9_41=mix(Port_Value1_N084,Port_Value2_N084,vec3(clamp((l9_39-Port_Position1_N084)/(Port_Position2_N084-Port_Position1_N084),0.0,1.0)));
}
else
{
l9_41=mix(Port_Value2_N084,Port_Value3_N084,vec3(clamp((l9_39-Port_Position2_N084)/(1.0-Port_Position2_N084),0.0,1.0)));
}
l9_40=l9_41;
}
bool l9_42;
...
bool l9_43;
vec4 l9_44;
if (l9_42&&(84==PreviewNodeID))
{
l9_44=vec4(l9_40,1.0);
l9_43=true;
}
else
{
...
vec3 l9_45=vec3(1.0)-l9_40;
vec3 l9_46=l9_29*l9_45;
vec3 l9_47=vec3(l9_27);
vec3 l9_48=l9_47*(l9_46*vec3(Port_Input2_N086));
float l9_49=l9_48.x;
vec4 l9_50=vec4(l9_20.x,l9_20.y,l9_20.z,vec4(0.0).w);
l9_50.w=l9_49;
if (dot(l9_50.xyz,vec3(0.29899999,0.58700001,0.114))<Port_Threshold_N012)
{
discard;
}
