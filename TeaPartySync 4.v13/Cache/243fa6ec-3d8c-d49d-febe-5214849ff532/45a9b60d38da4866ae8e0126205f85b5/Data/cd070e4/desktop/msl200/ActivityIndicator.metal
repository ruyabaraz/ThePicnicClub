...
//}
//ubo int UserUniforms 0:24:4736 {
//float4 sc_Time 1376
...
//float in_out 4128
//float Tweak_N38 4132
//float Tweak_N23 4136
//float Tweak_N33 4140
//float Tweak_N37 4144
//float3 Port_RotationAxis_N005 4160
//float Port_RangeMinA_N050 4176
//float Port_RangeMaxA_N050 4180
//float Port_RangeMinB_N050 4184
//float Port_Input0_N067 4188
//float Port_RangeMinA_N035 4192
//float Port_RangeMaxA_N035 4196
//float Port_RangeMinB_N035 4200
//float Port_RangeMaxB_N035 4204
//float4 Port_Input0_N022 4208
//float Port_RangeMinA_N025 4224
//float Port_RangeMaxA_N025 4228
//float Port_Input0_N057 4232
//float Port_Input0_N058 4236
//float Port_RangeMinA_N010 4240
//float Port_RangeMaxA_N010 4244
//float Port_RangeMinB_N010 4248
//float Port_RangeMaxB_N010 4252
//float Port_Value4_N007 4256
//float2 Port_Import_N017 4272
//float2 Port_Import_N014 4288
//float Port_RangeMinA_N046 4296
//float Port_RangeMaxA_N046 4300
//float Port_RangeMinB_N046 4304
//float Port_RangeMaxB_N046 4308
//float Port_Input0_N051 4312
//float Port_RangeMinA_N054 4316
//float Port_RangeMaxA_N054 4320
//float Port_Input0_N053 4324
//float Port_Input1_N077 4328
//float3 Port_Value0_N079 4336
//float Port_Position1_N079 4352
//float3 Port_Value1_N079 4368
//float Port_Position2_N079 4384
//float3 Port_Value2_N079 4400
//float3 Port_Value3_N079 4416
//float Port_RangeMinA_N000 4432
//float Port_RangeMaxA_N000 4436
//float Port_RangeMinB_N000 4440
//float Port_RangeMaxB_N000 4444
//float3 Port_Value0_N055 4448
//float Port_Position1_N055 4464
//float3 Port_Value1_N055 4480
//float Port_Position2_N055 4496
//float3 Port_Value2_N055 4512
//float Port_Position3_N055 4528
//float3 Port_Value3_N055 4544
//float Port_Position4_N055 4560
//float3 Port_Value4_N055 4576
//float3 Port_Value5_N055 4592
//float Port_RangeMinA_N083 4608
//float Port_RangeMaxA_N083 4612
//float Port_RangeMinB_N083 4616
//float Port_RangeMaxB_N083 4620
//float3 Port_Value0_N084 4624
//float Port_Position1_N084 4640
//float3 Port_Value1_N084 4656
//float Port_Position2_N084 4672
//float3 Port_Value2_N084 4688
//float3 Port_Value3_N084 4704
//float Port_Input2_N086 4720
//float Port_Threshold_N012 4724
//}
...
l9_120=float(l9_121)/((*sc_set0.UserUniforms).sc_GeometryInfo.y-1.0);
}
else
{
l9_120=0.0;
}
Globals.gInstanceRatio=l9_120;
float3 WorldPosition=out.varPos;
float3 WorldNormal=out.varNormal;
float3 WorldTangent=out.varTangent.xyz;
float InstanceID_N9=0.0;
int l9_122=gl_InstanceIndex;
InstanceID_N9=float(l9_122);
...
float3 l9_123=normalize(param_2);
float l9_124=sin(radians(param_3));
float l9_125=cos(radians(param_3));
float l9_126=1.0-l9_125;
float3x3 param_4=float3x3(float3(((l9_126*l9_123.x)*l9_123.x)+l9_125,((l9_126*l9_123.x)*l9_123.y)-(l9_123.z*l9_124),((l9_126*l9_123.z)*l9_123.x)+(l9_123.y*l9_124)),float3(((l9_126*l9_123.x)*l9_123.y)+(l9_123.z*l9_124),((l9_126*l9_123.y)*l9_123.y)+l9_125,((l9_126*l9_123.y)*l9_123.z)-(l9_123.x*l9_124)),float3(((l9_126*l9_123.z)*l9_123.x)-(l9_123.y*l9_124),((l9_126*l9_123.y)*l9_123.z)+(l9_123.x*l9_124),((l9_126*l9_123.z)*l9_123.z)+l9_125));
Matrix_N5=param_4;
...
int l9_139=l9_138;
l9_137=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_139]*param_9.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_144=param_9.position;
...
{
float4 l9_52=out.FragColor0;
float4 l9_53=l9_52;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_53.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_54=l9_53;
l9_51=l9_54;
}
...
{
float4 l9_55=gl_FragCoord;
float2 l9_56=l9_55.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_57=l9_56;
...
int l9_61=l9_60;
int l9_62=l9_61;
float3 l9_63=float3(l9_57,0.0);
int l9_64=l9_59;
int l9_65=l9_62;
if (l9_64==1)
{
l9_63.y=((2.0*l9_63.y)+float(l9_65))-1.0;
}
float2 l9_66=l9_63.xy;
l9_58=l9_66;
}
else
{
...
float2 l9_82=l9_78;
int l9_83=sc_ScreenTextureLayout_tmp;
int l9_84=l9_79;
float l9_85=l9_80;
float2 l9_86=l9_82;
int l9_87=l9_83;
...
float l9_93=l9_85;
float4 l9_94=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_92,bias(l9_93));
float4 l9_95=l9_94;
l9_81=l9_95;
float4 l9_96=l9_81;
float4 l9_97=l9_96;
...
{
l9_51.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_99=l9_51;
float4 l9_100=l9_99;
float3 l9_101=l9_100.xyz;
float3 l9_102=l9_101;
float3 l9_103=l9_49.xyz;
...
l9_50=float4(l9_104.x,l9_104.y,l9_104.z,l9_50.w);
float3 l9_105=mix(l9_101,l9_50.xyz,float3(l9_49.w));
l9_50=float4(l9_105.x,l9_105.y,l9_105.z,l9_50.w);
l9_50.w=1.0;
float4 l9_106=l9_50;
param_58=l9_106;
}
...
{
l9_112=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_112=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_59,param_60,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_61=FinalColor;
float4 l9_114=param_61;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_114.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_114;
return out;
}
} // FRAGMENT SHADER
