...
//}
//ubo int UserUniforms 0:47:5632 {
...
//float colorMultiplier 5168
//float Port_Speed_N022 5288
//float Port_Speed_N063 5344
//float4 Port_Default_N369 5360
//float Port_Value2_N073 5440
//float Port_Default_N204 5496
//float Port_Input2_N072 5508
//float Port_Strength1_N200 5536
//float3 Port_Default_N113 5552
//float Port_Strength2_N200 5568
//float3 Port_Emissive_N036 5584
//float3 Port_AO_N036 5600
//float depthRef 5616
//}
...
float l9_2608=param_22;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_2608<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_2609=gl_FragCoord;
float2 l9_2610=floor(mod(l9_2609.xy,float2(4.0)));
float l9_2611=(mod(dot(l9_2610,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_2608<l9_2611)
{
discard_fragment();
}
...
bool l9_2625=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_2625)
{
...
float4 l9_2626=fast::max(param_31,float4(0.0));
float4 param_32=l9_2626;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_2627=param_33;
float4 l9_2628=l9_2627;
float l9_2629=1.0;
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_2629=fast::clamp(l9_2628.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_2629=fast::clamp(dot(l9_2628.xyz,float3(l9_2628.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_2629=(1.0-dot(l9_2628.xyz,float3(0.33333001)))*l9_2628.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2629=(1.0-fast::clamp(dot(l9_2628.xyz,float3(1.0)),0.0,1.0))*l9_2628.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_2629=fast::clamp(dot(l9_2628.xyz,float3(1.0)),0.0,1.0)*l9_2628.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_2629=fast::clamp(dot(l9_2628.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_2629=dot(l9_2628.xyz,float3(0.33333001))*l9_2628.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_2629=1.0-fast::clamp(dot(l9_2628.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_2631=l9_2630;
float l9_2632=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_2631;
float3 l9_2633=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_2627.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_2634=float4(l9_2633.x,l9_2633.y,l9_2633.z,l9_2632);
param_33=l9_2634;
}
else
{
...
{
float4 l9_2635=param_33;
float4 l9_2636=float4(0.0);
float4 l9_2637=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_2638=out.FragColor0;
float4 l9_2639=l9_2638;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_2639.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_2640=l9_2639;
l9_2637=l9_2640;
}
else
{
float4 l9_2641=gl_FragCoord;
float2 l9_2642=l9_2641.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_2643=l9_2642;
...
{
l9_2646=in.varStereoViewID;
}
int l9_2647=l9_2646;
int l9_2648=l9_2647;
float3 l9_2649=float3(l9_2643,0.0);
int l9_2650=l9_2645;
int l9_2651=l9_2648;
if (l9_2650==1)
{
l9_2649.y=((2.0*l9_2649.y)+float(l9_2651))-1.0;
}
float2 l9_2652=l9_2649.xy;
l9_2644=l9_2652;
}
else
{
...
float2 l9_2653=l9_2644;
float2 l9_2654=l9_2653;
float2 l9_2655=l9_2654;
int l9_2656=0;
if ((int(sc_ScreenTextureHasSwappedViews_tmp)!=0))
{
int l9_2657=0;
...
int l9_2661=l9_2656;
float2 l9_2662=l9_2655;
int l9_2663=l9_2661;
float2 l9_2664=l9_2662;
int l9_2665=l9_2663;
float l9_2666=0.0;
float4 l9_2667=float4(0.0);
float2 l9_2668=l9_2664;
int l9_2669=sc_ScreenTextureLayout_tmp;
int l9_2670=l9_2665;
float l9_2671=l9_2666;
float2 l9_2672=l9_2668;
int l9_2673=l9_2669;
int l9_2674=l9_2670;
float3 l9_2675=float3(0.0);
if (l9_2673==0)
{
l9_2675=float3(l9_2672,0.0);
}
else
{
if (l9_2673==1)
{
l9_2675=float3(l9_2672.x,(l9_2672.y*0.5)+(0.5-(float(l9_2674)*0.5)),0.0);
}
else
{
l9_2675=float3(l9_2672,float(l9_2674));
}
}
float3 l9_2676=l9_2675;
float3 l9_2677=l9_2676;
float2 l9_2678=l9_2677.xy;
float l9_2679=l9_2671;
float4 l9_2680=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_2678,bias(l9_2679));
float4 l9_2681=l9_2680;
l9_2667=l9_2681;
float4 l9_2682=l9_2667;
...
if ((((int(sc_IsEditor_tmp)!=0)&&(int(sc_GetFramebufferColorInvalidUsageMarker_tmp)!=0))&&(!(int(sc_BlendMode_Software_tmp)!=0)))&&(!(int(sc_BlendMode_ColoredGlass_tmp)!=0)))
{
l9_2637.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_2685=l9_2637;
float4 l9_2686=l9_2685;
float3 l9_2687=l9_2686.xyz;
float3 l9_2688=l9_2687;
float3 l9_2689=l9_2635.xyz;
float3 l9_2690=definedBlend(l9_2688,l9_2689,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_2636=float4(l9_2690.x,l9_2690.y,l9_2690.z,l9_2636.w);
float3 l9_2691=mix(l9_2687,l9_2636.xyz,float3(l9_2635.w));
l9_2636=float4(l9_2691.x,l9_2691.y,l9_2691.z,l9_2636.w);
l9_2636.w=1.0;
float4 l9_2692=l9_2636;
param_33=l9_2692;
}
else
{
float4 l9_2693=param_33;
float4 l9_2694=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2694=float4(mix(float3(1.0),l9_2693.xyz,float3(l9_2693.w)),l9_2693.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_2695=l9_2693.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_2695=fast::clamp(l9_2695,0.0,1.0);
}
l9_2694=float4(l9_2693.xyz*l9_2695,l9_2695);
}
else
{
l9_2694=l9_2693;
...
{
l9_2698=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_2698=float4(0.0);
}
float4 l9_2699=l9_2698;
float4 Cost=l9_2699;
if (Cost.w>0.0)
{
FinalColor=Cost;
...
float4 l9_2700=param_36;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_2700.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_2700;
return out;
}
} // FRAGMENT SHADER
