...
//float3x3 simple_round_buttonTransform 4320
//float4 simple_round_buttonUvMinMax 4368
//float4 simple_round_buttonBorderColor 4384
//float Port_Import_N027 4400
//float3 Port_Import_N089 4416
//float Port_Input1_N037 4432
//float Port_Input2_N037 4436
//float3 Port_Input1_N002 4448
//float2 Port_Input1_N010 4464
//float2 Port_Input2_N010 4472
//float4 Port_Value0_N030 4480
//float Port_Position1_N030 4496
//float4 Port_Value1_N030 4512
//float4 Port_Value2_N030 4528
//float4 Port_Input1_N034 4544
//float3 Port_Normal_N031 4560
//float Port_Exponent_N031 4576
//float Port_Intensity_N031 4580
//float depthRef 4584
//}
...
//spec_const bool simple_round_buttonHasSwappedViews 73 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_simple_round_button 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_simple_round_button 77 -1
...
//spec_const int simple_round_buttonLayout 86 0
//SG_REFLECTION_END
...
constant bool simple_round_buttonHasSwappedViews [[function_constant(73)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_simple_round_button [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_simple_round_button [[function_constant(77)]];
...
constant int simple_round_buttonLayout [[function_constant(86)]];
...
int l9_9=l9_8;
VectorOut_N96=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_9]*float4(Output_N91,0.0)).xyz;
...
float l9_85=l9_77;
float4 l9_86=sc_set0.simple_round_button.sample(sc_set0.simple_round_buttonSmpSC,l9_84,bias(l9_85));
float4 l9_87=l9_86;
float4 l9_88=l9_87;
if (param_10)
{
...
float l9_90=abs(dot(-param_23.ViewDirWS,param_19));
float param_22=pow(1.0-l9_90,param_20);
...
bool l9_94=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_94)
{
...
float4 l9_95=fast::max(param_28,float4(0.0));
float4 param_29=l9_95;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_108.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
int l9_130=l9_125;
float2 l9_131=l9_124;
int l9_132=l9_130;
float2 l9_133=l9_131;
int l9_134=l9_132;
float l9_135=0.0;
...
float l9_148=l9_140;
float4 l9_149=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_147,bias(l9_148));
float4 l9_150=l9_149;
l9_136=l9_150;
float4 l9_151=l9_136;
...
{
l9_106.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_154=l9_106;
float4 l9_155=l9_154;
float3 l9_156=l9_155.xyz;
float3 l9_157=l9_156;
float3 l9_158=l9_104.xyz;
float3 l9_159=definedBlend(l9_157,l9_158,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_105=float4(l9_159.x,l9_159.y,l9_159.z,l9_105.w);
float3 l9_160=mix(l9_156,l9_105.xyz,float3(l9_104.w));
l9_105=float4(l9_160.x,l9_160.y,l9_160.z,l9_105.w);
l9_105.w=1.0;
float4 l9_161=l9_105;
param_30=l9_161;
}
else
{
float4 l9_162=param_30;
...
{
l9_167=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_167=float4(0.0);
