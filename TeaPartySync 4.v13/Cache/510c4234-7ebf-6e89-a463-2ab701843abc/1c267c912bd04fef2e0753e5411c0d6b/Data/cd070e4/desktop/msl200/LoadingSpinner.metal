...
//}
//ubo int UserUniforms 0:24:4192 {
//float4 sc_Time 1376
...
//float2 ringRadius 4128
//float2 ringStroke 4136
//float2 arcCenter 4144
//float arcSpread 4152
...
float3 l9_119=tempGlobals.SurfacePosition_ObjectSpace;
float3 l9_120=l9_119;
float2 l9_121=tempGlobals.Surface_UVCoord0;
float2 l9_122=l9_121;
float2 l9_123=tempGlobals.Surface_UVCoord1;
float2 l9_124=l9_123;
float2 l9_125=l9_120.xy*dot(l9_122,N0_RingStroke);
l9_120=float3(l9_125.x,l9_125.y,l9_120.z);
l9_120.x+=dot(l9_122,N0_RingRadius);
float l9_126=dot(l9_122,N0_ArcCenter);
l9_126+=(N0_ArcSpread*l9_124.x);
float l9_127=cos(l9_126);
float l9_128=sin(l9_126);
float l9_129=dot(l9_120.xy,float2(l9_127,-l9_128));
float l9_130=dot(l9_120.xy,float2(l9_128,l9_127));
l9_120.x=l9_129;
l9_120.y=l9_130;
float4x4 l9_131=(*sc_set0.UserUniforms).sc_ModelMatrix;
float4 l9_132=l9_131*float4(l9_120,1.0);
N0_WorldPos=l9_132.xyz/float3(l9_132.w);
param_9=N0_WorldPos;
WorldPos_N0=param_9;
...
int l9_145=l9_144;
l9_143=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_145]*param_11.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_147=l9_146;
l9_143=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_147]*float4(out.varPos,1.0);
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_149=l9_148;
l9_143=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_149]*float4(out.varPos,1.0);
}
}
}
}
out.varPackedTex=float4(param_11.texture0,param_11.texture1);
if ((int(sc_ProjectiveShadowsReceiver_tmp)!=0))
{
float4 l9_150=param_11.position;
...
{
l9_13.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_61=l9_13;
float4 l9_62=l9_61;
