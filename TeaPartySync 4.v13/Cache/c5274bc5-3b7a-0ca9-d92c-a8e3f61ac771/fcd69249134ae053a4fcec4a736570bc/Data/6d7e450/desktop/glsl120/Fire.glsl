...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N14 33 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N14 35 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 36 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N14 37 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 38 0
//spec_const bool Tweak_N14HasSwappedViews 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N14 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N14 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 84 -1
//spec_const int Tweak_N14Layout 85 0
...
vec4 param_5;
Node17_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),Port_Default_N017,param_5,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_30,varColor,texture3));
vec3 l9_32;
vec3 l9_33;
vec3 l9_34;
if (l9_27)
...
l9_34=varTangent.xyz;
l9_33=l9_31;
l9_32=(sc_ModelMatrix*vec4(((l9_30*vec3((float(sc_GetLocalInstanceID())*Port_Input1_N009)+Port_Input1_N007,Port_Value2_N059,Port_Value3_N059))*param_5.xyz)*vec3(smoothstep(Port_Input0_N006,Port_Input1_N006,fire_scale)),1.0)).xyz;
}
varPos=l9_32;
...
if (l9_1==1.0)
{
float l9_14=clamp(Interpolator_UVCoord3.y,0.0,1.0);
vec4 l9_15;
if (l9_14<Port_Position1_N043)
{
l9_15=mix(Port_Value0_N043,Port_Value1_N043,vec4(clamp(l9_14/Port_Position1_N043,0.0,1.0)));
}
else
{
l9_15=mix(Port_Value1_N043,Port_Value2_N043,vec4(clamp((l9_14-Port_Position1_N043)/(1.0-Port_Position1_N043),0.0,1.0)));
}
...
if (l9_1==2.0)
{
float l9_23=clamp(Interpolator_UVCoord3.y,0.0,1.0);
vec4 l9_24;
if (l9_23<Port_Position1_N044)
{
l9_24=mix(Port_Value0_N044,Port_Value1_N044,vec4(clamp(l9_23/Port_Position1_N044,0.0,1.0)));
}
else
{
l9_24=mix(Port_Value1_N044,Port_Value2_N044,vec4(clamp((l9_23-Port_Position1_N044)/(1.0-Port_Position1_N044),0.0,1.0)));
}
...
{
l9_22=PreviewVertexColor;
l9_21=l9_0;
l9_20=Port_Default_N042;
}
l9_13=l9_22;
l9_12=l9_21;
l9_11=l9_20;
...
float l9_29=radians(Port_Rotation_N012);
float l9_30=clamp((vec2(dot(vec2(cos(l9_29),sin(l9_29)),Interpolator_UVCoord3-Port_Center_N012),0.0)+Port_Center_N012).x,0.0,1.0);
vec4 l9_31;
if (l9_30<Port_Position1_N049)
{
l9_31=mix(Port_Value0_N049,Port_Value1_N049,vec4(clamp(l9_30/Port_Position1_N049,0.0,1.0)));
}
else
{
l9_31=mix(Port_Value1_N049,Port_Value2_N049,vec4(clamp((l9_30-Port_Position1_N049)/(1.0-Port_Position1_N049),0.0,1.0)));
}
...
vec2 l9_36=Interpolator_UVCoord3+(Port_Direction_N013*(sc_Time.x*Port_Speed_N013));
int l9_37;
...
#endif
bool l9_38=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N14)!=0));
float l9_39=l9_36.x;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).x);
float l9_40=l9_39;
float l9_41=l9_36.y;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).y);
float l9_42=l9_41;
vec2 l9_43;
float l9_44;
...
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).x==3;
}
#else
{
l9_45=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14)!=0);
}
#endif
float l9_46=l9_40;
float l9_47=1.0;
sc_ClampUV(l9_46,Tweak_N14UvMinMax.x,Tweak_N14UvMinMax.z,l9_45,l9_47);
float l9_48=l9_46;
float l9_49=l9_47;
bool l9_50;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N14)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).y==3;
}
#else
{
...
float l9_51=l9_42;
float l9_52=l9_49;
sc_ClampUV(l9_51,Tweak_N14UvMinMax.y,Tweak_N14UvMinMax.w,l9_50,l9_52);
l9_44=l9_52;
...
#endif
vec2 l9_53=sc_TransformUV(l9_43,(int(SC_USE_UV_TRANSFORM_Tweak_N14)!=0),Tweak_N14Transform);
float l9_54=l9_53.x;
float l9_55=l9_44;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).x,l9_38,l9_55);
float l9_56=l9_53.y;
float l9_57=l9_55;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).y,l9_38,l9_57);
float l9_58=l9_57;
vec3 l9_59=sc_SamplingCoordsViewToGlobal(vec2(l9_54,l9_56),Tweak_N14Layout,l9_37);
vec4 l9_60=texture2D(Tweak_N14,l9_59.xy,0.0);
vec4 l9_61;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N14)
{
l9_61=mix(Tweak_N14BorderColor,l9_60,vec4(l9_58));
}
#else
{
l9_61=l9_60;
...
#endif
vec3 l9_62=mix(l9_2.xyz,l9_31.xyz,vec3(1.0-l9_61.x));
vec4 l9_63=vec4(l9_62.x,l9_62.y,l9_62.z,vec4(0.0).w);
l9_63.w=Port_Value2_N001;
...
{
l9_66=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_67;
...
{
l9_67=clamp(dot(l9_63.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_68;
...
{
l9_69=(1.0-dot(l9_63.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_70;
...
{
l9_70=(1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_72;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_73=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_74;
...
{
l9_74=dot(l9_63.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_75;
...
#endif
l9_79=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_83,sc_ScreenTextureLayout,l9_84).xy,0.0);
}
#endif
vec4 l9_85;
...
#endif
vec3 l9_87=mix(l9_85.xyz,definedBlend(l9_85.xyz,l9_63.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_89=vec4(mix(vec3(1.0),l9_63.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_90;
...
{
l9_91=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_91=Port_Value2_N001;
}
#endif
l9_90=vec4(l9_63.xyz*l9_91,l9_91);
}
#else
{
l9_90=l9_63;
...
#endif
int l9_100=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_99).xy);
...
if (l9_117==0)
{
l9_120=texture2D(sc_OITAlpha0,l9_112);
l9_119=texture2D(sc_OITDepthLow0,l9_112);
l9_118=texture2D(sc_OITDepthHigh0,l9_112);
}
else
{
l9_120=vec4(0.0);
...
if (l9_117==1)
{
l9_123=texture2D(sc_OITAlpha1,l9_112);
l9_122=texture2D(sc_OITDepthLow1,l9_112);
l9_121=texture2D(sc_OITDepthHigh1,l9_112);
}
else
{
l9_123=l9_120;
...
vec4 l9_138=texture2D(sc_OITFilteredDepthBoundsTexture,l9_112);
