...
//spec_const bool Tweak_N16 38 0
//spec_const bool Tweak_N2 39 0
//spec_const bool Tweak_N25 40 0
//spec_const bool Tweak_N52 41 0
...
{
vec2 l9_9;
Node29_If_else(0.0,vec2(0.0),vec2(0.0),l9_9,l9_2);
l9_8=l9_9;
}
#else
{
...
#endif
bool l9_16=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_17=l9_6.x;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_18=l9_17;
float l9_19=l9_6.y;
sc_SoftwareWrapEarly(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_20=l9_19;
vec2 l9_21;
float l9_22;
...
{
l9_23=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_23=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_24=l9_18;
float l9_25=1.0;
sc_ClampUV(l9_24,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_23,l9_25);
float l9_26=l9_24;
float l9_27=l9_25;
bool l9_28;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_28=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_29=l9_20;
float l9_30=l9_27;
sc_ClampUV(l9_29,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_28,l9_30);
l9_22=l9_30;
...
#endif
vec2 l9_31=sc_TransformUV(l9_21,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_32=l9_31.x;
float l9_33=l9_22;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_16,l9_33);
float l9_34=l9_31.y;
float l9_35=l9_33;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_16,l9_35);
float l9_36=l9_35;
vec3 l9_37=sc_SamplingCoordsViewToGlobal(vec2(l9_32,l9_34),opacityTexLayout,l9_15);
vec4 l9_38=texture2D(opacityTex,l9_37.xy,0.0);
vec4 l9_39;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_39=mix(opacityTexBorderColor,l9_38,vec4(l9_36));
}
#else
{
l9_39=l9_38;
...
#endif
l9_3=mix(Port_Input0_N006,l9_5,vec3(l9_39.x));
}
#else
{
vec3 l9_40;
Node0_Shadow_Sample(l9_40,l9_2);
l9_3=l9_40;
}
#endif
vec4 l9_41=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_41.w=Port_Value2_N001;
...
{
l9_44=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_41.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_47=(1.0-dot(l9_41.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_50;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_51=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_52;
...
{
l9_52=dot(l9_41.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_53;
...
#endif
vec3 l9_65=mix(l9_63.xyz,definedBlend(l9_63.xyz,l9_41.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_67=vec4(mix(vec3(1.0),l9_41.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_68;
...
{
l9_69=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
