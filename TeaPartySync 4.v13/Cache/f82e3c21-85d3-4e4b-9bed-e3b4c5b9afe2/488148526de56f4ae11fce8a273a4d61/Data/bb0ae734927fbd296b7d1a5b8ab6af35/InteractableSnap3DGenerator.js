...
let Snap3DInteractableFactory = class Snap3DInteractableFactory extends BaseScriptComponent {
    ...
    createInteractable3DObject(input, overridePosition) {
        return new Promise((resolve, reject) => {
            ...
            let outputObj = this.snap3DInteractablePrefab.instantiate(this.getSceneObject());
            ...
            if (!snap3DInteractable) {
                print("Failed to find Snap3DInteractable component.");
                this.avaliableToRequest = true;
                reject("Snap3DInteractable component missing.");
                return;
            }
            if (overridePosition) {
