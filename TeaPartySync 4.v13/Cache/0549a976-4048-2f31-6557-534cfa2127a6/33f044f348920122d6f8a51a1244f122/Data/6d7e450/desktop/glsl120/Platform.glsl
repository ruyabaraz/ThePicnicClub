...
//spec_const bool SC_USE_UV_MIN_MAX_planet_refl_map 37 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N6 38 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 39 0
//spec_const bool SC_USE_UV_TRANSFORM_planet_refl_map 40 0
...
#endif
bool l9_42=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_43=varPackedTex.x;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_44=l9_43;
float l9_45=varPackedTex.y;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_46=l9_45;
vec2 l9_47;
float l9_48;
...
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_50=l9_44;
float l9_51=1.0;
sc_ClampUV(l9_50,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_49,l9_51);
float l9_52=l9_50;
float l9_53=l9_51;
bool l9_54;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_54=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_54=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_55=l9_46;
float l9_56=l9_53;
sc_ClampUV(l9_55,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_54,l9_56);
l9_48=l9_56;
...
#endif
vec2 l9_57=sc_TransformUV(l9_47,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_42,l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_42,l9_61);
float l9_62=l9_61;
vec3 l9_63=sc_SamplingCoordsViewToGlobal(vec2(l9_58,l9_60),Tweak_N6Layout,l9_41);
vec4 l9_64=texture2D(Tweak_N6,l9_63.xy,0.0);
vec4 l9_65;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_65=mix(Tweak_N6BorderColor,l9_64,vec4(l9_62));
}
#else
{
l9_65=l9_64;
...
#endif
vec3 l9_66=l9_40.xyz;
vec3 l9_67=mix(l9_66,(l9_65.xyz*l9_66).xyz,vec3(l9_65.w));
float l9_68=l9_40.w;
...
{
l9_73=clamp(dot(l9_69.xyz,vec3(l9_68)),0.0,1.0);
}
#else
{
float l9_74;
...
{
l9_75=(1.0-dot(l9_69.xyz,vec3(0.33333001)))*l9_68;
}
#else
{
float l9_76;
...
{
l9_76=(1.0-clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0))*l9_68;
}
#else
{
float l9_77;
...
{
l9_77=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0)*l9_68;
}
#else
{
float l9_78;
#if (sc_BlendMode_Add)
{
l9_78=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_79;
...
{
l9_80=dot(l9_69.xyz,vec3(0.33333001))*l9_68;
}
#else
{
float l9_81;
#if (sc_BlendMode_Min)
{
l9_81=1.0-clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_82;
#if (sc_BlendMode_Max)
{
l9_82=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_82=1.0;
...
#endif
l9_70=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_69.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_71);
}
#else
{
vec4 l9_83;
...
#endif
l9_85=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_89,sc_ScreenTextureLayout,l9_90).xy,0.0);
}
#endif
vec4 l9_91;
...
{
vec4 l9_92=l9_85;
l9_92.x=l9_85.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_91=l9_92;
}
#else
{
...
#endif
vec3 l9_93=mix(l9_91.xyz,definedBlend(l9_91.xyz,l9_69.xyz).xyz,vec3(l9_68));
