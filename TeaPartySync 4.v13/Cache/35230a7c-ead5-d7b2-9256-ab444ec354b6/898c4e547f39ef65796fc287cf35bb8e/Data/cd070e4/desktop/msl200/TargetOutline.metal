...
//float lineWeight 4128
//float4 lineColor 4144
//float Port_Input1_N016 4160
//float Port_Input1_N013 4164
//float Port_Input1_N017 4168
//float4 Port_Value1_N015 4176
//float Port_Input1_N024 4192
//float4 Port_Value1_N022 4208
//}
...
float l9_120=0.0;
float l9_121=(*sc_set0.UserUniforms).lineWeight;
l9_120=l9_121;
float l9_122=0.0;
l9_122=float(l9_120<(*sc_set0.UserUniforms).Port_Input1_N016);
param_1=l9_122;
float3 param_4;
if ((param_1*1.0)!=0.0)
{
float3 l9_123=float3(0.0);
l9_123=param_5.VertexNormal_ObjectSpace;
...
float l9_126=dot(param_6,param_6);
float l9_127;
if (l9_126>0.0)
{
...
float param_10=0.0;
float l9_129=0.0;
int l9_130=gl_InstanceIndex;
l9_129=float(l9_130);
float l9_131=0.0;
l9_131=float(l9_129>(*sc_set0.UserUniforms).Port_Input1_N013);
param_8=l9_131;
float param_11;
if ((param_8*1.0)!=0.0)
{
...
{
l9_38.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_39=l9_38;
l9_36=l9_39;
}
...
float3 l9_75=l9_74;
float3 l9_76=l9_75;
float2 l9_77=l9_76.xy;
float l9_78=l9_70;
float4 l9_79=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_77,bias(l9_78));
float4 l9_80=l9_79;
l9_66=l9_80;
float4 l9_81=l9_66;
float4 l9_82=l9_81;
...
{
l9_36.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_84=l9_36;
float4 l9_85=l9_84;
float3 l9_86=l9_85.xyz;
float3 l9_87=l9_86;
float3 l9_88=l9_34.xyz;
float3 l9_89=definedBlend(l9_87,l9_88,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_35=float4(l9_89.x,l9_89.y,l9_89.z,l9_35.w);
float3 l9_90=mix(l9_86,l9_35.xyz,float3(l9_34.w));
l9_35=float4(l9_90.x,l9_90.y,l9_90.z,l9_35.w);
l9_35.w=1.0;
float4 l9_91=l9_35;
param_6=l9_91;
}
...
{
l9_97=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_97=float4(0.0);
