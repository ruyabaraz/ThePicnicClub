...
//}
//ubo int UserUniforms 0:61:6480 {
...
//float3 emissiveFactor 4560
//float3x3 emissiveTextureTransform 4624
//float4 emissiveTextureUvMinMax 4672
//float4 emissiveTextureBorderColor 4688
//float normalTextureScale 4704
//float3x3 normalTextureTransform 4768
//float4 normalTextureUvMinMax 4816
//float4 normalTextureBorderColor 4832
//float metallicFactor 4848
//float roughnessFactor 4852
//float occlusionTextureStrength 4856
//float3x3 metallicRoughnessTextureTransform 4912
//float4 metallicRoughnessTextureUvMinMax 4960
//float4 metallicRoughnessTextureBorderColor 4976
//float transmissionFactor 4992
//float3x3 transmissionTextureTransform 5056
//float4 transmissionTextureUvMinMax 5104
//float4 transmissionTextureBorderColor 5120
//float3x3 screenTextureTransform 5184
//float4 screenTextureUvMinMax 5232
//float4 screenTextureBorderColor 5248
//float3 sheenColorFactor 5264
//float3x3 sheenColorTextureTransform 5328
//float4 sheenColorTextureUvMinMax 5376
//float4 sheenColorTextureBorderColor 5392
//float sheenRoughnessFactor 5408
//float3x3 sheenRoughnessTextureTransform 5472
//float4 sheenRoughnessTextureUvMinMax 5520
//float4 sheenRoughnessTextureBorderColor 5536
//float clearcoatFactor 5552
//float3x3 clearcoatTextureTransform 5616
//float4 clearcoatTextureUvMinMax 5664
//float4 clearcoatTextureBorderColor 5680
//float clearcoatRoughnessFactor 5696
//float3x3 clearcoatRoughnessTextureTransform 5760
//float4 clearcoatRoughnessTextureUvMinMax 5808
//float4 clearcoatRoughnessTextureBorderColor 5824
//float3x3 clearcoatNormalTextureTransform 5888
//float4 clearcoatNormalTextureUvMinMax 5936
//float4 clearcoatNormalTextureBorderColor 5952
//float3x3 baseColorTextureTransform 6016
//float4 baseColorTextureUvMinMax 6064
//float4 baseColorTextureBorderColor 6080
//float4 baseColorFactor 6096
//float2 baseColorTexture_offset 6112
//float2 baseColorTexture_scale 6120
//float baseColorTexture_rotation 6128
//float2 emissiveTexture_offset 6136
//float2 emissiveTexture_scale 6144
//float emissiveTexture_rotation 6152
//float2 normalTexture_offset 6160
//float2 normalTexture_scale 6168
//float normalTexture_rotation 6176
//float2 metallicRoughnessTexture_offset 6184
//float2 metallicRoughnessTexture_scale 6192
//float metallicRoughnessTexture_rotation 6200
//float2 transmissionTexture_offset 6208
//float2 transmissionTexture_scale 6216
//float transmissionTexture_rotation 6224
//float2 sheenColorTexture_offset 6232
//float2 sheenColorTexture_scale 6240
//float sheenColorTexture_rotation 6248
//float2 sheenRoughnessTexture_offset 6256
//float2 sheenRoughnessTexture_scale 6264
//float sheenRoughnessTexture_rotation 6272
//float2 clearcoatTexture_offset 6280
//float2 clearcoatTexture_scale 6288
//float clearcoatTexture_rotation 6296
//float2 clearcoatNormalTexture_offset 6304
//float2 clearcoatNormalTexture_scale 6312
//float clearcoatNormalTexture_rotation 6320
//float2 clearcoatRoughnessTexture_offset 6328
//float2 clearcoatRoughnessTexture_scale 6336
//float clearcoatRoughnessTexture_rotation 6344
//float colorMultiplier 6348
//float Port_Input2_N043 6360
//float Port_Input2_N062 6364
//float3 Port_SpecularAO_N036 6368
//float3 Port_Albedo_N405 6384
//float Port_Opacity_N405 6400
//float3 Port_Emissive_N405 6416
//float Port_Metallic_N405 6432
//float3 Port_SpecularAO_N405 6448
//float depthRef 6464
//}
...
//spec_const bool sc_ProjectiveShadowsCaster 130 0
//spec_const bool sc_ProjectiveShadowsReceiver 131 0
//spec_const bool sc_ProxyAlphaOne 132 0
...
//spec_const int sc_RayTracedAoTextureLayout 208 0
//spec_const int sc_RayTracedDiffIndTextureLayout 209 0
//spec_const int sc_RayTracedReflectionTextureLayout 210 0
//spec_const int sc_RayTracedShadowTextureLayout 211 0
...
//spec_const int screenTextureLayout 218 0
//spec_const int sheenColorTextureLayout 219 0
//spec_const int sheenRoughnessTextureLayout 220 0
//spec_const int transmissionTextureLayout 221 0
//SG_REFLECTION_END
...
constant bool sc_BlendMode_Software [[function_constant(117)]];
constant bool sc_BlendMode_Software_tmp = is_function_constant_defined(sc_BlendMode_Software) ? sc_BlendMode_Software : false;
constant bool sc_DepthOnly [[function_constant(118)]];
constant bool sc_DepthOnly_tmp = is_function_constant_defined(sc_DepthOnly) ? sc_DepthOnly : false;
constant bool sc_EnvmapDiffuseHasSwappedViews [[function_constant(119)]];
constant bool sc_EnvmapDiffuseHasSwappedViews_tmp = is_function_constant_defined(sc_EnvmapDiffuseHasSwappedViews) ? sc_EnvmapDiffuseHasSwappedViews : false;
constant bool sc_EnvmapSpecularHasSwappedViews [[function_constant(120)]];
constant bool sc_EnvmapSpecularHasSwappedViews_tmp = is_function_constant_defined(sc_EnvmapSpecularHasSwappedViews) ? sc_EnvmapSpecularHasSwappedViews : false;
constant bool sc_FramebufferFetch [[function_constant(121)]];
constant bool sc_FramebufferFetch_tmp = is_function_constant_defined(sc_FramebufferFetch) ? sc_FramebufferFetch : false;
constant bool sc_GetFramebufferColorInvalidUsageMarker [[function_constant(122)]];
...
constant bool sc_HasDiffuseEnvmap [[function_constant(123)]];
constant bool sc_HasDiffuseEnvmap_tmp = is_function_constant_defined(sc_HasDiffuseEnvmap) ? sc_HasDiffuseEnvmap : false;
constant bool sc_IsEditor [[function_constant(124)]];
constant bool sc_IsEditor_tmp = is_function_constant_defined(sc_IsEditor) ? sc_IsEditor : false;
constant bool sc_LightEstimation [[function_constant(125)]];
constant bool sc_LightEstimation_tmp = is_function_constant_defined(sc_LightEstimation) ? sc_LightEstimation : false;
constant bool sc_MotionVectorsPass [[function_constant(126)]];
constant bool sc_MotionVectorsPass_tmp = is_function_constant_defined(sc_MotionVectorsPass) ? sc_MotionVectorsPass : false;
constant bool sc_OITCompositingPass [[function_constant(127)]];
constant bool sc_OITCompositingPass_tmp = is_function_constant_defined(sc_OITCompositingPass) ? sc_OITCompositingPass : false;
constant bool sc_OITDepthBoundsPass [[function_constant(128)]];
constant bool sc_OITDepthBoundsPass_tmp = is_function_constant_defined(sc_OITDepthBoundsPass) ? sc_OITDepthBoundsPass : false;
constant bool sc_OITDepthGatherPass [[function_constant(129)]];
constant bool sc_OITDepthGatherPass_tmp = is_function_constant_defined(sc_OITDepthGatherPass) ? sc_OITDepthGatherPass : false;
constant bool sc_ProjectiveShadowsCaster [[function_constant(130)]];
constant bool sc_ProjectiveShadowsCaster_tmp = is_function_constant_defined(sc_ProjectiveShadowsCaster) ? sc_ProjectiveShadowsCaster : false;
constant bool sc_ProjectiveShadowsReceiver [[function_constant(131)]];
constant bool sc_ProjectiveShadowsReceiver_tmp = is_function_constant_defined(sc_ProjectiveShadowsReceiver) ? sc_ProjectiveShadowsReceiver : false;
constant bool sc_ProxyAlphaOne [[function_constant(132)]];
...
constant bool screenTextureHasSwappedViews [[function_constant(145)]];
...
constant bool sheenColorTextureHasSwappedViews [[function_constant(146)]];
...
constant bool sheenRoughnessTextureHasSwappedViews [[function_constant(147)]];
...
constant bool transmissionTextureHasSwappedViews [[function_constant(148)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture [[function_constant(155)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture [[function_constant(156)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture [[function_constant(157)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_emissiveTexture [[function_constant(158)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture [[function_constant(159)]];
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_U_intensityTexture : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture [[function_constant(160)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_normalTexture [[function_constant(161)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_screenTexture [[function_constant(162)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture [[function_constant(163)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture [[function_constant(164)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_transmissionTexture [[function_constant(165)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_baseColorTexture [[function_constant(166)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture [[function_constant(167)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture [[function_constant(168)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture [[function_constant(169)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_emissiveTexture [[function_constant(170)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture [[function_constant(172)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_normalTexture [[function_constant(173)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_screenTexture [[function_constant(174)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture [[function_constant(175)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture [[function_constant(176)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_transmissionTexture [[function_constant(177)]];
...
constant int clearcoatRoughnessTextureLayout [[function_constant(186)]];
...
constant int normalTextureLayout [[function_constant(191)]];
constant int normalTextureLayout_tmp = is_function_constant_defined(normalTextureLayout) ? normalTextureLayout : 0;
constant int sc_AmbientLightMode0 [[function_constant(192)]];
constant int sc_AmbientLightMode0_tmp = is_function_constant_defined(sc_AmbientLightMode0) ? sc_AmbientLightMode0 : 0;
constant int sc_AmbientLightMode1 [[function_constant(193)]];
constant int sc_AmbientLightMode1_tmp = is_function_constant_defined(sc_AmbientLightMode1) ? sc_AmbientLightMode1 : 0;
constant int sc_AmbientLightMode2 [[function_constant(194)]];
constant int sc_AmbientLightMode2_tmp = is_function_constant_defined(sc_AmbientLightMode2) ? sc_AmbientLightMode2 : 0;
constant int sc_AmbientLightMode_Constant [[function_constant(195)]];
constant int sc_AmbientLightMode_Constant_tmp = is_function_constant_defined(sc_AmbientLightMode_Constant) ? sc_AmbientLightMode_Constant : 0;
constant int sc_AmbientLightMode_EnvironmentMap [[function_constant(196)]];
constant int sc_AmbientLightMode_EnvironmentMap_tmp = is_function_constant_defined(sc_AmbientLightMode_EnvironmentMap) ? sc_AmbientLightMode_EnvironmentMap : 0;
constant int sc_AmbientLightMode_FromCamera [[function_constant(197)]];
constant int sc_AmbientLightMode_FromCamera_tmp = is_function_constant_defined(sc_AmbientLightMode_FromCamera) ? sc_AmbientLightMode_FromCamera : 0;
constant int sc_AmbientLightMode_SphericalHarmonics [[function_constant(198)]];
constant int sc_AmbientLightMode_SphericalHarmonics_tmp = is_function_constant_defined(sc_AmbientLightMode_SphericalHarmonics) ? sc_AmbientLightMode_SphericalHarmonics : 0;
constant int sc_AmbientLightsCount [[function_constant(199)]];
constant int sc_AmbientLightsCount_tmp = is_function_constant_defined(sc_AmbientLightsCount) ? sc_AmbientLightsCount : 0;
constant int sc_DepthBufferMode [[function_constant(200)]];
constant int sc_DepthBufferMode_tmp = is_function_constant_defined(sc_DepthBufferMode) ? sc_DepthBufferMode : 0;
constant int sc_DirectionalLightsCount [[function_constant(201)]];
constant int sc_DirectionalLightsCount_tmp = is_function_constant_defined(sc_DirectionalLightsCount) ? sc_DirectionalLightsCount : 0;
constant int sc_EnvLightMode [[function_constant(202)]];
constant int sc_EnvLightMode_tmp = is_function_constant_defined(sc_EnvLightMode) ? sc_EnvLightMode : 0;
constant int sc_EnvmapDiffuseLayout [[function_constant(203)]];
constant int sc_EnvmapDiffuseLayout_tmp = is_function_constant_defined(sc_EnvmapDiffuseLayout) ? sc_EnvmapDiffuseLayout : 0;
constant int sc_EnvmapSpecularLayout [[function_constant(204)]];
constant int sc_EnvmapSpecularLayout_tmp = is_function_constant_defined(sc_EnvmapSpecularLayout) ? sc_EnvmapSpecularLayout : 0;
constant int sc_LightEstimationSGCount [[function_constant(205)]];
constant int sc_LightEstimationSGCount_tmp = is_function_constant_defined(sc_LightEstimationSGCount) ? sc_LightEstimationSGCount : 0;
constant int sc_MaxTextureImageUnits [[function_constant(206)]];
constant int sc_MaxTextureImageUnits_tmp = is_function_constant_defined(sc_MaxTextureImageUnits) ? sc_MaxTextureImageUnits : 0;
constant int sc_PointLightsCount [[function_constant(207)]];
constant int sc_PointLightsCount_tmp = is_function_constant_defined(sc_PointLightsCount) ? sc_PointLightsCount : 0;
constant int sc_RayTracedAoTextureLayout [[function_constant(208)]];
...
constant int sc_RayTracedDiffIndTextureLayout [[function_constant(209)]];
...
constant int sc_RayTracedReflectionTextureLayout [[function_constant(210)]];
...
constant int sc_RayTracedShadowTextureLayout [[function_constant(211)]];
...
constant int sc_RenderingSpace [[function_constant(212)]];
constant int sc_RenderingSpace_tmp = is_function_constant_defined(sc_RenderingSpace) ? sc_RenderingSpace : -1;
constant int sc_ScreenTextureLayout [[function_constant(213)]];
constant int sc_ScreenTextureLayout_tmp = is_function_constant_defined(sc_ScreenTextureLayout) ? sc_ScreenTextureLayout : 0;
constant int sc_ShaderCacheConstant [[function_constant(214)]];
constant int sc_ShaderCacheConstant_tmp = is_function_constant_defined(sc_ShaderCacheConstant) ? sc_ShaderCacheConstant : 0;
constant int sc_SkinBonesCount [[function_constant(215)]];
constant int sc_SkinBonesCount_tmp = is_function_constant_defined(sc_SkinBonesCount) ? sc_SkinBonesCount : 0;
constant int sc_StereoRenderingMode [[function_constant(216)]];
constant int sc_StereoRenderingMode_tmp = is_function_constant_defined(sc_StereoRenderingMode) ? sc_StereoRenderingMode : 0;
constant int sc_StereoRendering_IsClipDistanceEnabled [[function_constant(217)]];
constant int sc_StereoRendering_IsClipDistanceEnabled_tmp = is_function_constant_defined(sc_StereoRendering_IsClipDistanceEnabled) ? sc_StereoRendering_IsClipDistanceEnabled : 0;
constant int screenTextureLayout [[function_constant(218)]];
constant int screenTextureLayout_tmp = is_function_constant_defined(screenTextureLayout) ? screenTextureLayout : 0;
constant int sheenColorTextureLayout [[function_constant(219)]];
constant int sheenColorTextureLayout_tmp = is_function_constant_defined(sheenColorTextureLayout) ? sheenColorTextureLayout : 0;
constant int sheenRoughnessTextureLayout [[function_constant(220)]];
...
constant int transmissionTextureLayout [[function_constant(221)]];
...
float3 l9_22=(*sc_set0.UserUniforms).emissiveFactor;
l9_21=l9_22;
float l9_23=0.0;
float l9_24=1.0;
float l9_25=(*sc_set0.UserUniforms).Port_Input2_N043;
float l9_26;
if ((int(ENABLE_NORMALMAP_tmp)!=0))
{
float l9_27=0.0;
float l9_28=(*sc_set0.UserUniforms).normalTextureScale;
l9_27=l9_28;
l9_24=l9_27;
l9_26=l9_24;
}
...
l9_23=l9_26;
float l9_29=0.0;
float l9_30=(*sc_set0.UserUniforms).metallicFactor;
l9_29=l9_30;
float l9_31=0.0;
float l9_32=(*sc_set0.UserUniforms).roughnessFactor;
l9_31=l9_32;
float l9_33=0.0;
float l9_34=1.0;
float l9_35=(*sc_set0.UserUniforms).Port_Input2_N062;
float l9_36;
if ((int(ENABLE_METALLIC_ROUGHNESS_TEX_tmp)!=0))
{
float l9_37=0.0;
float l9_38=(*sc_set0.UserUniforms).occlusionTextureStrength;
l9_37=l9_38;
l9_34=l9_37;
l9_36=l9_34;
}
...
l9_33=l9_36;
float l9_39=0.0;
float l9_40=(*sc_set0.UserUniforms).transmissionFactor;
l9_39=l9_40;
float3 l9_41=float3(0.0);
float3 l9_42=(*sc_set0.UserUniforms).sheenColorFactor;
l9_41=l9_42;
float l9_43=0.0;
float l9_44=(*sc_set0.UserUniforms).sheenRoughnessFactor;
l9_43=l9_44;
float l9_45=0.0;
float l9_46=(*sc_set0.UserUniforms).clearcoatFactor;
l9_45=l9_46;
float l9_47=0.0;
float l9_48=(*sc_set0.UserUniforms).clearcoatRoughnessFactor;
l9_47=l9_48;
float4 l9_49=float4(0.0);
float4 l9_50=(*sc_set0.UserUniforms).baseColorFactor;
l9_49=l9_50;
float2 l9_51=float2(0.0);
float2 l9_52=(*sc_set0.UserUniforms).baseColorTexture_offset;
l9_51=l9_52;
float2 l9_53=float2(0.0);
float2 l9_54=(*sc_set0.UserUniforms).baseColorTexture_scale;
l9_53=l9_54;
float l9_55=0.0;
float l9_56=(*sc_set0.UserUniforms).baseColorTexture_rotation;
l9_55=l9_56;
...
N35_BaseTextureOffset=l9_60;
N35_BaseTextureScale=l9_61;
N35_BaseTextureRotation=l9_62;
float4 l9_66=N35_BaseColorFactor;
if (N35_EnableBaseTexture)
{
int l9_67=N35_BaseColorTextureCoord;
float2 l9_68=tempGlobals.Surface_UVCoord0;
float2 l9_69=l9_68;
if (l9_67==0)
{
...
if (l9_67==1)
{
float2 l9_71=tempGlobals.Surface_UVCoord1;
l9_69=l9_71;
}
float2 l9_72=l9_69;
float2 l9_73=l9_72;
...
{
float2 l9_74=l9_73;
float2 l9_75=N35_BaseTextureOffset;
float2 l9_76=N35_BaseTextureScale;
float l9_77=N35_BaseTextureRotation;
float3x3 l9_78=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_75.x,l9_75.y,1.0));
float3x3 l9_79=float3x3(float3(cos(l9_77),sin(l9_77),0.0),float3(-sin(l9_77),cos(l9_77),0.0),float3(0.0,0.0,1.0));
float3x3 l9_80=float3x3(float3(l9_76.x,0.0,0.0),float3(0.0,l9_76.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_81=(l9_78*l9_79)*l9_80;
float2 l9_82=(l9_81*float3(l9_74,1.0)).xy;
l9_73=l9_82;
}
float2 l9_83=l9_73;
...
int l9_90=l9_85;
int l9_91=baseColorTextureLayout_tmp;
int l9_92=l9_90;
float2 l9_93=l9_83;
bool l9_94=(int(SC_USE_UV_TRANSFORM_baseColorTexture_tmp)!=0);
float3x3 l9_95=(*sc_set0.UserUniforms).baseColorTextureTransform;
int2 l9_96=int2(SC_SOFTWARE_WRAP_MODE_U_baseColorTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_baseColorTexture_tmp);
bool l9_97=(int(SC_USE_UV_MIN_MAX_baseColorTexture_tmp)!=0);
float4 l9_98=(*sc_set0.UserUniforms).baseColorTextureUvMinMax;
bool l9_99=(int(SC_USE_CLAMP_TO_BORDER_baseColorTexture_tmp)!=0);
float4 l9_100=(*sc_set0.UserUniforms).baseColorTextureBorderColor;
float l9_101=0.0;
...
float2 l9_170=l9_169.xy;
float l9_171=l9_163;
float4 l9_172=sc_set0.baseColorTexture.sample(sc_set0.baseColorTextureSmpSC,l9_170,bias(l9_171));
float4 l9_173=l9_172;
float4 l9_174=l9_173;
if (l9_99)
{
l9_174=mix(l9_100,l9_174,float4(l9_103));
}
...
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_178=float4(pow(l9_177.x,2.2),pow(l9_177.y,2.2),pow(l9_177.z,2.2),pow(l9_177.w,2.2));
}
else
{
l9_178=l9_177*l9_177;
}
...
{
float4 l9_180=tempGlobals.VertexColor;
l9_66*=l9_180;
}
N35_BaseColor=l9_66.xyz;
N35_Opacity=l9_66.w;
float4 l9_181=l9_66;
float4 l9_182;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_182=float4(pow(l9_181.x,0.45454544),pow(l9_181.y,0.45454544),pow(l9_181.z,0.45454544),pow(l9_181.w,0.45454544));
}
else
{
l9_182=sqrt(l9_181);
...
N35_UnlitColor=l9_183;
l9_64=N35_BaseColor;
l9_65=N35_Opacity;
l9_57=l9_64;
l9_58=l9_65;
float2 l9_184=float2(0.0);
float2 l9_185=(*sc_set0.UserUniforms).emissiveTexture_offset;
l9_184=l9_185;
float2 l9_186=float2(0.0);
float2 l9_187=(*sc_set0.UserUniforms).emissiveTexture_scale;
l9_186=l9_187;
float l9_188=0.0;
float l9_189=(*sc_set0.UserUniforms).emissiveTexture_rotation;
l9_188=l9_189;
float2 l9_190=float2(0.0);
float2 l9_191=(*sc_set0.UserUniforms).normalTexture_offset;
l9_190=l9_191;
float2 l9_192=float2(0.0);
float2 l9_193=(*sc_set0.UserUniforms).normalTexture_scale;
l9_192=l9_193;
float l9_194=0.0;
float l9_195=(*sc_set0.UserUniforms).normalTexture_rotation;
l9_194=l9_195;
float2 l9_196=float2(0.0);
float2 l9_197=(*sc_set0.UserUniforms).metallicRoughnessTexture_offset;
l9_196=l9_197;
float2 l9_198=float2(0.0);
float2 l9_199=(*sc_set0.UserUniforms).metallicRoughnessTexture_scale;
l9_198=l9_199;
float l9_200=0.0;
float l9_201=(*sc_set0.UserUniforms).metallicRoughnessTexture_rotation;
l9_200=l9_201;
float2 l9_202=float2(0.0);
float2 l9_203=(*sc_set0.UserUniforms).transmissionTexture_offset;
l9_202=l9_203;
float2 l9_204=float2(0.0);
float2 l9_205=(*sc_set0.UserUniforms).transmissionTexture_scale;
l9_204=l9_205;
float l9_206=0.0;
float l9_207=(*sc_set0.UserUniforms).transmissionTexture_rotation;
l9_206=l9_207;
float2 l9_208=float2(0.0);
float2 l9_209=(*sc_set0.UserUniforms).sheenColorTexture_offset;
l9_208=l9_209;
float2 l9_210=float2(0.0);
float2 l9_211=(*sc_set0.UserUniforms).sheenColorTexture_scale;
l9_210=l9_211;
float l9_212=0.0;
float l9_213=(*sc_set0.UserUniforms).sheenColorTexture_rotation;
l9_212=l9_213;
float2 l9_214=float2(0.0);
float2 l9_215=(*sc_set0.UserUniforms).sheenRoughnessTexture_offset;
l9_214=l9_215;
float2 l9_216=float2(0.0);
float2 l9_217=(*sc_set0.UserUniforms).sheenRoughnessTexture_scale;
l9_216=l9_217;
float l9_218=0.0;
float l9_219=(*sc_set0.UserUniforms).sheenRoughnessTexture_rotation;
l9_218=l9_219;
float2 l9_220=float2(0.0);
float2 l9_221=(*sc_set0.UserUniforms).clearcoatTexture_offset;
l9_220=l9_221;
float2 l9_222=float2(0.0);
float2 l9_223=(*sc_set0.UserUniforms).clearcoatTexture_scale;
l9_222=l9_223;
float l9_224=0.0;
float l9_225=(*sc_set0.UserUniforms).clearcoatTexture_rotation;
l9_224=l9_225;
float2 l9_226=float2(0.0);
float2 l9_227=(*sc_set0.UserUniforms).clearcoatNormalTexture_offset;
l9_226=l9_227;
float2 l9_228=float2(0.0);
float2 l9_229=(*sc_set0.UserUniforms).clearcoatNormalTexture_scale;
l9_228=l9_229;
float l9_230=0.0;
float l9_231=(*sc_set0.UserUniforms).clearcoatNormalTexture_rotation;
l9_230=l9_231;
float2 l9_232=float2(0.0);
float2 l9_233=(*sc_set0.UserUniforms).clearcoatRoughnessTexture_offset;
l9_232=l9_233;
float2 l9_234=float2(0.0);
float2 l9_235=(*sc_set0.UserUniforms).clearcoatRoughnessTexture_scale;
l9_234=l9_235;
float l9_236=0.0;
float l9_237=(*sc_set0.UserUniforms).clearcoatRoughnessTexture_rotation;
l9_236=l9_237;
...
float3 l9_260=l9_57;
float l9_261=l9_58;
float2 l9_262=l9_184;
float2 l9_263=l9_186;
float l9_264=l9_188;
float2 l9_265=l9_190;
float2 l9_266=l9_192;
float l9_267=l9_194;
float2 l9_268=l9_196;
float2 l9_269=l9_198;
float l9_270=l9_200;
float2 l9_271=l9_202;
float2 l9_272=l9_204;
float l9_273=l9_206;
float2 l9_274=l9_208;
float2 l9_275=l9_210;
float l9_276=l9_212;
float2 l9_277=l9_214;
float2 l9_278=l9_216;
float l9_279=l9_218;
float2 l9_280=l9_220;
float2 l9_281=l9_222;
float l9_282=l9_224;
float2 l9_283=l9_226;
float2 l9_284=l9_228;
float l9_285=l9_230;
float2 l9_286=l9_232;
float2 l9_287=l9_234;
float l9_288=l9_236;
ssGlobals l9_289=param_3;
tempGlobals=l9_289;
...
N3_EmissiveTextureOffset=l9_262;
N3_EmissiveTextureScale=l9_263;
N3_EmissiveTextureRotation=l9_264;
N3_NormalTextureTransform=(int(ENABLE_NORMAL_TEXTURE_TRANSFORM_tmp)!=0);
N3_NormalTextureOffset=l9_265;
N3_NormalTextureScale=l9_266;
N3_NormalTextureRotation=l9_267;
N3_MaterialParamsTextureTransform=(int(ENABLE_METALLIC_ROUGHNESS_TEXTURE_TRANSFORM_tmp)!=0);
N3_MaterialParamsTextureOffset=l9_268;
N3_MaterialParamsTextureScale=l9_269;
N3_MaterialParamsTextureRotation=l9_270;
N3_TransmissionTextureTransform=(int(ENABLE_TRANSMISSION_TEXTURE_TRANSFORM_tmp)!=0);
N3_TransmissionTextureOffset=l9_271;
N3_TransmissionTextureScale=l9_272;
N3_TransmissionTextureRotation=l9_273;
N3_SheenColorTextureTransform=(int(ENABLE_SHEEN_COLOR_TEXTURE_TRANSFORM_tmp)!=0);
N3_SheenColorTextureOffset=l9_274;
N3_SheenColorTextureScale=l9_275;
N3_SheenColorTextureRotation=l9_276;
N3_SheenRoughnessTextureTransform=(int(ENABLE_SHEEN_ROUGHNESS_TEXTURE_TRANSFORM_tmp)!=0);
N3_SheenRoughnessTextureOffset=l9_277;
N3_SheenRoughnessTextureScale=l9_278;
N3_SheenRoughnessTextureRotation=l9_279;
N3_ClearcoatTextureTransform=(int(ENABLE_CLEARCOAT_TEXTURE_TRANSFORM_tmp)!=0);
N3_ClearcoatTextureOffset=l9_280;
N3_ClearcoatTextureScale=l9_281;
N3_ClearcoatTextureRotation=l9_282;
N3_ClearcoatNormalTextureTransform=(int(ENABLE_CLEARCOAT_NORMAL_TEXTURE_TRANSFORM_tmp)!=0);
N3_ClearcoatNormalTextureOffset=l9_283;
N3_ClearcoatNormalTextureScale=l9_284;
N3_ClearcoatNormalTextureRotation=l9_285;
N3_ClearcoatRoughnessTextureTransform=(int(ENABLE_CLEARCOAT_ROUGHNESS_TEXTURE_TRANSFORM_tmp)!=0);
N3_ClearcoatRoughnessTextureOffset=l9_286;
N3_ClearcoatRoughnessTextureScale=l9_287;
N3_ClearcoatRoughnessTextureRotation=l9_288;
N3_BaseColor=N3_BaseColorIn;
N3_Opacity=N3_OpacityIn;
N3_Emissive=N3_EmissiveColor;
if (N3_EnableEmissiveTexture)
{
float3 l9_302=N3_Emissive;
int l9_303=N3_EmissiveTextureCoord;
float2 l9_304=tempGlobals.Surface_UVCoord0;
...
if (l9_303==1)
{
float2 l9_307=tempGlobals.Surface_UVCoord1;
l9_305=l9_307;
}
...
float2 l9_311=N3_EmissiveTextureOffset;
float2 l9_312=N3_EmissiveTextureScale;
float l9_313=N3_EmissiveTextureRotation;
float l9_314=radians(l9_313);
float3x3 l9_315=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_311.x,l9_311.y,1.0));
float3x3 l9_316=float3x3(float3(cos(l9_314),sin(l9_314),0.0),float3(-sin(l9_314),cos(l9_314),0.0),float3(0.0,0.0,1.0));
float3x3 l9_317=float3x3(float3(l9_312.x,0.0,0.0),float3(0.0,l9_312.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_318=(l9_315*l9_316)*l9_317;
float2 l9_319=(l9_318*float3(l9_310,1.0)).xy;
l9_309=l9_319;
}
float2 l9_320=l9_309;
...
int l9_327=l9_322;
int l9_328=emissiveTextureLayout_tmp;
int l9_329=l9_327;
float2 l9_330=l9_320;
bool l9_331=(int(SC_USE_UV_TRANSFORM_emissiveTexture_tmp)!=0);
float3x3 l9_332=(*sc_set0.UserUniforms).emissiveTextureTransform;
int2 l9_333=int2(SC_SOFTWARE_WRAP_MODE_U_emissiveTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_emissiveTexture_tmp);
bool l9_334=(int(SC_USE_UV_MIN_MAX_emissiveTexture_tmp)!=0);
float4 l9_335=(*sc_set0.UserUniforms).emissiveTextureUvMinMax;
bool l9_336=(int(SC_USE_CLAMP_TO_BORDER_emissiveTexture_tmp)!=0);
float4 l9_337=(*sc_set0.UserUniforms).emissiveTextureBorderColor;
float l9_338=0.0;
...
float l9_408=l9_400;
float4 l9_409=sc_set0.emissiveTexture.sample(sc_set0.emissiveTextureSmpSC,l9_407,bias(l9_408));
...
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_415=float3(pow(l9_414.x,2.2),pow(l9_414.y,2.2),pow(l9_414.z,2.2));
}
else
{
l9_415=l9_414*l9_414;
}
float3 l9_416=l9_415;
float3 l9_417=l9_416;
float3 l9_418=l9_302;
float3 l9_419;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_419=float3(pow(l9_418.x,2.2),pow(l9_418.y,2.2),pow(l9_418.z,2.2));
}
else
{
l9_419=l9_418*l9_418;
}
float3 l9_420=l9_419;
l9_302=l9_417*l9_420;
N3_Emissive=l9_302;
}
float3 l9_421=tempGlobals.VertexNormal_WorldSpace;
N3_Normal=normalize(l9_421);
if (N3_EnableNormalTexture)
{
float3 l9_422=N3_Normal;
int l9_423=N3_NormalTextureCoord;
float2 l9_424=tempGlobals.Surface_UVCoord0;
float2 l9_425=l9_424;
if (l9_423==0)
{
...
if (l9_423==1)
{
float2 l9_427=tempGlobals.Surface_UVCoord1;
l9_425=l9_427;
}
...
float2 l9_431=N3_NormalTextureOffset;
float2 l9_432=N3_NormalTextureScale;
float l9_433=N3_NormalTextureRotation;
float l9_434=radians(l9_433);
float3x3 l9_435=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_431.x,l9_431.y,1.0));
float3x3 l9_436=float3x3(float3(cos(l9_434),sin(l9_434),0.0),float3(-sin(l9_434),cos(l9_434),0.0),float3(0.0,0.0,1.0));
float3x3 l9_437=float3x3(float3(l9_432.x,0.0,0.0),float3(0.0,l9_432.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_438=(l9_435*l9_436)*l9_437;
float2 l9_439=(l9_438*float3(l9_430,1.0)).xy;
l9_429=l9_439;
}
float2 l9_440=l9_429;
...
int l9_447=l9_442;
int l9_448=normalTextureLayout_tmp;
int l9_449=l9_447;
float2 l9_450=l9_440;
bool l9_451=(int(SC_USE_UV_TRANSFORM_normalTexture_tmp)!=0);
float3x3 l9_452=(*sc_set0.UserUniforms).normalTextureTransform;
int2 l9_453=int2(SC_SOFTWARE_WRAP_MODE_U_normalTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTexture_tmp);
bool l9_454=(int(SC_USE_UV_MIN_MAX_normalTexture_tmp)!=0);
float4 l9_455=(*sc_set0.UserUniforms).normalTextureUvMinMax;
bool l9_456=(int(SC_USE_CLAMP_TO_BORDER_normalTexture_tmp)!=0);
float4 l9_457=(*sc_set0.UserUniforms).normalTextureBorderColor;
float l9_458=0.0;
bool l9_459=l9_456&&(!l9_454);
float l9_460=1.0;
float l9_461=l9_450.x;
int l9_462=l9_453.x;
if (l9_462==1)
{
l9_461=fract(l9_461);
...
if (l9_467==2)
{
float l9_468=fract(l9_466);
float l9_469=l9_466-l9_468;
float l9_470=step(0.25,fract(l9_469*0.5));
l9_466=mix(l9_468,1.0-l9_468,fast::clamp(l9_470,0.0,1.0));
}
}
l9_450.y=l9_466;
if (l9_454)
...
float l9_473=l9_450.x;
float l9_474=l9_455.x;
float l9_475=l9_455.z;
bool l9_476=l9_472;
float l9_477=l9_460;
...
float l9_482=l9_450.y;
float l9_483=l9_455.y;
float l9_484=l9_455.w;
bool l9_485=l9_481;
float l9_486=l9_460;
...
float2 l9_489=l9_450;
bool l9_490=l9_451;
float3x3 l9_491=l9_452;
if (l9_490)
{
l9_489=float2((l9_491*float3(l9_489,1.0)).xy);
}
float2 l9_492=l9_489;
float2 l9_493=l9_492;
float2 l9_494=l9_493;
l9_450=l9_494;
float l9_495=l9_450.x;
int l9_496=l9_453.x;
bool l9_497=l9_459;
float l9_498=l9_460;
...
float2 l9_527=l9_526.xy;
float l9_528=l9_520;
float4 l9_529=sc_set0.normalTexture.sample(sc_set0.normalTextureSmpSC,l9_527,bias(l9_528));
float4 l9_530=l9_529;
float4 l9_531=l9_530;
if (l9_456)
{
l9_531=mix(l9_457,l9_531,float4(l9_460));
}
float4 l9_532=l9_531;
l9_441=l9_532;
float4 l9_533=l9_441;
float3 l9_534=(l9_533.xyz*1.9921875)-float3(1.0);
l9_534=mix(float3(0.0,0.0,1.0),l9_534,float3(N3_NormalScale));
float3 l9_535=tempGlobals.VertexTangent_WorldSpace;
float3 l9_536=l9_535;
float3 l9_537=tempGlobals.VertexBinormal_WorldSpace;
float3 l9_538=l9_537;
float3x3 l9_539=float3x3(float3(l9_536),float3(l9_538),float3(l9_422));
l9_422=normalize(l9_539*l9_534);
N3_Normal=l9_422;
}
...
{
float l9_540=N3_Metallic;
float l9_541=N3_Roughness;
float4 l9_542=N3_Occlusion;
int l9_543=N3_MaterialParamsTextureCoord;
float2 l9_544=tempGlobals.Surface_UVCoord0;
float2 l9_545=l9_544;
if (l9_543==0)
{
...
if (l9_543==1)
{
float2 l9_547=tempGlobals.Surface_UVCoord1;
l9_545=l9_547;
}
...
float2 l9_551=N3_MaterialParamsTextureOffset;
float2 l9_552=N3_MaterialParamsTextureScale;
float l9_553=N3_MaterialParamsTextureRotation;
float l9_554=radians(l9_553);
float3x3 l9_555=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_551.x,l9_551.y,1.0));
float3x3 l9_556=float3x3(float3(cos(l9_554),sin(l9_554),0.0),float3(-sin(l9_554),cos(l9_554),0.0),float3(0.0,0.0,1.0));
float3x3 l9_557=float3x3(float3(l9_552.x,0.0,0.0),float3(0.0,l9_552.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_558=(l9_555*l9_556)*l9_557;
float2 l9_559=(l9_558*float3(l9_550,1.0)).xy;
l9_549=l9_559;
}
float2 l9_560=l9_549;
...
int l9_567=l9_562;
int l9_568=metallicRoughnessTextureLayout_tmp;
int l9_569=l9_567;
float2 l9_570=l9_560;
bool l9_571=(int(SC_USE_UV_TRANSFORM_metallicRoughnessTexture_tmp)!=0);
float3x3 l9_572=(*sc_set0.UserUniforms).metallicRoughnessTextureTransform;
int2 l9_573=int2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture_tmp);
bool l9_574=(int(SC_USE_UV_MIN_MAX_metallicRoughnessTexture_tmp)!=0);
float4 l9_575=(*sc_set0.UserUniforms).metallicRoughnessTextureUvMinMax;
bool l9_576=(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture_tmp)!=0);
float4 l9_577=(*sc_set0.UserUniforms).metallicRoughnessTextureBorderColor;
float l9_578=0.0;
bool l9_579=l9_576&&(!l9_574);
float l9_580=1.0;
float l9_581=l9_570.x;
int l9_582=l9_573.x;
if (l9_582==1)
{
l9_581=fract(l9_581);
...
float l9_593=l9_570.x;
float l9_594=l9_575.x;
float l9_595=l9_575.z;
bool l9_596=l9_592;
float l9_597=l9_580;
...
float l9_602=l9_570.y;
float l9_603=l9_575.y;
float l9_604=l9_575.w;
bool l9_605=l9_601;
float l9_606=l9_580;
...
float2 l9_609=l9_570;
bool l9_610=l9_571;
float3x3 l9_611=l9_572;
if (l9_610)
{
l9_609=float2((l9_611*float3(l9_609,1.0)).xy);
}
float2 l9_612=l9_609;
float2 l9_613=l9_612;
float2 l9_614=l9_613;
l9_570=l9_614;
float l9_615=l9_570.x;
int l9_616=l9_573.x;
bool l9_617=l9_579;
float l9_618=l9_580;
...
float l9_648=l9_640;
float4 l9_649=sc_set0.metallicRoughnessTexture.sample(sc_set0.metallicRoughnessTextureSmpSC,l9_647,bias(l9_648));
float4 l9_650=l9_649;
float4 l9_651=l9_650;
if (l9_576)
{
l9_651=mix(l9_577,l9_651,float4(l9_580));
}
float4 l9_652=l9_651;
l9_561=l9_652;
float4 l9_653=l9_561;
float3 l9_654=l9_653.xyz;
l9_540*=l9_654.x;
l9_541*=l9_654.y;
l9_542.w=N3_OcclusionStrength;
float3 l9_655=float3(1.0+(l9_542.w*(l9_654.z-1.0)));
l9_542=float4(l9_655.x,l9_655.y,l9_655.z,l9_542.w);
N3_Metallic=l9_540;
N3_Roughness=l9_541;
N3_Occlusion=l9_542;
}
...
{
float3 l9_656=N3_BaseColor;
float3 l9_657=N3_Emissive;
float l9_658=N3_Metallic;
float2 l9_659=tempGlobals.gScreenCoord;
float2 l9_660=l9_659;
float4 l9_661=float4(0.0);
int l9_662=0;
...
int l9_667=l9_662;
int l9_668=screenTextureLayout_tmp;
int l9_669=l9_667;
float2 l9_670=l9_660;
bool l9_671=(int(SC_USE_UV_TRANSFORM_screenTexture_tmp)!=0);
float3x3 l9_672=(*sc_set0.UserUniforms).screenTextureTransform;
int2 l9_673=int2(SC_SOFTWARE_WRAP_MODE_U_screenTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTexture_tmp);
bool l9_674=(int(SC_USE_UV_MIN_MAX_screenTexture_tmp)!=0);
float4 l9_675=(*sc_set0.UserUniforms).screenTextureUvMinMax;
bool l9_676=(int(SC_USE_CLAMP_TO_BORDER_screenTexture_tmp)!=0);
float4 l9_677=(*sc_set0.UserUniforms).screenTextureBorderColor;
float l9_678=0.0;
bool l9_679=l9_676&&(!l9_674);
float l9_680=1.0;
float l9_681=l9_670.x;
int l9_682=l9_673.x;
if (l9_682==1)
{
l9_681=fract(l9_681);
...
float l9_693=l9_670.x;
float l9_694=l9_675.x;
float l9_695=l9_675.z;
bool l9_696=l9_692;
float l9_697=l9_680;
...
float l9_702=l9_670.y;
float l9_703=l9_675.y;
float l9_704=l9_675.w;
bool l9_705=l9_701;
float l9_706=l9_680;
...
float2 l9_709=l9_670;
bool l9_710=l9_671;
float3x3 l9_711=l9_672;
if (l9_710)
{
l9_709=float2((l9_711*float3(l9_709,1.0)).xy);
}
float2 l9_712=l9_709;
float2 l9_713=l9_712;
float2 l9_714=l9_713;
l9_670=l9_714;
float l9_715=l9_670.x;
int l9_716=l9_673.x;
bool l9_717=l9_679;
float l9_718=l9_680;
...
float l9_748=l9_740;
float4 l9_749=sc_set0.screenTexture.sample(sc_set0.screenTextureSmpSC,l9_747,bias(l9_748));
float4 l9_750=l9_749;
float4 l9_751=l9_750;
if (l9_676)
{
l9_751=mix(l9_677,l9_751,float4(l9_680));
}
float4 l9_752=l9_751;
l9_661=l9_752;
float4 l9_753=l9_661;
float3 l9_754=l9_753.xyz;
float3 l9_755;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_755=float3(pow(l9_754.x,2.2),pow(l9_754.y,2.2),pow(l9_754.z,2.2));
}
else
{
l9_755=l9_754*l9_754;
}
float3 l9_756=l9_755;
N3_Background=l9_756;
float l9_757=1.0;
if (N3_EnableTransmissionTexture)
{
int l9_758=N3_TransmissionTextureCoord;
float2 l9_759=tempGlobals.Surface_UVCoord0;
float2 l9_760=l9_759;
if (l9_758==0)
{
...
if (l9_758==1)
{
float2 l9_762=tempGlobals.Surface_UVCoord1;
l9_760=l9_762;
}
...
float2 l9_766=N3_TransmissionTextureOffset;
float2 l9_767=N3_TransmissionTextureScale;
float l9_768=N3_TransmissionTextureRotation;
float l9_769=radians(l9_768);
float3x3 l9_770=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_766.x,l9_766.y,1.0));
float3x3 l9_771=float3x3(float3(cos(l9_769),sin(l9_769),0.0),float3(-sin(l9_769),cos(l9_769),0.0),float3(0.0,0.0,1.0));
float3x3 l9_772=float3x3(float3(l9_767.x,0.0,0.0),float3(0.0,l9_767.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_773=(l9_770*l9_771)*l9_772;
float2 l9_774=(l9_773*float3(l9_765,1.0)).xy;
l9_764=l9_774;
}
float2 l9_775=l9_764;
...
int l9_782=l9_777;
int l9_783=transmissionTextureLayout_tmp;
int l9_784=l9_782;
float2 l9_785=l9_775;
bool l9_786=(int(SC_USE_UV_TRANSFORM_transmissionTexture_tmp)!=0);
float3x3 l9_787=(*sc_set0.UserUniforms).transmissionTextureTransform;
int2 l9_788=int2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture_tmp);
bool l9_789=(int(SC_USE_UV_MIN_MAX_transmissionTexture_tmp)!=0);
float4 l9_790=(*sc_set0.UserUniforms).transmissionTextureUvMinMax;
bool l9_791=(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture_tmp)!=0);
float4 l9_792=(*sc_set0.UserUniforms).transmissionTextureBorderColor;
float l9_793=0.0;
...
float l9_863=l9_855;
float4 l9_864=sc_set0.transmissionTexture.sample(sc_set0.transmissionTextureSmpSC,l9_862,bias(l9_863));
float4 l9_865=l9_864;
float4 l9_866=l9_865;
if (l9_791)
{
l9_866=mix(l9_792,l9_866,float4(l9_795));
}
float4 l9_867=l9_866;
l9_776=l9_867;
float4 l9_868=l9_776;
l9_757=l9_868.x;
}
l9_757*=N3_TransmissionFactor;
float3 l9_869=l9_656;
l9_656=mix(l9_869,float3(0.0),float3(l9_757));
l9_656=mix(l9_656,l9_869,float3(l9_658));
float3 l9_870=l9_657;
l9_657=mix(float3(0.0),l9_869,float3(l9_757))*N3_Background;
l9_657=mix(l9_657,float3(0.0),float3(l9_658))+l9_870;
N3_BaseColor=l9_656;
N3_Emissive=l9_657;
}
float3 l9_871=N3_BaseColor;
float3 l9_872;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_872=float3(pow(l9_871.x,0.45454544),pow(l9_871.y,0.45454544),pow(l9_871.z,0.45454544));
}
else
{
l9_872=sqrt(l9_871);
...
N3_BaseColor=l9_873;
float l9_874=N3_Opacity;
float l9_875;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_875=pow(l9_874,0.45454544);
}
else
{
l9_875=sqrt(l9_874);
...
float l9_876=l9_875;
N3_Opacity=l9_876;
float3 l9_877=N3_Emissive;
float3 l9_878;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_878=float3(pow(l9_877.x,0.45454544),pow(l9_877.y,0.45454544),pow(l9_877.z,0.45454544));
}
else
{
l9_878=sqrt(l9_877);
...
if (N3_SheenEnable)
{
float3 l9_880=N3_Normal;
float4 l9_881=N3_Occlusion;
float3 l9_882=N3_SheenColorFactor;
float l9_883=N3_SheenRoughnessFactor;
if (N3_EnableSheenTexture)
{
int l9_884=N3_SheenColorTextureCoord;
float2 l9_885=tempGlobals.Surface_UVCoord0;
...
if (l9_884==1)
{
float2 l9_888=tempGlobals.Surface_UVCoord1;
l9_886=l9_888;
}
...
float2 l9_892=N3_SheenColorTextureOffset;
float2 l9_893=N3_SheenColorTextureScale;
float l9_894=N3_SheenColorTextureRotation;
float l9_895=radians(l9_894);
float3x3 l9_896=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_892.x,l9_892.y,1.0));
float3x3 l9_897=float3x3(float3(cos(l9_895),sin(l9_895),0.0),float3(-sin(l9_895),cos(l9_895),0.0),float3(0.0,0.0,1.0));
float3x3 l9_898=float3x3(float3(l9_893.x,0.0,0.0),float3(0.0,l9_893.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_899=(l9_896*l9_897)*l9_898;
float2 l9_900=(l9_899*float3(l9_891,1.0)).xy;
l9_890=l9_900;
}
float2 l9_901=l9_890;
...
int l9_908=l9_903;
int l9_909=sheenColorTextureLayout_tmp;
int l9_910=l9_908;
float2 l9_911=l9_901;
bool l9_912=(int(SC_USE_UV_TRANSFORM_sheenColorTexture_tmp)!=0);
float3x3 l9_913=(*sc_set0.UserUniforms).sheenColorTextureTransform;
int2 l9_914=int2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture_tmp);
bool l9_915=(int(SC_USE_UV_MIN_MAX_sheenColorTexture_tmp)!=0);
float4 l9_916=(*sc_set0.UserUniforms).sheenColorTextureUvMinMax;
bool l9_917=(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture_tmp)!=0);
float4 l9_918=(*sc_set0.UserUniforms).sheenColorTextureBorderColor;
float l9_919=0.0;
...
float l9_989=l9_981;
float4 l9_990=sc_set0.sheenColorTexture.sample(sc_set0.sheenColorTextureSmpSC,l9_988,bias(l9_989));
...
float3 l9_995=l9_994.xyz;
float3 l9_996;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_996=float3(pow(l9_995.x,2.2),pow(l9_995.y,2.2),pow(l9_995.z,2.2));
}
else
{
l9_996=l9_995*l9_995;
}
...
{
int l9_998=N3_SheenRoughnessTextureCoord;
float2 l9_999=tempGlobals.Surface_UVCoord0;
float2 l9_1000=l9_999;
if (l9_998==0)
{
...
if (l9_998==1)
{
float2 l9_1002=tempGlobals.Surface_UVCoord1;
l9_1000=l9_1002;
}
...
float2 l9_1006=N3_SheenRoughnessTextureOffset;
float2 l9_1007=N3_SheenRoughnessTextureScale;
float l9_1008=N3_SheenRoughnessTextureRotation;
float l9_1009=radians(l9_1008);
float3x3 l9_1010=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1006.x,l9_1006.y,1.0));
float3x3 l9_1011=float3x3(float3(cos(l9_1009),sin(l9_1009),0.0),float3(-sin(l9_1009),cos(l9_1009),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1012=float3x3(float3(l9_1007.x,0.0,0.0),float3(0.0,l9_1007.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1013=(l9_1010*l9_1011)*l9_1012;
float2 l9_1014=(l9_1013*float3(l9_1005,1.0)).xy;
l9_1004=l9_1014;
}
float2 l9_1015=l9_1004;
...
int l9_1022=l9_1017;
int l9_1023=sheenRoughnessTextureLayout_tmp;
int l9_1024=l9_1022;
float2 l9_1025=l9_1015;
bool l9_1026=(int(SC_USE_UV_TRANSFORM_sheenRoughnessTexture_tmp)!=0);
float3x3 l9_1027=(*sc_set0.UserUniforms).sheenRoughnessTextureTransform;
int2 l9_1028=int2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture_tmp);
bool l9_1029=(int(SC_USE_UV_MIN_MAX_sheenRoughnessTexture_tmp)!=0);
float4 l9_1030=(*sc_set0.UserUniforms).sheenRoughnessTextureUvMinMax;
bool l9_1031=(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture_tmp)!=0);
float4 l9_1032=(*sc_set0.UserUniforms).sheenRoughnessTextureBorderColor;
float l9_1033=0.0;
bool l9_1034=l9_1031&&(!l9_1029);
float l9_1035=1.0;
float l9_1036=l9_1025.x;
int l9_1037=l9_1028.x;
if (l9_1037==1)
{
l9_1036=fract(l9_1036);
}
else
{
if (l9_1037==2)
{
float l9_1038=fract(l9_1036);
float l9_1039=l9_1036-l9_1038;
float l9_1040=step(0.25,fract(l9_1039*0.5));
l9_1036=mix(l9_1038,1.0-l9_1038,fast::clamp(l9_1040,0.0,1.0));
}
}
l9_1025.x=l9_1036;
float l9_1041=l9_1025.y;
int l9_1042=l9_1028.y;
if (l9_1042==1)
{
l9_1041=fract(l9_1041);
}
else
{
if (l9_1042==2)
{
float l9_1043=fract(l9_1041);
float l9_1044=l9_1041-l9_1043;
float l9_1045=step(0.25,fract(l9_1044*0.5));
l9_1041=mix(l9_1043,1.0-l9_1043,fast::clamp(l9_1045,0.0,1.0));
}
}
l9_1025.y=l9_1041;
if (l9_1029)
{
bool l9_1046=l9_1031;
bool l9_1047;
if (l9_1046)
{
l9_1047=l9_1028.x==3;
...
float l9_1048=l9_1025.x;
float l9_1049=l9_1030.x;
float l9_1050=l9_1030.z;
bool l9_1051=l9_1047;
float l9_1052=l9_1035;
...
float l9_1057=l9_1025.y;
float l9_1058=l9_1030.y;
float l9_1059=l9_1030.w;
bool l9_1060=l9_1056;
float l9_1061=l9_1035;
...
float2 l9_1064=l9_1025;
bool l9_1065=l9_1026;
float3x3 l9_1066=l9_1027;
if (l9_1065)
{
l9_1064=float2((l9_1066*float3(l9_1064,1.0)).xy);
}
float2 l9_1067=l9_1064;
float2 l9_1068=l9_1067;
float2 l9_1069=l9_1068;
l9_1025=l9_1069;
float l9_1070=l9_1025.x;
int l9_1071=l9_1028.x;
bool l9_1072=l9_1034;
float l9_1073=l9_1035;
...
l9_1025.x=l9_1070;
l9_1035=l9_1073;
float l9_1081=l9_1025.y;
int l9_1082=l9_1028.y;
bool l9_1083=l9_1034;
float l9_1084=l9_1035;
...
l9_1025.y=l9_1081;
l9_1035=l9_1084;
float2 l9_1092=l9_1025;
int l9_1093=l9_1023;
int l9_1094=l9_1024;
float l9_1095=l9_1033;
...
float2 l9_1102=l9_1101.xy;
float l9_1103=l9_1095;
float4 l9_1104=sc_set0.sheenRoughnessTexture.sample(sc_set0.sheenRoughnessTextureSmpSC,l9_1102,bias(l9_1103));
float4 l9_1105=l9_1104;
float4 l9_1106=l9_1105;
if (l9_1031)
{
l9_1106=mix(l9_1032,l9_1106,float4(l9_1035));
}
float4 l9_1107=l9_1106;
l9_1016=l9_1107;
float4 l9_1108=l9_1016;
float l9_1109=l9_1108.w;
float l9_1110;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1110=pow(l9_1109,2.2);
}
else
{
l9_1110=l9_1109*l9_1109;
}
float l9_1111=l9_1110;
l9_883*=l9_1111;
}
l9_883=fast::max(l9_883,9.9999997e-05);
N3_SheenOut=float4(0.0);
float3 l9_1112=l9_880;
float3 l9_1113=(*sc_set0.UserUniforms).sc_Camera.position;
float3 l9_1114=tempGlobals.SurfacePosition_WorldSpace;
float3 l9_1115=normalize(l9_1113-l9_1114);
float3 l9_1116=l9_1112;
float3 l9_1117=l9_1115;
float l9_1118=fast::clamp(dot(l9_1116,l9_1117),0.0,1.0);
float l9_1119=fast::max(l9_1118,9.9999997e-05);
float l9_1120=l9_883*l9_883;
float3 l9_1121=normalize(reflect(-l9_1115,l9_1112));
float l9_1122=l9_1119;
float3 l9_1123=l9_1121;
float l9_1124=l9_883;
float3 l9_1125=l9_882;
float l9_1126=l9_1124*4.0;
l9_1126=3.0+(((l9_1126-0.0)*2.0)/5.000001);
float l9_1127=l9_1124*l9_1124;
float l9_1128;
if (l9_1124<0.25)
{
l9_1128=(((-339.20001)*l9_1127)+(161.39999*l9_1124))-25.9;
}
else
{
l9_1128=(((-8.4799995)*l9_1127)+(14.3*l9_1124))-9.9499998;
}
float l9_1129=l9_1128;
float l9_1130;
if (l9_1124<0.25)
{
l9_1130=((44.0*l9_1127)-(23.700001*l9_1124))+3.26;
}
else
{
l9_1130=((1.97*l9_1127)-(3.27*l9_1124))+0.72000003;
}
float l9_1131=l9_1130;
float l9_1132=l9_1129;
float l9_1133=l9_1122;
...
{
l9_1135=0.1*(l9_1124-0.25);
}
float l9_1136=exp((l9_1132*l9_1133)+l9_1134)+l9_1135;
float l9_1137=3.1415927;
l9_1136=fast::clamp(l9_1136*l9_1137,0.0,1.0);
float3 l9_1138=l9_1123;
float l9_1139=l9_1126;
float3 l9_1140=float3(0.0);
float3 l9_1141=l9_1138;
float l9_1142=l9_1139;
float3 l9_1143=l9_1141;
float l9_1144=l9_1142;
float4 l9_1145=float4(0.0);
float3 l9_1146=l9_1143;
float l9_1147=(*sc_set0.UserUniforms).sc_EnvmapRotation.y;
float2 l9_1148=float2(0.0);
float l9_1149=l9_1146.x;
float l9_1150=-l9_1146.z;
float l9_1151=(l9_1149<0.0) ? (-1.0) : 1.0;
float l9_1152=l9_1151*acos(fast::clamp(l9_1150/length(float2(l9_1149,l9_1150)),-1.0,1.0));
l9_1148.x=l9_1152-1.5707964;
l9_1148.y=acos(l9_1146.y);
l9_1148/=float2(6.2831855,3.1415927);
l9_1148.y=1.0-l9_1148.y;
l9_1148.x+=(l9_1147/360.0);
l9_1148.x=fract((l9_1148.x+floor(l9_1148.x))+1.0);
float2 l9_1153=l9_1148;
float2 l9_1154=l9_1153;
if (SC_DEVICE_CLASS_tmp>=2)
{
float l9_1155=floor(l9_1144);
float l9_1156=ceil(l9_1144);
float l9_1157=l9_1144-l9_1155;
float2 l9_1158=l9_1154;
float2 l9_1159=(*sc_set0.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_1160=l9_1155;
float2 l9_1161=calcSeamlessPanoramicUvsForSampling(l9_1158,l9_1159,l9_1160);
float2 l9_1162=l9_1161;
float l9_1163=l9_1155;
float2 l9_1164=l9_1162;
float l9_1165=l9_1163;
int l9_1166=0;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1167=0;
...
int l9_1171=l9_1166;
float2 l9_1172=l9_1164;
int l9_1173=l9_1171;
float l9_1174=l9_1165;
float4 l9_1175=float4(0.0);
float2 l9_1176=l9_1172;
int l9_1177=sc_EnvmapSpecularLayout_tmp;
int l9_1178=l9_1173;
float l9_1179=l9_1174;
float2 l9_1180=l9_1176;
int l9_1181=l9_1177;
int l9_1182=l9_1178;
float3 l9_1183=float3(0.0);
if (l9_1181==0)
{
l9_1183=float3(l9_1180,0.0);
}
else
{
if (l9_1181==1)
{
l9_1183=float3(l9_1180.x,(l9_1180.y*0.5)+(0.5-(float(l9_1182)*0.5)),0.0);
}
else
{
l9_1183=float3(l9_1180,float(l9_1182));
}
}
float3 l9_1184=l9_1183;
float3 l9_1185=l9_1184;
float2 l9_1186=l9_1185.xy;
float l9_1187=l9_1179;
float4 l9_1188=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1186,level(l9_1187));
float4 l9_1189=l9_1188;
l9_1175=l9_1189;
float4 l9_1190=l9_1175;
float4 l9_1191=l9_1190;
float4 l9_1192=l9_1191;
float4 l9_1193=l9_1192;
float2 l9_1194=l9_1154;
float2 l9_1195=(*sc_set0.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_1196=l9_1156;
float2 l9_1197=calcSeamlessPanoramicUvsForSampling(l9_1194,l9_1195,l9_1196);
float2 l9_1198=l9_1197;
float l9_1199=l9_1156;
float2 l9_1200=l9_1198;
float l9_1201=l9_1199;
int l9_1202=0;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1203=0;
...
int l9_1207=l9_1202;
float2 l9_1208=l9_1200;
int l9_1209=l9_1207;
float l9_1210=l9_1201;
float4 l9_1211=float4(0.0);
float2 l9_1212=l9_1208;
int l9_1213=sc_EnvmapSpecularLayout_tmp;
int l9_1214=l9_1209;
float l9_1215=l9_1210;
...
float2 l9_1222=l9_1221.xy;
float l9_1223=l9_1215;
float4 l9_1224=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1222,level(l9_1223));
float4 l9_1225=l9_1224;
l9_1211=l9_1225;
float4 l9_1226=l9_1211;
float4 l9_1227=l9_1226;
float4 l9_1228=l9_1227;
float4 l9_1229=l9_1228;
l9_1145=mix(l9_1193,l9_1229,float4(l9_1157));
}
else
{
float2 l9_1230=l9_1154;
float l9_1231=l9_1144;
float2 l9_1232=l9_1230;
...
int l9_1239=l9_1234;
float2 l9_1240=l9_1232;
int l9_1241=l9_1239;
float l9_1242=l9_1233;
float4 l9_1243=float4(0.0);
float2 l9_1244=l9_1240;
int l9_1245=sc_EnvmapSpecularLayout_tmp;
int l9_1246=l9_1241;
float l9_1247=l9_1242;
...
float4 l9_1256=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1254,level(l9_1255));
float4 l9_1257=l9_1256;
l9_1243=l9_1257;
float4 l9_1258=l9_1243;
float4 l9_1259=l9_1258;
float4 l9_1260=l9_1259;
l9_1145=l9_1260;
}
float4 l9_1261=l9_1145;
float3 l9_1262=l9_1261.xyz*(1.0/l9_1261.w);
float3 l9_1263=l9_1262;
float3 l9_1264=l9_1263*(*sc_set0.UserUniforms).sc_EnvmapExposure;
l9_1264+=float3(1e-06);
float3 l9_1265=l9_1264;
l9_1140=l9_1265;
float3 l9_1266=l9_1140;
float3 l9_1267=l9_1266;
float3 l9_1268=(l9_1267*l9_1125)*l9_1136;
float3 l9_1269=N3_SheenOut.xyz+l9_1268;
N3_SheenOut=float4(l9_1269.x,l9_1269.y,l9_1269.z,N3_SheenOut.w);
float3 l9_1270=mix(N3_SheenOut.xyz,N3_SheenOut.xyz*l9_881.xyz,float3(l9_881.w));
N3_SheenOut=float4(l9_1270.x,l9_1270.y,l9_1270.z,N3_SheenOut.w);
float3 l9_1271=l9_882;
float3 l9_1272=l9_1112;
float3 l9_1273=l9_1115;
float l9_1274=l9_1119;
float l9_1275=l9_1120;
float3 l9_1276=float3(0.0);
int l9_1277=0;
l9_1277=sc_DirectionalLightsCount_tmp;
int l9_1278=l9_1277;
if (l9_1278>0)
{
float l9_1279;
...
{
int l9_1281=0;
l9_1281=sc_DirectionalLightsCount_tmp;
int l9_1282=l9_1281;
if (l9_1280<l9_1282)
{
int l9_1283=l9_1280;
float3 l9_1284=float3(0.0);
if (l9_1283<sc_DirectionalLightsCount_tmp)
{
l9_1284=(*sc_set0.UserUniforms).sc_DirectionalLights[l9_1283].color.xyz;
}
float3 l9_1285=l9_1284;
float3 l9_1286=l9_1285;
int l9_1287=l9_1280;
float l9_1288=0.0;
if (l9_1287<sc_DirectionalLightsCount_tmp)
{
l9_1288=(*sc_set0.UserUniforms).sc_DirectionalLights[l9_1287].color.w;
}
float l9_1289=l9_1288;
float l9_1290=l9_1289;
l9_1286*=l9_1290;
l9_1286*=3.1415901;
int l9_1291=l9_1280;
float3 l9_1292=float3(0.0);
if (l9_1291<sc_DirectionalLightsCount_tmp)
{
l9_1292=-(*sc_set0.UserUniforms).sc_DirectionalLights[l9_1291].direction;
}
float3 l9_1293=l9_1292;
float3 l9_1294=normalize(-l9_1293);
float3 l9_1295=normalize(l9_1294+l9_1273);
float3 l9_1296=l9_1272;
float3 l9_1297=l9_1295;
float l9_1298=fast::clamp(dot(l9_1296,l9_1297),0.0,1.0);
float l9_1299=l9_1298;
float3 l9_1300=l9_1272;
float3 l9_1301=l9_1294;
float l9_1302=fast::clamp(dot(l9_1300,l9_1301),0.0,1.0);
float l9_1303=l9_1302;
float l9_1304=l9_1275;
float l9_1305=l9_1299;
float l9_1306=1.0/l9_1304;
float l9_1307=l9_1305*l9_1305;
float l9_1308=1.0-l9_1307;
float l9_1309=l9_1306;
float l9_1310=l9_1308;
float l9_1311=l9_1306*0.5;
if (l9_1310<=0.0)
{
l9_1279=0.0;
}
...
{
l9_1279=pow(l9_1310,l9_1311);
}
float l9_1312=l9_1279;
float l9_1313=3.1415927;
float l9_1314=((2.0+l9_1309)*l9_1312)/(2.0*l9_1313);
float l9_1315=l9_1314;
float l9_1316=l9_1274;
float l9_1317=l9_1303;
float l9_1318=1.0/(4.0*((l9_1317+l9_1316)-(l9_1317*l9_1316)));
float l9_1319=l9_1318;
l9_1276+=((((l9_1286*l9_1271)*l9_1315)*l9_1319)*l9_1303);
l9_1280++;
continue;
}
else
...
int l9_1320=0;
l9_1320=sc_PointLightsCount_tmp;
int l9_1321=l9_1320;
if (l9_1321>0)
{
float l9_1322;
...
{
int l9_1324=0;
l9_1324=sc_PointLightsCount_tmp;
int l9_1325=l9_1324;
if (l9_1323<l9_1325)
{
int l9_1326=l9_1323;
float3 l9_1327=float3(0.0);
if (l9_1326<sc_PointLightsCount_tmp)
{
l9_1327=(*sc_set0.UserUniforms).sc_PointLights[l9_1326].color.xyz;
}
float3 l9_1328=l9_1327;
float3 l9_1329=l9_1328;
int l9_1330=l9_1323;
float l9_1331=0.0;
if (l9_1330<sc_PointLightsCount_tmp)
{
l9_1331=(*sc_set0.UserUniforms).sc_PointLights[l9_1330].color.w;
}
float l9_1332=l9_1331;
float l9_1333=l9_1332;
l9_1329*=l9_1333;
l9_1329*=3.1415901;
int l9_1334=l9_1323;
float3 l9_1335=float3(0.0);
if (l9_1334<sc_PointLightsCount_tmp)
{
l9_1335=(*sc_set0.UserUniforms).sc_PointLights[l9_1334].position;
}
float3 l9_1336=l9_1335;
float3 l9_1337=l9_1336;
float3 l9_1338=tempGlobals.SurfacePosition_WorldSpace;
float3 l9_1339=normalize(l9_1337-l9_1338);
float3 l9_1340=normalize(l9_1339+l9_1273);
float3 l9_1341=l9_1272;
float3 l9_1342=l9_1340;
float l9_1343=fast::clamp(dot(l9_1341,l9_1342),0.0,1.0);
float l9_1344=l9_1343;
float3 l9_1345=l9_1272;
float3 l9_1346=l9_1339;
float l9_1347=fast::clamp(dot(l9_1345,l9_1346),0.0,1.0);
float l9_1348=l9_1347;
float l9_1349=l9_1275;
float l9_1350=l9_1344;
float l9_1351=1.0/l9_1349;
float l9_1352=l9_1350*l9_1350;
float l9_1353=1.0-l9_1352;
float l9_1354=l9_1351;
float l9_1355=l9_1353;
float l9_1356=l9_1351*0.5;
if (l9_1355<=0.0)
{
l9_1322=0.0;
}
...
{
l9_1322=pow(l9_1355,l9_1356);
}
float l9_1357=l9_1322;
float l9_1358=3.1415927;
float l9_1359=((2.0+l9_1354)*l9_1357)/(2.0*l9_1358);
float l9_1360=l9_1359;
float l9_1361=l9_1274;
float l9_1362=l9_1348;
float l9_1363=1.0/(4.0*((l9_1362+l9_1361)-(l9_1362*l9_1361)));
float l9_1364=l9_1363;
l9_1276+=((((l9_1329*l9_1271)*l9_1360)*l9_1364)*l9_1348);
l9_1323++;
continue;
}
else
...
int l9_1365=0;
l9_1365=sc_AmbientLightsCount_tmp;
int l9_1366=l9_1365;
if (l9_1366>0)
{
int l9_1367=0;
...
if (l9_1370<sc_AmbientLightsCount_tmp)
{
l9_1371=(*sc_set0.UserUniforms).sc_AmbientLights[l9_1370].color;
}
float3 l9_1372=l9_1371;
float3 l9_1373=l9_1372;
int l9_1374=l9_1367;
float l9_1375=0.0;
if (l9_1374<sc_AmbientLightsCount_tmp)
{
l9_1375=(*sc_set0.UserUniforms).sc_AmbientLights[l9_1374].intensity;
}
float l9_1376=l9_1375;
float l9_1377=l9_1376;
l9_1373*=l9_1377;
l9_1373/=float3(3.1415901);
l9_1276+=(l9_1373*l9_1271);
l9_1367++;
continue;
}
else
...
float3 l9_1378=l9_1276;
float3 l9_1379=N3_SheenOut.xyz+l9_1378;
N3_SheenOut=float4(l9_1379.x,l9_1379.y,l9_1379.z,N3_SheenOut.w);
float3 l9_1380=l9_882;
float3 l9_1381=l9_1380;
float l9_1382=fast::max(fast::max(l9_1381.x,l9_1381.y),l9_1381.z);
float l9_1383=1.0-(l9_1382*0.15700001);
N3_SheenOut.w=l9_1383;
}
...
{
int l9_1384=N3_ClearcoatTextureCoord;
float2 l9_1385=tempGlobals.Surface_UVCoord0;
...
if (l9_1384==1)
{
float2 l9_1388=tempGlobals.Surface_UVCoord1;
l9_1386=l9_1388;
}
float2 l9_1389=l9_1386;
float2 l9_1390=l9_1389;
if (N3_EnableTextureTransform&&N3_ClearcoatTextureTransform)
{
float2 l9_1391=l9_1390;
float2 l9_1392=N3_ClearcoatTextureOffset;
float2 l9_1393=N3_ClearcoatTextureScale;
float l9_1394=N3_ClearcoatTextureRotation;
float l9_1395=radians(l9_1394);
float3x3 l9_1396=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1392.x,l9_1392.y,1.0));
float3x3 l9_1397=float3x3(float3(cos(l9_1395),sin(l9_1395),0.0),float3(-sin(l9_1395),cos(l9_1395),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1398=float3x3(float3(l9_1393.x,0.0,0.0),float3(0.0,l9_1393.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1399=(l9_1396*l9_1397)*l9_1398;
float2 l9_1400=(l9_1399*float3(l9_1391,1.0)).xy;
l9_1390=l9_1400;
}
float2 l9_1401=l9_1390;
...
int l9_1408=l9_1403;
int l9_1409=clearcoatTextureLayout_tmp;
int l9_1410=l9_1408;
float2 l9_1411=l9_1401;
bool l9_1412=(int(SC_USE_UV_TRANSFORM_clearcoatTexture_tmp)!=0);
float3x3 l9_1413=(*sc_set0.UserUniforms).clearcoatTextureTransform;
int2 l9_1414=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture_tmp);
bool l9_1415=(int(SC_USE_UV_MIN_MAX_clearcoatTexture_tmp)!=0);
float4 l9_1416=(*sc_set0.UserUniforms).clearcoatTextureUvMinMax;
bool l9_1417=(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture_tmp)!=0);
float4 l9_1418=(*sc_set0.UserUniforms).clearcoatTextureBorderColor;
float l9_1419=0.0;
...
l9_1411=l9_1455;
float l9_1456=l9_1411.x;
int l9_1457=l9_1414.x;
bool l9_1458=l9_1420;
float l9_1459=l9_1421;
if ((l9_1457==0)||(l9_1457==3))
{
float l9_1460=l9_1456;
float l9_1461=0.0;
float l9_1462=1.0;
bool l9_1463=l9_1458;
float l9_1464=l9_1459;
...
l9_1411.x=l9_1456;
l9_1421=l9_1459;
float l9_1467=l9_1411.y;
int l9_1468=l9_1414.y;
bool l9_1469=l9_1420;
float l9_1470=l9_1421;
...
l9_1411.y=l9_1467;
l9_1421=l9_1470;
float2 l9_1478=l9_1411;
int l9_1479=l9_1409;
int l9_1480=l9_1410;
float l9_1481=l9_1419;
float2 l9_1482=l9_1478;
int l9_1483=l9_1479;
int l9_1484=l9_1480;
float3 l9_1485=float3(0.0);
if (l9_1483==0)
{
l9_1485=float3(l9_1482,0.0);
}
else
{
if (l9_1483==1)
{
l9_1485=float3(l9_1482.x,(l9_1482.y*0.5)+(0.5-(float(l9_1484)*0.5)),0.0);
}
else
{
l9_1485=float3(l9_1482,float(l9_1484));
}
}
float3 l9_1486=l9_1485;
float3 l9_1487=l9_1486;
float2 l9_1488=l9_1487.xy;
float l9_1489=l9_1481;
float4 l9_1490=sc_set0.clearcoatTexture.sample(sc_set0.clearcoatTextureSmpSC,l9_1488,bias(l9_1489));
float4 l9_1491=l9_1490;
float4 l9_1492=l9_1491;
if (l9_1417)
{
l9_1492=mix(l9_1418,l9_1492,float4(l9_1421));
}
float4 l9_1493=l9_1492;
l9_1402=l9_1493;
float4 l9_1494=l9_1402;
float l9_1495=l9_1494.x;
float l9_1496;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1496=pow(l9_1495,2.2);
}
else
{
l9_1496=l9_1495*l9_1495;
}
float l9_1497=l9_1496;
N3_ClearcoatBase=l9_1497;
}
N3_ClearcoatBase*=N3_ClearcoatFactor;
if (N3_EnableClearCoatRoughnessTexture)
{
int l9_1498=N3_ClearcoatRoughnessTextureCoord;
float2 l9_1499=tempGlobals.Surface_UVCoord0;
float2 l9_1500=l9_1499;
if (l9_1498==0)
{
...
if (l9_1498==1)
{
float2 l9_1502=tempGlobals.Surface_UVCoord1;
l9_1500=l9_1502;
}
...
{
float2 l9_1505=l9_1504;
float2 l9_1506=N3_ClearcoatRoughnessTextureOffset;
float2 l9_1507=N3_ClearcoatRoughnessTextureScale;
float l9_1508=N3_ClearcoatRoughnessTextureRotation;
float l9_1509=radians(l9_1508);
float3x3 l9_1510=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1506.x,l9_1506.y,1.0));
float3x3 l9_1511=float3x3(float3(cos(l9_1509),sin(l9_1509),0.0),float3(-sin(l9_1509),cos(l9_1509),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1512=float3x3(float3(l9_1507.x,0.0,0.0),float3(0.0,l9_1507.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1513=(l9_1510*l9_1511)*l9_1512;
float2 l9_1514=(l9_1513*float3(l9_1505,1.0)).xy;
l9_1504=l9_1514;
}
float2 l9_1515=l9_1504;
...
int l9_1522=l9_1517;
int l9_1523=clearcoatRoughnessTextureLayout_tmp;
int l9_1524=l9_1522;
float2 l9_1525=l9_1515;
bool l9_1526=(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture_tmp)!=0);
float3x3 l9_1527=(*sc_set0.UserUniforms).clearcoatRoughnessTextureTransform;
int2 l9_1528=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture_tmp);
bool l9_1529=(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_1530=(*sc_set0.UserUniforms).clearcoatRoughnessTextureUvMinMax;
bool l9_1531=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_1532=(*sc_set0.UserUniforms).clearcoatRoughnessTextureBorderColor;
float l9_1533=0.0;
bool l9_1534=l9_1531&&(!l9_1529);
float l9_1535=1.0;
float l9_1536=l9_1525.x;
int l9_1537=l9_1528.x;
if (l9_1537==1)
{
l9_1536=fract(l9_1536);
}
else
{
if (l9_1537==2)
{
float l9_1538=fract(l9_1536);
float l9_1539=l9_1536-l9_1538;
float l9_1540=step(0.25,fract(l9_1539*0.5));
l9_1536=mix(l9_1538,1.0-l9_1538,fast::clamp(l9_1540,0.0,1.0));
}
}
l9_1525.x=l9_1536;
float l9_1541=l9_1525.y;
int l9_1542=l9_1528.y;
if (l9_1542==1)
{
...
float l9_1548=l9_1525.x;
float l9_1549=l9_1530.x;
float l9_1550=l9_1530.z;
bool l9_1551=l9_1547;
float l9_1552=l9_1535;
float l9_1553=fast::clamp(l9_1548,l9_1549,l9_1550);
float l9_1554=step(abs(l9_1548-l9_1553),9.9999997e-06);
l9_1552*=(l9_1554+((1.0-float(l9_1551))*(1.0-l9_1554)));
l9_1548=l9_1553;
l9_1525.x=l9_1548;
l9_1535=l9_1552;
bool l9_1555=l9_1531;
bool l9_1556;
if (l9_1555)
{
l9_1556=l9_1528.y==3;
...
float l9_1557=l9_1525.y;
float l9_1558=l9_1530.y;
float l9_1559=l9_1530.w;
bool l9_1560=l9_1556;
float l9_1561=l9_1535;
float l9_1562=fast::clamp(l9_1557,l9_1558,l9_1559);
float l9_1563=step(abs(l9_1557-l9_1562),9.9999997e-06);
l9_1561*=(l9_1563+((1.0-float(l9_1560))*(1.0-l9_1563)));
l9_1557=l9_1562;
l9_1525.y=l9_1557;
l9_1535=l9_1561;
}
float2 l9_1564=l9_1525;
bool l9_1565=l9_1526;
float3x3 l9_1566=l9_1527;
if (l9_1565)
{
l9_1564=float2((l9_1566*float3(l9_1564,1.0)).xy);
}
float2 l9_1567=l9_1564;
float2 l9_1568=l9_1567;
float2 l9_1569=l9_1568;
l9_1525=l9_1569;
float l9_1570=l9_1525.x;
int l9_1571=l9_1528.x;
bool l9_1572=l9_1534;
float l9_1573=l9_1535;
if ((l9_1571==0)||(l9_1571==3))
{
float l9_1574=l9_1570;
float l9_1575=0.0;
float l9_1576=1.0;
bool l9_1577=l9_1572;
...
l9_1525.x=l9_1570;
l9_1535=l9_1573;
float l9_1581=l9_1525.y;
int l9_1582=l9_1528.y;
bool l9_1583=l9_1534;
float l9_1584=l9_1535;
...
l9_1525.y=l9_1581;
l9_1535=l9_1584;
float2 l9_1592=l9_1525;
int l9_1593=l9_1523;
int l9_1594=l9_1524;
float l9_1595=l9_1533;
...
float2 l9_1602=l9_1601.xy;
float l9_1603=l9_1595;
float4 l9_1604=sc_set0.clearcoatRoughnessTexture.sample(sc_set0.clearcoatRoughnessTextureSmpSC,l9_1602,bias(l9_1603));
float4 l9_1605=l9_1604;
float4 l9_1606=l9_1605;
if (l9_1531)
{
l9_1606=mix(l9_1532,l9_1606,float4(l9_1535));
}
float4 l9_1607=l9_1606;
l9_1516=l9_1607;
float4 l9_1608=l9_1516;
float l9_1609=l9_1608.y;
float l9_1610;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1610=pow(l9_1609,2.2);
}
else
{
l9_1610=l9_1609*l9_1609;
}
float l9_1611=l9_1610;
N3_ClearcoatRoughness=l9_1611;
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
int l9_1612=N3_ClearcoatNormalMapCoord;
float2 l9_1613=tempGlobals.Surface_UVCoord0;
...
if (l9_1612==1)
{
float2 l9_1616=tempGlobals.Surface_UVCoord1;
l9_1614=l9_1616;
}
float2 l9_1617=l9_1614;
float2 l9_1618=l9_1617;
if (N3_EnableTextureTransform&&N3_ClearcoatNormalTextureTransform)
{
float2 l9_1619=l9_1618;
float2 l9_1620=N3_ClearcoatNormalTextureOffset;
float2 l9_1621=N3_ClearcoatNormalTextureScale;
float l9_1622=N3_ClearcoatNormalTextureRotation;
float l9_1623=radians(l9_1622);
float3x3 l9_1624=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1620.x,l9_1620.y,1.0));
float3x3 l9_1625=float3x3(float3(cos(l9_1623),sin(l9_1623),0.0),float3(-sin(l9_1623),cos(l9_1623),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1626=float3x3(float3(l9_1621.x,0.0,0.0),float3(0.0,l9_1621.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1627=(l9_1624*l9_1625)*l9_1626;
float2 l9_1628=(l9_1627*float3(l9_1619,1.0)).xy;
l9_1618=l9_1628;
}
float2 l9_1629=l9_1618;
...
int l9_1636=l9_1631;
int l9_1637=clearcoatNormalTextureLayout_tmp;
int l9_1638=l9_1636;
float2 l9_1639=l9_1629;
bool l9_1640=(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture_tmp)!=0);
float3x3 l9_1641=(*sc_set0.UserUniforms).clearcoatNormalTextureTransform;
int2 l9_1642=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture_tmp);
bool l9_1643=(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture_tmp)!=0);
float4 l9_1644=(*sc_set0.UserUniforms).clearcoatNormalTextureUvMinMax;
bool l9_1645=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture_tmp)!=0);
float4 l9_1646=(*sc_set0.UserUniforms).clearcoatNormalTextureBorderColor;
float l9_1647=0.0;
...
l9_1639=l9_1683;
float l9_1684=l9_1639.x;
int l9_1685=l9_1642.x;
bool l9_1686=l9_1648;
float l9_1687=l9_1649;
if ((l9_1685==0)||(l9_1685==3))
{
float l9_1688=l9_1684;
float l9_1689=0.0;
float l9_1690=1.0;
bool l9_1691=l9_1686;
float l9_1692=l9_1687;
float l9_1693=fast::clamp(l9_1688,l9_1689,l9_1690);
float l9_1694=step(abs(l9_1688-l9_1693),9.9999997e-06);
l9_1692*=(l9_1694+((1.0-float(l9_1691))*(1.0-l9_1694)));
l9_1688=l9_1693;
l9_1684=l9_1688;
l9_1687=l9_1692;
}
l9_1639.x=l9_1684;
l9_1649=l9_1687;
float l9_1695=l9_1639.y;
int l9_1696=l9_1642.y;
bool l9_1697=l9_1648;
float l9_1698=l9_1649;
if ((l9_1696==0)||(l9_1696==3))
{
float l9_1699=l9_1695;
float l9_1700=0.0;
float l9_1701=1.0;
bool l9_1702=l9_1697;
float l9_1703=l9_1698;
float l9_1704=fast::clamp(l9_1699,l9_1700,l9_1701);
float l9_1705=step(abs(l9_1699-l9_1704),9.9999997e-06);
l9_1703*=(l9_1705+((1.0-float(l9_1702))*(1.0-l9_1705)));
l9_1699=l9_1704;
l9_1695=l9_1699;
l9_1698=l9_1703;
}
l9_1639.y=l9_1695;
l9_1649=l9_1698;
float2 l9_1706=l9_1639;
int l9_1707=l9_1637;
int l9_1708=l9_1638;
float l9_1709=l9_1647;
...
float2 l9_1716=l9_1715.xy;
float l9_1717=l9_1709;
float4 l9_1718=sc_set0.clearcoatNormalTexture.sample(sc_set0.clearcoatNormalTextureSmpSC,l9_1716,bias(l9_1717));
float4 l9_1719=l9_1718;
float4 l9_1720=l9_1719;
if (l9_1645)
{
l9_1720=mix(l9_1646,l9_1720,float4(l9_1649));
}
float4 l9_1721=l9_1720;
l9_1630=l9_1721;
float4 l9_1722=l9_1630;
N3_ClearcoatNormal=l9_1722.xyz;
...
l9_295=N3_Roughness;
l9_296=N3_Occlusion;
l9_297=N3_Background;
l9_298=N3_SheenOut;
l9_299=N3_ClearcoatBase;
l9_300=N3_ClearcoatNormal;
l9_301=N3_ClearcoatRoughness;
l9_238=l9_290;
l9_239=l9_291;
l9_240=l9_292;
l9_241=l9_293;
...
float3 l9_1724=l9_238;
float l9_1725=l9_239;
float3 l9_1726=l9_240;
float3 l9_1727=l9_241;
float l9_1728=l9_242;
float l9_1729=l9_243;
float3 l9_1730=l9_244.xyz;
float3 l9_1731=(*sc_set0.UserUniforms).Port_SpecularAO_N036;
ssGlobals l9_1732=param_3;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1732.BumpedNormal=l9_1726;
}
l9_1725=fast::clamp(l9_1725,0.0,1.0);
float l9_1733=l9_1725;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_1733<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_1734=gl_FragCoord;
float2 l9_1735=floor(mod(l9_1734.xy,float2(4.0)));
float l9_1736=(mod(dot(l9_1735,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_1733<l9_1736)
{
discard_fragment();
}
}
l9_1724=fast::max(l9_1724,float3(0.0));
float4 l9_1737;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1737=float4(l9_1724,l9_1725);
}
else
{
l9_1727=fast::max(l9_1727,float3(0.0));
l9_1728=fast::clamp(l9_1728,0.0,1.0);
l9_1729=fast::clamp(l9_1729,0.0,1.0);
l9_1730=fast::clamp(l9_1730,float3(0.0),float3(1.0));
float3 l9_1738=l9_1724;
float l9_1739=l9_1725;
float3 l9_1740=l9_1732.BumpedNormal;
float3 l9_1741=l9_1732.PositionWS;
float3 l9_1742=l9_1732.ViewDirWS;
float3 l9_1743=l9_1727;
float l9_1744=l9_1728;
float l9_1745=l9_1729;
float3 l9_1746=l9_1730;
float3 l9_1747=l9_1731;
l9_1737=ngsCalculateLighting(l9_1738,l9_1739,l9_1740,l9_1741,l9_1742,l9_1743,l9_1744,l9_1745,l9_1746,l9_1747,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.sc_EnvmapDiffuse,sc_set0.sc_EnvmapDiffuseSmpSC,sc_set0.sc_EnvmapSpecular,sc_set0.sc_EnvmapSpecularSmpSC,sc_set0.sc_ScreenTexture,sc_set0.sc_ScreenTextureSmpSC,sc_set0.sc_ShadowTexture,sc_set0.sc_ShadowTextureSmpSC,sc_set0.sc_SSAOTexture,sc_set0.sc_SSAOTextureSmpSC,sc_set0.sc_RayTracedReflectionTexture,sc_set0.sc_RayTracedReflectionTextureSmpSC,sc_set0.sc_RayTracedShadowTexture,sc_set0.sc_RayTracedShadowTextureSmpSC,sc_set0.sc_RayTracedDiffIndTexture,sc_set0.sc_RayTracedDiffIndTextureSmpSC,sc_set0.sc_RayTracedAoTexture,sc_set0.sc_RayTracedAoTextureSmpSC,gl_FragCoord,in.varShadowTex,out.FragColor0);
}
l9_1737=fast::max(l9_1737,float4(0.0));
l9_1723=l9_1737;
float4 l9_1748=float4(0.0);
float3 l9_1749=(*sc_set0.UserUniforms).Port_Albedo_N405;
float l9_1750=(*sc_set0.UserUniforms).Port_Opacity_N405;
float3 l9_1751=l9_248;
float3 l9_1752=(*sc_set0.UserUniforms).Port_Emissive_N405;
float l9_1753=(*sc_set0.UserUniforms).Port_Metallic_N405;
float l9_1754=l9_249;
float3 l9_1755=(*sc_set0.UserUniforms).Port_SpecularAO_N405;
ssGlobals l9_1756=param_3;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1756.BumpedNormal=float3x3(float3(l9_1756.VertexTangent_WorldSpace),float3(l9_1756.VertexBinormal_WorldSpace),float3(l9_1756.VertexNormal_WorldSpace))*l9_1751;
}
float l9_1757=l9_1750;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_1757<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
if ((int(ENABLE_STIPPLE_PATTERN_TEST_tmp)!=0))
{
float4 l9_1758=gl_FragCoord;
float2 l9_1759=floor(mod(l9_1758.xy,float2(4.0)));
float l9_1760=(mod(dot(l9_1759,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_1757<l9_1760)
{
discard_fragment();
}
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1761=float4(l9_1749,l9_1750);
}
else
{
l9_1754=fast::clamp(l9_1754,0.0,1.0);
float3 l9_1762=float3(1.0);
float3 l9_1763=l9_1749;
float l9_1764=l9_1750;
float3 l9_1765=l9_1756.BumpedNormal;
float3 l9_1766=l9_1756.PositionWS;
float3 l9_1767=l9_1756.ViewDirWS;
float3 l9_1768=l9_1752;
float l9_1769=l9_1753;
float l9_1770=l9_1754;
float3 l9_1771=l9_1762;
float3 l9_1772=l9_1755;
l9_1761=ngsCalculateLighting(l9_1763,l9_1764,l9_1765,l9_1766,l9_1767,l9_1768,l9_1769,l9_1770,l9_1771,l9_1772,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.sc_EnvmapDiffuse,sc_set0.sc_EnvmapDiffuseSmpSC,sc_set0.sc_EnvmapSpecular,sc_set0.sc_EnvmapSpecularSmpSC,sc_set0.sc_ScreenTexture,sc_set0.sc_ScreenTextureSmpSC,sc_set0.sc_ShadowTexture,sc_set0.sc_ShadowTextureSmpSC,sc_set0.sc_SSAOTexture,sc_set0.sc_SSAOTextureSmpSC,sc_set0.sc_RayTracedReflectionTexture,sc_set0.sc_RayTracedReflectionTextureSmpSC,sc_set0.sc_RayTracedShadowTexture,sc_set0.sc_RayTracedShadowTextureSmpSC,sc_set0.sc_RayTracedDiffIndTexture,sc_set0.sc_RayTracedDiffIndTextureSmpSC,sc_set0.sc_RayTracedAoTexture,sc_set0.sc_RayTracedAoTextureSmpSC,gl_FragCoord,in.varShadowTex,out.FragColor0);
}
l9_1761=fast::max(l9_1761,float4(0.0));
l9_1748=l9_1761;
float4 l9_1773=float4(0.0);
float4 l9_1774=l9_1723;
float l9_1775=l9_239;
float3 l9_1776=l9_245;
float4 l9_1777=l9_246;
float l9_1778=l9_247;
float4 l9_1779=l9_1748;
ssGlobals l9_1780=param_3;
tempGlobals=l9_1780;
float4 l9_1781=float4(0.0);
N31_PbrIn=l9_1774;
N31_EnableTransmission=(int(ENABLE_TRANSMISSION_tmp)!=0);
N31_Opacity=l9_1775;
N31_Background=l9_1776;
N31_EnableSheen=(int(ENABLE_SHEEN_tmp)!=0);
N31_SheenColor=l9_1777;
N31_EnableClearcoat=(int(ENABLE_CLEARCOAT_tmp)!=0);
N31_ClearcoatBase=l9_1778;
N31_ClearcoatColor=l9_1779;
N31_Result=N31_PbrIn;
if ((N31_EnableSheen||N31_EnableTransmission)||N31_EnableClearcoat)
{
float4 l9_1782=N31_Result;
float4 l9_1783;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1783=float4(pow(l9_1782.x,2.2),pow(l9_1782.y,2.2),pow(l9_1782.z,2.2),pow(l9_1782.w,2.2));
}
else
{
l9_1783=l9_1782*l9_1782;
}
float4 l9_1784=l9_1783;
N31_Result=l9_1784;
if (N31_EnableSheen)
{
float l9_1785=N31_SheenColor.w;
float3 l9_1786=(N31_Result.xyz*l9_1785)+N31_SheenColor.xyz;
N31_Result=float4(l9_1786.x,l9_1786.y,l9_1786.z,N31_Result.w);
}
if (N31_EnableTransmission)
{
float4 l9_1787=N31_Result;
float l9_1788=N31_Opacity;
float l9_1789;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1789=pow(l9_1788,2.2);
}
else
{
l9_1789=l9_1788*l9_1788;
}
float l9_1790=l9_1789;
N31_Result=mix(float4(N31_Background,1.0),l9_1787,float4(l9_1790));
N31_Result.w=1.0;
}
if (N31_EnableClearcoat)
{
float l9_1791=N31_ClearcoatBase;
float4 l9_1792=N31_ClearcoatColor;
float4 l9_1793;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1793=float4(pow(l9_1792.x,2.2),pow(l9_1792.y,2.2),pow(l9_1792.z,2.2),pow(l9_1792.w,2.2));
}
else
{
l9_1793=l9_1792*l9_1792;
}
float4 l9_1794=l9_1793;
float4 l9_1795=l9_1794*l9_1791;
float3 l9_1796=N31_Result.xyz+l9_1795.xyz;
N31_Result=float4(l9_1796.x,l9_1796.y,l9_1796.z,N31_Result.w);
}
float4 l9_1797=N31_Result;
float4 l9_1798;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1798=float4(pow(l9_1797.x,0.45454544),pow(l9_1797.y,0.45454544),pow(l9_1797.z,0.45454544),pow(l9_1797.w,0.45454544));
}
else
{
l9_1798=sqrt(l9_1797);
}
float4 l9_1799=l9_1798;
N31_Result=l9_1799;
}
l9_1781=N31_Result;
l9_1773=l9_1781;
...
{
float4 l9_1800=float4(0.0);
float4 l9_1801=(*sc_set0.UserUniforms).baseColorFactor;
l9_1800=l9_1801;
float2 l9_1802=float2(0.0);
float2 l9_1803=(*sc_set0.UserUniforms).baseColorTexture_offset;
l9_1802=l9_1803;
float2 l9_1804=float2(0.0);
float2 l9_1805=(*sc_set0.UserUniforms).baseColorTexture_scale;
l9_1804=l9_1805;
float l9_1806=0.0;
float l9_1807=(*sc_set0.UserUniforms).baseColorTexture_rotation;
l9_1806=l9_1807;
float4 l9_1808=float4(0.0);
float4 l9_1809=l9_1800;
float2 l9_1810=l9_1802;
float2 l9_1811=l9_1804;
float l9_1812=l9_1806;
ssGlobals l9_1813=param_3;
tempGlobals=l9_1813;
float4 l9_1814=float4(0.0);
N35_EnableVertexColor=(int(ENABLE_VERTEX_COLOR_BASE_tmp)!=0);
N35_EnableBaseTexture=(int(ENABLE_BASE_TEX_tmp)!=0);
N35_BaseColorTextureCoord=NODE_7_DROPLIST_ITEM_tmp;
N35_BaseColorFactor=l9_1809;
N35_EnableTextureTransform=(int(ENABLE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureTransform=(int(ENABLE_BASE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureOffset=l9_1810;
N35_BaseTextureScale=l9_1811;
N35_BaseTextureRotation=l9_1812;
float4 l9_1815=N35_BaseColorFactor;
if (N35_EnableBaseTexture)
{
int l9_1816=N35_BaseColorTextureCoord;
float2 l9_1817=tempGlobals.Surface_UVCoord0;
float2 l9_1818=l9_1817;
if (l9_1816==0)
{
...
if (l9_1816==1)
{
float2 l9_1820=tempGlobals.Surface_UVCoord1;
l9_1818=l9_1820;
}
float2 l9_1821=l9_1818;
float2 l9_1822=l9_1821;
if (N35_EnableTextureTransform&&N35_BaseTextureTransform)
{
float2 l9_1823=l9_1822;
float2 l9_1824=N35_BaseTextureOffset;
float2 l9_1825=N35_BaseTextureScale;
float l9_1826=N35_BaseTextureRotation;
float3x3 l9_1827=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1824.x,l9_1824.y,1.0));
float3x3 l9_1828=float3x3(float3(cos(l9_1826),sin(l9_1826),0.0),float3(-sin(l9_1826),cos(l9_1826),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1829=float3x3(float3(l9_1825.x,0.0,0.0),float3(0.0,l9_1825.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1830=(l9_1827*l9_1828)*l9_1829;
float2 l9_1831=(l9_1830*float3(l9_1823,1.0)).xy;
l9_1822=l9_1831;
}
float2 l9_1832=l9_1822;
float4 l9_1833=float4(0.0);
int l9_1834=0;
if ((int(baseColorTextureHasSwappedViews_tmp)!=0))
{
int l9_1835=0;
...
int l9_1839=l9_1834;
int l9_1840=baseColorTextureLayout_tmp;
int l9_1841=l9_1839;
float2 l9_1842=l9_1832;
bool l9_1843=(int(SC_USE_UV_TRANSFORM_baseColorTexture_tmp)!=0);
float3x3 l9_1844=(*sc_set0.UserUniforms).baseColorTextureTransform;
int2 l9_1845=int2(SC_SOFTWARE_WRAP_MODE_U_baseColorTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_baseColorTexture_tmp);
bool l9_1846=(int(SC_USE_UV_MIN_MAX_baseColorTexture_tmp)!=0);
float4 l9_1847=(*sc_set0.UserUniforms).baseColorTextureUvMinMax;
bool l9_1848=(int(SC_USE_CLAMP_TO_BORDER_baseColorTexture_tmp)!=0);
float4 l9_1849=(*sc_set0.UserUniforms).baseColorTextureBorderColor;
float l9_1850=0.0;
bool l9_1851=l9_1848&&(!l9_1846);
float l9_1852=1.0;
float l9_1853=l9_1842.x;
int l9_1854=l9_1845.x;
if (l9_1854==1)
{
l9_1853=fract(l9_1853);
}
else
{
if (l9_1854==2)
{
float l9_1855=fract(l9_1853);
float l9_1856=l9_1853-l9_1855;
float l9_1857=step(0.25,fract(l9_1856*0.5));
l9_1853=mix(l9_1855,1.0-l9_1855,fast::clamp(l9_1857,0.0,1.0));
}
}
l9_1842.x=l9_1853;
float l9_1858=l9_1842.y;
int l9_1859=l9_1845.y;
if (l9_1859==1)
{
l9_1858=fract(l9_1858);
}
else
{
if (l9_1859==2)
{
float l9_1860=fract(l9_1858);
float l9_1861=l9_1858-l9_1860;
float l9_1862=step(0.25,fract(l9_1861*0.5));
l9_1858=mix(l9_1860,1.0-l9_1860,fast::clamp(l9_1862,0.0,1.0));
}
}
l9_1842.y=l9_1858;
if (l9_1846)
{
bool l9_1863=l9_1848;
bool l9_1864;
if (l9_1863)
{
l9_1864=l9_1845.x==3;
...
float l9_1865=l9_1842.x;
float l9_1866=l9_1847.x;
float l9_1867=l9_1847.z;
bool l9_1868=l9_1864;
float l9_1869=l9_1852;
...
float l9_1874=l9_1842.y;
float l9_1875=l9_1847.y;
float l9_1876=l9_1847.w;
bool l9_1877=l9_1873;
float l9_1878=l9_1852;
...
float2 l9_1881=l9_1842;
bool l9_1882=l9_1843;
float3x3 l9_1883=l9_1844;
if (l9_1882)
{
l9_1881=float2((l9_1883*float3(l9_1881,1.0)).xy);
}
float2 l9_1884=l9_1881;
float2 l9_1885=l9_1884;
float2 l9_1886=l9_1885;
l9_1842=l9_1886;
float l9_1887=l9_1842.x;
int l9_1888=l9_1845.x;
bool l9_1889=l9_1851;
float l9_1890=l9_1852;
if ((l9_1888==0)||(l9_1888==3))
{
float l9_1891=l9_1887;
float l9_1892=0.0;
float l9_1893=1.0;
bool l9_1894=l9_1889;
float l9_1895=l9_1890;
float l9_1896=fast::clamp(l9_1891,l9_1892,l9_1893);
float l9_1897=step(abs(l9_1891-l9_1896),9.9999997e-06);
l9_1895*=(l9_1897+((1.0-float(l9_1894))*(1.0-l9_1897)));
l9_1891=l9_1896;
l9_1887=l9_1891;
l9_1890=l9_1895;
}
l9_1842.x=l9_1887;
l9_1852=l9_1890;
float l9_1898=l9_1842.y;
int l9_1899=l9_1845.y;
bool l9_1900=l9_1851;
float l9_1901=l9_1852;
if ((l9_1899==0)||(l9_1899==3))
{
float l9_1902=l9_1898;
float l9_1903=0.0;
float l9_1904=1.0;
bool l9_1905=l9_1900;
float l9_1906=l9_1901;
...
l9_1842.y=l9_1898;
l9_1852=l9_1901;
float2 l9_1909=l9_1842;
int l9_1910=l9_1840;
int l9_1911=l9_1841;
float l9_1912=l9_1850;
float2 l9_1913=l9_1909;
int l9_1914=l9_1910;
int l9_1915=l9_1911;
float3 l9_1916=float3(0.0);
if (l9_1914==0)
{
l9_1916=float3(l9_1913,0.0);
}
else
{
if (l9_1914==1)
{
l9_1916=float3(l9_1913.x,(l9_1913.y*0.5)+(0.5-(float(l9_1915)*0.5)),0.0);
}
else
{
l9_1916=float3(l9_1913,float(l9_1915));
}
}
float3 l9_1917=l9_1916;
float3 l9_1918=l9_1917;
float2 l9_1919=l9_1918.xy;
float l9_1920=l9_1912;
float4 l9_1921=sc_set0.baseColorTexture.sample(sc_set0.baseColorTextureSmpSC,l9_1919,bias(l9_1920));
float4 l9_1922=l9_1921;
float4 l9_1923=l9_1922;
if (l9_1848)
{
l9_1923=mix(l9_1849,l9_1923,float4(l9_1852));
}
float4 l9_1924=l9_1923;
l9_1833=l9_1924;
float4 l9_1925=l9_1833;
float4 l9_1926=l9_1925;
float4 l9_1927;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1927=float4(pow(l9_1926.x,2.2),pow(l9_1926.y,2.2),pow(l9_1926.z,2.2),pow(l9_1926.w,2.2));
}
else
{
l9_1927=l9_1926*l9_1926;
}
...
if (N35_EnableVertexColor)
{
float4 l9_1929=tempGlobals.VertexColor;
l9_1815*=l9_1929;
}
N35_BaseColor=l9_1815.xyz;
N35_Opacity=l9_1815.w;
float4 l9_1930=l9_1815;
float4 l9_1931;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1931=float4(pow(l9_1930.x,0.45454544),pow(l9_1930.y,0.45454544),pow(l9_1930.z,0.45454544),pow(l9_1930.w,0.45454544));
}
else
{
l9_1931=sqrt(l9_1930);
}
float4 l9_1932=l9_1931;
N35_UnlitColor=l9_1932;
l9_1814=N35_UnlitColor;
l9_1808=l9_1814;
param_1=l9_1808;
param_2=param_1;
}
...
bool l9_1933=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_1933)
{
...
float4 l9_1934=fast::max(param_7,float4(0.0));
float4 param_8=l9_1934;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_1935=param_9;
float4 l9_1936=l9_1935;
float l9_1937=1.0;
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_1937=fast::clamp(l9_1936.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_1937=fast::clamp(dot(l9_1936.xyz,float3(l9_1936.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_1937=(1.0-dot(l9_1936.xyz,float3(0.33333001)))*l9_1936.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_1937=(1.0-fast::clamp(dot(l9_1936.xyz,float3(1.0)),0.0,1.0))*l9_1936.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_1937=fast::clamp(dot(l9_1936.xyz,float3(1.0)),0.0,1.0)*l9_1936.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_1937=fast::clamp(dot(l9_1936.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_1937=dot(l9_1936.xyz,float3(0.33333001))*l9_1936.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_1937=1.0-fast::clamp(dot(l9_1936.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_1939=l9_1938;
float l9_1940=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_1939;
float3 l9_1941=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_1935.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_1942=float4(l9_1941.x,l9_1941.y,l9_1941.z,l9_1940);
param_9=l9_1942;
}
else
{
...
{
float4 l9_1943=param_9;
float4 l9_1944=float4(0.0);
float4 l9_1945=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_1946=out.FragColor0;
float4 l9_1947=l9_1946;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_1947.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_1949=gl_FragCoord;
float2 l9_1950=l9_1949.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_1951=l9_1950;
...
{
l9_1954=in.varStereoViewID;
}
int l9_1955=l9_1954;
int l9_1956=l9_1955;
float3 l9_1957=float3(l9_1951,0.0);
int l9_1958=l9_1953;
int l9_1959=l9_1956;
if (l9_1958==1)
{
l9_1957.y=((2.0*l9_1957.y)+float(l9_1959))-1.0;
}
float2 l9_1960=l9_1957.xy;
l9_1952=l9_1960;
}
else
{
...
float2 l9_1961=l9_1952;
float2 l9_1962=l9_1961;
float2 l9_1963=l9_1962;
int l9_1964=0;
if ((int(sc_ScreenTextureHasSwappedViews_tmp)!=0))
{
int l9_1965=0;
...
int l9_1969=l9_1964;
float2 l9_1970=l9_1963;
int l9_1971=l9_1969;
float2 l9_1972=l9_1970;
int l9_1973=l9_1971;
float l9_1974=0.0;
float4 l9_1975=float4(0.0);
float2 l9_1976=l9_1972;
int l9_1977=sc_ScreenTextureLayout_tmp;
int l9_1978=l9_1973;
float l9_1979=l9_1974;
float2 l9_1980=l9_1976;
int l9_1981=l9_1977;
int l9_1982=l9_1978;
float3 l9_1983=float3(0.0);
if (l9_1981==0)
{
l9_1983=float3(l9_1980,0.0);
}
else
{
if (l9_1981==1)
{
l9_1983=float3(l9_1980.x,(l9_1980.y*0.5)+(0.5-(float(l9_1982)*0.5)),0.0);
}
else
{
l9_1983=float3(l9_1980,float(l9_1982));
}
}
float3 l9_1984=l9_1983;
float3 l9_1985=l9_1984;
float2 l9_1986=l9_1985.xy;
float l9_1987=l9_1979;
float4 l9_1988=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_1986,bias(l9_1987));
float4 l9_1989=l9_1988;
l9_1975=l9_1989;
float4 l9_1990=l9_1975;
...
if ((((int(sc_IsEditor_tmp)!=0)&&(int(sc_GetFramebufferColorInvalidUsageMarker_tmp)!=0))&&(!(int(sc_BlendMode_Software_tmp)!=0)))&&(!(int(sc_BlendMode_ColoredGlass_tmp)!=0)))
{
l9_1945.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_1993=l9_1945;
float4 l9_1994=l9_1993;
float3 l9_1995=l9_1994.xyz;
float3 l9_1996=l9_1995;
float3 l9_1997=l9_1943.xyz;
float3 l9_1998=definedBlend(l9_1996,l9_1997,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_1944=float4(l9_1998.x,l9_1998.y,l9_1998.z,l9_1944.w);
float3 l9_1999=mix(l9_1995,l9_1944.xyz,float3(l9_1943.w));
l9_1944=float4(l9_1999.x,l9_1999.y,l9_1999.z,l9_1944.w);
l9_1944.w=1.0;
float4 l9_2000=l9_1944;
param_9=l9_2000;
}
else
{
float4 l9_2001=param_9;
float4 l9_2002=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2002=float4(mix(float3(1.0),l9_2001.xyz,float3(l9_2001.w)),l9_2001.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_2003=l9_2001.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_2003=fast::clamp(l9_2003,0.0,1.0);
}
l9_2002=float4(l9_2001.xyz*l9_2003,l9_2003);
}
else
{
l9_2002=l9_2001;
...
float4 l9_2004=l9_2002;
param_9=l9_2004;
}
}
}
float4 l9_2005=param_9;
FinalColor=l9_2005;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
float4 l9_2006=float4(0.0);
if ((int(sc_ShaderComplexityAnalyzer_tmp)!=0))
{
l9_2006=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_2006=float4(0.0);
}
float4 l9_2007=l9_2006;
float4 Cost=l9_2007;
if (Cost.w>0.0)
{
FinalColor=Cost;
...
float4 l9_2008=param_12;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_2008.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_2008;
return out;
}
} // FRAGMENT SHADER
...
l9_68=l9_112;
float l9_113=l9_68.x;
int l9_114=l9_71.x;
bool l9_115=l9_77;
float l9_116=l9_78;
if ((l9_114==0)||(l9_114==3))
{
float l9_117=l9_113;
float l9_118=0.0;
float l9_119=1.0;
...
float2 l9_145=l9_144.xy;
float l9_146=l9_138;
float4 l9_147=sc_set0.baseColorTexture.sample(sc_set0.baseColorTextureSmpSC,l9_145,bias(l9_146));
float4 l9_148=l9_147;
float4 l9_149=l9_148;
if (l9_74)
{
l9_149=mix(l9_75,l9_149,float4(l9_78));
}
...
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_153=float4(pow(l9_152.x,2.2),pow(l9_152.y,2.2),pow(l9_152.z,2.2),pow(l9_152.w,2.2));
}
else
{
l9_153=l9_152*l9_152;
}
...
if (N35_EnableVertexColor)
{
float4 l9_155=tempGlobals.VertexColor;
l9_41*=l9_155;
}
N35_Opacity=l9_41.w;
l9_40=N35_Opacity;
...
float2 l9_157=(*sc_set0.UserUniforms).normalTexture_offset;
l9_156=l9_157;
float2 l9_158=float2(0.0);
float2 l9_159=(*sc_set0.UserUniforms).normalTexture_scale;
l9_158=l9_159;
float l9_160=0.0;
float l9_161=(*sc_set0.UserUniforms).normalTexture_rotation;
l9_160=l9_161;
float2 l9_162=float2(0.0);
float2 l9_163=(*sc_set0.UserUniforms).metallicRoughnessTexture_offset;
l9_162=l9_163;
float2 l9_164=float2(0.0);
float2 l9_165=(*sc_set0.UserUniforms).metallicRoughnessTexture_scale;
l9_164=l9_165;
float l9_166=0.0;
float l9_167=(*sc_set0.UserUniforms).metallicRoughnessTexture_rotation;
l9_166=l9_167;
float2 l9_168=float2(0.0);
float2 l9_169=(*sc_set0.UserUniforms).sheenRoughnessTexture_offset;
l9_168=l9_169;
float2 l9_170=float2(0.0);
float2 l9_171=(*sc_set0.UserUniforms).sheenRoughnessTexture_scale;
l9_170=l9_171;
float l9_172=0.0;
float l9_173=(*sc_set0.UserUniforms).sheenRoughnessTexture_rotation;
l9_172=l9_173;
float2 l9_174=float2(0.0);
float2 l9_175=(*sc_set0.UserUniforms).clearcoatNormalTexture_offset;
l9_174=l9_175;
float2 l9_176=float2(0.0);
float2 l9_177=(*sc_set0.UserUniforms).clearcoatNormalTexture_scale;
l9_176=l9_177;
float l9_178=0.0;
float l9_179=(*sc_set0.UserUniforms).clearcoatNormalTexture_rotation;
l9_178=l9_179;
float2 l9_180=float2(0.0);
float2 l9_181=(*sc_set0.UserUniforms).clearcoatRoughnessTexture_offset;
l9_180=l9_181;
float2 l9_182=float2(0.0);
float2 l9_183=(*sc_set0.UserUniforms).clearcoatRoughnessTexture_scale;
l9_182=l9_183;
float l9_184=0.0;
float l9_185=(*sc_set0.UserUniforms).clearcoatRoughnessTexture_rotation;
l9_184=l9_185;
float l9_186=0.0;
...
float l9_194=l9_24;
float l9_195=l9_34;
float2 l9_196=l9_156;
float2 l9_197=l9_158;
float l9_198=l9_160;
float2 l9_199=l9_162;
float2 l9_200=l9_164;
float l9_201=l9_166;
float2 l9_202=l9_168;
float2 l9_203=l9_170;
float l9_204=l9_172;
float2 l9_205=l9_174;
float2 l9_206=l9_176;
float l9_207=l9_178;
float2 l9_208=l9_180;
float2 l9_209=l9_182;
float l9_210=l9_184;
ssGlobals l9_211=param;
tempGlobals=l9_211;
float l9_212=0.0;
...
float l9_216=0.0;
N3_EnableNormalTexture=(int(ENABLE_NORMALMAP_tmp)!=0);
N3_NormalScale=l9_191;
N3_NormalTextureCoord=NODE_8_DROPLIST_ITEM_tmp;
N3_RoughnessValue=l9_192;
N3_EnableMetallicRoughnessTexture=(int(ENABLE_METALLIC_ROUGHNESS_TEX_tmp)!=0);
N3_MaterialParamsTextureCoord=NODE_11_DROPLIST_ITEM_tmp;
N3_SheenEnable=(int(ENABLE_SHEEN_tmp)!=0);
N3_SheenRoughnessFactor=l9_193;
N3_EnableSheenRoughnessTexture=(int(ENABLE_SHEEN_ROUGHNESS_TEX_tmp)!=0);
N3_SheenRoughnessTextureCoord=Tweak_N37_tmp;
N3_ClearcoatEnable=(int(ENABLE_CLEARCOAT_tmp)!=0);
N3_ClearcoatRoughnessFactor=l9_194;
N3_EnableClearCoatRoughnessTexture=(int(ENABLE_CLEARCOAT_ROUGHNESS_TEX_tmp)!=0);
N3_ClearcoatRoughnessTextureCoord=Tweak_N60_tmp;
N3_EnableClearCoatNormalTexture=(int(ENABLE_CLEARCOAT_NORMAL_TEX_tmp)!=0);
N3_ClearcoatNormalMapCoord=Tweak_N47_tmp;
...
N3_EnableTextureTransform=(int(ENABLE_TEXTURE_TRANSFORM_tmp)!=0);
N3_NormalTextureTransform=(int(ENABLE_NORMAL_TEXTURE_TRANSFORM_tmp)!=0);
N3_NormalTextureOffset=l9_196;
N3_NormalTextureScale=l9_197;
N3_NormalTextureRotation=l9_198;
N3_MaterialParamsTextureTransform=(int(ENABLE_METALLIC_ROUGHNESS_TEXTURE_TRANSFORM_tmp)!=0);
N3_MaterialParamsTextureOffset=l9_199;
N3_MaterialParamsTextureScale=l9_200;
N3_MaterialParamsTextureRotation=l9_201;
N3_SheenRoughnessTextureTransform=(int(ENABLE_SHEEN_ROUGHNESS_TEXTURE_TRANSFORM_tmp)!=0);
N3_SheenRoughnessTextureOffset=l9_202;
N3_SheenRoughnessTextureScale=l9_203;
N3_SheenRoughnessTextureRotation=l9_204;
N3_ClearcoatNormalTextureTransform=(int(ENABLE_CLEARCOAT_NORMAL_TEXTURE_TRANSFORM_tmp)!=0);
N3_ClearcoatNormalTextureOffset=l9_205;
N3_ClearcoatNormalTextureScale=l9_206;
N3_ClearcoatNormalTextureRotation=l9_207;
N3_ClearcoatRoughnessTextureTransform=(int(ENABLE_CLEARCOAT_ROUGHNESS_TEXTURE_TRANSFORM_tmp)!=0);
N3_ClearcoatRoughnessTextureOffset=l9_208;
N3_ClearcoatRoughnessTextureScale=l9_209;
N3_ClearcoatRoughnessTextureRotation=l9_210;
N3_Opacity=N3_OpacityIn;
float3 l9_217=tempGlobals.VertexNormal_WorldSpace;
N3_Normal=normalize(l9_217);
if (N3_EnableNormalTexture)
{
float3 l9_218=N3_Normal;
int l9_219=N3_NormalTextureCoord;
float2 l9_220=tempGlobals.Surface_UVCoord0;
...
if (l9_219==1)
{
float2 l9_223=tempGlobals.Surface_UVCoord1;
l9_221=l9_223;
}
...
float2 l9_227=N3_NormalTextureOffset;
float2 l9_228=N3_NormalTextureScale;
float l9_229=N3_NormalTextureRotation;
float l9_230=radians(l9_229);
float3x3 l9_231=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_227.x,l9_227.y,1.0));
float3x3 l9_232=float3x3(float3(cos(l9_230),sin(l9_230),0.0),float3(-sin(l9_230),cos(l9_230),0.0),float3(0.0,0.0,1.0));
float3x3 l9_233=float3x3(float3(l9_228.x,0.0,0.0),float3(0.0,l9_228.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_234=(l9_231*l9_232)*l9_233;
float2 l9_235=(l9_234*float3(l9_226,1.0)).xy;
l9_225=l9_235;
}
float2 l9_236=l9_225;
...
int l9_243=l9_238;
int l9_244=normalTextureLayout_tmp;
int l9_245=l9_243;
float2 l9_246=l9_236;
bool l9_247=(int(SC_USE_UV_TRANSFORM_normalTexture_tmp)!=0);
float3x3 l9_248=(*sc_set0.UserUniforms).normalTextureTransform;
int2 l9_249=int2(SC_SOFTWARE_WRAP_MODE_U_normalTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTexture_tmp);
bool l9_250=(int(SC_USE_UV_MIN_MAX_normalTexture_tmp)!=0);
float4 l9_251=(*sc_set0.UserUniforms).normalTextureUvMinMax;
bool l9_252=(int(SC_USE_CLAMP_TO_BORDER_normalTexture_tmp)!=0);
float4 l9_253=(*sc_set0.UserUniforms).normalTextureBorderColor;
float l9_254=0.0;
...
float2 l9_323=l9_322.xy;
float l9_324=l9_316;
float4 l9_325=sc_set0.normalTexture.sample(sc_set0.normalTextureSmpSC,l9_323,bias(l9_324));
float4 l9_326=l9_325;
float4 l9_327=l9_326;
if (l9_252)
{
l9_327=mix(l9_253,l9_327,float4(l9_256));
}
float4 l9_328=l9_327;
l9_237=l9_328;
float4 l9_329=l9_237;
float3 l9_330=(l9_329.xyz*1.9921875)-float3(1.0);
l9_330=mix(float3(0.0,0.0,1.0),l9_330,float3(N3_NormalScale));
float3 l9_331=tempGlobals.VertexTangent_WorldSpace;
float3 l9_332=l9_331;
float3 l9_333=tempGlobals.VertexBinormal_WorldSpace;
float3 l9_334=l9_333;
float3x3 l9_335=float3x3(float3(l9_332),float3(l9_334),float3(l9_218));
l9_218=normalize(l9_335*l9_330);
N3_Normal=l9_218;
}
N3_Roughness=N3_RoughnessValue;
if (N3_EnableMetallicRoughnessTexture)
{
float l9_336=N3_Roughness;
int l9_337=N3_MaterialParamsTextureCoord;
...
if (l9_337==1)
{
float2 l9_341=tempGlobals.Surface_UVCoord1;
l9_339=l9_341;
}
...
float2 l9_345=N3_MaterialParamsTextureOffset;
float2 l9_346=N3_MaterialParamsTextureScale;
float l9_347=N3_MaterialParamsTextureRotation;
float l9_348=radians(l9_347);
float3x3 l9_349=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_345.x,l9_345.y,1.0));
float3x3 l9_350=float3x3(float3(cos(l9_348),sin(l9_348),0.0),float3(-sin(l9_348),cos(l9_348),0.0),float3(0.0,0.0,1.0));
float3x3 l9_351=float3x3(float3(l9_346.x,0.0,0.0),float3(0.0,l9_346.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_352=(l9_349*l9_350)*l9_351;
float2 l9_353=(l9_352*float3(l9_344,1.0)).xy;
l9_343=l9_353;
}
float2 l9_354=l9_343;
...
int l9_361=l9_356;
int l9_362=metallicRoughnessTextureLayout_tmp;
int l9_363=l9_361;
float2 l9_364=l9_354;
bool l9_365=(int(SC_USE_UV_TRANSFORM_metallicRoughnessTexture_tmp)!=0);
float3x3 l9_366=(*sc_set0.UserUniforms).metallicRoughnessTextureTransform;
int2 l9_367=int2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture_tmp);
bool l9_368=(int(SC_USE_UV_MIN_MAX_metallicRoughnessTexture_tmp)!=0);
float4 l9_369=(*sc_set0.UserUniforms).metallicRoughnessTextureUvMinMax;
bool l9_370=(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture_tmp)!=0);
float4 l9_371=(*sc_set0.UserUniforms).metallicRoughnessTextureBorderColor;
float l9_372=0.0;
...
float l9_442=l9_434;
float4 l9_443=sc_set0.metallicRoughnessTexture.sample(sc_set0.metallicRoughnessTextureSmpSC,l9_441,bias(l9_442));
...
float l9_449=N3_Opacity;
float l9_450;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_450=pow(l9_449,0.45454544);
}
else
{
l9_450=sqrt(l9_449);
...
if (N3_SheenEnable)
{
float3 l9_452=N3_Normal;
float l9_453=N3_SheenRoughnessFactor;
if (N3_EnableSheenRoughnessTexture)
{
int l9_454=N3_SheenRoughnessTextureCoord;
...
float2 l9_462=N3_SheenRoughnessTextureOffset;
float2 l9_463=N3_SheenRoughnessTextureScale;
float l9_464=N3_SheenRoughnessTextureRotation;
float l9_465=radians(l9_464);
float3x3 l9_466=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_462.x,l9_462.y,1.0));
float3x3 l9_467=float3x3(float3(cos(l9_465),sin(l9_465),0.0),float3(-sin(l9_465),cos(l9_465),0.0),float3(0.0,0.0,1.0));
float3x3 l9_468=float3x3(float3(l9_463.x,0.0,0.0),float3(0.0,l9_463.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_469=(l9_466*l9_467)*l9_468;
float2 l9_470=(l9_469*float3(l9_461,1.0)).xy;
l9_460=l9_470;
}
float2 l9_471=l9_460;
...
int l9_478=l9_473;
int l9_479=sheenRoughnessTextureLayout_tmp;
int l9_480=l9_478;
float2 l9_481=l9_471;
bool l9_482=(int(SC_USE_UV_TRANSFORM_sheenRoughnessTexture_tmp)!=0);
float3x3 l9_483=(*sc_set0.UserUniforms).sheenRoughnessTextureTransform;
int2 l9_484=int2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture_tmp);
bool l9_485=(int(SC_USE_UV_MIN_MAX_sheenRoughnessTexture_tmp)!=0);
float4 l9_486=(*sc_set0.UserUniforms).sheenRoughnessTextureUvMinMax;
bool l9_487=(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture_tmp)!=0);
float4 l9_488=(*sc_set0.UserUniforms).sheenRoughnessTextureBorderColor;
float l9_489=0.0;
...
float l9_559=l9_551;
float4 l9_560=sc_set0.sheenRoughnessTexture.sample(sc_set0.sheenRoughnessTextureSmpSC,l9_558,bias(l9_559));
...
float l9_565=l9_564.w;
float l9_566;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_566=pow(l9_565,2.2);
}
else
{
l9_566=l9_565*l9_565;
}
float l9_567=l9_566;
l9_453*=l9_567;
}
l9_453=fast::max(l9_453,9.9999997e-05);
float3 l9_568=l9_452;
float3 l9_569=(*sc_set0.UserUniforms).sc_Camera.position;
float3 l9_570=tempGlobals.SurfacePosition_WorldSpace;
float3 l9_571=normalize(l9_569-l9_570);
float3 l9_572=normalize(reflect(-l9_571,l9_568));
float3 l9_573=l9_572;
float l9_574=l9_453;
float l9_575=l9_574*4.0;
l9_575=3.0+(((l9_575-0.0)*2.0)/5.000001);
float3 l9_576=l9_573;
float l9_577=l9_575;
float3 l9_578=l9_576;
float l9_579=l9_577;
float3 l9_580=l9_578;
float l9_581=l9_579;
float3 l9_582=l9_580;
float l9_583=(*sc_set0.UserUniforms).sc_EnvmapRotation.y;
float2 l9_584=float2(0.0);
float l9_585=l9_582.x;
float l9_586=-l9_582.z;
float l9_587=(l9_585<0.0) ? (-1.0) : 1.0;
float l9_588=l9_587*acos(fast::clamp(l9_586/length(float2(l9_585,l9_586)),-1.0,1.0));
l9_584.x=l9_588-1.5707964;
l9_584.y=acos(l9_582.y);
l9_584/=float2(6.2831855,3.1415927);
l9_584.y=1.0-l9_584.y;
l9_584.x+=(l9_583/360.0);
l9_584.x=fract((l9_584.x+floor(l9_584.x))+1.0);
float2 l9_589=l9_584;
float2 l9_590=l9_589;
if (SC_DEVICE_CLASS_tmp>=2)
{
float l9_591=floor(l9_581);
float l9_592=ceil(l9_581);
float2 l9_593=l9_590;
float2 l9_594=(*sc_set0.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_595=l9_591;
float2 l9_596=l9_590;
float2 l9_597=(*sc_set0.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_598=l9_592;
}
else
{
...
if (N3_EnableClearCoatRoughnessTexture)
{
int l9_599=N3_ClearcoatRoughnessTextureCoord;
float2 l9_600=tempGlobals.Surface_UVCoord0;
...
if (l9_599==1)
{
float2 l9_603=tempGlobals.Surface_UVCoord1;
l9_601=l9_603;
}
...
float2 l9_607=N3_ClearcoatRoughnessTextureOffset;
float2 l9_608=N3_ClearcoatRoughnessTextureScale;
float l9_609=N3_ClearcoatRoughnessTextureRotation;
float l9_610=radians(l9_609);
float3x3 l9_611=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_607.x,l9_607.y,1.0));
float3x3 l9_612=float3x3(float3(cos(l9_610),sin(l9_610),0.0),float3(-sin(l9_610),cos(l9_610),0.0),float3(0.0,0.0,1.0));
float3x3 l9_613=float3x3(float3(l9_608.x,0.0,0.0),float3(0.0,l9_608.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_614=(l9_611*l9_612)*l9_613;
float2 l9_615=(l9_614*float3(l9_606,1.0)).xy;
l9_605=l9_615;
}
float2 l9_616=l9_605;
...
int l9_623=l9_618;
int l9_624=clearcoatRoughnessTextureLayout_tmp;
int l9_625=l9_623;
float2 l9_626=l9_616;
bool l9_627=(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture_tmp)!=0);
float3x3 l9_628=(*sc_set0.UserUniforms).clearcoatRoughnessTextureTransform;
int2 l9_629=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture_tmp);
bool l9_630=(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_631=(*sc_set0.UserUniforms).clearcoatRoughnessTextureUvMinMax;
bool l9_632=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_633=(*sc_set0.UserUniforms).clearcoatRoughnessTextureBorderColor;
float l9_634=0.0;
bool l9_635=l9_632&&(!l9_630);
float l9_636=1.0;
float l9_637=l9_626.x;
int l9_638=l9_629.x;
if (l9_638==1)
{
l9_637=fract(l9_637);
...
if (l9_638==2)
{
float l9_639=fract(l9_637);
float l9_640=l9_637-l9_639;
float l9_641=step(0.25,fract(l9_640*0.5));
l9_637=mix(l9_639,1.0-l9_639,fast::clamp(l9_641,0.0,1.0));
}
}
l9_626.x=l9_637;
float l9_642=l9_626.y;
int l9_643=l9_629.y;
if (l9_643==1)
{
l9_642=fract(l9_642);
...
float l9_649=l9_626.x;
float l9_650=l9_631.x;
float l9_651=l9_631.z;
bool l9_652=l9_648;
float l9_653=l9_636;
...
float l9_658=l9_626.y;
float l9_659=l9_631.y;
float l9_660=l9_631.w;
bool l9_661=l9_657;
float l9_662=l9_636;
...
float2 l9_665=l9_626;
bool l9_666=l9_627;
float3x3 l9_667=l9_628;
if (l9_666)
{
l9_665=float2((l9_667*float3(l9_665,1.0)).xy);
}
float2 l9_668=l9_665;
float2 l9_669=l9_668;
float2 l9_670=l9_669;
l9_626=l9_670;
float l9_671=l9_626.x;
int l9_672=l9_629.x;
bool l9_673=l9_635;
float l9_674=l9_636;
...
l9_626.x=l9_671;
l9_636=l9_674;
float l9_682=l9_626.y;
int l9_683=l9_629.y;
bool l9_684=l9_635;
float l9_685=l9_636;
if ((l9_683==0)||(l9_683==3))
{
float l9_686=l9_682;
float l9_687=0.0;
float l9_688=1.0;
...
l9_626.y=l9_682;
l9_636=l9_685;
float2 l9_693=l9_626;
int l9_694=l9_624;
int l9_695=l9_625;
float l9_696=l9_634;
float2 l9_697=l9_693;
int l9_698=l9_694;
int l9_699=l9_695;
float3 l9_700=float3(0.0);
if (l9_698==0)
{
l9_700=float3(l9_697,0.0);
}
else
{
if (l9_698==1)
{
l9_700=float3(l9_697.x,(l9_697.y*0.5)+(0.5-(float(l9_699)*0.5)),0.0);
}
else
{
l9_700=float3(l9_697,float(l9_699));
}
}
float3 l9_701=l9_700;
float3 l9_702=l9_701;
float2 l9_703=l9_702.xy;
float l9_704=l9_696;
float4 l9_705=sc_set0.clearcoatRoughnessTexture.sample(sc_set0.clearcoatRoughnessTextureSmpSC,l9_703,bias(l9_704));
float4 l9_706=l9_705;
float4 l9_707=l9_706;
if (l9_632)
{
l9_707=mix(l9_633,l9_707,float4(l9_636));
}
float4 l9_708=l9_707;
l9_617=l9_708;
float4 l9_709=l9_617;
float l9_710=l9_709.y;
float l9_711;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_711=pow(l9_710,2.2);
}
else
{
l9_711=l9_710*l9_710;
}
float l9_712=l9_711;
N3_ClearcoatRoughness=l9_712;
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
int l9_713=N3_ClearcoatNormalMapCoord;
float2 l9_714=tempGlobals.Surface_UVCoord0;
...
if (l9_713==1)
{
float2 l9_717=tempGlobals.Surface_UVCoord1;
l9_715=l9_717;
}
float2 l9_718=l9_715;
float2 l9_719=l9_718;
if (N3_EnableTextureTransform&&N3_ClearcoatNormalTextureTransform)
{
float2 l9_720=l9_719;
float2 l9_721=N3_ClearcoatNormalTextureOffset;
float2 l9_722=N3_ClearcoatNormalTextureScale;
float l9_723=N3_ClearcoatNormalTextureRotation;
float l9_724=radians(l9_723);
float3x3 l9_725=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_721.x,l9_721.y,1.0));
float3x3 l9_726=float3x3(float3(cos(l9_724),sin(l9_724),0.0),float3(-sin(l9_724),cos(l9_724),0.0),float3(0.0,0.0,1.0));
float3x3 l9_727=float3x3(float3(l9_722.x,0.0,0.0),float3(0.0,l9_722.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_728=(l9_725*l9_726)*l9_727;
float2 l9_729=(l9_728*float3(l9_720,1.0)).xy;
l9_719=l9_729;
}
float2 l9_730=l9_719;
...
int l9_737=l9_732;
int l9_738=clearcoatNormalTextureLayout_tmp;
int l9_739=l9_737;
float2 l9_740=l9_730;
bool l9_741=(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture_tmp)!=0);
float3x3 l9_742=(*sc_set0.UserUniforms).clearcoatNormalTextureTransform;
int2 l9_743=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture_tmp);
bool l9_744=(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture_tmp)!=0);
float4 l9_745=(*sc_set0.UserUniforms).clearcoatNormalTextureUvMinMax;
bool l9_746=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture_tmp)!=0);
float4 l9_747=(*sc_set0.UserUniforms).clearcoatNormalTextureBorderColor;
float l9_748=0.0;
bool l9_749=l9_746&&(!l9_744);
float l9_750=1.0;
float l9_751=l9_740.x;
int l9_752=l9_743.x;
if (l9_752==1)
{
l9_751=fract(l9_751);
...
if (l9_752==2)
{
float l9_753=fract(l9_751);
float l9_754=l9_751-l9_753;
float l9_755=step(0.25,fract(l9_754*0.5));
l9_751=mix(l9_753,1.0-l9_753,fast::clamp(l9_755,0.0,1.0));
}
}
l9_740.x=l9_751;
float l9_756=l9_740.y;
int l9_757=l9_743.y;
if (l9_757==1)
{
l9_756=fract(l9_756);
...
float l9_763=l9_740.x;
float l9_764=l9_745.x;
float l9_765=l9_745.z;
bool l9_766=l9_762;
float l9_767=l9_750;
...
float l9_772=l9_740.y;
float l9_773=l9_745.y;
float l9_774=l9_745.w;
bool l9_775=l9_771;
float l9_776=l9_750;
...
float2 l9_779=l9_740;
bool l9_780=l9_741;
float3x3 l9_781=l9_742;
if (l9_780)
{
l9_779=float2((l9_781*float3(l9_779,1.0)).xy);
}
float2 l9_782=l9_779;
float2 l9_783=l9_782;
float2 l9_784=l9_783;
l9_740=l9_784;
float l9_785=l9_740.x;
int l9_786=l9_743.x;
bool l9_787=l9_749;
float l9_788=l9_750;
...
float l9_818=l9_810;
float4 l9_819=sc_set0.clearcoatNormalTexture.sample(sc_set0.clearcoatNormalTextureSmpSC,l9_817,bias(l9_818));
float4 l9_820=l9_819;
float4 l9_821=l9_820;
if (l9_746)
{
l9_821=mix(l9_747,l9_821,float4(l9_750));
}
float4 l9_822=l9_821;
l9_731=l9_822;
float4 l9_823=l9_731;
N3_ClearcoatNormal=l9_823.xyz;
N3_ClearcoatNormal*=0.9921875;
}
}
l9_212=N3_Opacity;
l9_213=N3_Normal;
l9_214=N3_Roughness;
l9_215=N3_ClearcoatNormal;
l9_216=N3_ClearcoatRoughness;
l9_186=l9_212;
l9_187=l9_213;
l9_188=l9_214;
l9_189=l9_215;
l9_190=l9_216;
float l9_824=l9_186;
float3 l9_825=l9_187;
float l9_826=l9_188;
ssGlobals l9_827=param;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_827.BumpedNormal=l9_825;
}
l9_824=fast::clamp(l9_824,0.0,1.0);
float l9_828=l9_824;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_828<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
if ((int(ENABLE_STIPPLE_PATTERN_TEST_tmp)!=0))
{
float4 l9_829=gl_FragCoord;
float2 l9_830=floor(mod(l9_829.xy,float2(4.0)));
float l9_831=(mod(dot(l9_830,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_828<l9_831)
{
discard_fragment();
}
}
float3 l9_832=l9_827.PositionWS;
float3 l9_833=l9_827.BumpedNormal;
float l9_834=l9_826;
float3 l9_835=normalize((*sc_set0.UserUniforms).sc_Camera.position-l9_832);
if (dot(l9_835,l9_833)>=(-0.050000001))
{
uint3 l9_836=uint3(round((l9_832-(*sc_set0.UserUniforms).OriginNormalizationOffset)*(*sc_set0.UserUniforms).OriginNormalizationScale));
out.position_and_mask=uint4(l9_836.x,l9_836.y,l9_836.z,out.position_and_mask.w);
out.position_and_mask.w=uint((*sc_set0.UserUniforms).receiver_mask);
float3 l9_837=l9_833;
float l9_838=dot(abs(l9_837),float3(1.0));
l9_837/=float3(l9_838);
float l9_839=fast::clamp(-l9_837.z,0.0,1.0);
float2 l9_840=l9_837.xy;
float l9_841;
if (l9_837.x>=0.0)
{
l9_841=l9_839;
...
uint2 l9_845=uint2(as_type<uint>(half2(float2(l9_844.x,0.0))),as_type<uint>(half2(float2(l9_844.y,0.0))));
out.normal_and_more=uint4(l9_845.x,l9_845.y,out.normal_and_more.z,out.normal_and_more.w);
...
{
l9_846=uint(fast::clamp(l9_834,0.0,1.0)*1000.0);
}
uint l9_847=l9_846;
l9_847 |= uint(((*sc_set0.UserUniforms).receiverId%32)<<int(10u));
out.normal_and_more.w=l9_847;
}
else
{
...
float l9_848=(*sc_set0.UserUniforms).Port_Opacity_N405;
float3 l9_849=l9_189;
float l9_850=l9_190;
ssGlobals l9_851=param;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_851.BumpedNormal=float3x3(float3(l9_851.VertexTangent_WorldSpace),float3(l9_851.VertexBinormal_WorldSpace),float3(l9_851.VertexNormal_WorldSpace))*l9_849;
}
float l9_852=l9_848;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_852<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_854=floor(mod(l9_853.xy,float2(4.0)));
float l9_855=(mod(dot(l9_854,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_852<l9_855)
{
discard_fragment();
}
}
float3 l9_856=l9_851.PositionWS;
float3 l9_857=l9_851.BumpedNormal;
float l9_858=l9_850;
float3 l9_859=normalize((*sc_set0.UserUniforms).sc_Camera.position-l9_856);
if (dot(l9_859,l9_857)>=(-0.050000001))
{
uint3 l9_860=uint3(round((l9_856-(*sc_set0.UserUniforms).OriginNormalizationOffset)*(*sc_set0.UserUniforms).OriginNormalizationScale));
out.position_and_mask=uint4(l9_860.x,l9_860.y,l9_860.z,out.position_and_mask.w);
out.position_and_mask.w=uint((*sc_set0.UserUniforms).receiver_mask);
float3 l9_861=l9_857;
float l9_862=dot(abs(l9_861),float3(1.0));
l9_861/=float3(l9_862);
float l9_863=fast::clamp(-l9_861.z,0.0,1.0);
...
uint2 l9_869=uint2(as_type<uint>(half2(float2(l9_868.x,0.0))),as_type<uint>(half2(float2(l9_868.y,0.0))));
out.normal_and_more=uint4(l9_869.x,l9_869.y,out.normal_and_more.z,out.normal_and_more.w);
out.normal_and_more.z=as_type<uint>(half2(float2(0.0)));
uint l9_870;
if (l9_858<0.0)
{
...
{
l9_870=uint(fast::clamp(l9_858,0.0,1.0)*1000.0);
}
uint l9_871=l9_870;
l9_871 |= uint(((*sc_set0.UserUniforms).receiverId%32)<<int(10u));
out.normal_and_more.w=l9_871;
}
else
{
out.position_and_mask=uint4(0u);
...
ssGlobals l9_872=param;
tempGlobals=l9_872;
}
else
{
float4 l9_873=float4(0.0);
float4 l9_874=(*sc_set0.UserUniforms).baseColorFactor;
l9_873=l9_874;
float2 l9_875=float2(0.0);
float2 l9_876=(*sc_set0.UserUniforms).baseColorTexture_offset;
l9_875=l9_876;
float2 l9_877=float2(0.0);
float2 l9_878=(*sc_set0.UserUniforms).baseColorTexture_scale;
l9_877=l9_878;
float l9_879=0.0;
float l9_880=(*sc_set0.UserUniforms).baseColorTexture_rotation;
l9_879=l9_880;
float4 l9_881=l9_873;
float2 l9_882=l9_875;
float2 l9_883=l9_877;
float l9_884=l9_879;
ssGlobals l9_885=param;
tempGlobals=l9_885;
N35_EnableVertexColor=(int(ENABLE_VERTEX_COLOR_BASE_tmp)!=0);
N35_EnableBaseTexture=(int(ENABLE_BASE_TEX_tmp)!=0);
N35_BaseColorTextureCoord=NODE_7_DROPLIST_ITEM_tmp;
N35_BaseColorFactor=l9_881;
N35_EnableTextureTransform=(int(ENABLE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureTransform=(int(ENABLE_BASE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureOffset=l9_882;
N35_BaseTextureScale=l9_883;
N35_BaseTextureRotation=l9_884;
float4 l9_886=N35_BaseColorFactor;
if (N35_EnableBaseTexture)
{
int l9_887=N35_BaseColorTextureCoord;
...
float2 l9_895=N35_BaseTextureOffset;
float2 l9_896=N35_BaseTextureScale;
float l9_897=N35_BaseTextureRotation;
float3x3 l9_898=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_895.x,l9_895.y,1.0));
float3x3 l9_899=float3x3(float3(cos(l9_897),sin(l9_897),0.0),float3(-sin(l9_897),cos(l9_897),0.0),float3(0.0,0.0,1.0));
float3x3 l9_900=float3x3(float3(l9_896.x,0.0,0.0),float3(0.0,l9_896.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_901=(l9_898*l9_899)*l9_900;
float2 l9_902=(l9_901*float3(l9_894,1.0)).xy;
l9_893=l9_902;
}
...
int l9_910=l9_905;
int l9_911=baseColorTextureLayout_tmp;
int l9_912=l9_910;
float2 l9_913=l9_903;
bool l9_914=(int(SC_USE_UV_TRANSFORM_baseColorTexture_tmp)!=0);
float3x3 l9_915=(*sc_set0.UserUniforms).baseColorTextureTransform;
int2 l9_916=int2(SC_SOFTWARE_WRAP_MODE_U_baseColorTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_baseColorTexture_tmp);
bool l9_917=(int(SC_USE_UV_MIN_MAX_baseColorTexture_tmp)!=0);
float4 l9_918=(*sc_set0.UserUniforms).baseColorTextureUvMinMax;
bool l9_919=(int(SC_USE_CLAMP_TO_BORDER_baseColorTexture_tmp)!=0);
float4 l9_920=(*sc_set0.UserUniforms).baseColorTextureBorderColor;
float l9_921=0.0;
...
float l9_991=l9_983;
float4 l9_992=sc_set0.baseColorTexture.sample(sc_set0.baseColorTextureSmpSC,l9_990,bias(l9_991));
float4 l9_993=l9_992;
...
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_998=float4(pow(l9_997.x,2.2),pow(l9_997.y,2.2),pow(l9_997.z,2.2),pow(l9_997.w,2.2));
}
else
{
...
if (N35_EnableVertexColor)
{
float4 l9_1000=tempGlobals.VertexColor;
l9_886*=l9_1000;
}
N35_Opacity=l9_886.w;
}
return out;
}
