...
//float notification_tile_lightness 4272
//float notification_outline_lightness 4276
//float3x3 notification_outline_maskTransform 4336
//float4 notification_outline_maskUvMinMax 4384
//float4 notification_outline_maskBorderColor 4400
//float notification_tile_opacity 4416
//float Port_Input1_N018 4420
//float Port_Input1_N021 4424
//float4 Port_Import_N038 4432
//float4 Port_Import_N039 4448
//float Port_Input0_N066 4464
//float Port_Input1_N066 4468
//float Port_RangeMinA_N033 4472
//float Port_RangeMaxA_N033 4476
//float Port_RangeMinB_N033 4480
//float Port_RangeMaxB_N033 4484
//float2 Port_Import_N025 4488
//float2 Port_Center_N047 4496
//float2 Port_Import_N058 4504
//float2 Port_Import_N060 4512
//float Port_Input1_N065 4520
//float Port_Input2_N065 4524
//float2 Port_Offset_N003 4528
//float Port_Rotation_N007 4536
//float2 Port_Center_N007 4544
//float4 Port_Value0_N001 4560
//float Port_Position1_N001 4576
//float4 Port_Value1_N001 4592
//float Port_Position2_N001 4608
//float4 Port_Value2_N001 4624
//float4 Port_Value3_N001 4640
//float2 Port_Offset_N022 4656
//float Port_Rotation_N023 4664
//float2 Port_Center_N023 4672
//float3 Port_Value0_N000 4688
//float Port_Position1_N000 4704
//float3 Port_Value1_N000 4720
//float Port_Position2_N000 4736
//float3 Port_Value2_N000 4752
//float3 Port_Value3_N000 4768
//float Port_Value2_N014 4784
//float depthRef 4788
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_notification_outline_mask 32 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_notification_outline_mask 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_notification_outline_mask 36 0
//spec_const bool UseViewSpaceDepthVariant 37 1
//spec_const bool intensityTextureHasSwappedViews 38 0
//spec_const bool notification_outline_maskHasSwappedViews 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask 77 -1
//spec_const int intensityTextureLayout 78 0
//spec_const int notification_outline_maskLayout 79 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask [[function_constant(77)]];
...
constant int notification_outline_maskLayout [[function_constant(79)]];
...
ValueOut_N33=(((UVCoord_N119-float2((*sc_set0.UserUniforms).Port_RangeMinA_N033))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N033-(*sc_set0.UserUniforms).Port_RangeMinA_N033)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N033-(*sc_set0.UserUniforms).Port_RangeMinB_N033))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N033);
...
float l9_5=sin(radians(param_3));
float l9_6=cos(radians(param_3));
float2 param_5=param_2-param_4;
param_5=float2(dot(float2(l9_6,l9_5),param_5),dot(float2(-l9_5,l9_6),param_5))+param_4;
...
if (l9_8)
{
l9_9=1==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_9=l9_8;
...
float l9_10=sin(radians(param_16));
float l9_11=cos(radians(param_16));
float2 param_18=param_15-param_17;
param_18=float2(dot(float2(l9_11,l9_10),param_18),dot(float2(-l9_10,l9_11),param_18))+param_17;
...
if (l9_13)
{
l9_14=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_14=l9_13;
...
float param_38=0.0;
bool l9_21=param_36&&(!param_34);
float l9_22=1.0;
float l9_23=param_30.x;
int l9_24=param_33.x;
if (l9_24==1)
{
l9_23=fract(l9_23);
}
...
param_30.x=l9_23;
float l9_28=param_30.y;
int l9_29=param_33.y;
if (l9_29==1)
{
l9_28=fract(l9_28);
}
...
float l9_35=param_30.x;
float l9_36=param_35.x;
float l9_37=param_35.z;
bool l9_38=l9_34;
float l9_39=l9_22;
...
float l9_44=param_30.y;
float l9_45=param_35.y;
float l9_46=param_35.w;
bool l9_47=l9_43;
float l9_48=l9_22;
...
float2 l9_51=param_30;
bool l9_52=param_31;
float3x3 l9_53=param_32;
if (l9_52)
{
...
float2 l9_56=l9_55;
param_30=l9_56;
float l9_57=param_30.x;
int l9_58=param_33.x;
bool l9_59=l9_21;
float l9_60=l9_22;
if ((l9_58==0)||(l9_58==3))
{
...
param_30.x=l9_57;
l9_22=l9_60;
float l9_68=param_30.y;
int l9_69=param_33.y;
bool l9_70=l9_21;
float l9_71=l9_22;
if ((l9_69==0)||(l9_69==3))
{
...
param_30.y=l9_68;
l9_22=l9_71;
float2 l9_79=param_30;
int l9_80=param_28;
int l9_81=param_29;
float l9_82=param_38;
float2 l9_83=l9_79;
int l9_84=l9_80;
int l9_85=l9_81;
...
float l9_90=l9_82;
float4 l9_91=sc_set0.notification_outline_mask.sample(sc_set0.notification_outline_maskSmpSC,l9_89,bias(l9_90));
float4 l9_92=l9_91;
float4 l9_93=l9_92;
if (param_36)
{
l9_93=mix(param_37,l9_93,float4(l9_22));
}
float4 l9_94=l9_93;
Color_N11=l9_94;
...
bool l9_98=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_98)
{
...
float4 l9_99=fast::max(param_41,float4(0.0));
float4 param_42=l9_99;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_102=fast::clamp(l9_101.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_102=fast::clamp(dot(l9_101.xyz,float3(l9_101.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_102=(1.0-dot(l9_101.xyz,float3(0.33333001)))*l9_101.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_102=(1.0-fast::clamp(dot(l9_101.xyz,float3(1.0)),0.0,1.0))*l9_101.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_102=fast::clamp(dot(l9_101.xyz,float3(1.0)),0.0,1.0)*l9_101.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_102=fast::clamp(dot(l9_101.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_102=dot(l9_101.xyz,float3(0.33333001))*l9_101.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_102=1.0-fast::clamp(dot(l9_101.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_103=l9_102;
float l9_104=l9_103;
float l9_105=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_104;
float3 l9_106=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_100.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_107=float4(l9_106.x,l9_106.y,l9_106.z,l9_105);
param_43=l9_107;
}
else
{
...
{
float4 l9_108=param_43;
float4 l9_109=float4(0.0);
float4 l9_110=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_111=out.FragColor0;
float4 l9_112=l9_111;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_112.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
int l9_142=sc_ScreenTextureLayout_tmp;
int l9_143=l9_138;
float l9_144=l9_139;
...
float l9_152=l9_144;
float4 l9_153=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_151,bias(l9_152));
float4 l9_154=l9_153;
l9_140=l9_154;
float4 l9_155=l9_140;
...
{
l9_110.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_158=l9_110;
float4 l9_159=l9_158;
float3 l9_160=l9_159.xyz;
float3 l9_161=l9_160;
float3 l9_162=l9_108.xyz;
...
l9_109=float4(l9_163.x,l9_163.y,l9_163.z,l9_109.w);
float3 l9_164=mix(l9_160,l9_109.xyz,float3(l9_108.w));
l9_109=float4(l9_164.x,l9_164.y,l9_164.z,l9_109.w);
l9_109.w=1.0;
float4 l9_165=l9_109;
param_43=l9_165;
}
else
{
float4 l9_166=param_43;
float4 l9_167=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_167=float4(mix(float3(1.0),l9_166.xyz,float3(l9_166.w)),l9_166.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_168=l9_166.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_168=fast::clamp(l9_168,0.0,1.0);
}
l9_167=float4(l9_166.xyz*l9_168,l9_168);
}
else
{
l9_167=l9_166;
...
float4 l9_169=l9_167;
param_43=l9_169;
}
}
}
float4 l9_170=param_43;
FinalColor=l9_170;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_171=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_171=float4(0.0);
...
float4 l9_173=param_46;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_173.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_173;
return out;
}
} // FRAGMENT SHADER
