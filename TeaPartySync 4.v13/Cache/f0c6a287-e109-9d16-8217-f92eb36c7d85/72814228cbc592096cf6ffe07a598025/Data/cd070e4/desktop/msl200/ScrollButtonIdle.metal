...
//}
//ubo int UserUniforms 0:37:5088 {
//float4 sc_Time 1376
...
//float2 Port_Input2_N028 4704
//float4 Port_Value0_N031 4720
//float Port_Position1_N031 4736
//float4 Port_Value1_N031 4752
//float Port_Position2_N031 4768
//float4 Port_Value2_N031 4784
//float Port_Position3_N031 4800
//float4 Port_Value3_N031 4816
//float4 Port_Value4_N031 4832
//float Port_Import_N027 4848
//float3 Port_Import_N041 4864
//float Port_Input1_N045 4880
//float Port_Input2_N045 4884
//float2 Port_Input1_N008 4888
//float2 Port_Input2_N008 4896
//float4 Port_Value0_N005 4912
//float Port_Position1_N005 4928
//float4 Port_Value1_N005 4944
//float Port_Position2_N005 4960
//float4 Port_Value2_N005 4976
//float4 Port_Value3_N005 4992
//float4 Port_Input1_N065 5008
//float3 Port_Normal_N064 5024
//float Port_Exponent_N064 5040
//float Port_Intensity_N064 5044
//float Port_Value0_N016 5048
//float Port_Position1_N016 5052
//float Port_Value1_N016 5056
//float Port_Position2_N016 5060
//float Port_Value2_N016 5064
//float Port_Position3_N016 5068
//float Port_Value3_N016 5072
//float Port_Value4_N016 5076
//float depthRef 5080
//}
...
float l9_170=dot(param_34,param_34);
float l9_171;
if (l9_170>0.0)
{
...
float l9_172=l9_171;
float3 param_35=param_34*l9_172;
Output_N43=param_35;
...
float param_46=0.0;
bool l9_181=param_44&&(!param_42);
float l9_182=1.0;
float l9_183=param_38.x;
int l9_184=param_41.x;
if (l9_184==1)
{
l9_183=fract(l9_183);
}
...
param_38.x=l9_183;
float l9_188=param_38.y;
int l9_189=param_41.y;
if (l9_189==1)
{
l9_188=fract(l9_188);
}
...
float l9_195=param_38.x;
float l9_196=param_43.x;
float l9_197=param_43.z;
bool l9_198=l9_194;
float l9_199=l9_182;
...
float l9_204=param_38.y;
float l9_205=param_43.y;
float l9_206=param_43.w;
bool l9_207=l9_203;
float l9_208=l9_182;
...
float2 l9_211=param_38;
bool l9_212=param_39;
float3x3 l9_213=param_40;
if (l9_212)
{
...
param_38=l9_216;
float l9_217=param_38.x;
int l9_218=param_41.x;
bool l9_219=l9_181;
float l9_220=l9_182;
...
param_38.x=l9_217;
l9_182=l9_220;
float l9_228=param_38.y;
int l9_229=param_41.y;
bool l9_230=l9_181;
float l9_231=l9_182;
...
param_38.y=l9_228;
l9_182=l9_231;
float2 l9_239=param_38;
int l9_240=param_36;
int l9_241=param_37;
float l9_242=param_46;
...
if (param_44)
{
l9_253=mix(param_45,l9_253,float4(l9_182));
}
...
float l9_255=abs(dot(-param_59.ViewDirWS,param_55));
float param_58=pow(1.0-l9_255,param_56);
...
float4 l9_260=fast::max(param_71,float4(0.0));
float4 param_72=l9_260;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_273.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_275=gl_FragCoord;
float2 l9_276=l9_275.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_281=l9_280;
int l9_282=l9_281;
float3 l9_283=float3(l9_277,0.0);
int l9_284=l9_279;
int l9_285=l9_282;
if (l9_284==1)
{
l9_283.y=((2.0*l9_283.y)+float(l9_285))-1.0;
}
float2 l9_286=l9_283.xy;
l9_278=l9_286;
}
else
{
...
int l9_303=sc_ScreenTextureLayout_tmp;
int l9_304=l9_299;
float l9_305=l9_300;
...
float l9_313=l9_305;
float4 l9_314=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_312,bias(l9_313));
...
{
l9_271.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_319=l9_271;
float4 l9_320=l9_319;
float3 l9_321=l9_320.xyz;
float3 l9_322=l9_321;
float3 l9_323=l9_269.xyz;
float3 l9_324=definedBlend(l9_322,l9_323,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_270=float4(l9_324.x,l9_324.y,l9_324.z,l9_270.w);
float3 l9_325=mix(l9_321,l9_270.xyz,float3(l9_269.w));
l9_270=float4(l9_325.x,l9_325.y,l9_325.z,l9_270.w);
l9_270.w=1.0;
float4 l9_326=l9_270;
param_73=l9_326;
}
else
{
float4 l9_327=param_73;
float4 l9_328=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_328=float4(mix(float3(1.0),l9_327.xyz,float3(l9_327.w)),l9_327.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_329=l9_327.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_329=fast::clamp(l9_329,0.0,1.0);
}
l9_328=float4(l9_327.xyz*l9_329,l9_329);
}
else
{
l9_328=l9_327;
...
float4 l9_330=l9_328;
param_73=l9_330;
}
}
}
float4 l9_331=param_73;
FinalColor=l9_331;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_332=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_332=float4(0.0);
...
float4 l9_334=param_76;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_334.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_334;
return out;
}
} // FRAGMENT SHADER
