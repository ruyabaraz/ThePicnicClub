...
//spec_const int NODE_31_DROPLIST_ITEM 5 0
//spec_const int renderTarget0Layout 6 0
//spec_const int renderTarget1Layout 7 0
//spec_const int renderTarget2Layout 8 0
//spec_const int renderTarget3Layout 9 0
...
#endif
#ifndef NODE_31_DROPLIST_ITEM
#define NODE_31_DROPLIST_ITEM 0
#endif
...
gParticle.Life=mix(float(NODE_31_DROPLIST_ITEM),Port_Import_N005,ssGetParticleRandom(1,true,true,true,9.0,gParticle,0.0,sc_Time.x).x);
