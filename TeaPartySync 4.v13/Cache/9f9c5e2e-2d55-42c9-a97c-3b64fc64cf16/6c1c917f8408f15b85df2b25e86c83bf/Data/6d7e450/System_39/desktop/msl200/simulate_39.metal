...
//ubo int UserUniforms 0:31:7504 {
//float4 sc_Time 1376
...
//float4 Tweak_N79 7152
//float4 Tweak_N80 7168
//float3 Port_Import_N216 7184
//float3 Port_Min_N086 7200
//float3 Port_Max_N086 7216
//float Port_Min_N254 7232
//float Port_Max_N254 7236
//float Port_Import_N087 7240
//float3 Port_Import_N089 7248
//float Port_Import_N003 7264
//float Port_Import_N005 7268
//float Port_Min_N008 7272
//float Port_Max_N008 7276
//float Port_Import_N268 7284
//float3 Port_Value_N001 7296
//float3 Port_Import_N013 7312
//float3 Port_Import_N016 7328
//float Port_Min_N043 7376
//float Port_Max_N043 7380
//float Port_Import_N041 7384
//float Port_Import_N059 7388
//float Port_Input0_N063 7396
//float Port_Import_N185 7400
//float Port_Input1_N227 7408
//float Port_Input2_N227 7412
//float Port_Input0_N066 7416
//float Port_Import_N188 7420
//float Port_Input1_N236 7428
//float Port_Input2_N236 7432
//float Port_Min_N038 7436
//float Port_Max_N038 7440
//float Port_Min_N023 7448
//float Port_Max_N023 7452
//float Port_Min_N125 7460
//float Port_Max_N125 7464
//float Port_Import_N163 7488
//}
...
gParticle.CopyId=float(InstanceID/150);
...
l9_61=!(UserUniforms.vfxBatchEnable[l9_62/150]!=0);
}
else
{
l9_61=l9_60;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/150];
...
float l9_192=0.0;
l9_192=(*sc_set0.UserUniforms).Port_Import_N003;
float l9_193=0.0;
l9_193=(*sc_set0.UserUniforms).Port_Import_N005;
float l9_194=0.0;
float l9_195=l9_192;
float l9_196=l9_193;
...
float l9_273=mix(l9_195,l9_196,l9_272.x);
l9_194=l9_273;
float l9_274=l9_194;
gParticle.Life=l9_274;
gParticle.Life=fast::clamp(gParticle.Life,0.1,3.0);
float l9_275=0.0;
float l9_276=(*sc_set0.UserUniforms).Port_Min_N008;
float l9_277=(*sc_set0.UserUniforms).Port_Max_N008;
...
l9_355=l9_275;
float l9_356=0.0;
l9_356=(*sc_set0.UserUniforms).Port_Import_N268;
float l9_357=0.0;
float l9_358=l9_355;
float l9_359=l9_356;
ssGlobals l9_360=param_1;
int l9_361=1;
bool l9_362=true;
bool l9_363=true;
bool l9_364=true;
float l9_365=269.0;
ssParticle l9_366=gParticle;
float l9_367=0.0;
float l9_368=l9_360.gTimeElapsed;
float4 l9_369=float4(0.0);
float4 l9_370=float4(0.0);
if (l9_362)
{
l9_370.x=floor(fract(l9_368)*1000.0);
}
if (l9_364)
{
l9_370.y=float(l9_366.Index1D^((l9_366.Index1D*15299)+l9_366.Index1D));
}
if (l9_363)
{
l9_370.z=l9_365;
}
l9_370.w=l9_367*1000.0;
int l9_371=int(l9_370.x);
int l9_372=int(l9_370.y);
int l9_373=int(l9_370.z);
int l9_374=int(l9_370.w);
int l9_375=(((l9_371*15299)^(l9_372*30133))^(l9_373*17539))^(l9_374*12113);
int l9_376=l9_375;
if (l9_361==1)
{
int l9_377=l9_376;
int l9_378=l9_377;
int l9_379=((l9_378*((l9_378*1471343)+101146501))+1559861749)&2147483647;
int l9_380=l9_379;
float l9_381=float(l9_380)*4.6566129e-10;
float l9_382=l9_381;
l9_369.x=l9_382;
}
else
...
int l9_383=l9_376;
int l9_384=l9_383;
int l9_385=((l9_384*((l9_384*1471343)+101146501))+1559861749)&2147483647;
int l9_386=l9_385;
int l9_387=l9_383*1399;
int l9_388=((l9_387*((l9_387*1471343)+101146501))+1559861749)&2147483647;
int l9_389=l9_388;
int l9_390=l9_386;
float l9_391=float(l9_390)*4.6566129e-10;
int l9_392=l9_389;
float l9_393=float(l9_392)*4.6566129e-10;
float2 l9_394=float2(l9_391,l9_393);
l9_369=float4(l9_394.x,l9_394.y,l9_369.z,l9_369.w);
}
else
{
if (l9_361==3)
...
int l9_395=l9_376;
int l9_396=l9_395;
int l9_397=((l9_396*((l9_396*1471343)+101146501))+1559861749)&2147483647;
int l9_398=l9_397;
int l9_399=l9_395*1399;
int l9_400=((l9_399*((l9_399*1471343)+101146501))+1559861749)&2147483647;
int l9_401=l9_400;
int l9_402=l9_395*7177;
int l9_403=((l9_402*((l9_402*1471343)+101146501))+1559861749)&2147483647;
int l9_404=l9_403;
int l9_405=l9_398;
float l9_406=float(l9_405)*4.6566129e-10;
int l9_407=l9_401;
float l9_408=float(l9_407)*4.6566129e-10;
int l9_409=l9_404;
float l9_410=float(l9_409)*4.6566129e-10;
float3 l9_411=float3(l9_406,l9_408,l9_410);
l9_369=float4(l9_411.x,l9_411.y,l9_411.z,l9_369.w);
}
else
{
int l9_412=l9_376;
int l9_413=l9_412;
int l9_414=((l9_413*((l9_413*1471343)+101146501))+1559861749)&2147483647;
int l9_415=l9_414;
int l9_416=l9_412*1399;
int l9_417=((l9_416*((l9_416*1471343)+101146501))+1559861749)&2147483647;
int l9_418=l9_417;
int l9_419=l9_412*7177;
int l9_420=((l9_419*((l9_419*1471343)+101146501))+1559861749)&2147483647;
int l9_421=l9_420;
int l9_422=l9_412*18919;
int l9_423=((l9_422*((l9_422*1471343)+101146501))+1559861749)&2147483647;
int l9_424=l9_423;
int l9_425=l9_415;
float l9_426=float(l9_425)*4.6566129e-10;
int l9_427=l9_418;
...
float4 l9_433=float4(l9_426,l9_428,l9_430,l9_432);
l9_369=l9_433;
}
}
}
float4 l9_434=l9_369;
float4 l9_435=l9_434;
float l9_436=mix(l9_358,l9_359,l9_435.x);
l9_357=l9_436;
gParticle.Size=l9_357;
gParticle.Velocity=(*sc_set0.UserUniforms).Port_Value_N001;
float3 l9_437=float3(0.0);
l9_437=(*sc_set0.UserUniforms).Port_Import_N013;
float3 l9_438=float3(0.0);
l9_438=(*sc_set0.UserUniforms).Port_Import_N016;
float3 l9_439=float3(0.0);
float3 l9_440=l9_437;
float3 l9_441=l9_438;
ssGlobals l9_442=param_1;
int l9_443=3;
bool l9_444=true;
bool l9_445=true;
bool l9_446=true;
float l9_447=17.0;
ssParticle l9_448=gParticle;
float l9_449=0.0;
float l9_450=l9_442.gTimeElapsed;
float4 l9_451=float4(0.0);
float4 l9_452=float4(0.0);
if (l9_444)
{
l9_452.x=floor(fract(l9_450)*1000.0);
}
if (l9_446)
{
l9_452.y=float(l9_448.Index1D^((l9_448.Index1D*15299)+l9_448.Index1D));
}
if (l9_445)
{
l9_452.z=l9_447;
}
l9_452.w=l9_449*1000.0;
int l9_453=int(l9_452.x);
int l9_454=int(l9_452.y);
int l9_455=int(l9_452.z);
int l9_456=int(l9_452.w);
int l9_457=(((l9_453*15299)^(l9_454*30133))^(l9_455*17539))^(l9_456*12113);
int l9_458=l9_457;
if (l9_443==1)
{
int l9_459=l9_458;
int l9_460=l9_459;
int l9_461=((l9_460*((l9_460*1471343)+101146501))+1559861749)&2147483647;
int l9_462=l9_461;
...
int l9_474=l9_471;
float l9_475=float(l9_474)*4.6566129e-10;
float2 l9_476=float2(l9_473,l9_475);
l9_451=float4(l9_476.x,l9_476.y,l9_451.z,l9_451.w);
}
else
{
if (l9_443==3)
...
int l9_477=l9_458;
int l9_478=l9_477;
int l9_479=((l9_478*((l9_478*1471343)+101146501))+1559861749)&2147483647;
int l9_480=l9_479;
int l9_481=l9_477*1399;
int l9_482=((l9_481*((l9_481*1471343)+101146501))+1559861749)&2147483647;
int l9_483=l9_482;
int l9_484=l9_477*7177;
int l9_485=((l9_484*((l9_484*1471343)+101146501))+1559861749)&2147483647;
int l9_486=l9_485;
int l9_487=l9_480;
float l9_488=float(l9_487)*4.6566129e-10;
int l9_489=l9_483;
float l9_490=float(l9_489)*4.6566129e-10;
int l9_491=l9_486;
float l9_492=float(l9_491)*4.6566129e-10;
float3 l9_493=float3(l9_488,l9_490,l9_492);
l9_451=float4(l9_493.x,l9_493.y,l9_493.z,l9_451.w);
}
else
{
int l9_494=l9_458;
...
int l9_497=l9_496;
int l9_498=l9_494*1399;
int l9_499=((l9_498*((l9_498*1471343)+101146501))+1559861749)&2147483647;
int l9_500=l9_499;
int l9_501=l9_494*7177;
int l9_502=((l9_501*((l9_501*1471343)+101146501))+1559861749)&2147483647;
int l9_503=l9_502;
int l9_504=l9_494*18919;
int l9_505=((l9_504*((l9_504*1471343)+101146501))+1559861749)&2147483647;
int l9_506=l9_505;
int l9_507=l9_497;
float l9_508=float(l9_507)*4.6566129e-10;
int l9_509=l9_500;
...
float4 l9_515=float4(l9_508,l9_510,l9_512,l9_514);
l9_451=l9_515;
}
}
}
float4 l9_516=l9_451;
float4 l9_517=l9_516;
float3 l9_518=mix(l9_440,l9_441,l9_517.xyz);
l9_439=l9_518;
float3x3 l9_519=float3x3(float3(0.0),float3(0.0),float3(0.0));
float3 l9_520=l9_439;
float l9_521=cos(radians(l9_520.x));
float l9_522=sin(radians(l9_520.x));
float l9_523=cos(radians(l9_520.y));
float l9_524=sin(radians(l9_520.y));
float l9_525=cos(radians(l9_520.z));
float l9_526=sin(radians(l9_520.z));
float3x3 l9_527=float3x3(float3(l9_523*l9_525,(l9_521*l9_526)+((l9_522*l9_524)*l9_525),(l9_522*l9_526)-((l9_521*l9_524)*l9_525)),float3((-l9_523)*l9_526,(l9_521*l9_525)-((l9_522*l9_524)*l9_526),(l9_522*l9_525)+((l9_521*l9_524)*l9_526)),float3(l9_524,(-l9_522)*l9_523,l9_521*l9_523));
l9_519=l9_527;
gParticle.Matrix=l9_519;
float4 l9_528=float4(0.0);
float4 l9_529=(*sc_set0.UserUniforms).Tweak_N79;
l9_528=l9_529;
float4 l9_530=float4(0.0);
l9_530=l9_528;
float4 l9_531=float4(0.0);
float4 l9_532=(*sc_set0.UserUniforms).Tweak_N80;
l9_531=l9_532;
float4 l9_533=float4(0.0);
l9_533=l9_531;
float l9_534=0.0;
float l9_535=(*sc_set0.UserUniforms).Port_Min_N043;
float l9_536=(*sc_set0.UserUniforms).Port_Max_N043;
ssGlobals l9_537=param_1;
int l9_538=1;
bool l9_539=true;
bool l9_540=true;
bool l9_541=true;
float l9_542=43.0;
ssParticle l9_543=gParticle;
float l9_544=0.0;
float l9_545=l9_537.gTimeElapsed;
float4 l9_546=float4(0.0);
float4 l9_547=float4(0.0);
if (l9_539)
{
l9_547.x=floor(fract(l9_545)*1000.0);
}
if (l9_541)
{
l9_547.y=float(l9_543.Index1D^((l9_543.Index1D*15299)+l9_543.Index1D));
}
if (l9_540)
{
l9_547.z=l9_542;
}
l9_547.w=l9_544*1000.0;
int l9_548=int(l9_547.x);
int l9_549=int(l9_547.y);
int l9_550=int(l9_547.z);
int l9_551=int(l9_547.w);
int l9_552=(((l9_548*15299)^(l9_549*30133))^(l9_550*17539))^(l9_551*12113);
int l9_553=l9_552;
if (l9_538==1)
{
int l9_554=l9_553;
...
int l9_563=l9_562;
int l9_564=l9_560*1399;
int l9_565=((l9_564*((l9_564*1471343)+101146501))+1559861749)&2147483647;
int l9_566=l9_565;
int l9_567=l9_563;
float l9_568=float(l9_567)*4.6566129e-10;
int l9_569=l9_566;
float l9_570=float(l9_569)*4.6566129e-10;
float2 l9_571=float2(l9_568,l9_570);
l9_546=float4(l9_571.x,l9_571.y,l9_546.z,l9_546.w);
}
else
{
if (l9_538==3)
...
l9_546=float4(l9_588.x,l9_588.y,l9_588.z,l9_546.w);
}
else
{
int l9_589=l9_553;
int l9_590=l9_589;
int l9_591=((l9_590*((l9_590*1471343)+101146501))+1559861749)&2147483647;
int l9_592=l9_591;
int l9_593=l9_589*1399;
int l9_594=((l9_593*((l9_593*1471343)+101146501))+1559861749)&2147483647;
int l9_595=l9_594;
int l9_596=l9_589*7177;
int l9_597=((l9_596*((l9_596*1471343)+101146501))+1559861749)&2147483647;
int l9_598=l9_597;
int l9_599=l9_589*18919;
int l9_600=((l9_599*((l9_599*1471343)+101146501))+1559861749)&2147483647;
int l9_601=l9_600;
int l9_602=l9_592;
float l9_603=float(l9_602)*4.6566129e-10;
int l9_604=l9_595;
float l9_605=float(l9_604)*4.6566129e-10;
int l9_606=l9_598;
float l9_607=float(l9_606)*4.6566129e-10;
int l9_608=l9_601;
float l9_609=float(l9_608)*4.6566129e-10;
float4 l9_610=float4(l9_603,l9_605,l9_607,l9_609);
l9_546=l9_610;
}
}
}
float4 l9_611=l9_546;
float4 l9_612=l9_611;
float l9_613=mix(l9_535,l9_536,l9_612.x);
l9_534=l9_613;
float4 l9_614=float4(0.0);
l9_614=mix(l9_530,l9_533,float4(l9_534));
gParticle.Color=l9_614;
...
float4 l9_618=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
...
bool l9_623=true;
float l9_624=38.0;
ssParticle l9_625=gParticle;
float l9_626=0.0;
float l9_627=param_6.gTimeElapsed;
float4 l9_628=float4(0.0);
float4 l9_629=float4(0.0);
if (l9_621)
{
l9_629.x=floor(fract(l9_627)*1000.0);
}
if (l9_623)
{
l9_629.y=float(l9_625.Index1D^((l9_625.Index1D*15299)+l9_625.Index1D));
}
if (l9_622)
{
l9_629.z=l9_624;
}
l9_629.w=l9_626*1000.0;
int l9_630=int(l9_629.x);
int l9_631=int(l9_629.y);
int l9_632=int(l9_629.z);
int l9_633=int(l9_629.w);
int l9_634=(((l9_630*15299)^(l9_631*30133))^(l9_632*17539))^(l9_633*12113);
int l9_635=l9_634;
if (l9_620==1)
{
int l9_636=l9_635;
...
int l9_639=l9_638;
float l9_640=float(l9_639)*4.6566129e-10;
float l9_641=l9_640;
l9_628.x=l9_641;
}
else
...
int l9_642=l9_635;
int l9_643=l9_642;
int l9_644=((l9_643*((l9_643*1471343)+101146501))+1559861749)&2147483647;
int l9_645=l9_644;
int l9_646=l9_642*1399;
int l9_647=((l9_646*((l9_646*1471343)+101146501))+1559861749)&2147483647;
int l9_648=l9_647;
int l9_649=l9_645;
float l9_650=float(l9_649)*4.6566129e-10;
int l9_651=l9_648;
float l9_652=float(l9_651)*4.6566129e-10;
float2 l9_653=float2(l9_650,l9_652);
l9_628=float4(l9_653.x,l9_653.y,l9_628.z,l9_628.w);
}
else
{
if (l9_620==3)
...
float3 l9_670=float3(l9_665,l9_667,l9_669);
l9_628=float4(l9_670.x,l9_670.y,l9_670.z,l9_628.w);
}
else
{
int l9_671=l9_635;
...
int l9_674=l9_673;
int l9_675=l9_671*1399;
int l9_676=((l9_675*((l9_675*1471343)+101146501))+1559861749)&2147483647;
int l9_677=l9_676;
int l9_678=l9_671*7177;
int l9_679=((l9_678*((l9_678*1471343)+101146501))+1559861749)&2147483647;
int l9_680=l9_679;
int l9_681=l9_671*18919;
...
float4 l9_692=float4(l9_685,l9_687,l9_689,l9_691);
l9_628=l9_692;
}
}
}
float4 l9_693=l9_628;
float4 l9_694=l9_693;
float param_5=mix(param_3,param_4,l9_694.x);
Random_N38=param_5;
...
bool l9_698=true;
float l9_699=23.0;
ssParticle l9_700=gParticle;
float l9_701=0.0;
float l9_702=param_10.gTimeElapsed;
float4 l9_703=float4(0.0);
float4 l9_704=float4(0.0);
if (l9_696)
{
l9_704.x=floor(fract(l9_702)*1000.0);
}
if (l9_698)
{
l9_704.y=float(l9_700.Index1D^((l9_700.Index1D*15299)+l9_700.Index1D));
}
if (l9_697)
{
l9_704.z=l9_699;
}
l9_704.w=l9_701*1000.0;
int l9_705=int(l9_704.x);
int l9_706=int(l9_704.y);
int l9_707=int(l9_704.z);
int l9_708=int(l9_704.w);
int l9_709=(((l9_705*15299)^(l9_706*30133))^(l9_707*17539))^(l9_708*12113);
int l9_710=l9_709;
if (l9_695==1)
{
int l9_711=l9_710;
...
int l9_717=l9_710;
int l9_718=l9_717;
int l9_719=((l9_718*((l9_718*1471343)+101146501))+1559861749)&2147483647;
int l9_720=l9_719;
int l9_721=l9_717*1399;
int l9_722=((l9_721*((l9_721*1471343)+101146501))+1559861749)&2147483647;
int l9_723=l9_722;
int l9_724=l9_720;
float l9_725=float(l9_724)*4.6566129e-10;
int l9_726=l9_723;
float l9_727=float(l9_726)*4.6566129e-10;
float2 l9_728=float2(l9_725,l9_727);
l9_703=float4(l9_728.x,l9_728.y,l9_703.z,l9_703.w);
}
else
{
if (l9_695==3)
...
int l9_729=l9_710;
int l9_730=l9_729;
int l9_731=((l9_730*((l9_730*1471343)+101146501))+1559861749)&2147483647;
int l9_732=l9_731;
int l9_733=l9_729*1399;
int l9_734=((l9_733*((l9_733*1471343)+101146501))+1559861749)&2147483647;
int l9_735=l9_734;
int l9_736=l9_729*7177;
int l9_737=((l9_736*((l9_736*1471343)+101146501))+1559861749)&2147483647;
int l9_738=l9_737;
int l9_739=l9_732;
float l9_740=float(l9_739)*4.6566129e-10;
int l9_741=l9_735;
float l9_742=float(l9_741)*4.6566129e-10;
int l9_743=l9_738;
float l9_744=float(l9_743)*4.6566129e-10;
float3 l9_745=float3(l9_740,l9_742,l9_744);
l9_703=float4(l9_745.x,l9_745.y,l9_745.z,l9_703.w);
}
else
{
int l9_746=l9_710;
...
int l9_749=l9_748;
int l9_750=l9_746*1399;
int l9_751=((l9_750*((l9_750*1471343)+101146501))+1559861749)&2147483647;
int l9_752=l9_751;
int l9_753=l9_746*7177;
int l9_754=((l9_753*((l9_753*1471343)+101146501))+1559861749)&2147483647;
int l9_755=l9_754;
int l9_756=l9_746*18919;
int l9_757=((l9_756*((l9_756*1471343)+101146501))+1559861749)&2147483647;
int l9_758=l9_757;
int l9_759=l9_749;
float l9_760=float(l9_759)*4.6566129e-10;
int l9_761=l9_752;
float l9_762=float(l9_761)*4.6566129e-10;
int l9_763=l9_755;
float l9_764=float(l9_763)*4.6566129e-10;
int l9_765=l9_758;
float l9_766=float(l9_765)*4.6566129e-10;
float4 l9_767=float4(l9_760,l9_762,l9_764,l9_766);
l9_703=l9_767;
}
}
}
float4 l9_768=l9_703;
float4 l9_769=l9_768;
float param_9=mix(param_7,param_8,l9_769.x);
Random_N23=param_9;
...
bool l9_773=true;
float l9_774=125.0;
ssParticle l9_775=gParticle;
float l9_776=0.0;
float l9_777=param_14.gTimeElapsed;
float4 l9_778=float4(0.0);
float4 l9_779=float4(0.0);
if (l9_771)
{
l9_779.x=floor(fract(l9_777)*1000.0);
}
if (l9_773)
{
l9_779.y=float(l9_775.Index1D^((l9_775.Index1D*15299)+l9_775.Index1D));
}
if (l9_772)
{
l9_779.z=l9_774;
}
l9_779.w=l9_776*1000.0;
int l9_780=int(l9_779.x);
int l9_781=int(l9_779.y);
int l9_782=int(l9_779.z);
int l9_783=int(l9_779.w);
int l9_784=(((l9_780*15299)^(l9_781*30133))^(l9_782*17539))^(l9_783*12113);
int l9_785=l9_784;
if (l9_770==1)
{
int l9_786=l9_785;
int l9_787=l9_786;
int l9_788=((l9_787*((l9_787*1471343)+101146501))+1559861749)&2147483647;
int l9_789=l9_788;
float l9_790=float(l9_789)*4.6566129e-10;
float l9_791=l9_790;
l9_778.x=l9_791;
}
else
...
int l9_792=l9_785;
int l9_793=l9_792;
int l9_794=((l9_793*((l9_793*1471343)+101146501))+1559861749)&2147483647;
int l9_795=l9_794;
int l9_796=l9_792*1399;
int l9_797=((l9_796*((l9_796*1471343)+101146501))+1559861749)&2147483647;
int l9_798=l9_797;
int l9_799=l9_795;
float l9_800=float(l9_799)*4.6566129e-10;
int l9_801=l9_798;
float l9_802=float(l9_801)*4.6566129e-10;
float2 l9_803=float2(l9_800,l9_802);
l9_778=float4(l9_803.x,l9_803.y,l9_778.z,l9_778.w);
}
else
{
if (l9_770==3)
...
float3 l9_820=float3(l9_815,l9_817,l9_819);
l9_778=float4(l9_820.x,l9_820.y,l9_820.z,l9_778.w);
}
else
{
int l9_821=l9_785;
int l9_822=l9_821;
int l9_823=((l9_822*((l9_822*1471343)+101146501))+1559861749)&2147483647;
int l9_824=l9_823;
int l9_825=l9_821*1399;
int l9_826=((l9_825*((l9_825*1471343)+101146501))+1559861749)&2147483647;
int l9_827=l9_826;
int l9_828=l9_821*7177;
int l9_829=((l9_828*((l9_828*1471343)+101146501))+1559861749)&2147483647;
int l9_830=l9_829;
int l9_831=l9_821*18919;
...
float4 l9_842=float4(l9_835,l9_837,l9_839,l9_841);
l9_778=l9_842;
}
}
}
float4 l9_843=l9_778;
float4 l9_844=l9_843;
float param_13=mix(param_11,param_12,l9_844.x);
...
float l9_845=dot(param_15,param_15);
float l9_846;
if (l9_845>0.0)
{
l9_846=1.0/sqrt(l9_845);
}
else
{
l9_846=0.0;
...
float l9_847=l9_846;
float3 param_16=param_15*l9_847;
...
float3 l9_848=normalize(param_17);
float l9_849=sin(radians(param_18));
float l9_850=cos(radians(param_18));
float l9_851=1.0-l9_850;
float3x3 param_19=float3x3(float3(((l9_851*l9_848.x)*l9_848.x)+l9_850,((l9_851*l9_848.x)*l9_848.y)-(l9_848.z*l9_849),((l9_851*l9_848.z)*l9_848.x)+(l9_848.y*l9_849)),float3(((l9_851*l9_848.x)*l9_848.y)+(l9_848.z*l9_849),((l9_851*l9_848.y)*l9_848.y)+l9_850,((l9_851*l9_848.y)*l9_848.z)-(l9_848.x*l9_849)),float3(((l9_851*l9_848.z)*l9_848.x)-(l9_848.y*l9_849),((l9_851*l9_848.y)*l9_848.z)+(l9_848.x*l9_849),((l9_851*l9_848.z)*l9_848.z)+l9_850));
...
float4 l9_852=param_21;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_853=dot(l9_852,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_854=l9_853;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_854;
}
}
float4 l9_855=float4(param_21.x,-param_21.y,(param_21.z*0.5)+(param_21.w*0.5),param_21.w);
out.gl_Position=l9_855;
return out;
}
float l9_856;
...
{
l9_856=gParticle.Force.x;
}
gParticle.Force.x=l9_856;
float l9_857;
...
{
l9_857=gParticle.Force.y;
}
gParticle.Force.y=l9_857;
float l9_858;
...
{
l9_858=gParticle.Force.z;
}
gParticle.Force.z=l9_858;
...
{
l9_859=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_859;
float l9_860;
...
{
l9_860=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_860;
float l9_861;
...
{
l9_861=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_861;
...
int l9_862=gl_InstanceIndex;
int offsetID=(*sc_set0.UserUniforms).vfxOffsetInstancesWrite+l9_862;
int particleRow=512;
...
float4 l9_865=param_22;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_866=dot(l9_865,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_867=l9_866;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_867;
}
}
float4 l9_868=float4(param_22.x,-param_22.y,(param_22.z*0.5)+(param_22.w*0.5),param_22.w);
out.gl_Position=l9_868;
int l9_869=gl_InstanceIndex;
out.Interp_Particle_Index=l9_869;
...
float4 l9_870=param_23;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_871=dot(l9_870,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_872=l9_871;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_872;
}
}
float4 l9_873=float4(param_23.x,-param_23.y,(param_23.z*0.5)+(param_23.w*0.5),param_23.w);
out.gl_Position=l9_873;
return out;
}
return out;
}
