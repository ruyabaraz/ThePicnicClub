...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/150];
}
else
{
l9_15=l9_14;
...
float l9_10=floor(12.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_10))/12.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_10)/12.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
