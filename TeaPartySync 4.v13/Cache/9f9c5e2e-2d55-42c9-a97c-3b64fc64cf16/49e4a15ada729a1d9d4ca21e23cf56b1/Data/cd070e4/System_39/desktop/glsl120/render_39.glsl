...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,l9_8,fract(abs(((l9_7*0.97637898)+0.151235)+(floor(((((l9_9-l9_8)-0.0)+0.0)+6.0)/3.0)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))/vec2(399.0),float(((l9_0*((l9_0*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,l9_0,l9_2,l9_3,(60*(l9_1+1))-1,(l9_5+0.5)/60.0,l9_7,l9_3/59.0,l9_4,(l9_6+vec2(0.5))/vec2(60.0,1.0),l9_6/vec2(59.0,1.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/60];
}
else
{
l9_17=l9_16;
...
bool l9_1=l9_0>=(60*(vfxNumCopies+1));
bool l9_2;
if (!l9_1)
{
l9_2=vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/60]==false;
}
else
{
l9_2=l9_1;
...
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/60]*vec4(gParticle.Position,1.0)).xyz;
int l9_7=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/60;
gParticle.Velocity=mat3(vfxModelMatrix[l9_7][0].xyz,vfxModelMatrix[l9_7][1].xyz,vfxModelMatrix[l9_7][2].xyz)*gParticle.Velocity;
int l9_8=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/60;
gParticle.Force=mat3(vfxModelMatrix[l9_8][0].xyz,vfxModelMatrix[l9_8][1].xyz,vfxModelMatrix[l9_8][2].xyz)*gParticle.Force;
int l9_9=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/60;
...
{
return ssPow(max(0.0,dot(viewVector,reflect(lightDirection,normal))),exp(10.0-N106_SpecHighlightSize))*N106_SpecularStrength;
}
...
void main()
{
N106_SpecularStrength=0.0;
N106_SpecHighlightSize=0.0;
...
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),baseTexLayout,l9_5);
...
#endif
float l9_30=clamp(Port_Import_N102,0.0,1.0);
N106_SpecularStrength=clamp(Port_Import_N103,0.0,1.0);
N106_SpecHighlightSize=clamp(Port_Import_N104,0.001,10.0);
vec3 l9_31=normalize(varPos-sc_Camera.position);
vec3 l9_32;
if (clamp(Port_Import_N100,0.0,1.0)!=0.0)
{
vec3 l9_33;
...
{
l9_32=Port_Import_N099;
}
vec4 l9_34;
if (sc_DirectionalLightsCount>0)
{
vec4 l9_35;
l9_35=vec4(0.0,0.0,0.0,1.0);
vec4 l9_36;
int l9_37=0;
bool l9_38;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_38=l9_37<sc_DirectionalLightsCount;
if (l9_38)
{
vec3 l9_39;
if (l9_38)
{
l9_39=-sc_DirectionalLights[l9_37].direction;
}
else
{
l9_39=vec3(0.0);
...
if (l9_38)
{
l9_41=sc_DirectionalLights[l9_37].color.xyz;
}
else
{
l9_41=vec3(0.0);
...
if (l9_38)
{
l9_42=sc_DirectionalLights[l9_37].color.w;
}
else
{
l9_42=0.0;
}
vec3 l9_43=l9_41*l9_42;
vec3 l9_44=(l9_35.xyz+(l9_43*(max(0.0,dot(l9_32,l9_40))*l9_30))).xyz+(l9_43*N106_getSpecular(l9_31,l9_32,l9_40));
l9_36=vec4(l9_44.x,l9_44.y,l9_44.z,l9_35.w);
l9_35=l9_36;
l9_37++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_49=l9_48<sc_PointLightsCount;
if (l9_49)
{
vec3 l9_50;
if (l9_49)
{
l9_50=sc_PointLights[l9_48].position;
}
else
{
l9_50=vec3(0.0);
...
if (l9_49)
{
l9_51=sc_PointLights[l9_48].color.xyz;
}
else
{
l9_51=vec3(0.0);
...
if (l9_49)
{
l9_52=sc_PointLights[l9_48].color.w;
}
else
{
l9_52=0.0;
}
vec3 l9_53=-normalize(varPos-l9_50);
vec3 l9_54=l9_51*l9_52;
vec3 l9_55=(l9_46.xyz+(l9_54*(max(0.0,dot(l9_32,l9_53))*l9_30))).xyz+(l9_54*N106_getSpecular(l9_31,l9_32,l9_53));
l9_47=vec4(l9_55.x,l9_55.y,l9_55.z,l9_46.w);
l9_46=l9_47;
l9_48++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_60=l9_59<sc_AmbientLightsCount;
if (l9_60)
{
vec3 l9_61;
if (l9_60)
{
l9_61=sc_AmbientLights[l9_59].color;
}
else
{
l9_61=vec3(0.0);
...
if (l9_60)
{
l9_62=sc_AmbientLights[l9_59].intensity;
}
else
{
l9_62=0.0;
}
vec3 l9_63=l9_57.xyz+((l9_61*l9_62)*clamp(Port_Import_N105,0.0,1.0));
l9_58=vec4(l9_63.x,l9_63.y,l9_63.z,l9_57.w);
l9_57=l9_58;
l9_59++;
continue;
}
...
vec4 l9_64=Interp_Particle_Color*l9_29;
vec4 l9_65=l9_56*l9_64;
vec4 l9_66;
...
#if (sc_StereoRenderingMode==1)
{
vec3 l9_74=vec3(l9_72,0.0);
l9_74.y=((2.0*l9_72.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_73=l9_74.xy;
}
#else
{
...
#endif
l9_68=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_73,sc_ScreenTextureLayout,l9_75).xy,0.0);
}
#endif
vec4 l9_76;
...
{
vec4 l9_77=l9_68;
l9_77.x=l9_68.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_76=l9_77;
}
#else
{
...
#endif
vec3 l9_78=mix(l9_76.xyz,definedBlend(l9_76.xyz,l9_65.xyz).xyz,vec3(l9_65.w));
...
{
float l9_81=l9_65.w;
l9_80=vec4(mix(vec3(1.0),l9_65.xyz,vec3(l9_81)),l9_81);
}
#else
{
vec4 l9_82;
...
#endif
l9_82=vec4(l9_65.xyz*l9_84,l9_84);
}
#else
{
l9_82=l9_65;
