...
gParticle.CopyId=float(InstanceID/240);
...
l9_61=!(UserUniforms.vfxBatchEnable[l9_62/240]!=0);
}
else
{
l9_61=l9_60;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/240];
