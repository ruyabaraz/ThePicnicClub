...
//float Port_Import_N003 7280
//float Port_Import_N005 7284
...
float param_3=(*sc_set0.UserUniforms).AlphaMax;
Output_N31=param_3;
float Value_N59=0.0;
Value_N59=Output_N31;
...
float param_4=(*sc_set0.UserUniforms).Port_Min_N038;
float param_5=(*sc_set0.UserUniforms).Port_Max_N038;
...
float l9_626=0.0;
float l9_627=param_7.gTimeElapsed;
...
float param_6=mix(param_4,param_5,l9_694.x);
Random_N38=param_6;
float Value_N251=0.0;
Value_N251=Random_N38;
float Random_N23=0.0;
float param_8=(*sc_set0.UserUniforms).Port_Min_N023;
float param_9=(*sc_set0.UserUniforms).Port_Max_N023;
...
float l9_701=0.0;
float l9_702=param_11.gTimeElapsed;
...
float param_10=mix(param_8,param_9,l9_769.x);
Random_N23=param_10;
...
float param_12=(*sc_set0.UserUniforms).Port_Min_N125;
float param_13=(*sc_set0.UserUniforms).Port_Max_N125;
...
float l9_776=0.0;
float l9_777=param_15.gTimeElapsed;
...
float param_14=mix(param_12,param_13,l9_844.x);
Random_N125=param_14;
...
float3 param_16=Value_N161;
float l9_845=dot(param_16,param_16);
float l9_846;
if (l9_845>0.0)
{
...
float l9_847=l9_846;
float3 param_17=param_16*l9_847;
Output_N162=param_17;
...
float3x3 param_21=gParticle.Matrix;
gParticle.Quaternion=matrixToQuaternion(param_21);
float Drift=0.0049999999;
if (gParticle.Dead)
{
float4 param_22=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_855=float4(param_22.x,-param_22.y,(param_22.z*0.5)+(param_22.w*0.5),param_22.w);
...
Vertex.y=l9_864;
Vertex+=Offset;
float4 param_23=float4((Vertex*2.0)-float2(1.0),1.0,1.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_868=float4(param_23.x,-param_23.y,(param_23.z*0.5)+(param_23.w*0.5),param_23.w);
...
if (gParticle.Dead)
{
float4 param_24=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_873=float4(param_24.x,-param_24.y,(param_24.z*0.5)+(param_24.w*0.5),param_24.w);
