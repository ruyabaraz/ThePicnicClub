...
gParticle.Position=Port_Import_N216+((((l9_12/(vec3(length(l9_12))+vec3(1.234e-06)))*vec3(l9_16))*vec3(LifeMin))*Port_Import_N089);
gParticle.Life=mix(LifeMin,Port_Import_N005,ssGetParticleRandom(1,true,true,true,9.0,gParticle,0.0,sc_Time.x).x);
