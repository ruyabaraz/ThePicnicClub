...
vec4 l9_69=mix(l9_62,Port_Input1_N024,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
vec2 l9_70=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
bool l9_71=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_72=l9_70.x;
float l9_73=l9_72;
...
{
l9_79=1.0;
l9_78=vec2(l9_74,l9_77);
}
#endif
vec2 l9_88=sc_TransformUV(l9_78,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_89=l9_88.x;
float l9_90=l9_79;
sc_SoftwareWrapLate(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_71,l9_90);
float l9_91=l9_88.y;
float l9_92=l9_90;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_71,l9_92);
float l9_93=l9_92;
...
{
float l9_98=l9_72;
sc_SoftwareWrapEarly(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_99=l9_98;
float l9_100=l9_75;
sc_SoftwareWrapEarly(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_101=l9_100;
vec2 l9_102;
float l9_103;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_104=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_104=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_105=l9_99;
float l9_106=1.0;
sc_ClampUV(l9_105,iconUvMinMax.x,iconUvMinMax.z,l9_104,l9_106);
float l9_107=l9_105;
float l9_108=l9_106;
bool l9_109;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_109=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_110=l9_101;
float l9_111=l9_108;
sc_ClampUV(l9_110,iconUvMinMax.y,iconUvMinMax.w,l9_109,l9_111);
l9_103=l9_111;
...
#endif
vec2 l9_112=sc_TransformUV(l9_102,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_113=l9_112.x;
float l9_114=l9_103;
sc_SoftwareWrapLate(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_71,l9_114);
float l9_115=l9_112.y;
float l9_116=l9_114;
sc_SoftwareWrapLate(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_71,l9_116);
float l9_117=l9_116;
vec3 l9_118=sc_SamplingCoordsViewToGlobal(vec2(l9_113,l9_115),iconLayout,iconGetStereoViewIndex());
vec4 l9_119=texture2D(icon,l9_118.xy,0.0);
vec4 l9_120;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_120=mix(iconBorderColor,l9_119,vec4(l9_117));
}
#else
{
l9_120=l9_119;
...
{
l9_97=Port_Input2_N007;
}
vec4 l9_121=vec4(l9_97);
vec4 l9_122=mix(mix(l9_32,l9_60,vec4(Port_Input2_N005))+l9_69,l9_96,l9_121);
