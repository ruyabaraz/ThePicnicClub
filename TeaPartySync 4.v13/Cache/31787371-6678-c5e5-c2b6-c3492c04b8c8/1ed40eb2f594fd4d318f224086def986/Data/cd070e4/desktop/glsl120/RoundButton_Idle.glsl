...
#endif
vec3 l9_62=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_38.xyz).xyz,vec3(l9_34.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_64=vec4(mix(vec3(1.0),l9_38.xyz,vec3(l9_34.w)),l9_34.w);
}
#else
{
vec4 l9_65;
