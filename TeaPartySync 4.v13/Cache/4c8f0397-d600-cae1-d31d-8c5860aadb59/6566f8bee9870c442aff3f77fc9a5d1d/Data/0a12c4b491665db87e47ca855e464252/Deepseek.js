...
class DeepSeek {
    ...
    static chatCompletions(deepSeekRequest) {
        return new Promise((resolve, reject) => {
            ...
            let apiToken = RemoteServiceGatewayCredentials_1.RemoteServiceGatewayCredentials.getApiToken(RemoteServiceGatewayCredentials_1.AvaliableApiTypes.DeepSeek);
